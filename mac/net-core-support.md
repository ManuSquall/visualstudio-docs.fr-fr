...
Version du kit SDK .NET Core  |Visual Studio pour Mac 8.1 (stable)  |Visual Studio pour Mac 8.2 (préversion)  |
|---------|---------|---------|
|v2.1.0 - v2.1.5xx    |✗|✗|
|v2.1.600 +     |✔︎|✔︎|
|v2.2.1 - v2.2.1xx|✗|✗|
...
* .NET Core v2.1.700 est installé par défaut avec le programme d’installation.
