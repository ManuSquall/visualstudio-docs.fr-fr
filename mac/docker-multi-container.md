...
1. Dans le solution Pad, cliquez à droite sur le projet DockerDemoFrontEnd et **sélectionnez Ajouter > Ajouter le support Docker**: ![Ajouter le support docker](media/docker-quickstart-3.png)
