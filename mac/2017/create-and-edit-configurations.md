...
ms.locfileid: "74983576"
---
# <a name="creating-and-editing-build-configurations"></a>Création et modification des configurations de build

Les configurations de build peuvent être créées pour des projets individuels ou à l’échelle d’une solution. Ces configurations vous donnent un contrôle précis sur une build.
