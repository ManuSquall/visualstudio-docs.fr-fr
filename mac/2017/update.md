...
* **Version bêta**  /  **Alpha** -fournit un accès précoce aux mises à jour qui sont candidates pour la mise en version dans le canal stable. Ces versions peuvent ne pas être fiables pour une utilisation quotidienne.
