...
1. Dans la boîte de dialogue **nouveau projet** , accédez à **.net Core** ** > ** application > **application Web** , puis sélectionnez **suivant**:
...
1. Exécutez le projet sans débogage à l’aide de la **commande + option + F5**.
   ...
   Visual Studio démarre [Kestrel](/aspnet/core/fundamentals/servers/kestrel), ouvre un navigateur pour `https://localhost:5001`et affiche votre première application Web Razor.
