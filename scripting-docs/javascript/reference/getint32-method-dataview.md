---
title: "getInt32, m&#233;thode (DataView) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# getInt32, m&#233;thode (DataView)
Obtient la valeur Int32 au niveau de l'offset d'octet spécifié à partir du début de la vue.  Il n'existe aucune contrainte d'alignement ; les valeurs multioctets peuvent être extraite à partir de n'importe quel offset.  
...
## Paramètres  
 `testInt`  
 Obligatoire.  Valeur Int32 retournée par la méthode.  
