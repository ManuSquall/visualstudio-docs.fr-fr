---
title: Math.Sqrt, fonction (JavaScript) | Documents Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638429"
---
# <a name="mathsqrt-function-javascript"></a>Math.sqrt, fonction (JavaScript)
...
## <a name="remarks"></a>Remarques  
 ...
 Si `number` est négatif, la valeur de retour est `NaN`.  
