---
title: "constructor, propriété (Intl.DateTimeFormat) | Documents Microsoft"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intldatetimeformat"></a>constructor, propriété (Intl.DateTimeFormat)
Spécifie la fonction qui crée un formateur.  
...
## <a name="remarks"></a>Remarques  
 Requis `dateTimeFormatter` est le nom du module de formatage.  
