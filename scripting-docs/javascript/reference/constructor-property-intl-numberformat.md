---
title: "constructor, propriété (Intl.NumberFormat) | Documents Microsoft"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intlnumberformat"></a>constructor, propriété (Intl.NumberFormat)
...
## <a name="remarks"></a>Remarques  
 Requis `numberFormatter` est le nom du module de formatage.  
