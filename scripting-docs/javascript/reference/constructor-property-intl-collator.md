---
title: "constructor, propriété (Intl.Collator) | Documents Microsoft"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intlcollator"></a>constructor, propriété (Intl.Collator)
Spécifie la fonction qui crée un assembleur.  
...
## <a name="remarks"></a>Remarques  
 Requis `collator` est le nom de l’assembleur.  
