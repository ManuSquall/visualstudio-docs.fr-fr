...
> [!IMPORTANT]
>  [!INCLUDE[jsv12text](../../javascript/includes/jsv12text-md.md)] \(navigateur Edge dans Windows 10\) n'inclut pas de prise en charge des modes de document hérités. La prise en charge des applications [!INCLUDE[winphone_appname](../../javascript/reference/includes/winphone-appname-md.md)] commence par Windows Phone 8.1. Les fonctionnalités expérimentales \(about:flags\) sont signalées par « Exp ».  
...
|------------------------|--------------------------------------------------------------------------------------------|-------------------------------------------|-------------------------------------------|--------------------------------------------|--------------------------------------------|--------------------|---------------------------|  
|[\_\_proto\_\_, propriété \(Object\)](../../javascript/reference/proto-property-object-javascript.md)|N|N|N|N|Y|Y|v8 \(Win\) : N<br />v8.1 \(Win\) : Y<br />v8.1 \(Phone\) : Y|  
|[$1...$9, propriétés \(RegExp\)](../../javascript/reference/dollar-1-dot-dot-dot-dollar-9-properties-regexp-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
...
|[Array.from, fonction \(Array\)](../../javascript/reference/array-from-function-array-javascript.md)|N|N|N|N|N|N|v8.1 : N<br />v10 : Y|  
|[Array.isArray, fonction](../../javascript/reference/array-isarray-function-javascript.md)|N|N|Y|Y|Y|Y|Y|  
|[Array.of, fonction \(Array\)](../../javascript/reference/array-of-function-array-javascript.md)|N|N|N|N|N|N|v8.1 : N<br />v10 : Y|  
|[ArrayBuffer, objet](../../javascript/reference/arraybuffer-object.md)|N|N|N|Y|Y|Y|Y|  
...
|[Object.assign, fonction \(Object\)](../../javascript/reference/object-assign-function-object-javascript.md)|N|N|N|N|N|N|v8.1 : N<br />v10 : Y|  
...
|[\<\< \(décalage vers la gauche\), opérateur de bits](../../javascript/reference/bitwise-left-shift-operator-decrement-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
|[~, opérateur de bits NOT](../../javascript/reference/bitwise-not-operator-decrement-tilde-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
|[Opération d'assignation au niveau du bit OR \(&#124;\=\)](../../javascript/reference/bitwise-or-assignment-operator-decrement-equal-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
|[Opérateur au niveau du bit OR \(&#124;\)](../../javascript/reference/bitwise-or-operator-decrement-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
...
|[WinRTError, objet](../../javascript/reference/winrterror-object-javascript.md)|N|N|N|Y|Y|Y|Y|  
