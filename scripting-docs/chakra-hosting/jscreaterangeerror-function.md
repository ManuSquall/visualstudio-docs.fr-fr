---
title: JsCreateRangeError, fonction | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24567819"
---
# <a name="jscreaterangeerror-function"></a>JsCreateRangeError, fonction
Crée un objet d'erreur JavaScript RangeError  
