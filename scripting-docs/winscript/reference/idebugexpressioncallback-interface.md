...
|Méthode|Description|  
|------------|-----------------|  
|[IDebugExpressionCallBack::onComplete](../../winscript/reference/idebugexpressioncallback-oncomplete.md)|Indique que l’évaluation d’expression est terminée.|