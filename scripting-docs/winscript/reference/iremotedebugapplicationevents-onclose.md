---
title: IRemoteDebugApplicationEvents::OnClose | Documents Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
## <a name="remarks"></a>Remarques  
 Cette méthode gère un événement fermer une application.  
