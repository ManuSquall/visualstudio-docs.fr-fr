...
> [!NOTE]
>  Le `IJSDebug*` interfaces et les `IEnumJsStackFrames` interface ont été apparus dans Internet Explorer 11 pour le débogage de code natif avec script. Le fichier d’en-tête de ces interfaces est jscript9diag.h.  
  
## <a name="in-this-section"></a>Dans cette section  
 Les interfaces suivantes autoriser indépendante du langage, indépendant de l’hôte de débogage :  
...
-   [Interface IWebAppDiagnosticsObjectInitialization](../../winscript/reference/iwebappdiagnosticsobjectinitialization-interface.md)  
 ...
 La section suivante répertorie les constantes, énumérations et structures utilisées pour le débogage :  
