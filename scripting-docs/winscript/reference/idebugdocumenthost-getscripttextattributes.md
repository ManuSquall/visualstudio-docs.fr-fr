...
#### <a name="parameters"></a>Paramètres  
 `pstrCode`  
 dans Texte du bloc de script. Cette chaîne ne doit pas nécessairement se terminer par une valeur null.  
...
## <a name="remarks"></a>Notes  
 Cette méthode retourne les attributs de texte pour un bloc arbitraire de texte de document. Il est acceptable pour les hôtes de retourner des `E_NOTIMPL`, auquel cas les attributs par défaut sont utilisés.  
