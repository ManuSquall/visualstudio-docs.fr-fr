...
ms.locfileid: "72571518"
---
# <a name="idebugformattergetvariantforstring"></a>IDebugFormatter::GetVariantForString
Retourne une valeur de type VARIANT contenant la chaîne donnée.  
...
#### <a name="parameters"></a>Paramètres  
 `pwstrValue`  
 dans Chaîne à stocker dans une variante.  
  
 `pvar`  
 à VARIANT contenant `pwstrValue`.  
...
## <a name="remarks"></a>Notes  
 Cette méthode retourne un VARIANT contenant la chaîne donnée.  
