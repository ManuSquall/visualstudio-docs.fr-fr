---
title: Ijsdebugprocess::performasyncbreak, méthode | Documents Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24728089"
---
# <a name="ijsdebugprocessperformasyncbreak-method"></a>IJsDebugProcess::PerformAsyncBreak, méthode
Place le moteur de script en mode arrêt, entraînant son arrêt sur l’instruction de script suivante.  
