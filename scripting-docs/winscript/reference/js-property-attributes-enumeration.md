...
ms.locfileid: "72571738"
---
# <a name="js_property_attributes-enumeration"></a>Énumération JS_PROPERTY_ATTRIBUTES
...
|`JS_PROPERTY_FAKE`|La propriété représente un nœud factice, tel que « [méthodes] ».|  
