...
---
# IApplicationDebugger::CreateInstanceAtDebugger
Permet la création des objets dans le processus du débogueur par le code qui est hors processus au débogueur.  
  
> [!IMPORTANT]
>  Cette méthode ne doit pas être implémentée, car elle permet au code non fiable pour créer des objets arbitraires dans un thread approuvé du débogueur.  
...
## Notes  
 ...
 La méthode n'est pas actuellement implémentée.  
