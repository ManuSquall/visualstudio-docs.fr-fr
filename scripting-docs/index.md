...
Cette page fournit des liens vers JavaScript, TypeScript et des technologies basées sur ECMAScript.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>En savoir plus sur les interfaces de script Windows</h3>
                    </div>
                </div>
            </div>
        </div>
