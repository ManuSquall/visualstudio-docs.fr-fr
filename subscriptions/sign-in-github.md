...
Une fois que vous avez lié vos informations d’identification GitHub et compte Microsoft, vous pouvez utiliser cette authentification unique partout où un compte Microsoft personnel peut être utilisé, comme sur les sites Azure, les applications Office et la Xbox. Vous pouvez également utiliser ces comptes pour Azure Active Directory des connexions invitées en tant que compte Microsoft, en supposant que l’adresse de messagerie corresponde à celle de l’invitation.
