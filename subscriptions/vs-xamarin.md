...
Les abonnés à Visual Studio Enterprise bénéficient de six mois d’accès illimité à l’ensemble du catalogue Xamarin University.  Les abonnés à Visual Studio Professional bénéficient de trois mois d’accès.

Les membres de Visual Studio Dev Essentials peuvent créer un compte gratuit incluant un accès à certains cours gratuits, conférences d’invités, deux cours en direct, des enregistrements Lightning Lecture, et bien plus encore.
...
| Visual Studio Professional (Standard, cloud annuel) | Licences en volume, Azure, Détail                                       | 3 mois       |  Oui |
...
### <a name="q--what-happens-when-my-free-subscription-expires"></a>Q : Que se passe-t-il lorsque mon abonnement gratuit arrive à expiration ?
R : Votre compte Xamarin University et votre progression sont conservés, mais votre abonnement passera à un compte gratuit, avec un accès limité à nos ressources. Si vous souhaitez garder tous les avantages d’un abonnement, vous pouvez [acheter un abonnement mensuel](https://aka.ms/buy-xamarin-university).
