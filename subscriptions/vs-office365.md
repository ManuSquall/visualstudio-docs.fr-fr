...
> [!NOTE]
> Votre abonnement Visual Studio vous permet d’utiliser Office 365 Pro Plus pour une utilisation de production.  

> [!IMPORTANT]
> Nous avons pris conscience d’un problème avec l’obtention des clés de produit pour Office 365 Pro Plus.  Nous travaillons sur le problème et fournirons une mise à jour lorsque le problème sera résolu. 
...
3. La liste de téléchargements recommandés s’affiche. Dans la liste Office, choisissez **Office 365 Pro Plus**.
   > [!div class="mx-imgBorder"]
   > ![Téléchargements Office 365 Pro Plus](_img/vs-office365/vs-office365-downloads.png)
0. Pour installer Office 365 Pro Plus, vous aurez besoin d’une clé de produit.  Cliquez sur le lien **clé Get** sous la liste Office 365 Pro Plus.
   > [!div class="mx-imgBorder"]
   > ![Office 365 Pro Plus Obtenir la clé du produit](_img/vs-office365/vs-office365-get-key.png)
...
0. Cliquez sur le bouton **Télécharger.**
   > [!div class="mx-imgBorder"]
   > ![Office 365 Pro Plus Démarrer Télécharger](_img/vs-office365/vs-office365-download-button.png)
...
0. Entrez votre clé de produit, votre pays ou région et votre langue, puis cliquez sur **Suivant**.
   > [!div class="mx-imgBorder"]
   > ![Office 365 Pro Plus Entrez la clé du produit](_img/vs-office365/vs-office365-enter-key.png)
...
| Visual Studio Professional avec GitHub Enterprise | Vl | Non disponible         |  N/A          |
...
<sup>1</sup>  *Comprend: Not for Resale (NFR), Visual Studio Industry Partner (VSIP), Microsoft Partner Network (MPN), FTE, MCT Software & Services Developer, BizSpark, Most Valuable Professional (MVP), Regional Director (RD), MCT Software & Services, Imagine, Microsoft Partner Network.*
