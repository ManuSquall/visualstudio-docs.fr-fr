...
- Cliquez sur la première case à cocher pour accepter les termes et conditions. 
- Cliquez sur **Suivant**.
    > [!div class="mx-imgBorder"]
    > ![Inscription à Office 365 Dev](_img\vs-office-dev\vs-office-dev-signup.png)
    
6.  Indiquez vos préférences et centres d’intérêt, puis cliquez sur **Activer l’abonnement**.   
    > [!div class="mx-imgBorder"]
    > ![Préférences d’Office 365 Dev](_img\vs-office-dev\vs-office-dev-preferences.png)

7.  Ensuite, vous allez vérifier votre pays/région et créer votre nom d’utilisateur, le domaine et le mot de passe.
    > [!div class="mx-imgBorder"]
    > ![Nom d’utilisateur et domaine Office 365 Dev](_img\vs-office-dev\vs-office-dev-domain.png)

8.  Entrez votre numéro de téléphone, puis cliquez sur **Envoyer un code**.  Ceci nous permet de vérifier que le compte est créé par une personne réelle. 
    > [!div class="mx-imgBorder"]
    > ![Vérification par téléphone d’Office 365 Dev](_img\vs-office-dev\vs-office-dev-send-code.png)

9.  Entrez le code reçu, puis cliquez sur **Configurer**.
    > [!div class="mx-imgBorder"]
    > ![Validation du code d’Office 365 Dev](_img\vs-office-dev\vs-office-dev-setup.png)

C’est tout !  Vous voyez alors une page affichant des informations adaptées à vos préférences.  Pour accéder à votre abonnement développeur, accédez à [office.com](https://www.office.com) et connectez-vous avec l’ID utilisateur et le mot de passe que vous venez de créer.
