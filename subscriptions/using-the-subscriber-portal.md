...
## <a name="support"></a>Assistance
Outre les avantages individuels figurant dans la catégorie Support de la page Avantages, la page Support fournit un accès aux ressources pour vous aider à tirer le meilleur parti de votre abonnement Visual Studio.  
- Consultez les [FAQ](https://www.visualstudio.com/my/myvsfaq).
- Accédez aux [ressources de support](https://www.visualstudio.com/subscriptions/support/) pour résoudre d’éventuels problèmes techniques ou questions liés à la vente d’abonnements, aux comptes et à la facturation.
