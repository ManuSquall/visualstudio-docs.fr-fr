...
- Pour vous permettre de superviser l’utilisation maximale de votre organisation, il existe un rapport [Utilisation maximale](maximum-usage.md) dans le [portail d’administration des abonnements](https://manage.visualstudio.com) Visual Studio. 
