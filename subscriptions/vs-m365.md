...
<sup>1</sup>  *Inclut :  Revente interdite (NFR), VSIP (Visual Studio Industry Partner), FTE, BizSpark, MCT Software & Services Developer.  Exclut : MCT (Software & services), Microsoft Partner Network (MPN), imaginez, MVP (Most Valuable Professional), le directeur régional (RD).*
...
### <a name="q-how-do-i-know-which-version-i-have"></a>Q : Comment faire connaître la version que j’ai ?
