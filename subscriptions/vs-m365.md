...
<sup>1</sup>  *comprend : non pour la revente (NFR), Visual Studio Industry Partner (VSIP), FTE, BizSpark, MCT Software & Services Developer. Exclut : MCT Software & services, Microsoft Partner Network (MPN), imaginez, MVP (Most Valuable Professional), RD (Regional Director), NFR de base.*
