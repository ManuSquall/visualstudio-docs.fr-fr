...
En tant qu’abonné Visual Studio actif, vous avez accès à une large gamme de fonctionnalités dans VSTS qui sont comprises dans votre abonnement sous forme d’avantages. Vous pouvez utiliser ces fonctionnalités dans chaque compte VSTS dans lequel vous êtes membre, que vous ayez créé le compte ou ayez été ajouté par quelqu’un d’autre.
