...
•   Les administrateurs d’abonnements actuels du Centre de gestion des licences en volume qui gèrent les programmes Open Licence vont recevoir un e-mail les invitant à se connecter au nouveau portail à l’aide de l’adresse e-mail fournie dans cet e-mail

•   Une fois connectés, ils auront accès aux abonnements de leur entreprise

Après la « date x », les clients et les partenaires seront répartis en fonction de l’un des scénarios listés ci-dessous. 
...
•   Le partenaire accède directement à https://manage.visualstudio.comet se connecte

•   Il sélectionne la liste déroulante des contrats et la fait défiler vers le bas, où se trouve une option pour **+New Open License (+Nouvelle licence ouverte)**

•   Dans le panneau contextuel, le partenaire saisit le numéro d’autorisation, le numéro de licence, ainsi que l’adresse e-mail du client figurant sur le contrat. Il coche la case, puis clique sur **Envoyer**
...
•   Puis, dans « Détails de la licence », sous « Abonnements Visual Studio », il sélectionne l’option de gestion des abonnements via le lien **cliquez ici**

•   Cela entraîne une redirection du partenaire pour qu’il se connecte au nouveau portail de gestion, où il doit utiliser la même adresse e-mail que celle utilisée pour se connecter au Centre de gestion des licences en volume

•   Le partenaire peut ensuite gérer les abonnements correspondant à ce programme Open License
