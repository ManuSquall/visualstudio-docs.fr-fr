...
Toute personne ayant un accès [propriétaire](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#owner), [administrateur ou coadministrateur du service](https://docs.microsoft.com/azure/billing/billing-add-change-azure-subscription-administrator#assign-a-subscription-administrator) sur l’abonnement Azure peut acheter des abonnements cloud.
