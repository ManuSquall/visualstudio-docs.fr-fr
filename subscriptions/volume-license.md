...
ms.locfileid: "70000949"
---
# <a name="accessing-the-administation-portal-as-an-admin-on-a-volume-license-agreement"></a>Accès au portail d’administration en tant qu’administrateur sur un contrat avec licence en volume
...
Si vous êtes le contact principal ou l’interlocuteur pour les notifications sur le contrat de votre organisation, votre accès au portail est provisionné automatiquement lors de la configuration de votre contrat de licence en volume. Vous recevez un e-mail de bienvenue déclenché par le système, qui vous invite à vous connecter au portail. L’e-mail indique l’adresse e-mail à utiliser pour se connecter au portail. 
   ...
   > ![Notification pour un administrateur de licence en volume](_img/volume-license/super-admin-notice.png)
...
Ceci s’applique à tous les types de contrats de licence en volume, notamment (liste non exhaustive) : Contrats Entreprise, Abonnements Entreprise, Select, Select Plus, Open, Licence Open, et contrats Secteur public et Éducation. 
