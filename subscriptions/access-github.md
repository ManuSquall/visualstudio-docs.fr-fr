...
R : Si vous utilisez GitHub Enterprise Server, vous pouvez sélectionner le lien de **support** visible au bas du client pour qu’il soit connecté à votre administrateur.
