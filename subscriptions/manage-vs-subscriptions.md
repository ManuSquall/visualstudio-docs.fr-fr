...
1.  Dans la page de confirmation ou l’e-mail de confirmation, cliquez sur **Cliquez ici pour vous connecter**.  Vous êtes alors redirigé vers https://my.visualstudio.com/subscriptions/activate.
...
**Abonnements achetés dans le cadre de programmes** : si vous obtenez votre abonnement dans le cadre d’un programme, votre abonnement est lié à votre participation au programme.  Vous pouvez obtenir plus d’informations auprès des contacts désignés pour les différents programmes. 
...
**Visual Studio Dev Essentials** : Dev Essentials est un programme gratuit et les abonnements n’ont pas de date d’expiration.  
...
1. Connectez-vous au [portail Abonné](https://my.visualstudio.com) à l’aide de votre compte Microsoft (MSA).
