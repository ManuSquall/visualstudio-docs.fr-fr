...
* [**Exporter**](/visualstudio/subscriptions/exporting-subscriptions) : exportez la liste de vos utilisateurs et les détails sur leurs affectations. Une liste de ce type peut s’avérer utile pour effectuer le suivi des affectations et des dates d’expiration.
...
* Explorez les nouveaux champs qui sont disponibles dans l’expérience [**Ajouter un abonnement**](assign-license.md) :
  ...
  * **E-mail de notification** : si votre organisation n’utilise pas Azure AD et que vous souhaitez utiliser pour les notifications une autre adresse e-mail que celle utilisée pour la connexion, vous pouvez l’ajouter.

    ![Ajouter une nouvelle adresse e-mail de notification](media\add-new-subscriber-notification-email.png)

  * **Préférences de communication** : choisissez la langue que vous souhaitez utiliser pour envoyer des e-mails d’affectation.
...
* [**Renvoyer un e-mail d’affectation**](resend-assignment-email.md) : renvoyez un e-mail de notification à toute personne de votre liste d’abonnés et autant de fois que vous le souhaitez.
...
* [**Filtre**](search-license.md) : organisez et filtrez les données d’abonnés en fonction de vos besoins.
