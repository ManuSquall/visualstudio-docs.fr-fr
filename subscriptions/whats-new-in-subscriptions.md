...
## <a name="2019-q3-june-august"></a>T3 2019 (juin-août)

### <a name="contact-my-admin-available-for-subscribers---august-2019"></a>« Contacter mon administrateur » disponible pour les abonnés - Août 2019
De nombreux abonnés Visual Studio obtiennent leurs abonnements via leur entreprise ou leur établissement scolaire, et ces abonnements sont attribués et gérés par les administrateurs.  Dans les organisations complexes ou de grande taille, il peut être difficile pour un abonné qui a besoin de l’aide d’un administrateur de savoir qui contacter.  Pour aider les abonnés, nous avons ajouté une nouvelle fonctionnalité « Contacter mon administrateur » dans le portail des abonnés sur https://my.visualstudio.com/subscriptions. Pour plus d’informations, consultez l’article [Contacter votre administrateur](contact-my-admin.md). 

### <a name="agreement-preferences-available-for-super-admins---august-2019"></a>Préférences des contrats disponibles pour les super administrateurs - Août 2019
Une nouvelle fonctionnalité du portail d’administration des abonnements permet désormais aux super administrateurs de définir des préférences globales pour leurs contrats.  Ceci permet de définir des préférences, ce qui va réduire la quantité de travail nécessaire des administrateurs lors de l’attribution d’abonnements et permettre un contrôle accru sur les fonctionnalités, par exemple si un administrateur peut créer un abonnement pour des utilisateurs externes à leur organisation.  Pour plus d’informations, consultez notre article [Définir les préférences des contrats](admin-prefs.md). 
