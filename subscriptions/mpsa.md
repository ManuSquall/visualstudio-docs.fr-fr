...
> [!NOTE]
> Quand vous avez terminé le processus de prise de contrôle de domaine, vous devez respecter les critères des cinq étapes de la section Association prélocataire (locataire managé). Une fois les critères remplis, il est nécessaire de contacter le support MPSA pour approvisionner d’autres administrateurs d’abonnements Visual Studio.
