...
1. Dans la boîte de dialogue **Installer de nouveaux packages npm**, recherchez le package react, sélectionnez **Installer le package** pour installer ce dernier.
...
1. Cliquez avec le bouton droit sur le nœud **npm** de votre projet, puis choisissez **Mettre à jour les packages npm**.
    ...
    Sélectionnez la fenêtre **Sortie** pour voir la progression de l’installation des packages. L’installation pouvant prendre quelques minutes, vous risquez de ne pas voir les résultats immédiatement.
...
1. Dans l’Explorateur de solutions, cliquez avec le bouton droit sur le nœud de projet. Choisissez **Ajouter** > **Dossier existant**, choisissez le dossier *dist*, puis choisissez **Sélectionner un dossier**.
...
Dans ce tutoriel, vous avez appris à créer une application Node.js et React, à transpiler du code JSX et à effectuer du débogage. Pour en savoir plus, consultez [Outils Node.js pour Visual Studio sur GitHub](https://github.com/Microsoft/nodejstools).