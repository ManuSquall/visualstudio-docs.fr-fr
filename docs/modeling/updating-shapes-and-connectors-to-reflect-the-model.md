...
ms.locfileid: "31950411"
---
# <a name="update-shapes-and-connectors-to-reflect-the-model"></a>Mettre à jour des formes et connecteurs pour refléter le modèle
...
## <a name="define-change-rules-to-make-color-style-or-location-depend-on-model-element-properties"></a>Définir des règles de modification pour rendre la couleur, le style ou emplacement dépendent des propriétés d’élément de modèle
