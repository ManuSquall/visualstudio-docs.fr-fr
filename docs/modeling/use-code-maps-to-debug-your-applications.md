...
## <a name="navigate-and-examine-code-from-the-map"></a>Naviguer et examiner le code à partir de la carte
 ...
 ![Carte de code &#45; examiner une définition de champ](../modeling/media/codemapstoryboardpaint5.png)

 ![Carte de code &#45; examiner une définition de champ](../modeling/media/codemapstoryboardpaint5a.png)
...
>  Par défaut, **disposition incrémentielle** est activée. Ainsi, lorsque vous ajoutez de nouveaux éléments, la carte est réorganisée au minimum. Pour réorganiser l’ensemble de la carte chaque fois que vous ajoutez de nouveaux éléments, désactivez **disposition incrémentielle**.
 ...
 ![Carte de code &#45; examiner une définition de méthode](../modeling/media/codemapstoryboardpaint8.png)
 ...
 ![Carte de code &#45; examiner une définition de méthode](../modeling/media/codemapstoryboardpaint9.png)
 ...
 ![Carte de code &#45; examiner une définition de méthode](../modeling/media/codemapstoryboardpaint10.png)
...
## <a name="share-your-discovery-and-next-steps"></a>Partager votre découverte et étapes suivantes
 ...
 ![Carte de code &#45; partager, exporter, courrier électronique](../modeling/media/codemapstoryboardpaint13.png)
...
## <a name="fix-the-problem-and-show-what-you-did"></a>Corriger le problème et afficher ce que vous avez fait
 ...
 ![Carte de code &#45; carte mise à jour avec un appel de méthode manquant](../modeling/media/codemapstoryboardpaint16.png)
