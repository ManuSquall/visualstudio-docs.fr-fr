...
## <a name="in-this-section"></a>Dans cette section
 [Procédure pas à pas : La création d’un hôte](../modeling/walkthrough-creating-a-custom-text-template-host.md) de modèle de texte personnalisé vous montre comment créer un hôte de modèle de texte personnalisé qui rend la fonctionnalité de modèle de texte disponible en dehors de Visual Studio.
