...
```  
 ...
 Votre application peut s’exécuter sur un ordinateur qui n’a pas [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] installé.  
 ...
 **Modèles de texte T4 au moment du design** sont exécutées dans [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] pour définir la partie du code source et autres ressources de votre application.  
...
```  
 ...
 Pour plus d’informations, consultez [génération du Code à l’aide de modèles de texte T4 au moment du Design](../modeling/design-time-code-generation-by-using-t4-text-templates.md). Pour plus d’informations sur la syntaxe des modèles, consultez [écriture d’un modèle de texte T4](../modeling/writing-a-t4-text-template.md).  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Si vous avez installé [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Visualization and Modeling SDK, vous pouvez garantir le logiciel généré restera à jour des modifications dans le modèle.  
