...
|Modifier la disposition à l'intérieur d'un groupe.|Sélectionnez le groupe, ouvrez le menu contextuel, choisissez **disposition**, puis sélectionnez le style de disposition souhaité.<br /><br /> ou<br /><br /> 1.  Sélectionnez le groupe et assurez-vous qu'il est développé.<br />2.  Cliquez de nouveau sur l'en-tête de groupe. La barre d'outils du groupe apparaît.<br />     ![Graphique de dépendance &#45; barre d’outils du groupe](../modeling/media/dependencygraph_group.png "DependencyGraph_Group")<br />3.  Ouvrez le **modifier le style de disposition du groupe** liste ![graphique de dépendance &#45; barre d’outils du groupe &#45; disposition](../modeling/media/dependencygraph_grouptoolbar.gif "DependencyGraph_GroupToolbar") et choisissez le style de disposition.<br /><br /> **Mode liste** réorganise les membres du groupe dans la liste. **Graphique par défaut** réinitialise la disposition du groupe à la disposition par défaut de carte. Pour les autres options, consultez [modifier la disposition de la carte](#Selecting).|
