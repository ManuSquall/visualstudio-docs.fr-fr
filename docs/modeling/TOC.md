...
## [Changer votre conception à l’aide des outils de visualisation et de modélisation](scenario-change-your-design-using-visualization-and-modeling.md)
## [Visualiser du code](visualize-code.md)
### [Utiliser des cartes de code pour mapper les dépendances](map-dependencies-across-your-solutions.md)
### [Partager des cartes de code](share-code-maps.md)
### [Cartes de code pour C++](code-maps-for-cpp.md)
### [Performances des cartes de code](code-maps-performance.md)
...
### [Personnaliser des cartes de code](customize-code-maps-by-editing-the-dgml-files.md)
...
### [Personnaliser et étendre un langage spécifique à un domaine](customizing-and-extending-a-domain-specific-language.md)
#### [Personnaliser la présentation du diagramme](customizing-presentation-on-the-diagram.md)
##### [Définir des formes et des connecteurs](defining-shapes-and-connectors.md)
##### [Contrôler la couleur, le style de trait et d’autres propriétés des formes](controlling-color-line-style-and-other-shape-properties.md)
##### [Contrôler la visibilité d’une icône ou d’un décorateur](controlling-the-visibility-of-an-icon-or-decorator.md)
##### [Personnaliser les champs de texte et d’image](customizing-text-and-image-fields.md)
##### [Définir une image d’arrière-plan dans un diagramme](setting-a-background-image-on-a-diagram.md)
##### [Imbriquer des formes](nesting-shapes.md)
##### [Incorporer un diagramme dans un Windows Form](embedding-a-diagram-in-a-windows-form.md)
#### [Personnaliser les outils et la boîte à outils](customizing-tools-and-the-toolbox.md)
#### [Personnaliser la création et le mouvement des éléments](customizing-element-creation-and-movement.md)
#### [Personnaliser le comportement de la copie](customizing-copy-behavior.md)
#### [Personnaliser le comportement de la suppression](customizing-deletion-behavior.md)
#### [Personnaliser la fenêtre Propriétés](customizing-the-properties-window.md)
#### [Personnaliser l’Explorateur de modèles](customizing-the-model-explorer.md)
...
#### [Partager des classes entre plusieurs DSL à l’aide d’une bibliothèque DSL](sharing-classes-between-dsls-by-using-a-dsl-library.md)
### [Écrire du code pour personnaliser un langage spécifique à un domaine](writing-code-to-customise-a-domain-specific-language.md)
#### [Remplacer et étendre les classes générées](overriding-and-extending-the-generated-classes.md)
#### [Accéder à un modèle et le mettre à jour dans le code du programme](navigating-and-updating-a-model-in-program-code.md)
...
#### [Intégrer des modèles à l’aide de Visual Studio ModelBus](integrating-models-by-using-visual-studio-modelbus.md)
...
#### [Définir une stratégie de verrouillage pour créer des segments en lecture seule](defining-a-locking-policy-to-create-read-only-segments.md)
#### [Ajouter des extensions à des définitions DSL](adding-extensions-to-dsl-definitions.md)
#### [Ajouter une propriété de suivi à une définition de langage spécifique à un domaine](adding-a-tracking-property-to-a-domain-specific-language-definition.md)
#### [Déboguer à l’aide de la visionneuse de magasins](debugging-by-using-the-store-viewer.md)
#### [Fichier DslDefinition.dsl](the-dsldefinition-dsl-file.md)
#### [Présentation du code DSL](understanding-the-dsl-code.md)
### [Validation dans un langage spécifique à un domaine](validation-in-a-domain-specific-language.md)
### [Écrire des commandes et des actions utilisateur](writing-user-commands-and-actions.md)
...
#### [Personnaliser les outils d’éléments](customizing-element-tools.md)
### [Répondre aux changements et les propager](responding-to-and-propagating-changes.md)
...
#### [Mettre à jour les formes et les connecteurs pour refléter le modèle](updating-shapes-and-connectors-to-reflect-the-model.md)
### [Générer du code à partir d’un langage spécifique à un domaine](generating-code-from-a-domain-specific-language.md)
#### [Accéder aux modèles à partir de modèles de texte](accessing-models-from-text-templates.md)
#### [Utiliser Visual Studio ModelBus dans un modèle de texte](using-visual-studio-modelbus-in-a-text-template.md)
#### [Procédure pas à pas : déboguer un modèle de texte qui accède à un modèle](walkthrough-debugging-a-text-template-that-accesses-a-model.md)
#### [Procédure pas à pas : connecter un hôte à un processeur de directive généré](walkthrough-connecting-a-host-to-a-generated-directive-processor.md)
#### [DslTextTransform, commande](the-dsltexttransform-command.md)
### [Personnaliser le stockage de fichiers et la sérialisation XML](customizing-file-storage-and-xml-serialization.md)
### [Déployer des solutions basées sur un langage spécifique à un domaine](deploying-domain-specific-language-solutions.md)
...
### [Créer un langage spécifique à un domaine basé sur Windows Forms](creating-a-windows-forms-based-domain-specific-language.md)
### [Créer un langage spécifique à un domaine basé sur WPF](creating-a-wpf-based-domain-specific-language.md)
### [Utiliser des solutions basées sur un langage spécifique à un domaine](working-with-domain-specific-language-solutions.md)
...
#### [Choisir un modèle de solution basée sur un langage spécifique à un domaine](choosing-a-domain-specific-language-solution-template.md)
...
#### [Utiliser le diagramme de définition DSL](working-with-the-dsl-definition-diagram.md)
#### [Utiliser l’Explorateur DSL](working-with-the-domain-specific-language-explorer.md)
...
#### [Générer des fichiers avec l’utilitaire TextTransform](generating-files-with-the-texttransform-utility.md)
### [Génération de texte à l’exécution à l’aide des modèles de texte T4](run-time-text-generation-with-t4-text-templates.md)
### [Écrire un modèle de texte T4](writing-a-t4-text-template.md)
...
#### [Accéder à Visual Studio ou d’autres hôtes à partir d’un modèle de texte](accessing-visual-studio-or-other-hosts-from-a-text-template.md)
#### [Utiliser des séquences d’échappement dans des modèles de texte](using-escape-sequences-in-text-templates.md)
...
### [Déboguer un modèle de texte T4](debugging-a-t4-text-template.md)
...
### [Personnaliser une transformation de texte T4](customizing-t4-text-transformation.md)
#### [Processus de transformation du modèle de texte](the-text-template-transformation-process.md)
#### [Créer des processeurs de directives de modèles de texte T4 personnalisés](creating-custom-t4-text-template-directive-processors.md)
##### [Déployer un processeur de directive personnalisé](deploying-a-custom-directive-processor.md)
##### [Procédure pas à pas : créer un processeur de directive personnalisé](walkthrough-creating-a-custom-directive-processor.md)
#### [Appeler une transformation de texte dans une extension Visual Studio](invoking-text-transformation-in-a-vs-extension.md)
#### [Traiter des modèles de texte à l’aide d’un hôte personnalisé](processing-text-templates-by-using-a-custom-host.md)
