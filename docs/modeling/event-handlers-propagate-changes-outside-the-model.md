...
## <a name="using-events-to-make-undoable-adjustments-in-the-store"></a>L’utilisation des événements pour effectuer des ajustements irréalisable dans le magasin  
