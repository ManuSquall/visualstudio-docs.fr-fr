...
## <a name="a-nameversionsupport-edition-support-for-architecture-and-modeling-tools"></a>prise en charge <a name="VersionSupport" />Edition pour les outils d’architecture et de modélisation
