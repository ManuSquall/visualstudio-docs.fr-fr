...
11. Pour tester l’extension, appuyez sur **F5**. Dans l’instance expérimentale de Visual Studio, créez ou ouvrez un exemple de fichier de la solution DSL.
