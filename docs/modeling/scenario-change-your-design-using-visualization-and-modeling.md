...
###  <a name="ValidatingCode"></a> Maintenir la cohérence avec la conception du Code
...
## <a name="update-the-system-using-visualization-and-modeling"></a>Mettre à jour la visualisation à l’aide du système et modélisation
