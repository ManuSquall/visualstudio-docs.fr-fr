...
![Fusion&#45;EMD&#95;DSL](../modeling/media/dsl-emd_merge.png)
...
![Détails&#45;de&#95;EMD DSL](../modeling/media/dsl-emd_details.png)
...
4. Sous **traiter la fusion en créant des liens**, ajoutez deux chemins d’accès :
   ...
   - L’autre chemin d’accès lie le nouvel élément à l’élément existant. L’expression de chemin d’accès spécifie la relation de référence et le rôle auquel le nouvel élément sera assigné. Ce chemin d’accès est le suivant :
      ...
      1. Sous **traiter la fusion en créant des liens dans chemins d'** accès, cliquez sur **\<add chemin d’accès >** .
...
1. Créez une solution [!INCLUDE[dsl](../modeling/includes/dsl_md.md)] à l’aide du modèle de modèle de composant.
