---
title: "Utiliser des modèles dans votre processus de développement | Documents Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|**Catégorie**|**Liens**|  
|------------------|---------------|  
|**Vidéos**|![lien vers la vidéo](~/docs/data-tools/media/playvideo.gif "PlayVideo") [MSDN vidéos : comment créer et utiliser les modèles UML et des diagrammes (Visual Studio 2010 Ultimate)](http://go.microsoft.com/fwlink/?LinkId=214460)<br /><br /> ![lien vers la vidéo](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Channel 9 : UML with Visual Studio 2010](http://go.microsoft.com/fwlink/?LinkID=201106)<br /><br /> ![lien vers la vidéo](~/docs/data-tools/media/playvideo.gif "PlayVideo") [série MSDN Comment faire : outils UML et extensibilité (Visual Studio 2010 Ultimate)](http://go.microsoft.com/fwlink/?LinkID=214467)|  
