...
## <a name="add-reference-and-include-paths"></a>Ajouter une référence et de chemins d’accès include
...
##  <a name="msbuild"></a> Utilisez les propriétés du projet dans l’assembly et les directives #include
