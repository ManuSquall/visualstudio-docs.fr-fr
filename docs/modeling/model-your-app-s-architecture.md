---
title: "Modèle d’architecture de votre application | Documents Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="model-your-app39s-architecture"></a>Modèle d’architecture de votre application
...
##  <a name="a-namestructurea-high-level-design"></a><a name="Structure"></a>Conception de haut niveau  
...
-   [Comprendre les besoins de](#Requirements). Le point de départ de toute conception est une vision claire des besoins des utilisateurs.  
...
##  <a name="a-namerequirementsa-understanding-the-requirements"></a><a name="Requirements"></a>Comprendre les impératifs  
...
##  <a name="a-namebigdecisionsa-architectural-patterns"></a><a name="BigDecisions"></a>Modèles architecturaux  
...
##  <a name="a-namepatternsa-design-patterns"></a><a name="Patterns"></a>Modèles de conception  
