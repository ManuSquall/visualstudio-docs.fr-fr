---
title: "Erreur du compilateur CS0254 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
manager: "wpickett"
---
# Erreur du compilateur CS0254
La partie droite d'une assignation d'instruction fixed peut ne pas être une expression de cast  
  
 La partie droite d’une expression [fixed](/dotnet/csharp/language-reference/keywords/fixed-statement) ne peut pas utiliser un cast. Pour plus d'informations, consultez [Pointeurs et code unsafe](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
