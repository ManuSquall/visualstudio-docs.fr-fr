...
Type byte, sbyte, short, ushort, int, uint, long ou ulong attendu  
 ...
 Certains types de données, tels que [enums](/dotnet/csharp/language-reference/keywords/enum), ne peuvent être déclarés que pour stocker des données de types spécifiés.  
