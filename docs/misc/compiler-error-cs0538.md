...
'nom' dans une déclaration d’interface explicite n’est pas une interface  
 ...
 Une tentative a été effectuée pour déclarer explicitement une [interface](/dotnet/csharp/language-reference/keywords/interface), mais aucune interface n’a été spécifiée.  
