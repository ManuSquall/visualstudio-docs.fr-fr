---
title: Le schéma ne correspond pas
description: Un ou plusieurs des objets de base de données sélectionnés retournent un schéma qui ne correspond pas au schéma de la classe cible
ms.date: 11/04/2016
...
2. Sélectionnez un objet de base de données qui retourne des données correspondant au schéma de la classe cible (classe dans laquelle l’objet de base de données est déposé dans le **Concepteur O/R**).
