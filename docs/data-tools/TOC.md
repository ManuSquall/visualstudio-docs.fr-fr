...
### [Guide pratique pour activer et désactiver la pluralisation (Concepteur OR)](how-to-turn-pluralization-on-and-off-o-r-designer.md)
...
### [Procédure pas à pas : création d’un service WPF dans Windows Forms](walkthrough-creating-a-simple-wcf-service-in-windows-forms.md)
