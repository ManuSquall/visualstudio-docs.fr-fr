...
4. Nommez le projet **ComplexControlWalkthrough**, puis choisissez **OK**. 
...
2.  Type **ComplexDataGridView** dans les **nom** zone, puis cliquez sur **ajouter**.  
...
4.  Sélectionnez le **ComplexDataGridView** dans la liste des **contrôles associés** dans les **Options de personnalisation de l’interface utilisateur de données** boîte de dialogue.  
  
5.  Cliquez sur la flèche déroulante du `Customers` de table, puis choisissez **ComplexDataGridView** à partir de la liste de contrôle.  
