...
Élément racine requis d’un fichier de projet MSBuild.
...
| Élément | Description |
| - | - |
| [Choisir](../msbuild/choose-element-msbuild.md) | Élément facultatif.<br /><br /> Évalue des éléments enfants pour sélectionner un ensemble d’éléments `ItemGroup` et/ou d’éléments `PropertyGroup` à évaluer. |
...
| [ProjetExtensions](../msbuild/projectextensions-element-msbuild.md) | Élément facultatif.<br /><br /> Fournit un moyen de persister les informations non-MSBuild dans un fichier de projet MSBuild. Un projet peut ne contenir aucun élément `ProjectExtensions` ou en contenir un. |
...
| [Sdk](../msbuild/sdk-element-msbuild.md) | Élément facultatif.<br /><br /> Références d’un projet MSBuild SDK.  Cet élément peut être utilisé comme alternative à l’attribut Sdk. |
| [Target](../msbuild/target-element-msbuild.md) | Élément facultatif.<br /><br /> Contient un ensemble de tâches pour MSBuild d’exécuter séquentiellement. Les tâches sont spécifiées à l’aide de l’élément [Task](../msbuild/task-element-msbuild.md). Un projet peut ne contenir aucun élément `Target` ou en contenir plusieurs. |
| [UsingTask](../msbuild/usingtask-element-msbuild.md) | Élément facultatif.<br /><br /> Fournit un moyen d’enregistrer les tâches dans MSBuild. Un projet peut ne contenir aucun élément `UsingTask` ou en contenir plusieurs. |
...
- [Comment : Préciser quel objectif construire en premier](../msbuild/how-to-specify-which-target-to-build-first.md)
