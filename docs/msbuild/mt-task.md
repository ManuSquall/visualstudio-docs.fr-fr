...
|**RegistrarScriptFile**|Paramètre de **chaîne** facultatif.<br /><br /> Spécifie le nom du fichier de script d’inscription ( *.rgs*) à utiliser pour la prise en charge du manifeste COM sans inscription.<br /><br /> Pour plus d’informations, voir l’option **/rgs** de [mt.exe](/windows/desktop/SbsCs/mt-exe).|
|**ReplacementsFile**|Paramètre de **chaîne** facultatif.<br /><br /> Spécifie le fichier qui contient des valeurs pour les chaînes remplaçables du fichier de script d’inscription ( *.rgs*).<br /><br /> Pour plus d’informations, voir l’option **/replacements** de [mt.exe](/windows/desktop/SbsCs/mt-exe).|
