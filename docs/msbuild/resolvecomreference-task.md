...
description: Découvrez comment MSBuild utilise la tâche ResolveComReference, pour obtenir une liste d’un ou plusieurs noms de bibliothèques de types ou de fichiers. tlb et les résoudre en emplacements sur le disque.
