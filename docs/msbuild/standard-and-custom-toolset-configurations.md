...
|------------------| - |
|2|*\<Chemin d’installation de Windows>\Microsoft.Net\Framework\v2.0.50727\\*|
...
|Current|*\<Chemin d’installation de Visual Studio>\MSBuild\Current\bin*|
