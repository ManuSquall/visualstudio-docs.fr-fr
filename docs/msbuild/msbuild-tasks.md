...
## <a name="task-logic"></a>Logique de tâche  
 ...
 La logique d’exécution d’une tâche est implémentée en tant que classe .NET qui implémente l’interface <xref:Microsoft.Build.Framework.ITask>, laquelle est définie dans l’espace de noms <xref:Microsoft.Build.Framework>.  
