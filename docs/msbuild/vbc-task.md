...
| `NoVBRuntimeReference` | Paramètre `Boolean` facultatif.<br /><br /> Usage interne uniquement. Si sa valeur est True, empêche la référence automatique à *Microsoft.VisualBasic.dll*. |
