...
ms.locfileid: "82167448"
---
# <a name="vbc-task"></a>Vbc (tâche)

Encapsule *vbc. exe*, qui produit des fichiers exécutables (*. exe*), des bibliothèques de liens dynamiques (*. dll*) ou des modules de code (*. netmodule*). Pour plus d’informations sur *vbc. exe*, consultez [Visual Basic compilateur de ligne de commande](/dotnet/visual-basic/reference/command-line-compiler/index).
