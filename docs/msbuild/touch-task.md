...
|`Time`|Paramètre `String` facultatif.<br /><br /> Spécifie une heure autre que l’heure actuelle. Elle doit être exprimée dans un format accepté par la méthode <xref:System.DateTime.Parse%2A>.|  
