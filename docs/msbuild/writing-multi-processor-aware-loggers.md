...
---
# <a name="writing-multi-processor-aware-loggers"></a>Écriture de journaux multiprocesseurs
...
## <a name="see-also"></a>Voir aussi  
 [Création de journaux d’événements de transfert](../msbuild/creating-forwarding-loggers.md)