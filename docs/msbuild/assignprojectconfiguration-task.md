...
|`VcxToDefaultPlatformMapping`|Optional<br /><br /> Paramètre de sortie `string`.<br /><br /> Contient la liste délimitée par des points-virgules des mappages des noms de plateforme *.vcxproj* aux noms de plateforme utilisés par la plupart des types.<br /><br /> Par exemple :<br /><br /> `"Win32=AnyCPU;X64=X64"`|
