...
description: Décrit l’objectif et les paramètres de la tâche ClangCompile MSBuild, qui encapsule l’outil compilateur C++, clang.exe.
...
ms.locfileid: "92796821"
---
# <a name="clangcompile-task"></a>Tâche ClangCompile

Encapsule l’outil compilateur Microsoft C++, clang.exe.
...
|**BufferSecurityCheck**|Paramètre de **chaîne** facultatif.<br/><br/>La vérification de la sécurité permet de détecter les saturations de mémoire tampon de pile, une tentative courante d’attaque contre la sécurité d’un programme. <br/><br/>Utiliser `fstack-protector`.|
...
|**ForcedIncludeFiles**|Paramètre **String []** facultatif.<br/><br/>Un ou plusieurs fichiers Include forcés.<br/><br/>Utiliser `-include [name]`.|
|**FunctionLevelLinking**|Paramètre **booléen** facultatif.<br/><br/>Permet au compilateur d’empaqueter des fonctions individuelles sous la forme de fonctions empaquetées (COMDATs). Requis avec l’option Modifier et Continuer.<br/><br/>Utiliser `ffunction-sections`.|
...
|**MSCompatibility**|Paramètre **booléen** facultatif.<br/><br/>Activez la compatibilité Microsoft C++ complète.|
...
|**ObjectFileName**|Paramètre de **chaîne** facultatif.<br/><br/>Spécifie un nom de substitution pour le nom de fichier objet par défaut. Il peut s’agir d’un nom de fichier ou de répertoire.<br/><br/>Utiliser `/Fo[name]`.|
...
|**PositionIndependentCode**|Paramètre **booléen** facultatif.<br/><br/>Génère le code PIC (Position Independent Code) à utiliser dans une bibliothèque partagée.|
...
|**PreprocessorDefinitions**|Paramètre **String []** facultatif.<br/><br/>Définit des symboles de prétraitement pour votre fichier source.<br/><br/>Utiliser `-D`.|
...
|**ShowIncludes**|Paramètre **booléen** facultatif.<br/><br/>Affiche la liste des fichiers include avec les résultats de la compilation.<br/><br/>Utiliser `-H`.|
|**Sources**|Paramètre **ITaskItem []** obligatoire.|
|**StrictAliasing**|Paramètre **booléen** facultatif.<br/><br/>Les règles d’alias les plus strictes sont utilisées. Un objet d’un type donné n’est jamais considéré comme résidant à la même adresse qu’un objet d’un autre type.|
...
|**UndefinePreprocessorDefinitions**|Paramètre **String []** facultatif.<br/><br/>Spécifie l’annulation de la définition d’une ou de plusieurs définitions du préprocesseur.<br/><br/>Utiliser `-U [macro]`.|
|**UndefineAllPreprocessorDefinitions**|Paramètre **booléen** facultatif.<br/><br/>Annule la définition de toutes les valeurs de préprocesseur précédemment définies.<br/><br/>Utiliser `-undef`.|
