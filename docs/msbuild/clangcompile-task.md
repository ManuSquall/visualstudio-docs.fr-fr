...
Enveloppe l’outil de compilation Microsoft CMD, clang.exe.
...
|**ForcedIncludeFiles**|Paramètre **de chaîne en** option.<br/><br/>Un ou plusieurs fichiers Include forcés.<br/><br/>Utilisez `-include [name]`.|
...
|**MSCompatibility**|Paramètre **booléen** facultatif.<br/><br/>Activez la compatibilité complète de Microsoft CMD.|
...
|**PrecompiledHeaderOutputFileDirectory**|Paramètre **de chaîne** facultatif.<br/><br/>Spécifie le répertoire de l’en-tête précompilé généré. Ce répertoire sera également ajouté aux **répertoires supplémentaires inclus** pendant la construction.|
...
|**PreprocessorDefinitions**|Paramètre **de chaîne en** option.<br/><br/>Définit des symboles de prétraitement pour votre fichier source.<br/><br/>Utilisez `-D`.|
...
|**UndefinePreprocessorDefinitions**|Paramètre **de chaîne en** option.<br/><br/>Spécifie l’annulation de la définition d’une ou de plusieurs définitions du préprocesseur.<br/><br/>Utilisez `-U [macro]`.|
...
|**WarningLevel**|Paramètre **de chaîne** facultatif.<br/><br/>Sélectionnez la rigueur avec laquelle le compilateur doit traiter les erreurs de code. D’autres drapeaux doivent être ajoutés `/Weverything`directement aux options **supplémentaires** (se `/w`, ).<br/><br/>**TurnOffAllWarnings**, désactive tous les avertissements du compilateur (utilisez `w`).<br/>**EnableAllWarnings**, active tous les avertissements, dont ceux qui sont désactivés par défaut (utilisez `Wall`).|
