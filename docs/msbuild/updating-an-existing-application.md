...
Ces instructions supposent d’utiliser des [références NuGet de type PackageReference](https://docs.microsoft.com/en-us/nuget/consume-packages/package-references-in-project-files).
