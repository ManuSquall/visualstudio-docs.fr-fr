...
Supprime les fichiers temporaires que MSBuild crée lors de la construction d’un projet C. Le processus de suppression des fichiers de build est appelé *nettoyage*.
...
|**DoDelete**|Paramètre **Boolean** optionnel.<br /><br /> Si `true`, nettoie les fichiers de build temporaires.|
