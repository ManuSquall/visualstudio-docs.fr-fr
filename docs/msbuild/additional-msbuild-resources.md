...
## <a name="community-forums"></a>Forums de communautés  
 ...
 Vous pouvez accéder aux ressources de la communauté [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)] sur le site web [Channel 9 MSBuild](http://channel9.msdn.com/).  
