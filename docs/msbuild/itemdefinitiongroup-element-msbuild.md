...
|Élément|Description|
|-------------|-----------------|
|[Item](../msbuild/item-element-msbuild.md)|Définit les entrées du processus de génération. Un élément `Item` peut ne contenir aucun élément `ItemDefinitionGroup` ou en contenir plusieurs.|
