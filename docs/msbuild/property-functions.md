...
-   [Fonction MSBuild GetRegistryValueFromView](#BKMK_GetRegistryValueFromView)  
  
-   [Fonction MSBuild MakeRelative](#BKMK_MakeRelative)  
  
-   [Fonction MSBuild ValueOrDefault](#BKMK_ValueOrDefault)  
  
##  <a name="a-namebkmksyntaxa-property-function-syntax"></a><a name="BKMK_Syntax"></a> Syntaxe des fonctions de propriétés  
...
###  <a name="a-namebkmkstringa-string-property-functions"></a><a name="BKMK_String"></a> Fonctions de propriétés de type chaîne  
...
###  <a name="a-namebkmkstatica-static-property-functions"></a><a name="BKMK_Static"></a> Fonctions de propriétés statiques  
...
###  <a name="a-namebkmkinstancemethodsa-calling-instance-methods-on-static-properties"></a><a name="BKMK_InstanceMethods"></a> Appel de méthodes d’instance sur des propriétés statiques  
...
###  <a name="a-namebkmkpropertyfunctionsa-msbuild-property-functions"></a><a name="BKMK_PropertyFunctions"></a> Fonctions de propriétés MSBuild  
...
##  <a name="a-namebkmknesteda-nested-property-functions"></a><a name="BKMK_Nested"></a> Fonctions de propriétés imbriquées  
...
##  <a name="a-namebkmkdoestaskhostexista-msbuild-doestaskhostexist"></a><a name="BKMK_DoesTaskHostExist"></a> Fonction MSBuild DoesTaskHostExist  
...
##  <a name="a-namebkmkgetdirectorynameoffileabovea-msbuild-getdirectorynameoffileabove"></a><a name="BKMK_GetDirectoryNameOfFileAbove"></a> Fonction MSBuild GetDirectoryNameOfFileAbove  
...
##  <a name="a-namebkmkgetregistryvaluea-msbuild-getregistryvalue"></a><a name="BKMK_GetRegistryValue"></a> Fonction MSBuild GetRegistryValue  
...
##  <a name="a-namebkmkgetregistryvaluefromviewa-msbuild-getregistryvaluefromview"></a><a name="BKMK_GetRegistryValueFromView"></a> Fonction MSBuild GetRegistryValueFromView  
...
##  <a name="a-namebkmkmakerelativea-msbuild-makerelative"></a><a name="BKMK_MakeRelative"></a> Fonction MSBuild MakeRelative  
...
##  <a name="a-namebkmkvalueordefaulta-msbuild-valueordefault"></a><a name="BKMK_ValueOrDefault"></a> Fonction MSBuild ValueOrDefault  
