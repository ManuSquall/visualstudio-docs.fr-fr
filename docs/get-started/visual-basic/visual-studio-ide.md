...
- [CodeLens](../../ide/find-code-changes-and-other-history-with-codelens.md)
   ...
   > [!NOTE]
   > CodeLens n’est pas disponible dans l’édition Community de Visual Studio 2017.
...
- [Atteindre la définition](../../ide/go-to-and-peek-definition.md)
   ...
   ![Atteindre la définition dans Visual Studio](media/go-to-definition-menu.png)
...
2. La boîte de dialogue **Nouveau projet** affiche plusieurs *modèles* de projet. Un modèle contient les fichiers et les paramètres de base nécessaires pour un type de projet donné. Choisissez la catégorie **.NET Core** sous **Visual Basic**, puis choisissez le modèle **Application console (.NET Core)**. Dans la zone de texte **Nom**, tapez **HelloWorld**, puis cliquez sur le bouton **OK**.
...
3. Maintenant, démarrez l’application en appuyant sur **Ctrl**+**F5**.
...
5. Ajoutons du code supplémentaire à l’application. Ajoutez le code Visual Basic suivant avant la ligne qui indique `Console.WriteLine("Hello World!")` :
...
7. Réexécutez l’application en appuyant sur **Ctrl**+**F5**.
...
8. Entrez votre nom dans la fenêtre de console et appuyez sur **Entrée**.
   ...
   Le programme vous accueille par votre nom.
