...
description: En savoir plus sur l’environnement de développement intégré (IDE) de Visual Studio, notamment les fenêtres, les menus et les autres fonctionnalités d’interface utilisateur les plus couramment utilisées.
