...
Pour réinitialiser la disposition des éléments, cliquez avec le bouton droit sur l’élément dans la fenêtre structure du document ou la planche graphique, puis choisissez réinitialisation de la **mise en page**  >   *NomPropriété*, où *PropertyName* est la propriété à réinitialiser (ou choisissez **disposition**  >  **Réinitialiser tout** pour réinitialiser toutes les propriétés de disposition de l’élément).
