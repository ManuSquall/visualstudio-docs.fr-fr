...
description: Découvrez comment créer et appliquer une ressource dans le Concepteur XAML afin de pouvoir stocker et réutiliser des styles et des modèles pour des éléments.
