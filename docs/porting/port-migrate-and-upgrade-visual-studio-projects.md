...
| SharePoint 2010 | Lorsqu’un projet de solution SharePoint sera ouvert avec Visual Studio 2017, il sera mis à niveau vers SharePoint 2013 ou SharePoint 2016. La charge de travail « Développement .NET Desktop » doit être installée dans Visual Studio 2017 pour la mise à niveau.<br/><br/>Pour plus d’informations sur la mise à niveau des projets SharePoint, consultez les articles [Mettre à niveau vers SharePoint 2013](https://technet.microsoft.com/en-us/library/cc303420.aspx), [Mettre à jour le flux de travail dans SharePoint Server 2013](https://technet.microsoft.com/en-us/library/dn133867.aspx) et [Créer une batterie de serveurs SharePoint Server 2016 pour une mise à niveau d’attachement de base de données](https://technet.microsoft.com/en-us/library/cc263026(v=office.16).aspx). |
...
| Visual C++ | Vous pouvez utiliser Visual Studio 2017 pour ouvrir des solutions et des projets créés dans Visual Studio 2015, mais les projets qui ont été créés dans des versions antérieures de Visual Studio peuvent nécessiter une mise à niveau ou un reciblage vers un ensemble d’outils plus récent pour être générés avec Visual Studio 2017. Pour plus d’informations, consultez [Procédure : Mise à niveau de projets Visual C++ vers Visual Studio 2015](https://msdn.microsoft.com/en-us/library/hh690665.aspx) et [Guide du portage et de la mise à niveau de Visual C++](https://msdn.microsoft.com/en-us/library/dn986839.aspx). |
