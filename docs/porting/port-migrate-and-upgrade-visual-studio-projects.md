...
| Microsoft Azure Tools pour Visual Studio | Pour ouvrir ces types de projets, installez tout d’abord le [kit SDK Microsoft Azure pour .NET.](http://azure.microsoft.com/en-us/downloads/), puis ouvrez le projet. Si nécessaire, votre projet est mis à jour. |
