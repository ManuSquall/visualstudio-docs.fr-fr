---
title: "Tests unitaires pour m&#233;thodes g&#233;n&#233;riques | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
manager: "douge"
---
# Tests unitaires pour m&#233;thodes g&#233;n&#233;riques
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Vous pouvez générer des tests unitaires pour les méthodes génériques exactement comme vous le feriez pour d'autres méthodes, comme décrit dans [How to: Create and Run a Unit Test](http://msdn.microsoft.com/fr-fr/5e0f43cf-5e51-48e2-9c98-0eb9324bdc48).  Les sections suivantes fournissent des informations et des exemples de création de tests unitaires pour les méthodes génériques.  
  
## Arguments de type et contraintes de type  
...
#### Projet de test  
 ...
 En d'autres termes, lorsque vous appelez la méthode `DataTestHelper<T>()` à partir de la méthode de test  `DataTest()`, vous devez passer un paramètre de type `Employee` ou une classe dérivée d'`Employee`.  
...
## Voir aussi  
 [Anatomy of a Unit Test](http://msdn.microsoft.com/fr-fr/a03d1ee7-9999-4e7c-85df-7d9073976144)   
