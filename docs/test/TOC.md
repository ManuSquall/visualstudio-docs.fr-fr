...
### [Définition d’une propriété Automation unique pour les contrôles UWP à des fins de test](set-a-unique-automation-property-for-windows-store-controls-for-testing.md)
...
## [Test d’applications UWP avec Visual Studio](testing-store-apps-with-visual-studio.md)
### [Création et exécution de tests unitaires pour une application UWP dans Visual Studio](create-and-run-unit-tests-for-a-store-app-in-visual-studio.md)
#### [Test unitaire d’une DLL Visual C++ pour les applications UWP](unit-testing-a-visual-cpp-dll-for-store-apps.md)
#### [Test unitaire du code Visual C# dans une application UWP](unit-testing-visual-csharp-code-in-a-store-app.md)
#### [Exécution de tests unitaires pour les applications UWP dans Visual Studio](run-unit-tests-for-store-apps-in-visual-studio.md)
### [Analyse de la qualité du code des applications UWP à l'aide de l'analyse statique du code Visual Studio](analyze-the-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analyse de la qualité du code Visual Basic et C# dans les applications UWP à l’aide de l’analyse statique du code Visual Studio](analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analyse de la qualité du code C++ des applications UWP à l'aide de l'analyse statique du code Visual Studio](analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
## [Gestion de laboratoire de test](lab-management/using-a-lab-environment-for-your-application-lifecycle.md)
### [Utiliser les fonctionnalités de build ou de mise en production pour les tests automatisés](lab-management/use-build-or-rm-instead-of-lab-management.md)
