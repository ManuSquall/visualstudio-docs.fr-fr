...
description: Utilisez l’infrastructure de tests unitaires C++ Microsoft pour pour créer des tests C++ unitaires pour votre code.
ms.date: 01/08/2020
ms.topic: conceptual
ms.author: corob
manager: markl
...
1. Modifiez les propriétés du projet de façon à inclure les fichiers d’en-tête et les fichiers bibliothèques nécessaires aux tests unitaires.
   ...
   1. Cliquez sur la flèche vers le bas dans les lignes suivantes et choisissez **\<Modifier>** . Ajoutez ces chemins :
...
## <a name="object_files"></a> Pour lier les tests aux fichiers objets ou bibliothèques
...
1. Sélectionnez les **Propriétés de Configuration** > **éditeur de liens** > page **d’entrée** , puis sélectionnez **dépendances supplémentaires**.
...
1. Sélectionnez la page **Propriétés de Configuration** > **Répertoires VC + +** , puis sélectionnez **répertoires Include**.
