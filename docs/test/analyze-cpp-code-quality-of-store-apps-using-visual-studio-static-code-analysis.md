...
> [!NOTE]
>  Dans Visual Studio Ultimate, Visual Studio Premium et Visual Studio Professional, vous pouvez utiliser les fonctionnalités complètes des outils d'analyse du code.  Voir [Analyse de la qualité des applications à l'aide des outils d'analyse du code](http://msdn.microsoft.com/library/dd264897.aspx) dans MSDN Library.  
...
## Dans cette rubrique  
 ...
 [Recherche et filtrage des résultats de l'analyse du code](../test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md#BKMK_Search)  
...
2.  Dans la page des propriétés du projet, choisissez **Analyse du code**, puis **Activer l'analyse du code pour la génération C\/C\+\+ sur la build**.  
 ...
 ![Fenêtre d'analyse du code](../test/media/ca_cpp_collapsed.png "CA\_CPP\_Collapsed")  
...
##  <a name="BKMK_Analyze"></a> Analyse et résolution des avertissements de l'analyse du code  
 ...
 ![Avertissements liés à l'analyse du code développé](../test/media/ca_cpp_expanded_callout.png "CA\_CPP\_Expanded\_Callout")  
 ...
 ![Code source en surbrillance](../test/media/ca_cpp_sourceline.png "CA\_CPP\_SourceLine")  
...
|[C6507](http://msdn.microsoft.com/fr-fr/18f88cd1-d035-4403-a6a4-12dd0affcf21)|Incompatibilité de null au déréférencement nul|  
...
|[C6519](http://msdn.microsoft.com/fr-fr/2b6326b0-0539-4d26-8fb1-720114933232)|Annotation non valide : la propriété NeedsRelease doit avoir la valeur Yes ou No|  
|[C6521](http://msdn.microsoft.com/fr-fr/e98d0ae3-6f13-47b2-9a15-15d4055af9ef)|Déréférencement de chaîne de taille non valide|  
|[C6522](../code-quality/c6522.md)|Type de chaîne de taille non valide|  
|[C6523](http://msdn.microsoft.com/fr-fr/11397a31-b224-46b0-afb7-d49ca576a3bb)|Paramètre de chaîne de taille non valide|  
|[C6525](../code-quality/c6525.md)|Chaîne de taille non valide. Emplacement inaccessible|  
|[C6526](http://msdn.microsoft.com/fr-fr/59c590c7-0098-4166-a1ac-87f324596002)|Type de tampon de chaîne de taille non valide|  
...
|[C6540](../code-quality/c6540.md)|L'utilisation des annotations d'attribut sur cette fonction rendra non valides toutes ses annotations \_\_declspec existantes|  
...
|[C28205](../code-quality/c28205.md)|\_Success\_ ou \_On\_failure\_ utilisé dans un contexte non autorisé|  
...
|[C28222](../code-quality/c28222.md)|\_\_yes, \_\_no ou \_\_maybe attendus pour l'annotation|  
...
|[C28234](../code-quality/c28234.md)|l'expression \_\_at ne s'applique pas à la fonction actuelle|  
...
|[C28303](../code-quality/c28303.md)|Un opérateur \_Deref\_ ambigu a été trouvé dans une annotation.|  
