...
description: Découvrez comment examiner les données générées pendant une exécution de test de charge plus en détail en utilisant des barres de zoom pour effectuer un zoom avant et accéder à une région du graphique.
