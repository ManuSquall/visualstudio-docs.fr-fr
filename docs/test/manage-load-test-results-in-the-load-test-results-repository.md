...
description: Découvrez comment gérer les données collectées pendant un test de charge, qui est stocké dans la base de données SQL de charge Résultats des tests référentiel.
