...
description: Découvrez comment utiliser l’adaptateur de données de diagnostic du profileur ASP.NET pour collecter des informations sur le profileur ASP.NET.
