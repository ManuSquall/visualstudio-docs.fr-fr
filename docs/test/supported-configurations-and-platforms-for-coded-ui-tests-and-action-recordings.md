...
Les plateformes et configurations prises en charge pour les tests codés de l’interface utilisateur pour Visual Studio Enterprise sont indiquées dans le tableau suivant. Ces configurations s'appliquent également aux enregistrements d'actions créés à l'aide de [!INCLUDE[MTRlong](../test/includes/mtrlong_md.md)].  
