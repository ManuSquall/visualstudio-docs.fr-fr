...
**R :** Oui, pour obtenir une vue d’ensemble globale, lisez ce [billet de blog](https://blogs.msdn.microsoft.com/devops/2015/07/05/intellitest-one-test-to-rule-them-all/).
