---
title: Utiliser MSTest dans les tests unitaires
description: En savoir plus sur l’infrastructure MSTest, qui prend en charge les tests unitaires dans Visual Studio. Utilisez ces classes et membres pour coder les tests unitaires.
