...
## <a name="using-test-explorer"></a>Utilisation de l'Explorateur de tests  
 ![Explorateur de tests unitaires montrant le bouton Exécuter tout](~/docs/test/media/unittestexplorer-beta-.png "UnitTestExplorer(beta)")  
