...
description: Découvrez comment vous pouvez implémenter des tests automatisés pour l’automatisation de la génération, du déploiement et des tests à l’aide de Azure Pipelines et Team Foundation Server.
