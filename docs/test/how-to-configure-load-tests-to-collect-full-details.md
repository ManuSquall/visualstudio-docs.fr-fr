...
ms.locfileid: "39379623"
---
# <a name="how-to-configure-load-tests-to-collect-full-details-to-enable-virtual-user-activity-in-test-results"></a>Guide pratique pour configurer les tests de charge en vue de collecter les détails complets et d’activer l’activité des utilisateurs virtuels dans les résultats des tests
