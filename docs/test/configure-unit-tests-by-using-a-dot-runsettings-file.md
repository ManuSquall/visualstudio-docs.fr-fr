...
- Placez un fichier de paramètres d’exécution nommé « . RunSettings » à la racine de votre solution.
  ...
  Si la détection automatique des fichiers de paramètres d’exécution est activée, les paramètres de ce fichier sont appliqués dans l’ensemble des tests exécutés. Vous pouvez activer la détection automatique des fichiers RunSettings à partir de deux emplacements :
    ...
    - **Outils** > **Options** > **Test** > **Détection automatique des fichiers RunSettings**
    ...
    - **Test** > **Configurer les paramètres** > d’exécution **Détection automatique des fichiers RunSettings**
...
3. Pour sélectionner le fichier de paramètres d’exécution, choisissez **tester**  >  **Sélectionner le fichier de paramètres**. Accédez au fichier *.runsettings* que vous avez créé, puis sélectionnez **OK**.
...
### <a name="logger-run-settings"></a>Paramètres d’exécution du journal
