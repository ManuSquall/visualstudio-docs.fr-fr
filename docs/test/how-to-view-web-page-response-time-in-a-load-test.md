...
Le temps qu’il faut pour chaque page web à charger est connu sous le nom *de temps de réponse*. Lorsque vous créez un test de performances web, vous pouvez définir un objectif de temps de réponse pour chaque requête de page web de votre test de performances web.
...
- Vous pouvez analyser les temps de réponse de la page Web en utilisant la vue des tables ou la vue graphique dans **l’analyseur de test de charge**:
...
1. Dans **l’analyseur de test de charge**, choisissez des **tables** sur la barre d’outils pour s’assurer que la grille de table est affichée.
...
3. Les données de chaque page s'affichent dans la grille. Généralement, les colonnes suivantes s'affichent :
   ...
   |**Objectif**|Objectif de temps de réponse de la page. Il s'agit d'une valeur constante pour la page. **Note:**  Page Time Goal n’est affiché que lorsque l’objectif a été défini pour la demande dans le test de performance Web.|
...
1. Dans **l’analyseur de test de charge**, choisissez des **graphiques** sur la barre d’outils pour s’assurer que le graphique est affiché.
