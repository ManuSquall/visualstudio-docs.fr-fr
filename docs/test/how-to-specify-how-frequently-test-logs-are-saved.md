...
ms.locfileid: "39381932"
---
# <a name="how-to-specify-how-frequently-test-logs-are-saved-using-the-load-test-editor"></a>Guide pratique pour spécifier la fréquence d’enregistrement des journaux des tests à l’aide de l’Éditeur de test de charge
