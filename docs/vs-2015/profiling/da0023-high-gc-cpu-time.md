...
ms.locfileid: "47501200"
---
# <a name="da0023-high-gc-cpu-time"></a>DA0023 : Temps processeur GC élevé
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [DA0023 : temps processeur GC élevé](https://docs.microsoft.com/visualstudio/profiling/da0023-high-gc-cpu-time).  
