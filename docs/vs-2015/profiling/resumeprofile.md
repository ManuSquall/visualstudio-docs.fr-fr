...
ms.locfileid: "47493391"
---
# <a name="resumeprofile"></a>ResumeProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [ResumeProfile](https://docs.microsoft.com/visualstudio/profiling/resumeprofile).  
