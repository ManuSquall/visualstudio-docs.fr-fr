...
7. Attachez le profileur au processus de travail [!INCLUDE[vstecasp](../includes/vstecasp-md.md)]. Tapez :  
...
1. Effectuez l’une des opérations suivantes pour détacher le profileur de l’application cible :  
   ...
   - Fermez le processus de travail [!INCLUDE[vstecasp](../includes/vstecasp-md.md)]. Tapez :  
