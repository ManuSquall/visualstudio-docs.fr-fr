...
Vous trouverez la dernière version de cette rubrique dans [personnalisation des vues de rapport d’outils de performances](https://docs.microsoft.com/visualstudio/profiling/customizing-performance-tools-report-views).  
