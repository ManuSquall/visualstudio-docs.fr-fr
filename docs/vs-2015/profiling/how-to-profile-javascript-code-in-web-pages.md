...
Vous trouverez la dernière version de cette rubrique dans [Comment : profiler du JavaScript Code dans les Pages Web](https://docs.microsoft.com/visualstudio/profiling/how-to-profile-javascript-code-in-web-pages).  
