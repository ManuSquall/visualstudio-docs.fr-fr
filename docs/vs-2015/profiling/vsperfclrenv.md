...
ms.locfileid: "47507806"
---
# <a name="vsperfclrenv"></a>VSPerfCLREnv
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [VSPerfCLREnv](https://docs.microsoft.com/visualstudio/profiling/vsperfclrenv).  
