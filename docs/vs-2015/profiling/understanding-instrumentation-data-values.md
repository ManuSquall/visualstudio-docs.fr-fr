...
ms.locfileid: "47506600"
---
# <a name="understanding-instrumentation-data-values"></a>Fonctionnement des valeurs de données d’instrumentation
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [valeurs de données d’Instrumentation compréhension](https://docs.microsoft.com/visualstudio/profiling/understanding-instrumentation-data-values).  
