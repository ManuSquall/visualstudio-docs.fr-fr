...
## <a name="lock-contention-and-serialized-execution"></a>Conflits de verrous et exécution sérialisée  
 ...
 Pour plus d’informations, consultez « Performance Pattern 1: Identifying Lock Contention » dans le blog [Parallel Performance Tools For Windows](https://docs.microsoft.com/archive/blogs/hshafi/) d’Hazim Shafi, sur MSDN Blogs.  
...
## <a name="uneven-workload-distribution"></a>Distribution inégale de la charge de travail  
 ![Charge de travail irrégulière](../profiling/media/unevenworkload-1.png "UnevenWorkLoad_1")  
 ...
 ![Charge de travail irrégulière](../profiling/media/unevenworkload-2.png "UnevenWorkload_2")  
...
## <a name="inefficient-io"></a>E/S inefficace  
 ![E&#47;O inefficace](../profiling/media/inefficient-io.png "Inefficient_IO")  
...
## <a name="lock-convoys"></a>Convois de verrouillage  
 ![Convois de verrouillage](../profiling/media/lock-convoys.png "Lock_Convoys")  
