...
## <a name="lock-contention-and-serialized-execution"></a>Conflits de verrous et exécution sérialisée  
 ![Conflits de verrous entraînant une exécution sérialisée](../profiling/media/lockcontention-serialized.png "LockContention_Serialized")  
...
## <a name="uneven-workload-distribution"></a>Distribution inégale de la charge de travail  
 ![Distribution inégale de la charge de travail](../profiling/media/unevenworkload-1.png "UnevenWorkLoad_1")  
 ...
 ![Distribution inégale de la charge de travail](../profiling/media/unevenworkload-2.png "UnevenWorkload_2")  
