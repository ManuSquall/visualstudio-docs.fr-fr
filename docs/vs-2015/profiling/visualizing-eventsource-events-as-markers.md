...
Vous trouverez la dernière version de cette rubrique dans [visualisation des événements EventSource comme marqueurs](https://docs.microsoft.com/visualstudio/profiling/visualizing-eventsource-events-as-markers).  
