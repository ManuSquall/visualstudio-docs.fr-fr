...
ms.locfileid: "47493461"
---
# <a name="modules-view---contention-data"></a>Vue Modules - Données de conflit
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [vue Modules - données de conflit](https://docs.microsoft.com/visualstudio/profiling/modules-view-contention-data).  
