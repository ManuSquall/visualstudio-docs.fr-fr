...
ms.locfileid: "47507804"
---
# <a name="performance-explorer-window"></a>Explorateur de performances, fenêtre
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fenêtre Explorateur de performances](https://docs.microsoft.com/visualstudio/profiling/performance-explorer-window).  
