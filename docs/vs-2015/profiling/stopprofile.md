...
ms.locfileid: "47507155"
---
# <a name="stopprofile"></a>StopProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [StopProfile](https://docs.microsoft.com/visualstudio/profiling/stopprofile).  
