...
ms.locfileid: "47500921"
---
# <a name="commentmarkatprofile"></a>CommentMarkAtProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [CommentMarkAtProfile](https://docs.microsoft.com/visualstudio/profiling/commentmarkatprofile).  
