...
## <a name="ending-the-profiling-session"></a>Fin d’une session de profilage  
 Pour mettre fin à une session de profilage, fermez l' [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] application Web, puis utilisez la commande Internet Information Services (IIS) **IISReset** pour fermer le [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] processus de travail. Appelez l’option **VSPerfCmd** [/shutdown](../profiling/shutdown.md) pour désactiver le profileur et fermer le fichier de données de profilage.  
