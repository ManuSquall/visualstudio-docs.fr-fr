...
Vous trouverez la dernière version de cette rubrique dans [DA0017 : taux élevés de pagination de la mémoire active sur le disque](https://docs.microsoft.com/visualstudio/profiling/da0017-high-rates-of-paging-active-memory-to-disk).  
