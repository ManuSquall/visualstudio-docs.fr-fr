...
Vous trouverez la dernière version de cette rubrique dans [DA0030 : mesures collecter d’Interaction de couche pour les projets de base de données](https://docs.microsoft.com/visualstudio/profiling/da0030-gather-tier-interaction-measurements-for-database-projects).  
