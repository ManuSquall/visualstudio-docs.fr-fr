...
ms.locfileid: "47494056"
---
# <a name="how-to-choose-collection-methods"></a>Comment : choisir des méthodes de collection
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : choisir les méthodes de Collection](https://docs.microsoft.com/visualstudio/profiling/how-to-choose-collection-methods).  
