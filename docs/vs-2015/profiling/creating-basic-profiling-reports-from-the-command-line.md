...
Vous trouverez la dernière version de cette rubrique dans [création profilage rapports de base à partir de la ligne de commande](https://docs.microsoft.com/visualstudio/profiling/creating-basic-profiling-reports-from-the-command-line).  
