...
ms.locfileid: "59657660"
---
# <a name="da0039-very-high-rate-of-lock-contentions"></a>DA0039 : Taux très élevé de conflits de verrou
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Pour obtenir la dernière documentation sur Visual Studio, consultez [DA0039 : Très haute taux de conflits de verrou](https://docs.microsoft.com/visualstudio/profiling/da0039-very-high-rate-of-lock-contentions).  
...
> [!NOTE]
> Quand le taux de conflits de verrou signalés dans les données de profilage est significatif mais pas excessif, le message d’information [DA0038 : Haute taux de conflits de verrou](../profiling/da0038-high-rate-of-lock-contentions.md) message d’information est déclenché à la place de ce message d’avertissement.  
