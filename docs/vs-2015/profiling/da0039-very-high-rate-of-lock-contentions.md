...
ms.locfileid: "58355449"
---
# <a name="da0039-very-high-rate-of-lock-contentions"></a>DA0039 : taux très élevé de conflits de verrouillage
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Pour obtenir la dernière documentation sur Visual Studio, consultez [DA0039 : très élevé taux de conflits de verrou](https://docs.microsoft.com/visualstudio/profiling/da0039-very-high-rate-of-lock-contentions) sur docs.microsoft.com.  
