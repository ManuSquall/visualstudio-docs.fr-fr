...
ms.locfileid: "47503926"
---
# <a name="utilization-view"></a>vue Utilisation
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [affichage de l’utilisation](https://docs.microsoft.com/visualstudio/profiling/utilization-view).  
