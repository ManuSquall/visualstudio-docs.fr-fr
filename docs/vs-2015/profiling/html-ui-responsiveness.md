...
ms.locfileid: "47494435"
---
# <a name="html-ui-responsiveness"></a>Réactivité de l'interface utilisateur HTML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [réactivité analyser de l’interface utilisateur HTML dans les applications UWP](https://docs.microsoft.com/visualstudio/profiling/html-ui-responsiveness).  
