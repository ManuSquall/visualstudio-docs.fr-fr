...
ms.locfileid: "47516779"
---
# <a name="concurrency-visualizer-sdk"></a>Kit de développement logiciel (SDK) du visualiseur concurrentiel
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [SDK du visualiseur concurrentiel](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-sdk).  
