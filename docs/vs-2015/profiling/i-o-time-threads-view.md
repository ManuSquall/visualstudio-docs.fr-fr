...
ms.locfileid: "47508408"
---
# <a name="io-time-threads-view"></a>Durée des E/S (vue Threads)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [e / S (vue Threads) de temps](https://docs.microsoft.com/visualstudio/profiling/i-o-time-threads-view).  
