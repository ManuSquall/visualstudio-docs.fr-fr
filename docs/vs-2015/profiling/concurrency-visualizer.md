...
Vous trouverez la dernière version de cette rubrique dans [visualiseur concurrentiel](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer).  
