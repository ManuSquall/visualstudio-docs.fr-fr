...
ms.locfileid: "47494648"
---
# <a name="function-details-view"></a>Vue Informations relatives à la fonction
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [affichage des détails de fonction](https://docs.microsoft.com/visualstudio/profiling/function-details-view).  
