...
## <a name="collect-application-timeline-data"></a><a name="BKMK_Collect_Timeline_data_for_your_app"></a> Collecter les données de chronologie de l'application  
...
2. Cliquez sur **Déboguer/profileur de performances.**... Vous devez voir une liste d’outils de profilage dans la fenêtre. diagsession.  
...
## <a name="analyze-timeline-profiling-data"></a><a name="BKMK_Analyze_Timeline_profiling_data"></a> Analyser les données de profilage de la chronologie  
...
### <a name="visual-throughput-fps-graph"></a><a name="BKMK_Visual_throughput_FPS_graph"></a> Graphique du débit visuel (images par seconde)  
 ![Graphe visuel de débit](../profiling/media/timeline-visualthroughput.png "TIMELINE_VisualThroughput")  
...
## <a name="see-also"></a>Voir aussi  
 [Blog de l’équipe WPF : nouvel outil d’analyse des performances de l’interface utilisateur pour les applications WPF](https://devblogs.microsoft.com/wpf/new-ui-performance-analysis-tool-for-wpf-applications/)   
 [Meilleures pratiques en matière de performances pour les applications du Windows Store en C++, C# et Visual Basic](https://msdn.microsoft.com/567bcefa-5da5-4e42-a4b8-1358c71adfa2)   
