...
ms.locfileid: "47501675"
---
# <a name="resource-contention-data-views"></a>Vues de données de conflit de ressources
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [les vues de données de conflit de ressources](https://docs.microsoft.com/visualstudio/profiling/resource-contention-data-views).  
