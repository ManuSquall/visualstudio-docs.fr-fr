...
ms.locfileid: "47507935"
---
# <a name="collecting-tier-interaction-data"></a>Collecte de données d’interaction de couche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [collecte de données d’interaction de couche](https://docs.microsoft.com/visualstudio/profiling/collecting-tier-interaction-data).  
