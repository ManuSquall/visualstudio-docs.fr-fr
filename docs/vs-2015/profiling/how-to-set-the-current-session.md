...
ms.locfileid: "47494901"
---
# <a name="how-to-set-the-current-session"></a>Guide pratique pour définir la session active
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : définir la Session active](https://docs.microsoft.com/visualstudio/profiling/how-to-set-the-current-session).  
