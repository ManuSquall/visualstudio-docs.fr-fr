...
ms.locfileid: "47507764"
---
# <a name="zoom-control-threads-view"></a>Contrôle Zoom (vue Threads)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [contrôle Zoom (vue Threads)](https://docs.microsoft.com/visualstudio/profiling/zoom-control-threads-view).  
