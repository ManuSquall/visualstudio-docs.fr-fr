...
## <a name="general"></a>Général  
 ...
 [Procédure : définir les options de nom de fichier de données de performances](../profiling/how-to-set-performance-data-file-name-options.md)  
...
## <a name="instrumentation"></a>Instrumentation  
 ...
 [Comment : spécifier des commandes de pré-instrumentation et de publication](../profiling/how-to-specify-pre-and-post-instrument-commands.md)  
...
## <a name="advanced"></a>Avancé  
 ...
 [Comment : spécifier le Runtime .NET Framework](../profiling/how-to-specify-the-dotnet-framework-runtime.md)  
