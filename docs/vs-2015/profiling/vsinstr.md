...
|**Couverture**|Exécute l’instrumentation de la couverture. Cette option ne peut être utilisée qu’avec les options suivantes : **Verbose**, **OutputPath**, **Exclude** et **Logfile**.|  
