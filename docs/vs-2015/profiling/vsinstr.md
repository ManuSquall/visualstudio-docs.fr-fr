...
|**Coverage**|Exécute l’instrumentation de la couverture. Il peut se qu'il peut être utilisé uniquement avec les options suivantes : **Verbose**, **OutputPath**, **Exclude**, and **Logfile**.|  
