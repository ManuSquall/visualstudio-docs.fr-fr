...
ms.locfileid: "47506715"
---
# <a name="channels-threads-view"></a>Canaux (vue Threads)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [canaux (vue Threads)](https://docs.microsoft.com/visualstudio/profiling/channels-threads-view).  
