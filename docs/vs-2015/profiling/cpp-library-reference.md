...
ms.locfileid: "47493953"
---
# <a name="c-library-reference"></a>Référence de bibliothèque C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [référence de la bibliothèque C++](https://docs.microsoft.com/visualstudio/profiling/cpp-library-reference).  
