...
ms.locfileid: "47505428"
---
# <a name="extending-the-editor-and-language-services"></a>Extension de l’éditeur et des services de langage
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [extension de l’éditeur et les Services de langage](https://docs.microsoft.com/visualstudio/extensibility/extending-the-editor-and-language-services).  
