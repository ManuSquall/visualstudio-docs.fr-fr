...
ms.locfileid: "47507285"
---
# <a name="createinplace-visual-studio-templates"></a>CreateInPlace (modèles Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [CreateInPlace (modèles Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/createinplace-visual-studio-templates).  
