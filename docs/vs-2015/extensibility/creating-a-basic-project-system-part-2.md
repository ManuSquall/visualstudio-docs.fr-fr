...
Vous trouverez la dernière version de cette rubrique dans [création d’un système de projet de base, partie 2](https://docs.microsoft.com/visualstudio/extensibility/creating-a-basic-project-system-part-2).  
