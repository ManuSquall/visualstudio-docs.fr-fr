...
ms.locfileid: "47502545"
---
# <a name="group-element"></a>Élément Group
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [élément groupe](https://docs.microsoft.com/visualstudio/extensibility/group-element).  
