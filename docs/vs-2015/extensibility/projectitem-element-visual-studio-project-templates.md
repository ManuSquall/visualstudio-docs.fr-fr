...
Vous trouverez la dernière version de cette rubrique dans [ProjectItem, élément (modèles de projet Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/projectitem-element-visual-studio-project-templates).  
