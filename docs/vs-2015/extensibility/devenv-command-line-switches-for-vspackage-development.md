...
Vous trouverez la dernière version de cette rubrique dans [commutateurs de ligne de commande de Devenv pour le développement VSPackage](https://docs.microsoft.com/visualstudio/extensibility/devenv-command-line-switches-for-vspackage-development).  
