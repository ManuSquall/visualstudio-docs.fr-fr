...
ms.locfileid: "47504442"
---
# <a name="managing-vspackages"></a>Gestion de VSPackages
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [la gestion de VSPackages](https://docs.microsoft.com/visualstudio/extensibility/managing-vspackages).  
