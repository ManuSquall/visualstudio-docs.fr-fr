...
ms.locfileid: "47507544"
---
# <a name="sccsetoption-function"></a>Fonction SccSetOption
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonction SccSetOption](https://docs.microsoft.com/visualstudio/extensibility/sccsetoption-function).  
