...
ms.locfileid: "47506188"
---
# <a name="adapting-legacy-code-to-the-editor"></a>Adaptation de l’éditeur de Code hérité
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [adapter le Code hérité à l’éditeur](https://docs.microsoft.com/visualstudio/extensibility/adapting-legacy-code-to-the-editor).  
