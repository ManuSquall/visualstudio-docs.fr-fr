...
ms.locfileid: "47493893"
---
# <a name="menus-and-commands-for-visual-studio"></a>Menus et commandes de Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Menus et commandes de Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/menus-and-commands-for-visual-studio).  
