...
ms.locfileid: "47507444"
---
# <a name="evaluation-tools-for-visual-studio"></a>Outils d’évaluation pour Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [outils d’évaluation pour Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/evaluation-tools-for-visual-studio).  
