...
ms.locfileid: "47505661"
---
# <a name="keybindings-element"></a>Élément KeyBindings
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [KeyBindings élément](https://docs.microsoft.com/visualstudio/extensibility/keybindings-element).  
