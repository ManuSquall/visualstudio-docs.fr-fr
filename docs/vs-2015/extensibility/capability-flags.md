...
ms.locfileid: "47504436"
---
# <a name="capability-flags"></a>Indicateurs de capacité
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [indicateurs de capacité](https://docs.microsoft.com/visualstudio/extensibility/capability-flags).  
