...
|`SCC_CAP_SCCFILE`|0x80000000L|Prend en charge le MSSCCPRJ. Fichier SCC (soumis aux remplacements utilisateur/administrateur) et [SccWillCreateSccFile](../extensibility/sccwillcreatesccfile-function.md).|  
