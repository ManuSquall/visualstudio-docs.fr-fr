...
Vous trouverez la dernière version de cette rubrique dans [l’aide du Gestionnaire de texte aux paramètres globaux du moniteur](https://docs.microsoft.com/visualstudio/extensibility/using-the-text-manager-to-monitor-global-settings).  
