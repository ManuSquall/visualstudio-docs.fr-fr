...
ms.locfileid: "47501957"
---
# <a name="ide-constants"></a>Constantes de l’IDE
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [IDE constantes](https://docs.microsoft.com/visualstudio/extensibility/ide-constants).  
