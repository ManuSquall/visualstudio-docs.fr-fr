...
ms.locfileid: "47494881"
---
# <a name="sccproperties-function"></a>Fonction SccProperties
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonction SccProperties](https://docs.microsoft.com/visualstudio/extensibility/sccproperties-function).  
