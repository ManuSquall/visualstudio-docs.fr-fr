...
Vous trouverez la dernière version de cette rubrique dans [spécifiant des gestionnaires de fichiers pour les Extensions de nom de fichier](https://docs.microsoft.com/visualstudio/extensibility/specifying-file-handlers-for-file-name-extensions).  
