...
ms.locfileid: "47492801"
---
# <a name="sccaddfilesfromscc-function"></a>Fonction SccAddFilesFromSCC
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonction SccAddFilesFromSCC](https://docs.microsoft.com/visualstudio/extensibility/sccaddfilesfromscc-function).  
