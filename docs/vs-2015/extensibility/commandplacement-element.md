...
ms.locfileid: "47505051"
---
# <a name="commandplacement-element"></a>Élément CommandPlacement
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [CommandPlacement élément](https://docs.microsoft.com/visualstudio/extensibility/commandplacement-element).  
