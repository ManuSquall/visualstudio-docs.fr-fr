...
ms.locfileid: "47503057"
---
# <a name="parent-element"></a>Parent, élément
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [élément Parent](https://docs.microsoft.com/visualstudio/extensibility/parent-element).  
