...
Vous trouverez la dernière version de cette rubrique dans [procédure pas à pas : à l’aide d’une touche de raccourci avec une Extension de l’éditeur](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-using-a-shortcut-key-with-an-editor-extension).  
