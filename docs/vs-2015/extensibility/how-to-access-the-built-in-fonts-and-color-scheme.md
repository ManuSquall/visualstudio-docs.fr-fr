...
Vous trouverez la dernière version de cette rubrique dans [Comment : accéder aux polices intégrées et modèle de couleurs](https://docs.microsoft.com/visualstudio/extensibility/how-to-access-the-built-in-fonts-and-color-scheme).  
