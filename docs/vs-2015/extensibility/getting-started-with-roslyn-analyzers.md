...
## <a name="getting-started"></a>Prise en main  
 ...
 [Ajout de procédure pas à pas de correctifs de Code : Fournir des correctifs d’utilisateurs pour les problèmes de l’analyseur](https://msdn.microsoft.com/magazine/dn904670.aspx)  
