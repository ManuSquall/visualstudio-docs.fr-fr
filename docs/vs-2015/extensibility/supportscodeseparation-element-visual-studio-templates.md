...
Vous trouverez la dernière version de cette rubrique dans [SupportsCodeSeparation, élément (modèles Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/supportscodeseparation-element-visual-studio-templates).  
