...
ms.locfileid: "47508792"
---
# <a name="sccrunscc-function"></a>Fonction SccRunScc
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonction SccRunScc](https://docs.microsoft.com/visualstudio/extensibility/sccrunscc-function).  
