...
Vous trouverez la dernière version de cette rubrique dans [LocationField, élément (modèles de projet Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/locationfield-element-visual-studio-project-templates).  
