...
Vous trouverez la dernière version de cette rubrique dans [LocalizedName élément (schéma du module linguistique VSIX)](https://docs.microsoft.com/visualstudio/extensibility/localizedname-element-vsix-language-pack-schema).  
