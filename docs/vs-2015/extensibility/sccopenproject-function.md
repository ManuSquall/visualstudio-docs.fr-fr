...
ms.locfileid: "47504484"
---
# <a name="sccopenproject-function"></a>Fonction SccOpenProject
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonction SccOpenProject](https://docs.microsoft.com/visualstudio/extensibility/sccopenproject-function).  
