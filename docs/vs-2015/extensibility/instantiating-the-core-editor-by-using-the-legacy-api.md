...
Vous trouverez la dernière version de cette rubrique dans [instanciation le principal éditeur par à l’aide de l’API héritée](https://docs.microsoft.com/visualstudio/extensibility/instantiating-the-core-editor-by-using-the-legacy-api).  
