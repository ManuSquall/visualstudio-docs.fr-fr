...
Vous trouverez la dernière version de cette rubrique dans [gestion Annuler et rétablir à l’aide de l’API héritée](https://docs.microsoft.com/visualstudio/extensibility/managing-undo-and-redo-by-using-the-legacy-api).  
