...
ms.locfileid: "47493203"
---
# <a name="how-to-implement-undo-management"></a>Comment : implémenter la gestion de l’annulation
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : implémenter Annuler gestion](https://docs.microsoft.com/visualstudio/extensibility/how-to-implement-undo-management).  
