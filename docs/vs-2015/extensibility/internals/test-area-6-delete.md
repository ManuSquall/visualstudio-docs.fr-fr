...
ms.locfileid: "47504817"
---
# <a name="test-area-6-delete"></a>Zone de test 6 : Supprimer
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Test zone 6 : supprimer](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-6-delete).  
