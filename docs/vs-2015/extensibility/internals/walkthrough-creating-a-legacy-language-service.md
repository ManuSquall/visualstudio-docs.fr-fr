...
L’utilisation des classes de langage de Managed package Framework (MPF) pour implémenter un service de langage dans [!INCLUDE[csprcs](../../includes/csprcs-md.md)] est simple. Vous avez besoin d’un VSPackage pour héberger le service de langage, le service de langage lui-même et un analyseur pour votre langue.  
...
3. Sélectionnez [!INCLUDE[csprcs](../../includes/csprcs-md.md)] comme langue et l’option permettant de générer un nouveau fichier de clé. Cliquez sur **Suivant**.  
...
6. Dans le fichier MyLanguageService.cs, ajoutez les `using` instructions suivantes.  
...
1. Ouvrez le fichier MyLanguagePackagePackage.cs et ajoutez les `using` instructions suivantes :  
...
3. Dans le nouveau fichier de classe, ajoutez les `using` instructions suivantes.  
