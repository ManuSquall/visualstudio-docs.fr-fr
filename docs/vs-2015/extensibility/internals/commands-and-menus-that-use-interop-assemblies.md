...
Vous trouverez la dernière version de cette rubrique dans [commandes et Menus qu’utilisation d’assemblys Interop](https://docs.microsoft.com/visualstudio/extensibility/internals/commands-and-menus-that-use-interop-assemblies).  
