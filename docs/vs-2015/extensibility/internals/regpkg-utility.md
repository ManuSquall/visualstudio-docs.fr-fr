...
ms.locfileid: "47493072"
---
# <a name="regpkg-utility"></a>Utilitaire RegPkg
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [utilitaire RegPkg](https://docs.microsoft.com/visualstudio/extensibility/internals/regpkg-utility).  
