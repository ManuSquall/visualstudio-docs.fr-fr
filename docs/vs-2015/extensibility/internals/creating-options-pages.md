...
ms.locfileid: "47505926"
---
# <a name="creating-options-pages"></a>Création de pages Options
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [création de Pages Options](https://docs.microsoft.com/visualstudio/extensibility/internals/creating-options-pages).  
