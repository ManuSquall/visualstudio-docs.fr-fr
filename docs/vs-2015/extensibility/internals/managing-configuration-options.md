...
ms.locfileid: "47504779"
---
# <a name="managing-configuration-options"></a>Gestion des options de configuration
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [la gestion des Options de Configuration](https://docs.microsoft.com/visualstudio/extensibility/internals/managing-configuration-options).  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit comment les projets dans [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] peut prendre en charge les configurations à plusieurs.  
 ...
 Définit l’action de déploiement et les deux façons [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] prend en charge les projets qui prennent en charge le déploiement.  
