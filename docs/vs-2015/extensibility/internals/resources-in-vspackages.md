...
ms.locfileid: "47501970"
---
# <a name="resources-in-vspackages"></a>Ressources dans VSPackages
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [ressources dans VSPackages](https://docs.microsoft.com/visualstudio/extensibility/internals/resources-in-vspackages).  
