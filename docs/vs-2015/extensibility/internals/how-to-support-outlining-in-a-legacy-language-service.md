...
Vous trouverez la dernière version de cette rubrique dans [Comment : prise en charge le mode plan dans un Service de langage hérité](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-support-outlining-in-a-legacy-language-service).  
