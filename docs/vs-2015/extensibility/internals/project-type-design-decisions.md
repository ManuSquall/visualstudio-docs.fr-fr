...
## <a name="project-items"></a>Éléments de projet  
 ...
 Dans les projets basés sur une référence, les éléments peuvent apparaître dans plusieurs projets. Toutefois, le fichier réel représenté par un élément se trouve dans un seul répertoire. Dans les projets basés sur des répertoires, il existe tous les éléments de projet dans la structure de répertoires. Pour plus d’informations, consultez [plume : gestion des éléments dans les projets](https://msdn.microsoft.com/762e606b-7f44-4b66-97a1-e30a703654a0).  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [PLUME : gestion des éléments dans les projets](https://msdn.microsoft.com/762e606b-7f44-4b66-97a1-e30a703654a0)   
