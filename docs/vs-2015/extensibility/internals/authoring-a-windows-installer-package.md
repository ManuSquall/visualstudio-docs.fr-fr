...
- Recherchez dans le système les versions de [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] votre package pris en charge (à l’aide de Windows Installer des tables qui incluent AppSearch, CompLocator, RegLocator, DrLocator et signature).  
...
- ensemble d'outils XML de Windows Installer  
  ...
  Pour les produits commerciaux qui s’intègrent à à l' [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] aide de [!INCLUDE[vsipsdk](../../includes/vsipsdk-md.md)] , consultez [https://marketplace.visualstudio.com/](https://marketplace.visualstudio.com/) .  
