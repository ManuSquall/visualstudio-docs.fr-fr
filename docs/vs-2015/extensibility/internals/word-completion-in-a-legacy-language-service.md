...
Vous trouverez la dernière version de cette rubrique dans [semi-automatique dans un Service de langage hérité](https://docs.microsoft.com/visualstudio/extensibility/internals/word-completion-in-a-legacy-language-service).  
