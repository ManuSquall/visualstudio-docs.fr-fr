...
Vous trouverez la dernière version de cette rubrique dans [propriétés et méthodes étendues par les sous-types de projet](https://docs.microsoft.com/visualstudio/extensibility/internals/properties-and-methods-extended-by-project-subtypes).  
