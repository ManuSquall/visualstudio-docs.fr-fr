...
Dans Managed package Framework (MPF), le service de langage est offerts par un VSPackage (voir [VSPackages](../../extensibility/internals/vspackages.md)) et est inscrit auprès de [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] en ajoutant des clés et des entrées de registre. Ce processus d’inscription s’effectue en partie pendant l’installation et en partie au moment de l’exécution.  
