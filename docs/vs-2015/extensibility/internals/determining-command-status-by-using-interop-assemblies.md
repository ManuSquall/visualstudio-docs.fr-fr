...
Vous trouverez la dernière version de cette rubrique dans [détermination commande état par à l’aide d’assemblys PIA](https://docs.microsoft.com/visualstudio/extensibility/internals/determining-command-status-by-using-interop-assemblies).  
