...
ms.locfileid: "47503199"
---
# <a name="elimination-of-sak-files"></a>Élimination des fichiers ~SAK
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [élimination de ~ SAK fichiers](https://docs.microsoft.com/visualstudio/extensibility/internals/elimination-of-tilde-sak-files).  
