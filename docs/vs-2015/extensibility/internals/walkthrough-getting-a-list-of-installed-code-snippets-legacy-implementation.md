...
Vous trouverez la dernière version de cette rubrique dans [obtenir une liste d’installé des extraits de Code (hérité)](https://docs.microsoft.com/visualstudio/extensibility/internals/walkthrough-getting-a-list-of-installed-code-snippets-legacy-implementation).  
