...
ms.locfileid: "47495392"
---
# <a name="inside-the-visual-studio-sdk"></a>Dans le kit SDK Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [dans le SDK Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/internals/inside-the-visual-studio-sdk).  
