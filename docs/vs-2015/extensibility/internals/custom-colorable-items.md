...
ms.locfileid: "47506702"
---
# <a name="custom-colorable-items"></a>Éléments coloriables personnalisés
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [éléments Coloriables personnalisés](https://docs.microsoft.com/visualstudio/extensibility/internals/custom-colorable-items).  
