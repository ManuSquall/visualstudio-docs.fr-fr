...
ms.locfileid: "90840210"
---
# <a name="registering-a-project-type"></a>Inscription d’un type de projet
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Lorsque vous créez un nouveau type de projet, vous devez créer des entrées de Registre qui permettent [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] à de reconnaître et d’utiliser votre type de projet. En général, vous créez ces entrées de Registre à l’aide d’un fichier de script de Registre (. RGS).  
