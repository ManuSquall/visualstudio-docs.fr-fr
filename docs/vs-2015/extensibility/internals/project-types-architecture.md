...
ms.locfileid: "47501928"
---
# <a name="project-types-architecture"></a>Architecture des types de projets
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Architecture des Types de projet](https://docs.microsoft.com/visualstudio/extensibility/internals/project-types-architecture).  
