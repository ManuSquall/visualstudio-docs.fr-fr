...
ms.locfileid: "47501316"
---
# <a name="miscellaneous-files-project"></a>Projet Fichiers divers
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [le projet fichiers divers](https://docs.microsoft.com/visualstudio/extensibility/internals/miscellaneous-files-project).  
