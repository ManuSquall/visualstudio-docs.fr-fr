...
## <a name="command-menu-access"></a>Accès au menu commande  
 Le [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] chemin d’accès au menu de l’environnement de développement intégré suivant est utilisé dans les cas de test.  
