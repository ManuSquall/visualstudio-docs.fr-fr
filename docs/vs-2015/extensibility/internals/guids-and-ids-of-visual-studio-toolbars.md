...
ms.locfileid: "47502069"
---
# <a name="guids-and-ids-of-visual-studio-toolbars"></a>GUID et ID des barres d’outils Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [GUID et ID de Visual Studio barres d’outils](https://docs.microsoft.com/visualstudio/extensibility/internals/guids-and-ids-of-visual-studio-toolbars).  
