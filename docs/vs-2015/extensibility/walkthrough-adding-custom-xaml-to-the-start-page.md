...
Vous trouverez la dernière version de cette rubrique dans [procédure pas à pas : ajout de XAML personnalisé à la Page de démarrage](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-adding-custom-xaml-to-the-start-page).  
