...
ms.locfileid: "47505636"
---
# <a name="registering-a-tool-window"></a>Enregistrement d’une fenêtre d’outil
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [l’inscription d’une fenêtre outil](https://docs.microsoft.com/visualstudio/extensibility/registering-a-tool-window).  
