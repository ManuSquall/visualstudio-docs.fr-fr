...
7. Dans le constructeur de HighlightWordTag, transmettez le nom de la définition de format que vous venez de créer.  
...
5. Vous devez également ajouter un `TagsChanged` événement qui sera appelé par la méthode de mise à jour.  
...
## <a name="creating-a-tagger-provider"></a>Création d’un fournisseur de balises  
