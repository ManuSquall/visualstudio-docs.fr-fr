...
ms.locfileid: "47507008"
---
# <a name="scchistory-function"></a>Fonction SccHistory
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonction SccHistory](https://docs.microsoft.com/visualstudio/extensibility/scchistory-function).  
