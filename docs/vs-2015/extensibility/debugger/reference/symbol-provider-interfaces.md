...
ms.locfileid: "47502693"
---
# <a name="symbol-provider-interfaces"></a>Interfaces des fournisseurs de symboles
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Interfaces de fournisseur de symboles](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/symbol-provider-interfaces).  
  
Les éléments suivants sont les Interfaces de gestion des symboles pour le [!INCLUDE[vsipsdk](../../../includes/vsipsdk-md.md)].  
