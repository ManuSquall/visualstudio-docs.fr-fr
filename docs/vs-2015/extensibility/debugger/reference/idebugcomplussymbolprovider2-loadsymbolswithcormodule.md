...
Vous trouverez la dernière version de cette rubrique dans [IDebugComPlusSymbolProvider2::LoadSymbolsWithCorModule](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugcomplussymbolprovider2-loadsymbolswithcormodule).  
  
Compte tenus des symboles de débogage de charges le **ICorDebugModule** objet.  
...
#### <a name="parameters"></a>Paramètres  
 ...
 `pUnkMetadataImport`  
 [in] Objet qui contient les métadonnées de symboles de débogage.  
