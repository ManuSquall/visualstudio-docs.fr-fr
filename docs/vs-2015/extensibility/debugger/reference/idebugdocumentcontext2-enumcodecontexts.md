...
#### <a name="parameters"></a>Paramètres  
 `ppEnumCodeCxts`  
 à Retourne un objet [IEnumDebugCodeContexts2](../../../extensibility/debugger/reference/ienumdebugcodecontexts2.md) qui contient une liste de contextes de code.  
