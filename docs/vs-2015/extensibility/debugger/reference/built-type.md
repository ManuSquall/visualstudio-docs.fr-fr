...
ms.locfileid: "47508781"
---
# <a name="builttype"></a>BUILT_TYPE
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [BUILT_TYPE](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/built-type).  
