...
- Le SDM appelle [QueryInterface](https://msdn.microsoft.com/library/62fce95e-aafa-4187-b50b-e6611b74c3b3) sur une `IDebugProcess2` interface pour obtenir cette interface.  
