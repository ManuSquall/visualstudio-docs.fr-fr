...
ms.locfileid: "47501941"
---
# <a name="evaluating-locals"></a>Évaluation des variables locales
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [variables locales de l’évaluation](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-locals).  
