...
Vous trouverez la dernière version de cette rubrique dans [implémentation de visualiseurs de Type et les visionneuses personnalisées](https://docs.microsoft.com/visualstudio/extensibility/debugger/implementing-type-visualizers-and-custom-viewers).  
