...
ms.locfileid: "47504336"
---
# <a name="stack-frames"></a>Frames de pile
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Frames de pile](https://docs.microsoft.com/visualstudio/extensibility/debugger/stack-frames).  
