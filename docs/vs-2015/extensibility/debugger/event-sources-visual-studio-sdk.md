...
ms.locfileid: "47495866"
---
# <a name="event-sources-visual-studio-sdk"></a>Sources d’événements (SDK Visual Studio)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Sources d’événements (SDK Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/debugger/event-sources-visual-studio-sdk).  
