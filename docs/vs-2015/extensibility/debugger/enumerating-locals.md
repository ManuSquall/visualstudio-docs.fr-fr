...
ms.locfileid: "47505593"
---
# <a name="enumerating-locals"></a>Énumération de variables locales
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [variables locales de l’énumération](https://docs.microsoft.com/visualstudio/extensibility/debugger/enumerating-locals).  
