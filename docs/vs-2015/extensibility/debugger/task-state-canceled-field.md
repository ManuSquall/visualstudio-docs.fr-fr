...
ms.locfileid: "47503330"
---
# <a name="taskstatecanceled-field"></a>Champ TASK_STATE_CANCELED
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [champ TASK_STATE_CANCELED](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-canceled-field).  
