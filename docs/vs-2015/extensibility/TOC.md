# [Kit de développement logiciel Visual Studio](visual-studio-sdk.md)
...
# [Questions fréquentes (FAQ) : Conversion des compléments en extensions VSPackage](faq-converting-add-ins-to-vspackage-extensions.md)
...
### [Procédure pas à pas : Mettre du texte en surbrillance](walkthrough-highlighting-text.md)
...
## [Guide pratique pour ajouter une dépendance à un package VSIX](how-to-add-a-dependency-to-a-vsix-package.md)
...
### [Guide pratique pour fournir un contexte pour les éditeurs](how-to-provide-context-for-editors.md)
