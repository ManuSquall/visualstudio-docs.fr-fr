...
ms.locfileid: "47504048"
---
# <a name="context-menus"></a>Menus contextuels
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Menus contextuels](https://docs.microsoft.com/visualstudio/extensibility/context-menus).  
