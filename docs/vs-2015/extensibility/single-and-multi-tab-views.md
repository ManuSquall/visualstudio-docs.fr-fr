...
## <a name="accessing-physical-views"></a>Accès aux vues physiques  
 ...
 Pour activer votre éditeur afin d’accéder à toutes les vues physiques disponibles, vous devez créer une chaîne de la vue physique unique pour chaque type d’objet de vue de document que votre fabrique d’éditeur peut créer. Par exemple, le [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] fabrique d’éditeur peut créer le document des objets de vue pour une fenêtre de code et une fenêtre de Concepteur de formulaires.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Guide pratique : Joindre des vues de données de document](../extensibility/how-to-attach-views-to-document-data.md)   
