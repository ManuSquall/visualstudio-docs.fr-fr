...
ms.locfileid: "47496347"
---
# <a name="drop-down-bar"></a>Barre déroulante
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [barre déroulante](https://docs.microsoft.com/visualstudio/extensibility/drop-down-bar).  
