...
ms.locfileid: "47501934"
---
# <a name="vsct-xml-schema-reference"></a>Informations de référence sur le schéma XML VSCT
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [VSCT XML Schema Reference](https://docs.microsoft.com/visualstudio/extensibility/vsct-xml-schema-reference).  
