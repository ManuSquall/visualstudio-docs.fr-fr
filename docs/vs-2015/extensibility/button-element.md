...
ms.locfileid: "47494229"
---
# <a name="button-element"></a>Élément Button
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [élément Button](https://docs.microsoft.com/visualstudio/extensibility/button-element).  
