...
## <a name="adding-a-private-gallery-to-extensions-and-updates-in-visual-studio"></a>Ajout d’une galerie privée à des extensions et des mises à jour dans Visual Studio  
