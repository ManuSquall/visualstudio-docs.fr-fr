...
Vous trouverez la dernière version de cette rubrique dans [Impossible de créer une association &lt;nom de l’association&gt; -types de propriété ne correspondent pas](https://docs.microsoft.com/visualstudio/data-tools/cannot-create-an-association-association-name-property-types-do-not-match).  
