...
La boîte de dialogue **configurer la référence de service** vous permet de configurer le comportement des services [!INCLUDE[vsindigo](../includes/vsindigo-md.md)].
