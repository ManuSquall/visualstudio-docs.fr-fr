...
Vous trouverez la dernière version de cette rubrique dans [filtrer et trier des données dans une application Windows Forms](https://docs.microsoft.com/visualstudio/data-tools/filter-and-sort-data-in-a-windows-forms-application).  
