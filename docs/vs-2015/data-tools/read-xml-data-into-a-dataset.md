...
4. Création du DataSet, lecture du fichier XML et affichage dans un <xref:System.Windows.Forms.DataGridView> contrôle

5. Ajout de code pour afficher le schéma XML en fonction du fichier XML dans un <xref:System.Windows.Forms.TextBox> contrôle
