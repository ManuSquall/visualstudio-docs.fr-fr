...
ms.locfileid: "47504138"
---
# <a name="pass-data-between-forms"></a>Passer des données entre des formulaires
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [passer des données entre formulaires](https://docs.microsoft.com/visualstudio/data-tools/pass-data-between-forms).  
