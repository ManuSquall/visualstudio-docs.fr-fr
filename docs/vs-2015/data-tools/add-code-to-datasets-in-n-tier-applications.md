...
Vous trouverez la dernière version de cette rubrique dans [ajouter du code à des jeux de données dans les applications multicouches](https://docs.microsoft.com/visualstudio/data-tools/add-code-to-datasets-in-n-tier-applications).  
