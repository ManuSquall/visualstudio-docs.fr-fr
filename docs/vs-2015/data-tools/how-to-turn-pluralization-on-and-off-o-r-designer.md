...
2. Affectez à la **pluralisation des noms** la valeur **Enabled**  =  **false** pour définir le [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] afin qu’il ne modifie pas les noms de classe.

3. Attribuez la **valeur**true à la **pluralisation des noms** pour  =  **True** appliquer les règles de pluralité aux noms des classes des objets ajoutés au [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] .
