...
Un ou plusieurs des éléments déplacés à partir de **Explorateur de serveurs** /**explorateur de base de données** sur le [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] contient un type de données qui n’est pas pris en charge par le [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] (par exemple, les [types CLR définis](https://msdn.microsoft.com/library/9f70e0b0-3a0d-4eb1-b914-07a5d0c167c2)par l’utilisateur).

### <a name="to-correct-this-error"></a>Pour corriger cette erreur

1. Créez une vue basée sur la table souhaitée qui n'inclut pas le type de données non pris en charge.

2. Faites glisser la vue de **Explorateur de serveurs** /**Explorateur de base de données** sur le concepteur.
