...
ms.locfileid: "47501298"
---
# <a name="save-data-by-using-a-transaction"></a>Enregistrer des données à l’aide d’une transaction
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [enregistrer les données à l’aide d’une transaction](https://docs.microsoft.com/visualstudio/data-tools/save-data-by-using-a-transaction).  
