...
Vous trouverez la dernière version de cette rubrique dans [cette méthode associée est la méthode de stockage pour le suivant par défaut d’insertion, mise à jour, méthodes ou de suppression](https://docs.microsoft.com/visualstudio/data-tools/this-related-method-is-the-backing-method-for-the-following-default-insert-update-or-delete-methods).  
