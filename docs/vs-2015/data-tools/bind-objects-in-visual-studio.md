...
### <a name="addobjects-to-a-collection"></a>AddObjects à une collection
 ...
 Pour obtenir un exemple d’ajout à une collection à l’aide d’un <xref:System.Windows.Forms.BindingSource> , consultez la `LoadCustomers` méthode dans [procédure pas à pas : connexion à des données dans des objets (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).

 Pour obtenir un exemple d’ajout d’objets à une collection personnalisée, consultez la `LoadOrders` méthode dans [procédure pas à pas : connexion à des données dans des objets (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).
