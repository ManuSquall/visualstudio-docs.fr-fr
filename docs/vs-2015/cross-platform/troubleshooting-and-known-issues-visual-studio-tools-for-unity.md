...
Vous trouverez la dernière version de cette rubrique dans [dépannage et problèmes connus (Visual Studio Tools pour Unity)](https://docs.microsoft.com/visualstudio/cross-platform/troubleshooting-and-known-issues-visual-studio-tools-for-unity).  
