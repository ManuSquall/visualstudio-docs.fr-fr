...
Vous trouverez la dernière version de cette rubrique dans [en savoir plus sur le développement mobile avec Xamarin](https://docs.microsoft.com/visualstudio/cross-platform/learn-about-mobile-development-with-xamarin).  
