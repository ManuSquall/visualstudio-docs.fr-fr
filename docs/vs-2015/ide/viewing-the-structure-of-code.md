...
ms.locfileid: "47503168"
---
# <a name="viewing-the-structure-of-code"></a>Affichage de la structure du code
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [affichage de la Structure du Code](https://docs.microsoft.com/visualstudio/ide/viewing-the-structure-of-code).  
