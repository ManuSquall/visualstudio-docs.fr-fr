...
2. Remplissez le titre de l’extrait de code, par exemple « Hello World VB », dans l’élément title.
...
9. Le code doit ressembler à l’exemple ci-dessous, où les remplacements `SQL connection string` et `dcConnection` sont indiqués en orange clair. Appuyez sur TAB pour naviguer de l’un à l’autre.
