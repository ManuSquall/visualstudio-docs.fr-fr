...
## <a name="example-how-to-change-manifest-information-by-using-a-post-build-event"></a>Exemple : Comment modifier les informations de manifeste à l’aide d’un événement post-Build  
