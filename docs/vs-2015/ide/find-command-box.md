...
ms.locfileid: "47495798"
---
# <a name="findcommand-box"></a>zone Rechercher/Commande
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [zone Rechercher / commande](https://docs.microsoft.com/visualstudio/ide/find-command-box).  
