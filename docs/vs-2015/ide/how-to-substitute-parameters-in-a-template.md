...
ms.locfileid: "47504803"
---
# <a name="how-to-substitute-parameters-in-a-template"></a>Comment : substituer des paramètres dans un modèle
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : substituer des paramètres dans un modèle](https://docs.microsoft.com/visualstudio/ide/how-to-substitute-parameters-in-a-template).  
