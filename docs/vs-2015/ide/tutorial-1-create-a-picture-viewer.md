...
- Écrire des méthodes de gestionnaire d'événements.
  ...
  ![lien vers la vidéo](../data-tools/media/playvideo.gif "PlayVideo") Pour obtenir une version vidéo de cette rubrique, consultez [procédure : créer une visionneuse d’images dans Visual Basic ?](https://msdn.microsoft.com/vstudio/gg315352) ou [Comment faire : créer une visionneuse d’images en C#](https://msdn.microsoft.com/vcsharp/gg278960.aspx).
...
>
> Pour afficher le code pour Visual Basic, choisissez l’onglet **VB** en haut des blocs de code, et pour afficher le code pour Visual C#, choisissez l’onglet **C#** . Si vous souhaitez en savoir plus sur Visual C++, consultez le didacticiel sur le langage [prise en main](../misc/getting-started-with-visual-cpp-in-visual-studio-2015.md) et [C++](http://www.cplusplus.com/doc/tutorial/).
>
