...
ms.locfileid: "47503078"
---
# <a name="walkthrough-building-an-application"></a>Procédure pas à pas : génération d'une application
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [procédure pas à pas : création d’une Application](https://docs.microsoft.com/visualstudio/ide/walkthrough-building-an-application).  
