...
2. Sélectionnez l’événement **Enter**, entrez `answer_Enter`answer_Enter, puis choisissez la touche Entrée.  
     ...
     ![Boîte de dialogue Propriétés](../ide/media/express-answerenter.png "Express_AnswerEnter")  
...
- Pour revenir à l’étape précédente du tutoriel, consultez [Étape 4 : Ajoutez la méthode CheckTheAnswer()](../ide/step-4-add-the-checktheanswer-parens-method.md).
