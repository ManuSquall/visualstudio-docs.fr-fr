---
title: 'Procédure : Désactiver le processus d’hébergement | Microsoft Docs'
ms.date: 11/15/2016
...
---
# <a name="how-to-disable-the-hosting-process"></a>Procédure : Désactiver le processus d’hébergement
