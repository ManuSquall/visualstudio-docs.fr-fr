...
5. Enregistrez et exécutez votre code.
     ...
     ![Questionnaire mathématique avec problème de soustraction](../ide/media/express-addsubtract.png "Express_AddSubtract") Questionnaire mathématique avec problème de soustraction
