...
ms.locfileid: "49279734"
---
# <a name="class-view-and-object-browser-icons"></a>Affichage de classes et Explorateur d'objets, icônes
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Classe vue ** et **Explorateur d’objets** afficher des icônes qui représentent des entités de code, par exemple, les espaces de noms, les classes, les fonctions et variables. Le tableau suivant illustre et décrit ces icônes.  
