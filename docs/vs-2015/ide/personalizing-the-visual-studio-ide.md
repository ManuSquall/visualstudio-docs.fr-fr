...
### <a name="window-layouts"></a>Dispositions de fenêtres
 Pour réorganiser les positions et le comportement des fenêtres, et enregistrer des dispositions personnalisées, consultez [Personnalisation des dispositions de fenêtres](../ide/customizing-window-layouts-in-visual-studio.md).
...
### <a name="external-tools"></a>Outils externes
 Pour personnaliser les outils externes qui s’affichent dans les menus et les barres d’outils, consultez [gestion des outils externes](../ide/managing-external-tools.md).
