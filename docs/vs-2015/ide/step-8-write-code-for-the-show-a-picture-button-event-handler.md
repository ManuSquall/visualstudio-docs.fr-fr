...
Vous trouverez la dernière version de cette rubrique dans [étape 8 : écrire du Code pour l’afficher un gestionnaire d’événements de bouton image](https://docs.microsoft.com/visualstudio/ide/step-8-write-code-for-the-show-a-picture-button-event-handler).  
