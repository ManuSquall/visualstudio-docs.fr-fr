...
1. Dans l’**Explorateur de solutions**, ouvrez le menu contextuel du projet que vous souhaitez modifier, puis choisissez **Propriétés**.
     ...
     ![Propriétés de Explorateur de solutions Visual Studio](../ide/media/vs-slnexplorer-properties.png "vs_slnExplorer_Properties")
...
2. Dans la colonne de gauche de la fenêtre Propriétés, choisissez l’onglet **Application**.
     ...
     ![Onglet application des propriétés de l’application Visual Studio](../ide/media/vs-slnexplorer-properties-applicationtab.png "vs_slnExplorer_Properties_ApplicationTab")
