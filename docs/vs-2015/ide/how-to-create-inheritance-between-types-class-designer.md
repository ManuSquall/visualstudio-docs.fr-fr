...
## <a name="see-also"></a>Voir aussi
 [Inheritance](https://msdn.microsoft.com/library/81d64ee4-50f9-4d6c-a8dc-257c348d2eea) [Notions de base de l’héritage](https://msdn.microsoft.com/library/dfc8deba-f5b3-4d1d-a937-7cb826446fc5) [d’héritage Comment : afficher l’héritage entre les classes de types (Concepteur de classes)](../ide/how-to-view-inheritance-between-types-class-designer.md) [Visual C++ dans Concepteur de classes](../ide/visual-cpp-classes-in-class-designer.md)
