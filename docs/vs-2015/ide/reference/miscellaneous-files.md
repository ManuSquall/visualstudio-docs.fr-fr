...
## <a name="see-also"></a>Voir aussi
 Documents [de projets et de solutions](../../ide/solutions-and-projects-in-visual-studio.md) [, environnement, boîte de dialogue Options](../../ide/reference/documents-environment-options-dialog-box.md)
