...
ms.locfileid: "47506930"
---
# <a name="accessibility-products-and-services-from-microsoft"></a>Services et produits d’accessibilité de Microsoft
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Microsoft Services et produits d’accessibilité](https://docs.microsoft.com/visualstudio/ide/reference/accessibility-products-and-services-from-microsoft).  
