 ...
 **Utiliser la chaîne de connexion personnalisée** Indique si les fournisseurs de services clients utilisent un magasin de données personnalisé pour le cache local. Par défaut, ils utilisent le système de fichiers local. Quand elle est sélectionnée, cette option permet de remplir automatiquement la zone de texte avec une chaîne de connexion par défaut. Vous pouvez conserver la chaîne de connexion par défaut pour automatiquement générer et utiliser une base de données SQL Server Compact Edition. Vous pouvez également spécifier une chaîne de connexion à une base de données SQL Server existante. Pour plus d’informations, consultez [Comment : configurer les services d’application cliente](https://msdn.microsoft.com/library/34a8688a-a32c-40d3-94be-c8e610c6a4e8). Cette option est désactivée par défaut.

## <a name="see-also"></a>Voir aussi
 Page services du [client services d’application](https://msdn.microsoft.com/library/1487d8df-089e-4f21-abfb-a791a652b58e) [, concepteur de projets](../../ide/reference/services-page-project-designer.md) [comment : configurer le client services d’application](https://msdn.microsoft.com/library/34a8688a-a32c-40d3-94be-c8e610c6a4e8) [procédure : travailler hors connexion avec le client services d’application](https://msdn.microsoft.com/f792cb16-8520-4a0f-9dc9-07bfbc454e38)
