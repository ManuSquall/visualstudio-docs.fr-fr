...
## <a name="task-list"></a>Liste des tâches  
 [Guide pratique pour configurer les services d’application cliente](https://msdn.microsoft.com/library/34a8688a-a32c-40d3-94be-c8e610c6a4e8)  
  
 [Guide pratique pour Travailler hors connexion avec les Services d’Application cliente](https://msdn.microsoft.com/f792cb16-8520-4a0f-9dc9-07bfbc454e38)  
