...
## <a name="see-also"></a>Voir aussi
 [Fonctionnalités d’accessibilité des ressources Visual Studio](../../ide/reference/accessibility-features-of-visual-studio.md) [pour la conception d’applications accessibles](../../ide/reference/resources-for-designing-accessible-applications.md)
