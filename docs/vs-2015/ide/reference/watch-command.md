...
ms.locfileid: "47504309"
---
# <a name="watch-command"></a>Espion, commande
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [espion, commande](https://docs.microsoft.com/visualstudio/ide/reference/watch-command).  
