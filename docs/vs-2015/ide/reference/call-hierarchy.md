...
## <a name="using-call-hierarchy"></a>Utilisation de la hiérarchie d’appels
 ...
 ![Hiérarchie d’appels avec un nœud ouvert](../../ide/reference/media/onenode.png "OneNode") Fenêtre hiérarchie d’appels
...
- Si vous développez le nœud **Appels de**, tous les membres qui sont appelés par le membre sélectionné sont affichés.
  ...
  ![Hiérarchie d’appels avec plusieurs nœuds ouverts](../../ide/media/multiplenodes.png "MultipleNodes") Fenêtre hiérarchie d’appels
