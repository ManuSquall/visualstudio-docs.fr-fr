...
ms.locfileid: "47503050"
---
# <a name="prerequisites-dialog-box"></a>Composants requis, boîte de dialogue
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Prerequisites Dialog Box](https://docs.microsoft.com/visualstudio/ide/reference/prerequisites-dialog-box).  
