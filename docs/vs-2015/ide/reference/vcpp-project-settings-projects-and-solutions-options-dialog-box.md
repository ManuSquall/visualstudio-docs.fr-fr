...
Vous trouverez la dernière version de cette rubrique dans [paramètres de projet VC ++, projets et Solutions, boîte de dialogue Options](https://docs.microsoft.com/visualstudio/ide/reference/vcpp-project-settings-projects-and-solutions-options-dialog-box).  
