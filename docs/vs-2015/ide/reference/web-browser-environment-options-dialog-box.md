...
> L’ouverture de certains fichiers ou composants à partir du web peut entraîner l’exécution de code sur votre ordinateur.
 ...
 Page d’hébergement définit la page affichée lorsque vous ouvrez le navigateur Web IDE.

 Page de recherche vous permet de désigner une page de recherche pour le navigateur Web interne. Cet emplacement peut différer de la page de recherche utilisée par des instances d’Internet Explorer lancées en dehors de l’environnement de développement intégré (IDE).

 Afficher la source dans définit l’éditeur utilisé pour ouvrir une page Web lorsque vous choisissez **afficher la source** dans la page à partir du navigateur Web interne.
...
## <a name="see-also"></a>Voir aussi
 Boîte de [dialogue Options](../../ide/reference/environment-options-dialog-box.md) [de l’environnement général, environnement, boîte de dialogue Options,](../../ide/reference/general-environment-options-dialog-box.md) [Concepteur HTML](https://msdn.microsoft.com/library/640043cc-3657-4677-a091-bc315e636477)
