...
ms.locfileid: "47504757"
---
# <a name="find-in-files-command"></a>Rechercher dans les fichiers, commande
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [rechercher dans les fichiers de commande](https://docs.microsoft.com/visualstudio/ide/reference/find-in-files-command).  
