...
|Personnaliser lorsque des boîtes de message s’affichent et comment la fenêtre **Rechercher et remplacer** agit pendant une recherche rapide ou un remplacement rapide, et également remplir automatiquement la zone Rechercher.|[Rechercher et remplacer, Environnement, boîte de dialogue Options](../../ide/reference/find-and-replace-environment-options-dialog-box.md)|
