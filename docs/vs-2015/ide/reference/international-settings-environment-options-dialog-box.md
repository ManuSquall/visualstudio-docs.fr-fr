...
Vous trouverez la dernière version de cette rubrique dans [paramètres internationaux, environnement, boîte de dialogue Options](https://docs.microsoft.com/visualstudio/ide/reference/international-settings-environment-options-dialog-box).  
