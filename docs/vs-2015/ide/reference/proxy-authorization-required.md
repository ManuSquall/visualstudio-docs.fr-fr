...
- Démarrez Visual Studio. Une boîte de dialogue d'authentification du proxy doit s'afficher. Entrez vos informations d'identification dedans.
...
- Vous pouvez supprimer l' https://go.microsoft.com adresse de la liste verte pour que la boîte de dialogue d’authentification de proxy s’affiche à la fois pour l' https://go.microsoft.com adresse et les points de terminaison de serveur lors du redémarrage de Visual Studio.
