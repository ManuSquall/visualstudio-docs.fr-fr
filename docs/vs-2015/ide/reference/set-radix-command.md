...
## <a name="arguments"></a>Arguments
 `10` ou ou ou `16` `hex` `dec` facultatif. Indique un nombre décimal (10 ou dec) ou hexadécimal (16 ou hex). Si l’argument est omis, la valeur actuelle de la base est retournée.
