...
## <a name="see-also"></a>Voir aussi
 [Personnalisation de la boîte de](../../ide/customizing-the-editor.md) [dialogue Options](../../ide/reference/text-editor-options-dialog-box.md) de l’éditeur de texte de l’éditeur écriture du [code](../../ide/writing-code-in-the-code-and-text-editor.md) [Comment : modifier les polices et les couleurs](../../ide/how-to-change-fonts-and-colors-in-visual-studio.md)
