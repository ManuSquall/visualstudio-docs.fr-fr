...
ms.locfileid: "47508550"
---
# <a name="toolbox-html-tab"></a>Boîte à outils, onglet HTML
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [boîte à outils, onglet HTML](https://docs.microsoft.com/visualstudio/ide/reference/toolbox-html-tab).  
