...
## <a name="see-also"></a>Voir aussi
 [Présentation de la page références du concepteur de projet](https://msdn.microsoft.com/898dd854-c98d-430c-ba1b-a913ce3c73d7) [, concepteur de projets (Visual Basic)](../ide/reference/references-page-project-designer-visual-basic.md) [bec Comment : ajouter ou supprimer des références à l’aide de la boîte de dialogue Ajouter une référence](https://msdn.microsoft.com/3bd75d61-f00c-47c0-86a2-dd1f20e231c9)
