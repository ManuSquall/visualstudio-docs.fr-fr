...
ms.locfileid: "47502610"
---
# <a name="troubleshooting-broken-references"></a>Dépannage de références rompues
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [dépanner des références rompues](https://docs.microsoft.com/visualstudio/ide/troubleshooting-broken-references).  
