...
## <a name="accessing-visual-studio-tools"></a><a name="BKMK_Access"></a> Accès Visual Studio Tools
...
## <a name="writing-code"></a><a name="BKMK_Writing"></a> Écriture de code
...
## <a name="navigating-within-your-code"></a><a name="BKMK_Navigating"></a> Navigation dans votre code
...
## <a name="finding-items-faster"></a><a name="BKMK_Finding"></a> Recherche d’éléments plus rapide
...
## <a name="debugging-code"></a><a name="BKMK_Debugging"></a> Débogage de code
...
## <a name="managing-files-toolbars-and-windows"></a><a name="BKMK_Managing"></a> Gestion de fichiers, de barres d’outils et de fenêtres
