...
ms.locfileid: "47493153"
---
# <a name="application-properties"></a>Propriétés des applications
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [propriétés de l’Application](https://docs.microsoft.com/visualstudio/ide/application-properties).  
