...
ms.locfileid: "72645697"
---
# <a name="filtered-completion-lists-in-visual-basic"></a>Listes de saisie semi-automatique filtrées en Visual Basic
...
## <a name="see-also"></a>Voir aussi
 [Utilisation](../ide/using-intellisense.md) d' [intellisense spécifiques à Visual Basic](../ide/visual-basic-specific-intellisense.md) IntelliSense
