...
Vous trouverez la dernière version de cette rubrique dans [identification et personnalisation des raccourcis clavier dans Visual Studio](https://docs.microsoft.com/visualstudio/ide/identifying-and-customizing-keyboard-shortcuts-in-visual-studio).  
