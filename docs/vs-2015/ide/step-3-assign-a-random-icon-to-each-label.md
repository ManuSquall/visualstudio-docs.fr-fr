...
ms.locfileid: "47495704"
---
# <a name="step-3-assign-a-random-icon-to-each-label"></a>Étape 3 : Assigner une icône aléatoire à chaque contrôle Label
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [étape 3 : assigner une icône aléatoire à chaque contrôle Label](https://docs.microsoft.com/visualstudio/ide/step-3-assign-a-random-icon-to-each-label).  
