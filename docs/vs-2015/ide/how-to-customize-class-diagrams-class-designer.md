...
Vous trouverez la dernière version de cette rubrique dans [Comment : personnaliser des diagrammes de classes (Concepteur de classes)](https://docs.microsoft.com/visualstudio/ide/how-to-customize-class-diagrams-class-designer).  
