---
title: 'Procédure : Personnaliser des diagrammes de classes (Concepteur de classes) | Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Guide pratique pour Changer la Notation entre les membres et la Notation Association (Concepteur de classes)](../ide/how-to-change-between-member-notation-and-association-notation-class-designer.md)   
