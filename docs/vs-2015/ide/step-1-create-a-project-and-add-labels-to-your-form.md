...
Vous trouverez la dernière version de cette rubrique dans [étape 1 : créer un projet et l’ajouter des étiquettes à votre formulaire](https://docs.microsoft.com/visualstudio/ide/step-1-create-a-project-and-add-labels-to-your-form).  
...
7.  Choisissez le signe plus (+) en regard de la propriété **Font**, puis remplacez la valeur de la propriété **Size** par **15,75**.  
     ...
     ![Fenêtre Propriétés affichant la taille de police](../ide/media/express-setfontsize.png "Express_setFontSize")  
...
16. Modifiez la propriété **(Name)** du contrôle **NumericUpDown** en lui affectant la valeur **sum** (somme).  
     ...
     ![Première ligne du questionnaire mathématique](../ide/media/express-firstrow.png "Express_firstRow")  
...
7.  Affectez à la propriété **TabIndex** du contrôle NumericUpDown de somme la valeur **2**, à celle du contrôle de différence la valeur **3**, à celle du contrôle de produit la valeur **4** et à celle du contrôle quotient la valeur **5**.  
     ...
     ![Formulaire de questionnaire mathématique initial](../ide/media/express-formlaidout.png "Express_FormLaidOut")  
