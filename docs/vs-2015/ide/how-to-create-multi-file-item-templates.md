...
## <a name="see-also"></a>Voir aussi
 [Création de modèles de projet et d’élément](../ide/creating-project-and-item-templates.md) [Comment : créer des modèles d’élément](../ide/how-to-create-item-templates.md) [paramètres](../ide/template-parameters.md) [de modèle Comment : substituer des paramètres dans un modèle](../ide/how-to-substitute-parameters-in-a-template.md)
