...
### <a name="performing-static-code-analysis"></a>Analyse statique du code
 ...
 ![Élément de menu d'analyse du code Visual Studio 2015](../ide/media/vs-ide-gs-debug-run-code-analysis.png "Vs_ide_gs_debug_run_code_analysis")
 ...
 ![Pointage de l’avertissement de l’analyse de Visual Studio Code](../ide/media/vs-ide-gs-debug-code-analysis-warning-hover.png "vs_ide_gs_debug_code_analysis_warning_hover")
...
### <a name="using-light-bulbs-to-fix-or-refactor-code"></a>Utilisation des ampoules pour corriger ou refactoriser du code
 ...
 ![Options rapides de l’ampoule Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb1.png "Vs_ide_gs_debug_light_bulb1")

 La liste des corrections ou des refactorisations que vous pouvez appliquer à cette ligne de code s'affiche.

 ![Aperçu de l’ampoule Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb-preview-changes.PNG "Vs_ide_gs_debug_light_bulb_preview_changes")
 ...
 ![Texte « aucune option » de l’ampoule Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb-no-options.PNG "Vs_ide_gs_debug_light_bulb_no_options")
...
### <a name="debugging-your-running-code"></a>Débogage de votre code en cours d'exécution
 ...
 Si votre code s'exécute parfaitement et exactement comme prévu, félicitations ! Faites passer votre build en configuration **Release** et régénérez-la en vue de son déploiement. (Toutefois, les professionnels peuvent être amenés à aller sur le bit sur les tests unitaires à la fin.) Toutefois, s’il cesse de répondre ou s’est bloqué, ou a donné des résultats étranges, vous devez rechercher la source de ces problèmes et résoudre les bogues.
...
1. Pour réduire la source d’un incident ou un programme qui ne répond pas, diffusez-les dans le code de l’appel de méthode que vous pensez être à l’origine de l’échec. À mesure que vous effectuez un pas à pas dans le code, supprimez les points d'arrêt, puis rapprochez-les les uns des autres jusqu'à ce que vous identifiiez la ligne de code incriminée.
...
### <a name="setting-conditional-breakpoints"></a>Définition de points d'arrêt conditionnels
 ...
 ![Point d’arrêt conditionnel Visual Studio 2015](../ide/media/vs-ide-gs-debug-breakpoint-conditional.PNG "Vs_ide_gs_debug_breakpoint_conditional")
...
### <a name="inspecting-your-code-at-run-time"></a>Inspection du code au moment de l'exécution
 ...
 ![Inspection de la valeur d’heure&#45;Visual Studio 2015](../ide/media/vs-ide-gs-debug-inspect-value.PNG "vs_ide_gs_debug_inspect_value")
 ...
 Par ailleurs, Visual Studio 2015 affiche la fenêtre Outils de diagnostic. Celle-ci vous permet d'observer l'utilisation de l'UC et de la mémoire de votre application au fil du temps. Inspectez ces valeurs pour identifier toute hausse inattendue de l'utilisation de l'UC ou de l'allocation de la mémoire. Utilisez-la conjointement avec la fenêtre **Espion** et les points d’arrêt pour déterminer ce qui provoque une utilisation intensive inattendue ou des ressources non libérées.

 ![Fenêtre Outils de diagnostic Visual Studio 2015](../ide/media/vs-ide-gs-debug-diagnostic-tools.PNG "Vs_ide_gs_debug_diagnostic_tools")
