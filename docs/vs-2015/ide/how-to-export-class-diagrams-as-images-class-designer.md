...
## <a name="see-also"></a>Voir aussi
 [Comment : imprimer des diagrammes de classes (Concepteur de classes)](../ide/how-to-print-class-diagrams-class-designer.md) [utilisation de diagrammes de classes (Concepteur de classes)](../ide/working-with-class-diagrams-class-designer.md)
