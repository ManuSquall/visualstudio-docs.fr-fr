...
ms.locfileid: "47501693"
---
# <a name="visual-studio-template-reference"></a>Référence de modèles Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [référence de modèle Visual Studio](https://docs.microsoft.com/visualstudio/ide/visual-studio-template-reference).  
