...
ms.locfileid: "47506479"
---
# <a name="managing-external-tools"></a>Gestion des outils externes
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [gérer des outils externes](https://docs.microsoft.com/visualstudio/ide/managing-external-tools).  
