...
|Domaine|Séquence de touches|Action|
|----------|---------------|------------|
...
|Barre d’outils|Retour arrière<br /><br /> OU<br /><br /> Alt+Gauche|Afficher la page précédente.|
|Barre d’outils|Alt+Droite|Afficher la page suivante.|
|Barre d’outils|Alt+Accueil|Afficher la page d’accueil de la visionneuse d’aide.|
...
|Barre d’outils|Ctrl+Maj+M|Afficher l’onglet **Gérer le contenu**.|
...
|Rechercher|Maj+Entrée|Définir le focus sur l’élément précédent.|
...
|Onglet|Remplacer le focus par le **déplacement...** .|
