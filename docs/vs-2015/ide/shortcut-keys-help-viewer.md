...
|Rubrique|Début|Accéder au début du document.|
...
|Rechercher|Touche Échap|Effacer la zone de texte de recherche.|
...
|Trouver|Entrée|Définir le focus sur l’élément suivant.|
|Trouver|Maj+Entrée|Définir le focus sur l’élément précédent.|
|Trouver|Touche Échap|Masquer la zone de texte **Rechercher**.|
...
|Onglet|Remplacer le focus par le **déplacement...** disproportionnée.|
