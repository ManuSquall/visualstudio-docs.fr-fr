...
Vous trouverez la dernière version de cette rubrique dans [prise en charge de l’éditeur Ajout de Visual Studio pour d’autres langages](https://docs.microsoft.com/visualstudio/ide/adding-visual-studio-editor-support-for-other-languages).  
...
## <a name="see-also"></a>Voir aussi  
 [Améliorations apportées à la fonctionnalité Naviguer vers de Visual Studio 2013](https://blogs.msdn.microsoft.com/mvpawardprogram/2013/10/22/visual-studio-2013-navigate-to-improvements/)   
