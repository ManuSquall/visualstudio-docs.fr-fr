...
Vous trouverez la dernière version de cette rubrique dans [Comment : Sign Application and Deployment Manifests](https://docs.microsoft.com/visualstudio/ide/how-to-sign-application-and-deployment-manifests).  
