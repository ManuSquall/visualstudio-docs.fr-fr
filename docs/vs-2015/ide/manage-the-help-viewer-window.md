...
ms.locfileid: "72651391"
---
# <a name="manage-the-help-viewer-window"></a>Gérer la fenêtre de la Visionneuse d'aide
...
## <a name="docking-tabs"></a>Ancrage des onglets
 ...
 Pour restaurer la disposition par défaut de la fenêtre Help Viewer, ouvrez la boîte de dialogue **Options de la visionneuse**, puis choisissez le bouton **Réinitialiser**.

## <a name="opening-a-topic-in-a-new-tab"></a>Ouverture d’une rubrique sous un nouvel onglet
 Choisissez la rubrique dans n’importe quel onglet de navigation, puis appuyez sur les touches Ctrl + Entrée.
