...
#### [Procédure pas à pas : création d’une application simple](walkthrough-create-a-simple-application-with-visual-csharp-or-visual-basic.md)
...
### [Guide pratique pour personnaliser des menus et des barres d’outils](how-to-customize-menus-and-toolbars-in-visual-studio.md)
...
#### [Alias de commandes Visual Studio](reference/visual-studio-command-aliases.md)
...
##### [Guide pratique pour définir les options d’accessibilité IDE](reference/how-to-set-ide-accessibility-options.md)
