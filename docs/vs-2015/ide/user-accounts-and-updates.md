...
> [!WARNING]
> Visual Studio 2015 ne peut pas accéder aux ressources qui sont configurées pour l’accès conditionnel. Pour utiliser ces ressources, effectuez une mise à niveau vers Visual Studio 2019 version 16,6 ou ultérieure et suivez les instructions [pour utiliser Visual Studio avec des comptes qui requièrent des conseils sur l’authentification multifacteur](../../ide/work-with-multi-factor-authentication.md) .
...
|[Comment déverrouiller Visual Studio](../ide/how-to-unlock-visual-studio.md)|Décrit comment déverrouiller Visual Studio dans différents scénarios.|
