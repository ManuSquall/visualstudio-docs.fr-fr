...
|Zone|Description|
|----------|-----------------|
|[Exemples du Centre de développement Windows](http://go.microsoft.com/fwlink/?LinkID=255278)|Montre comment développer des applications [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] .|
