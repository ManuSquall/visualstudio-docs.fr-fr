...
ms.locfileid: "47504443"
---
# <a name="unit-test-your-code"></a>Tests unitaires sur votre code
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Test unitaire votre Code](https://docs.microsoft.com/visualstudio/test/unit-test-your-code).  
