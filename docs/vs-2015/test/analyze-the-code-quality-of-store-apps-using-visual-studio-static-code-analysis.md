...
|[Blog de l'équipe d'analyse du code MSDN](https://blogs.msdn.com/b/codeanalysis/)|Découvrez plus d'informations, notamment des articles techniques et des exemples, sur le blog de l'équipe d'analyse du code.|
