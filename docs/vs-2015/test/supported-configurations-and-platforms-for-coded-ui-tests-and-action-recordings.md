...
|.NET|.NET 2.0, 3.0, 3.5, 4 et 4.5. **Remarque :** [!INCLUDE[TCMext](../includes/tcmext-md.md)] et Visual Studio requièrent .net 4 pour fonctionner. Cependant, les applications développées à l’aide des versions .NET répertoriées sont prises en charge.|
...
|Platform|Niveau de prise en charge|
|--------------|----------------------|
