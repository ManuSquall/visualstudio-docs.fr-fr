...
Vous trouverez la dernière version de cette rubrique dans [plateformes et Configurations de prise en charge pour des Tests codés de l’interface utilisateur t enregistrements des actions](https://docs.microsoft.com/visualstudio/test/supported-configurations-and-platforms-for-coded-ui-tests-and-action-recordings).  
