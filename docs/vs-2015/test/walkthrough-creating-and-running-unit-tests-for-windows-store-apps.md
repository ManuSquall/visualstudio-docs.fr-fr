...
> [!TIP]
> Pour plus d’informations sur le développement d’applications [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] , consultez [Prise en main des applications du Windows Store](https://go.microsoft.com/fwlink/?LinkID=241410).
...
6. Laissez l'option **Créer le répertoire pour la solution** sélectionnée et choisissez le bouton **OK** .
     ...
     ![Bibliothèque de tests unitaires personnalisée](../test/media/unit-test-win8-1.png "Unit_Test_Win8_1")
...
1. Dans l'Explorateur de solutions, dans le projet de test unitaire [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] , cliquez avec le bouton droit sur le fichier Package.appxmanifest et choisissez **Ouvrir**.
...
1. Dans l'Éditeur de code, modifiez le test unitaire et ajoutez les assertions et la logique requises pour votre test.
     ...
     Pour plus d’informations, consultez [Utilisation des classes Assert](https://go.microsoft.com/fwlink/?LinkID=224991) dans MSDN Library.
...
4. Choisissez **Exécuter tout**.
     ...
     ![Test unitaire d' &#45; exécution de l’Explorateur de tests unitaires](../test/media/unit-test-win8-unittestexplorer-contextmenurun.png "Unit_Test_Win8_UnitTestExplorer_ContextMenuRun")
    ...
    >  ![Explorateur &#45; de tests unitaires menu contextuel de test Uni](../test/media/unit-test-win8-unittestexplorer-contextmenu.png "Unit_Test_Win8_UnitTestExplorer_ContextMenu")
     ...
     ![Test de l' &#45; Explorateur de tests unitaires terminé](../test/media/unit-test-win8-unittestexplorer-done.png "Unit_Test_Win8_UnitTestExplorer_Done")
...
### <a name="msdn-library"></a>MSDN Library
 [MSDN Library – Création et exécution de tests unitaires pour le code existant (Visual Studio 2010)](https://go.microsoft.com/fwlink/?LinkID=223683)
