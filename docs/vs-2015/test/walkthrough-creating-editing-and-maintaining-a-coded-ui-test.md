...
Vous trouverez la dernière version de cette rubrique dans [procédure pas à pas : création, Édition et gestion d’un Test de l’interface utilisateur codé](https://docs.microsoft.com/visualstudio/test/walkthrough-creating-editing-and-maintaining-a-coded-ui-test).  
