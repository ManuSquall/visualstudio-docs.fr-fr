...
Vous trouverez la dernière version de cette rubrique dans [exécuter des tests unitaires pour les applications de Store dans Visual Studio](https://docs.microsoft.com/visualstudio/test/run-unit-tests-for-store-apps-in-visual-studio).  
