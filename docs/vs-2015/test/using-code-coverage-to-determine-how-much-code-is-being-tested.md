...
Vous trouverez la dernière version de cette rubrique dans [à l’aide de la couverture du Code pour déterminer la quantité de Code testé](https://docs.microsoft.com/visualstudio/test/using-code-coverage-to-determine-how-much-code-is-being-tested).  
