...
Vous trouverez la dernière version de cette rubrique dans [test une grande Application avec plusieurs mappages d’IU](https://docs.microsoft.com/visualstudio/test/testing-a-large-application-with-multiple-ui-maps).  
