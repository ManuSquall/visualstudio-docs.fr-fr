...
1. Dans la fenêtre de l’éditeur de code, cliquez avec le bouton droit et choisissez **Créer des tests unitaires** dans le menu contextuel.
    ...
    ![Dans la fenêtre de l’éditeur, affichez le menu contextuel.](../test/media/createunittestsrightclick.png "CreateUnitTestsRightClick")
...
2. Cliquez sur OK pour accepter les valeurs par défaut pour créer vos tests unitaires, ou modifiez les valeurs utilisées pour créer et nommer le projet de test unitaire et les tests unitaires. Vous pouvez sélectionner le code qui est ajouté par défaut aux méthodes de test unitaire.
    ...
    ![Cliquez&#45;avec le bouton droit dans l’éditeur, puis choisissez créer des tests unitaires](../test/media/createunittestsdialog.png "CreateUnitTestsDialog")
...
|||
|-|-|
|![Exécuter après la génération](../test/media/ute-runafterbuild-btn.png "UTE_RunAfterBuild_btn")|Pour exécuter vos tests unitaires après chaque génération locale, choisissez **Test** dans le menu standard, puis **Exécuter les tests après la génération** dans la barre d’outils de l’explorateur de tests.|
...
|||
|-|-|
|![Bouton groupe de l’Explorateur de tests](../test/media/ute-groupby-btn.png "UTE_GroupBy_btn")|Pour regrouper vos tests par catégorie, choisissez le bouton **Grouper par** .|
...
2. Les*shims* utilisent l’instrumentation du runtime pour rediriger les appels à une méthode cible vers une méthode shim de substitution pour les méthodes non virtuelles.
   ...
   **R :** Oui, suivez ces étapes pour [rechercher et installer d’autres infrastructures](../test/install-third-party-unit-test-frameworks.md). Après le redémarrage de Visual Studio, rouvrez votre solution pour créer vos tests unitaires, puis sélectionnez vos infrastructures installées ici :
   ...
   ![Sélectionner une autre infrastructure de tests unitaires installée](../test/media/createunittestsdialogextensions.png "CreateUnitTestsDialogExtensions")
