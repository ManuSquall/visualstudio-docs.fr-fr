...
### <a name="q-do-i-have-to-deploy-the-windows-phone-app-in-the-emulator-in-order-to-map-ui-controls"></a>Q : Dois-je déployer l’application Windows Phone dans l’émulateur pour mapper des contrôles d’interface utilisateur?
 **R** : Oui, le générateur de test codé de l’interface utilisateur exige qu’un émulateur soit en cours d’exécution et que l’application soit déployée sur celui-ci. Sinon, il génère un message d’erreur signalant qu’aucun émulateur en cours d’exécution n’a été détecté.
 ...
 **R** : Non, les modèles de projet de test codé de l’interface utilisateur sont uniquement disponibles sur Windows 8.1 et Windows 10. Pour créer l’automation pour les applications de plateforme Windows universelle, vous aurez besoin de Windows 10.

<a name="uwpapps"></a>
### <a name="q-how-do-i-create-coded-ui-tests-for-universal-windows-platform-uwp-apps"></a>Q : Comment faire créer des tests codés de l’interface utilisateur pour les applications plateforme Windows universelle (UWP)?
 **R** : En fonction de la plateforme dans laquelle vous testez votre application UWP, créez un projet de test codé de l’interface utilisateur de l’une des manières suivantes:
...
### <a name="q-can-i-select-controls-that-are-outside-the-emulator"></a>Q : Puis-je sélectionner des contrôles qui se trouvent en dehors de l’émulateur?
 **R** : Non, le générateur ne les détectera pas.

### <a name="q-can-i-use-the-coded-ui-test-builder-to-map-controls-using-a-physical-phone-device"></a>Q : Puis-je utiliser le générateur de test codé de l’interface utilisateur pour mapper des contrôles à l’aide d’un appareil téléphonique physique?
...
### <a name="q-can-i-run-a-coded-ui-test-on-my-windows-phone-app-from-the-command-line"></a>Q : Puis-je exécuter un test codé de l’interface utilisateur sur mon Windows Phone application à partir de la ligne de commande?
 **R** : Oui, vous utilisez un fichier RunSettings pour spécifier l’appareil cible pour l’exécution du test. Par exemple :
...
### <a name="q-what-are-the-differences-between-coded-ui-tests-for-xaml-based-windows-store-apps-and-windows-phone-apps"></a>Q : Quelles sont les différences entre les tests codés de l’interface utilisateur pour les applications du Windows Store basées sur XAML et les applications de Windows Phone?
...
|Exécution de tests automatisés à partir de MTM|Pris en charge.|Non pris en charge.|
...
## <a name="external-resources"></a>Ressources externes
 Microsoft Visual Studio blog Application Lifecycle Management: [Utilisation de l’interface utilisateur codée pour tester les applications Windows Phone basées sur XAML](http://blogs.msdn.com/b/visualstudioalm/archive/2014/04/05/using-coded-ui-to-test-xaml-based-windows-phone-apps.aspx?PageIndex=2#comments)
