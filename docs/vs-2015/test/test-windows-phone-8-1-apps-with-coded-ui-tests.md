...
Vous trouverez la dernière version de cette rubrique dans [Test Windows UWP et des applications Phone 8.1 avec des Tests codés de l’interface utilisateur](https://docs.microsoft.com/visualstudio/test/test-windows-phone-8-1-apps-with-coded-ui-tests).  
