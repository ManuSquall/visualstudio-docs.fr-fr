...
Vous trouverez la dernière version de cette rubrique dans [rendre codé de l’interface utilisateur Tests attendre pour spécifique événements pendant la lecture](https://docs.microsoft.com/visualstudio/test/making-coded-ui-tests-wait-for-specific-events-during-playback).  
