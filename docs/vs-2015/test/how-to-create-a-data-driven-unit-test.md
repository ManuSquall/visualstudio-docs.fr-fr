...
## <a name="see-also"></a>Voir aussi
 ...
 [Comment : créer et exécuter un](https://msdn.microsoft.com/5e0f43cf-5e51-48e2-9c98-0eb9324bdc48) [test unitaire de test unitaire votre code](../test/unit-test-your-code.md) [exécuter des tests unitaires avec l’Explorateur de tests](../test/run-unit-tests-with-test-explorer.md) [écriture de tests unitaires pour le .NET Framework avec l’infrastructure de tests unitaires Microsoft pour le code managé](../test/writing-unit-tests-for-the-dotnet-framework-with-the-microsoft-unit-test-framework-for-managed-code.md)
