...
## <a name="see-also"></a>Voir aussi
 Personnalisation de l’analyse de la [couverture du code](../test/customizing-code-coverage-analysis.md) [spécification des paramètres de test pour les tests Visual Studio](https://msdn.microsoft.com/library/0c15317e-80c6-4317-aed3-82b8e15e3901)
