...
Vous trouverez la dernière version de cette rubrique dans [test d’Applications SharePoint 2010 avec des Tests codés de l’interface utilisateur](https://docs.microsoft.com/visualstudio/test/testing-sharepoint-2010-applications-with-coded-ui-tests).  
