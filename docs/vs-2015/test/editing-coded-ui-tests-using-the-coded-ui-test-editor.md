...
## <a name="open-a-coded-ui-test"></a>Ouvrir un test codé de l'interface utilisateur
 ...
 ![Menu contextuel modifier avec le générateur de test codé de l’interface utilisateur](../test/media/editcodeduitest.png "EditCodedUITest")
...
## <a name="CodedUITestEditor_DeleteUIActions"></a> Supprimer les actions d’interface utilisateur inutiles
 ...
 ![Supprimer l’action d’interface utilisateur](../test/media/codeduideleteuiaction.png "CodedUIDeleteUIAction")
...
## <a name="CodedUITestEditor_LocateUIControl"></a> Localisation d’un contrôle d’IU dans l’application testée
 ...
 ![Localiser le contrôle d’interface utilisateur](../test/media/codeduilocatecontrol.png "CodedUILocateControl")

 ![Contrôle situé dans l’application testée](../test/media/codeduilocatecontrol2.png "CodedUILocateControl2")
...
## <a name="CodedUITestEditor_LocateDecendants"></a> Localisation d’un contrôle et de ses descendants
 ...
 ![Rechercher tous les contrôles descendants](../test/media/codeduilocateall.png "CodedUILocateAll")

 ![Tous les contrôles situés](../test/media/codeduilocateall2.png "CodedUILocateAll2")
...
## <a name="CodedUITestEditor_InsertDelay"></a> Insertion d’un délai avant une action d’interface utilisateur
 ...
 ![Insérer un délai avant une action d’interface utilisateur](../test/media/codeduidelay.png "CodedUIDelay")

 ![Délai ajouté avec 5 secondes](../test/media/codeduidealy2.png "CodedUIDealy2")
