...
- Pour exécuter tous les tests dans un groupe par défaut, choisissez **exécuter...** , puis choisissez le groupe dans le menu.
...
### <a name="run-tests-after-every-build"></a><a name="BKMK_Run_tests_after_every_build"></a> Exécuter des tests après chaque génération
...
### <a name="view-the-source-code-of-a-test-method"></a><a name="BKMK_View_the_source_code_of_a_test_method"></a> Afficher le code source d'une méthode de test
...
## <a name="group-and-filter-the-test-list"></a><a name="BKMK_Group_and_filter_the_test_list"></a> Regrouper et filtrer la liste de tests
...
### <a name="grouping-the-test-list"></a><a name="BKMK_Grouping_the_test_list"></a> Regroupement de la liste de tests
...
### <a name="group-by-traits"></a><a name="BKMK_Group_by_traits"></a> Regrouper par caractéristiques
...
### <a name="search-and-filter-the-test-list"></a><a name="BKMK_Search_and_filter_the_test_list"></a> Rechercher et filtrer la liste de tests
...
## <a name="debug-and-analyze-unit-tests"></a><a name="BKMK_Debug_and_analyze_unit_tests"></a> Déboguer et analyser des tests unitaires
...
### <a name="debug-unit-tests"></a><a name="BKMK_Debug_unit_tests"></a> Déboguer les tests unitaires
...
### <a name="diagnose-test-method-performance-issues"></a><a name="BKMK_Diagnose_test_method_performance_issues"></a> Diagnostiquer les problèmes de performances de méthode de test
...
### <a name="analyze-unit-test-code-coverage"></a><a name="BKMK_Analyzeunit_test_code_coverage"></a> Analyser la couverture du code de test unitaire
