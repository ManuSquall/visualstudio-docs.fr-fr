---
title: Exemple de code de navigation du débogueur (XAML et C#) | Microsoft Docs
ms.date: 11/15/2016
...
Le code de cette rubrique est l’exemple de fichier de la rubrique [naviguer dans une session de débogage (XAML et C#)](../debugger/navigate-a-debugging-session-in-visual-studio-xaml-and-csharp.md) .  
