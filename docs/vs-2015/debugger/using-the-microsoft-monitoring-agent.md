...
1.  Vérifiez les points suivants :  
    ...
    -   Votre serveur web est en cours d’exécution [versions d’Internet Information Services (IIS) prises en charge](http://technet.microsoft.com/library/dn465154.aspx).  
