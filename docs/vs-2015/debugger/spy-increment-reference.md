...
ms.locfileid: "47495315"
---
# <a name="spy-reference"></a>Référence Spy++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [référence Spy ++](https://docs.microsoft.com/visualstudio/debugger/spy-increment-reference).  
