...
ms.locfileid: "47503195"
---
# <a name="pseudovariables"></a>Pseudo-variables
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [pseudo-variables](https://docs.microsoft.com/visualstudio/debugger/pseudovariables).  
