---
title: Débogage des applications Windows Store et Windows universelles | Microsoft Docs
ms.date: 11/15/2016
...
Le débogueur Visual Studio fournit une prise en charge complète pour déboguer les applications du Windows Store.  
 ...
 Pour déboguer des applications Windows Phone, consultez [débogage d’applications pour Windows Phone 8](https://msdn.microsoft.com/library/windows/apps/ff402572\(v=vs.105\).aspx).  
