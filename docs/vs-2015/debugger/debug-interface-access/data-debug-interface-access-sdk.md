...
ms.locfileid: "47494234"
---
# <a name="data-debug-interface-access-sdk"></a>Données (Kit de développement logiciel de Debug Interface Access)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [(Debug Interface Access SDK) de données](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/data-debug-interface-access-sdk).  
