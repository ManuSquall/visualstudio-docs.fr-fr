...
ms.locfileid: "47508931"
---
# <a name="udt"></a>UDT
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [UDT](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/udt).  
