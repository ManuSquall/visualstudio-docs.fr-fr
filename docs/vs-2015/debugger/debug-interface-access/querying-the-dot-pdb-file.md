...
ms.locfileid: "47503706"
---
# <a name="querying-the-pdb-file"></a>Interrogation du fichier .Pdb
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [interrogation le. Fichier PDB](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/querying-the-dot-pdb-file).  
