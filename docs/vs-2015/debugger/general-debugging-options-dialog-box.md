...
ms.locfileid: "47506779"
---
# <a name="general-debugging-options-dialog-box"></a>Général, Débogage, boîte de dialogue Options
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [général, débogage, boîte de dialogue Options](https://docs.microsoft.com/visualstudio/debugger/general-debugging-options-dialog-box).  
 ...
 **Arrêter lorsque des exceptions dépassent les limites AppDomain ou managées/natives**  
 ...
 2\) lorsque le code managé exécuté dans le domaine d’application 1 appelle du code managé dans le domaine d’application 2, et le code dans le domaine d’application 2 lève une exception. Consultez [Programming with Application Domains](http://msdn.microsoft.com/en-us/bd36055b-56bd-43eb-b4d8-820c37172131).  
