...
ms.locfileid: "65702876"
---
# <a name="exception-assistant-dialog-box"></a>Assistant Exception, boîte de dialogue
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La boîte de dialogue **Assistant Exception** s’affiche lorsqu’une exception au moment de l’exécution est levée. L' **Assistant Exception** affiche le type d’exception, fournit des informations supplémentaires et des liens vers des conseils de dépannage, offre un moyen de rechercher de l’aide en ligne supplémentaire et permet à l’utilisateur d’effectuer certaines actions, telles que l’affichage des détails de l’exception.  
  
## <a name="task-list"></a>Liste des tâches  
 Pour voir une rubrique traitant du dépannage du type d’exception que vous avez rencontré, cliquez sur l’un des messages d’info-bulle affichés dans le volet **conseils de dépannage** .  
...
## <a name="user-interface-element-list"></a>Liste des éléments d'interface utilisateur  
 **Type d'exception**  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Comment : corriger les erreurs d’exécution avec l’Assistant Exception](https://msdn.microsoft.com/library/23b08d45-7b20-42c9-bdc9-fb3157ad823b)   
 [Types d’erreurs](https://msdn.microsoft.com/library/3048aabf-8c97-4e13-9150-853769cb5f6f)
