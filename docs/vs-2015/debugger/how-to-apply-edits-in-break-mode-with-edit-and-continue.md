...
Vous trouverez la dernière version de cette rubrique dans [Comment : appliquer des modifications en Mode arrêt avec Modifier & Continuer](https://docs.microsoft.com/visualstudio/debugger/how-to-apply-edits-in-break-mode-with-edit-and-continue).  
