---
title: Utilisation de l’attribut DebuggerTypeProxy | Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "65684072"
---
# <a name="using-debuggertypeproxy-attribute"></a>Utilisation de l'attribut DebuggerTypeProxy
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

DebuggerTypeProxyAttribute] (assetId:///T : System. Diagnostics. DebuggerTypeProxyAttribute ? qualifyHint = false&AutoUpgrade = true) spécifie un proxy, ou un élément de préversion, pour un type et modifie la façon dont le type est affiché dans les fenêtres du débogueur. Quand vous visualisez une variable possédant un proxy, ce dernier remplace le type d’origine dans l’**affichage**. La fenêtre de variables du débogueur   n'affiche que les membres publics du type du proxy. Les membres privés ne sont pas affichés.  
...
## <a name="using-generics-with-debuggertypeproxy"></a>Utilisation de génériques avec DebuggerTypeProxy  
 ...
 Pour plus d’informations sur les types ouverts et fermés en C#, consultez la [spécification du langage c#](https://msdn.microsoft.com/library/e5d5a5cc-636b-4bff-b9c8-a8edc6207c22), section 20.5.2 Open et Closed types.  
