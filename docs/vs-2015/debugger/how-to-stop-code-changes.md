...
ms.locfileid: "47495512"
---
# <a name="how-to-stop-code-changes"></a>Comment : arrêter des modifications de code
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : arrêter des modifications de Code](https://docs.microsoft.com/visualstudio/debugger/how-to-stop-code-changes).  
