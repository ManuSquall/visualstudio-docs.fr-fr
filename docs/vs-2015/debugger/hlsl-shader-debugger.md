...
ms.locfileid: "47493684"
---
# <a name="hlsl-shader-debugger"></a>Débogueur du nuanceur HLSL
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [débogueur du nuanceur HLSL](https://docs.microsoft.com/visualstudio/debugger/graphics/hlsl-shader-debugger).  
