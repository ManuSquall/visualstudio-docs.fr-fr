...
ms.locfileid: "47504934"
---
# <a name="web-control-library-managed-code"></a>Bibliothèque de contrôles Web (code managé)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [bibliothèque de contrôles Web (Code managé)](https://docs.microsoft.com/visualstudio/debugger/web-control-library-managed-code).  
