...
## <a name="the-remote-debugger-port-on-32-bit-operating-systems"></a>Port du débogueur distant sur les systèmes d’exploitation 32 bits  
 ...
 Vous pouvez rechercher tous les commutateurs de ligne de commande du débogueur distant dans l’aide du débogage distant (appuyez sur **F1** ou cliquez sur **aide/utilisation** dans la fenêtre du débogueur distant).  
...
|**Connection**|**Port sur le service cloud**|**Port sur la machine virtuelle**|  
|-|-|-|
