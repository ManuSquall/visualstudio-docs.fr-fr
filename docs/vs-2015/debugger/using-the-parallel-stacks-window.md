...
ms.locfileid: "47495431"
---
# <a name="using-the-parallel-stacks-window"></a>Utilisation de la fenêtre Piles parallèles
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [à l’aide de la fenêtre Piles parallèles](https://docs.microsoft.com/visualstudio/debugger/using-the-parallel-stacks-window).  
