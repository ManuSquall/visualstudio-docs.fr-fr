...
ms.locfileid: "47500976"
---
# <a name="source-server-security-alert"></a>Alerte de sécurité du serveur source
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [alerte de sécurité du serveur Source](https://docs.microsoft.com/visualstudio/debugger/source-server-security-alert).  
