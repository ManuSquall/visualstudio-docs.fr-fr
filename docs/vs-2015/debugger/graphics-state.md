...
ms.locfileid: "47502168"
---
# <a name="graphics-state"></a>État graphique
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [état graphique](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-state).  
