...
ms.locfileid: "47495858"
---
# <a name="capturing-graphics-information"></a>Capture d'informations graphiques
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [capture les informations graphiques](https://docs.microsoft.com/visualstudio/debugger/graphics/capturing-graphics-information).  
