...
1. Installez la [stratégie de kits ARM](https://msdn.microsoft.com/windows/desktop/dn469188) sur votre appareil ARM.  
  
2. Installez le [outils de débogage distant](https://my.visualstudio.com/Downloads?q=remote%20tools%20visual%20studio%202015) sur votre appareil ARM.  
...
1. Dans la liste déroulante **plateformes solution** , sélectionnez **ARM** afin que votre appareil ARM soit disponible en tant que cible de débogage distant.  
  
2. Dans la liste déroulante **cible de débogage** , sélectionnez votre appareil ARM.  
  
3. Dans le menu, choisissez **Déboguer**, **graphiques**, **Démarrer les diagnostics**. (clavier : Alt+F5)  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Procédure : modifier l’ordinateur de lecture Graphics Diagnostics](../debugger/how-to-change-the-graphics-diagnostics-playback-machine.md)
