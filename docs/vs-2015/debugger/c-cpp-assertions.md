...
ms.locfileid: "47494828"
---
# <a name="cc-assertions"></a>Assertions C/C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Assertions C/C++](https://docs.microsoft.com/visualstudio/debugger/c-cpp-assertions).  
