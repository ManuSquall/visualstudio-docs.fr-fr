...
ms.locfileid: "47495738"
---
# <a name="debug-html-css-and-javascript-sample-code"></a>Déboguer un exemple de code HTML, CSS et JavaScript
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [déboguer du code HTML, CSS et JavaScript exemple de code](https://docs.microsoft.com/visualstudio/debugger/debug-html-css-and-javascript-sample-code).  
...
## <a name="sample-code"></a>Exemple de code  
 Le code HTML suivant est utilisé dans le \<corps > balise dans le Guide de démarrage rapide.  
