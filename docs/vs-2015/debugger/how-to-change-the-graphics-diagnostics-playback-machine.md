...
Vous trouverez la dernière version de cette rubrique dans [Comment : modifier l’ordinateur de lecture Graphics Diagnostics](https://docs.microsoft.com/visualstudio/debugger/graphics/how-to-change-the-graphics-diagnostics-playback-machine).  
