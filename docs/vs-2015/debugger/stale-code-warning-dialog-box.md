...
Cette boîte de dialogue s'affiche lorsque vous avez effectué des modifications au code natif que la fonction **Modifier & Continuer** n'a pas pu appliquer immédiatement. Par conséquent, une partie du code natif du frame de pile actif n'est plus à jour ; il est périmé. Pour plus d'informations, voir [Procédure : Travailler avec le Code périmé](https://msdn.microsoft.com/c7536e95-66a6-44a0-995d-3fe5035250b4).  
