...
ms.locfileid: "47495154"
---
# <a name="how-to-use-native-run-time-checks"></a>Comment : utiliser les contrôles natifs à l'exécution
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : utiliser les contrôles d’exécution natifs](https://docs.microsoft.com/visualstudio/debugger/how-to-use-native-run-time-checks).  
  
Dans Visual C++, vous pouvez utiliser native [runtime_checks](http://msdn.microsoft.com/library/ae50b43f-f88d-47ad-a2db-3389e9e7df5b) pour dépister les erreurs d’exécution courantes, telles que :  
