...
ms.locfileid: "47501284"
---
# <a name="search-tools-for-spy-views"></a>Outils de recherche pour les vues Spy++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [des outils de recherche pour les vues Spy ++](https://docs.microsoft.com/visualstudio/debugger/search-tools-for-spy-increment-views).  
