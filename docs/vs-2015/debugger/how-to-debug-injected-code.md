...
ms.locfileid: "47503888"
---
# <a name="how-to-debug-injected-code"></a>Comment : déboguer du code injecté
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : déboguer le Code injecté](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-injected-code).  
