...
### <a name="windows-81-and-direct3d-112"></a>Windows 8.1 et Direct3D 11.2
 Dans [!INCLUDE[win81](../includes/win81-md.md)], DirectX 11.2 inaugure de nouvelles fonctionnalités qui prennent en charge la capture d'informations graphiques pendant toute son exécution. [!INCLUDE[win81](../includes/win81-md.md)] utilise la nouvelle capture basée sur le runtime, appelée *capture fiable*, exclusivement pour toutes les versions de DirectX [!INCLUDE[win81](../includes/win81-md.md)] prises en charge par. La capture robuste prend aussi en charge les nouvelles fonctionnalités de Direct3D 11.2.
...
### <a name="diagnostics-capture-interface"></a>Interface de capture de Diagnostics
 ...
 Pour plus d’informations, consultez [Capture d’informations Graphics](../debugger/capturing-graphics-information.md).
...
### <a name="gpu-usage"></a>Utilisation du GPU
 ...
 Pour plus d’informations, consultez [Utilisation du GPU](../debugger/gpu-usage.md).
...
## <a name="graphics-analyzer"></a>Graphics Analyzer
 ...
 ![Toutes les fenêtres du débogueur de graphiques](../debugger/media/graphicsdebuggerwindows.png "GraphicsDebuggerWindows")
...
### <a name="the-graphics-toolbar-graphics-analyzer"></a>Barre d'outils Graphics (Graphics Analyzer)
 ...
 ![Barre d’outils Graphics en mode de diagnostics des graphiques](../debugger/media/vsg-toolbar.png "vsg_toolbar")
...
### <a name="graphics-state"></a>État graphique
 ...
 La fenêtre [État](../debugger/graphics-state.md) collecte les informations d’état relatives à chaque appel de dessin au même emplacement pour en faciliter la localisation. En outre, elle met en surbrillance les modifications d’état qui se sont produites depuis l’appel de dessin précédent.
...
## <a name="see-also"></a>Voir aussi
 [Outil de capture en ligne de commande,](../debugger/command-line-capture-tool.md) [débogueur HLSL](../debugger/hlsl-shader-debugger.md)
