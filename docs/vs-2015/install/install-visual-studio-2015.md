...
|![En savoir plus sur les licences](../install/media/licensing.png "Licence") |**Licence**: pour en savoir plus sur les options de licence pour les particuliers ou les clients d’entreprise, consultez le livre blanc sur les [licences Visual Studio 2015](https://www.microsoft.com/download/details.aspx?id=13350).|
