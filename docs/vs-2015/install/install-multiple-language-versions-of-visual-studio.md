---
title: Installer des versions multilingues | Microsoft Docs
ms.date: 11/15/2016
...
Pour consulter la documentation à jour sur Visual Studio, voir [Installer des modules linguistiques](/visualstudio/install/install-visual-studio?view=vs-2019#step-6---install-language-packs-optional).
...
- [Packs linguistiques LIP (Language Interface Pack) Microsoft et Visual Studio](../install/microsoft-language-interface-packs-lips-and-visual-studio.md)
