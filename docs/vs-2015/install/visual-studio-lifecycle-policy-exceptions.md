...
|[Pile web ASP.NET](https://support.microsoft.com/kb/2902020)|ASP.NET MVC 4<br /><br /> ASP.NET MVC 5<br /><br /> API web ASP.NET<br /><br /> API Web ASP.NET 2<br /><br /> Pages web ASP.NET 2<br /><br /> Pages web ASP.NET 3|  
...
|Les mises à jour apportées à ces composants sont distribuées par le biais de NuGet et ne respectent pas les stratégies standard de cycle de vie Microsoft.  [http://docs.nuget.org/](/nuget/)Pour plus d’informations, consultez.|Gestionnaire de jetons web JSON pour le Microsoft .NET Framework 4.5<br /><br /> NuGet 2.7<br /><br /> SignalR<br /><br /> Web Optimization Framework<br /><br /> WebGrease|  
...
|[Services RIA WCF V1.0 SP2](https://support.microsoft.com/kb/2902020)|Services RIA WCF V1.0 SP2|  
...
|[Windows 8.1](https://support.microsoft.com/lifecycle/search?sort=PN&alpha=windows%208.1&Filter=FilterNO)|SDK Windows 8.1<br /><br /> Bibliothèque Windows pour JavaScript (WinJS)|  
|[Microsoft Azure](https://support.microsoft.com/help/18486/lifecycle-faq-azure)<br /><br /> <br />> Voir aussi : [stratégie de cycle de vie en ligne](https://support.microsoft.com/hub/4095338/microsoft-lifecycle-policy)|Kit de développement logiciel (SDK) de Microsoft Azure Mobile Services<br /><br /> Outils Microsoft Azure Mobile Services|
