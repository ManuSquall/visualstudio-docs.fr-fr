...
|[Guide pratique pour exporter une texture pour l’utiliser avec des applications Javascript ou Direct2D](../designers/how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps.md)|Montre comment créer une texture au format DDS avec alpha prémultiplié que vous pouvez utiliser dans une application Direct2D ou WWA.|
