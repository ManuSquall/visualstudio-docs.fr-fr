...
|Ajustez la dernière tangente sans la contrainte de lissage, ce qui vous permet de faire un angle aigu|Cliquez pour créer le point, puis appuyez sur ALT avant de relâcher le bouton de la souris.|![](../designers/media/317e5475-b70c-489f-9477-110a98639ade.png "317e5475-b70c-489f-9477-110a98639ade")<br /><br /> Pointeur d'ajustement du stylet|
...
|Créer un angle aigu lors de la jonction de deux tracés|Sélectionnez deux tracés, cliquez sur l’outil **Plume**, et cliquez sur un point de terminaison de l’un des tracés, puis sur un point de terminaison de l’autre tracé.|![](../designers/media/bd12dfa4-112e-4f37-9765-3479e6b69894.png "bd12dfa4-112e-4f37-9765-3479e6b69894")<br /><br /> Pointeur de jonction du stylet|
|Créer un angle arrondi lors de la jonction de deux tracés|Sélectionnez deux tracés, cliquez sur l’outil **Plume**, et cliquez sur un point de terminaison de l’un des tracés, puis faites glisser un point de terminaison de l’autre tracé.|![](../designers/media/bd12dfa4-112e-4f37-9765-3479e6b69894.png "bd12dfa4-112e-4f37-9765-3479e6b69894")<br /><br /> Pointeur de jonction du stylet|
|Créer un tracé|Maintenez la touche CTRL enfoncée et cliquez en dehors du tracé précédent pour cesser d’ajouter des points à ce tracé, puis cliquez ou faites glisser jusqu’à l’endroit où vous voulez que le nouveau tracé commence.|![](../designers/media/69758176-5f53-465b-808c-f13fd1a0b3f2.png "69758176-5f53-465b-808c-f13fd1a0b3f2")<br /><br /> Pointeur de départ du stylet|

## <a name="see-also"></a>Voir aussi
 [Raccourcis clavier et touches de modification touches de modification de](../designers/keyboard-shortcuts-and-modifier-keys-in-blend.md) la [planche graphique](../designers/artboard-modifier-keys-in-blend.md) [sélection directe](../designers/direct-selection-tool-modifier-keys-in-blend.md) touches de modification de l’outil [dessiner des formes et des tracés](../designers/draw-shapes-and-paths.md)
