---
title: Value (propriété dynamique XElement) | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>Voir aussi
 <xref:System.Xml.Linq.XElement.Value%2A?displayProperty=fullName>[Propriétés dynamiques de la classe XElement](../designers/xelement-class-dynamic-properties.md) [XML](../designers/xml-xelement-dynamic-property.md)
