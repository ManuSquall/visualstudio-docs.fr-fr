...
## <a name="see-also"></a>Voir aussi
 [Procédure pas à pas : exemple](../designers/walkthrough-linqtoxmldatabinding-example.md) de [code source L2DBForm.Xaml.cs](../designers/l2dbform-xaml-cs-source-code.md)
