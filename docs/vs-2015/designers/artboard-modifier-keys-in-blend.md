...
## <a name="see-also"></a>Voir aussi
 [Raccourcis clavier](../designers/keyboard-shortcuts-in-blend.md) [touches de modification de l’outil stylet](../designers/pen-tool-modifier-keys-in-blend.md) [sélection directe touches de modification](../designers/direct-selection-tool-modifier-keys-in-blend.md) de l’outil
