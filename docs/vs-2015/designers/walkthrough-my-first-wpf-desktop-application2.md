...
## <a name="see-also"></a>Voir aussi
 [Procédure pas à pas : créer une application de bureau WPF connectée à un service mobile Azure](../designers/walkthrough-create-a-wpf-desktop-application-connected-to-an-azure-mobile-service.md) [créer des applications de bureau modernes avec Windows Presentation Foundation](../designers/create-modern-desktop-applications-with-windows-presentation-foundation.md)
