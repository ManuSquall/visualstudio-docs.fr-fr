...
### <a name="shader-designer-toolbars"></a>Barres d’outils du concepteur de nuanceur
 ...
 Les commandes qui affectent l’état du concepteur de nuanceur se trouvent dans la barre d’outils **Mode du concepteur de nuanceur**, dans la fenêtre principale de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]. Les outils et commandes de conception sont situés dans la barre d’outils **Concepteur de nuanceur** de l’aire de conception du concepteur de nuanceur.
