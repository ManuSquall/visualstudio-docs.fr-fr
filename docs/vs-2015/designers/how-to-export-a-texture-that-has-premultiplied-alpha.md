...
1. Commencez par une texture de base. Chargez un fichier image existant, ou créez-en un comme décrit dans [Comment : créer une texture de base](../designers/how-to-create-a-basic-texture.md).
