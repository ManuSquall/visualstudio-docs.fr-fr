...
ms.locfileid: "54796153"
---
# <a name="xelement-class-dynamic-properties"></a>Propriétés dynamiques de la classe XElement
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Cette section décrit les propriétés dynamiques de la <xref:System.Xml.Linq.XElement?displayProperty=fullName>[t] (<!-- TODO: review code entity reference <xref:assetId:///t?qualifyHint=False&amp;autoUpgrade=True>  -->) classe.  
