...
Vous trouverez la dernière version de cette rubrique dans [procédure pas à pas : créer une Application de bureau WPF connectée à un Service Mobile Azure](https://docs.microsoft.com/visualstudio/designers/walkthrough-create-a-wpf-desktop-application-connected-to-an-azure-mobile-service).  
