...
## <a name="see-also"></a>Voir aussi
 [Liaison de données WPF avec LINQ to XML](../designers/wpf-data-binding-with-linq-to-xml.md) [liaison de données WPF avec LINQ to XML vue d’ensemble](../designers/wpf-data-binding-with-linq-to-xml-overview.md) [IntroductionC#aux requêtes LINQ ()](https://msdn.microsoft.com/library/37895c02-268c-41d5-be39-f7d936fa88a8)
