...
ms.locfileid: "47502074"
---
# <a name="how-to-create-a-basic-lambert-shader"></a>Procédure : créer un nuanceur Lambert de base
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : créer un nuanceur Lambert de base](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-lambert-shader).  
