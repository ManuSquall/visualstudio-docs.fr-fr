...
1. Sélectionnez les éléments que vous souhaitez aligner. Pour sélectionner plusieurs éléments, appuyez sur la touche Ctrl, puis tout en la maintenant enfoncée, sélectionnez les éléments.  
...
#### <a name="to-align-two-or-more-elements-by-using-snaplines"></a>Pour aligner plusieurs éléments à l'aide des lignes d'alignement  
...
1. Sélectionnez les éléments que vous souhaitez regrouper. (Pour sélectionner plusieurs éléments, appuyez sur la touche Ctrl puis, tout en la maintenant enfoncée, cliquez sur les éléments.)  
