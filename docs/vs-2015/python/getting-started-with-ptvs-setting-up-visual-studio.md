---
title: 'Bien démarrer avec PTVS : configuration de Visual Studio | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
La première chose que vous avez besoin est Visual Studio. Si vous êtes un développeur open source ou individuel, vous pouvez utiliser Visual Studio [Community Edition](https://www.visualstudio.com/products/visual-studio-community-vs), qui est gratuite et fonctionnelle pour les professionnels de le. Vous pouvez également utiliser l’édition Community dans une organisation tant que c’est pour la classe d’apprentissage, les recherches universitaires, ou de contribuer à des projets open source. Si vous êtes étudiant ou propriétaire d'une jeune entreprise, examinez les programmes DreamSpark et BizSpark pour voir si vous pouvez bénéficier d'un accès gratuit, ou demandez à votre employeur si vous disposez d'un abonnement MSDN.
