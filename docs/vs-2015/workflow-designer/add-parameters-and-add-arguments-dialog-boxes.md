...
Le tableau suivant décrit les éléments d’interface utilisateur (IU) de la boîte de dialogue **Ajouter des paramètres** utilisée par le <xref:System.Activities.Statements.InvokeMethod> Concepteur.
