...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Concepteurs d’activités utilisés pour interagir entre [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)] / [!INCLUDE[netfx35_short](../includes/netfx35-short-md.md)] et [!INCLUDE[netfx40_short](../includes/netfx40-short-md.md)] des flux de travail.  
