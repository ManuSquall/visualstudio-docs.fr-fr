...
## <a name="using-the-statemachine-activity-designer"></a>Utilisation du concepteur d'activités StateMachine
 Pour ajouter une activité <xref:System.Activities.Statements.StateMachine>, faites glisser le concepteur d’activités **StateMachine** de la section **machine à États** de la **boîte à outils** et déposez-le sur l’aire de [!INCLUDE[wfd1](../includes/wfd1-md.md)]. Pour ajouter un État enfant à cette activité <xref:System.Activities.Statements.StateMachine>, faites glisser une <xref:System.Activities.Statements.State> ou <xref:System.Activities.Core.Presentation.FinalState> de la **boîte à outils** et déposez-la sur la **StateMachine**.
...
## <a name="see-also"></a>Voir aussi
 [Organigramme](../workflow-designer/flowchart-activity-designer.md) [Flux de contrôle](../workflow-designer/control-flow-activity-designers.md)