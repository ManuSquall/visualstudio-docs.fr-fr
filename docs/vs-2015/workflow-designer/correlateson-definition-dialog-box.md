...
La boîte de dialogue **CorrelatesOn** est utilisée dans [!INCLUDE[wfd1](../includes/wfd1-md.md)] pour modifier la <xref:System.ServiceModel.Activities.Receive.CorrelatesOn%2A> propriété d’une <xref:System.ServiceModel.Activities.Receive> activité. [!INCLUDE[crdefault](../includes/crdefault-md.md)] rubrique [Receive](../workflow-designer/receive-activity-designer.md) .
...
## <a name="see-also"></a>Voir aussi
 <xref:System.ServiceModel.Activities.Receive>Boîte de dialogue [Ajouter un CorrelationInitializers](../workflow-designer/add-correlationinitializers-dialog-box.md) boîte de dialogue [d’initialisation](../workflow-designer/initialize-correlation-dialog-box.md) de la corrélation