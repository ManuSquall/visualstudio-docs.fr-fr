---
title: Flux de travail de Visual Studio Windows (hérité) | Microsoft Docs
ms.date: 11/15/2016
...
|Properties|Utilisée pour configurer les propriétés de l'activité de workflow.|  
...
|Fenêtres de débogage|Le débogage windows, tel que Visual Studio standard la **Threads**, **pile des appels**, **point d’arrêt**, **Locals Tool**et **Watch Tool** windows.|  
