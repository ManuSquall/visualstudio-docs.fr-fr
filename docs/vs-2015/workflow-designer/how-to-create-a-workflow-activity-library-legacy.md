---
title: 'Comment : créer une bibliothèque d’activités de workflow (héritée) | Microsoft Docs'
ms.date: 11/15/2016
...
5. Dans le volet **modèles** , sélectionnez **bibliothèque d’activité de flux de travail**.
...
## <a name="see-also"></a>Voir aussi
 [Création de projets de workflow hérités](../workflow-designer/creating-legacy-workflow-projects.md) [à l’aide des](../workflow-designer/using-the-legacy-activity-designer.md) [activités de workflow](../workflow-designer/legacy-workflow-activities.md) héritées du concepteur d’activités héritées développement d’activités de [Workflow](https://msdn.microsoft.com/19876dfc-dfa5-4d52-b1f5-1d087474cc52) [Windows Workflow Foundation activités](https://msdn.microsoft.com/192c4c1e-afb6-4f58-ab11-2b5bbbc2d2c0)