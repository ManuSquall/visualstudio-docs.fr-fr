---
title: Concepteurs d’activités de Runtime | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="in-this-section"></a>Dans cette section
 [Conserver](../workflow-designer/persist-activity-designer.md) Utilisé pour créer et configurer une <xref:System.Activities.Statements.Persist> activité.

 [TerminateWorkflow](../workflow-designer/terminateworkflow-activity-designer.md) Utilisé pour créer et configurer une <xref:System.Activities.Statements.TerminateWorkflow> activité.
