...
Vous trouverez la dernière version de cette rubrique dans [problèmes de sécurité, le contrôle de version et manifeste dans les déploiements ClickOnce](https://docs.microsoft.com/visualstudio/deployment/security-versioning-and-manifest-issues-in-clickonce-deployments).  
