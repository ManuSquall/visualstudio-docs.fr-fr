...
ms.locfileid: "47505794"
---
# <a name="how-to-create-a-package-manifest"></a>Comment : créer un manifeste de package
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : créer un manifeste de Package](https://docs.microsoft.com/visualstudio/deployment/how-to-create-a-package-manifest).  
