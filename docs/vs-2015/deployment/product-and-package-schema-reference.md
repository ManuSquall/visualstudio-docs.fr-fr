...
## <a name="example"></a>Exemple  
 L’exemple de code suivant montre un fichier produit complet pour l’installation de [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] .  
