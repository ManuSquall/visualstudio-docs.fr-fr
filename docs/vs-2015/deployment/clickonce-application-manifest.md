...
ms.locfileid: "47504597"
---
# <a name="clickonce-application-manifest"></a>ClickOnce Application Manifest
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [manifeste d’Application ClickOnce](https://docs.microsoft.com/visualstudio/deployment/clickonce-application-manifest).  
