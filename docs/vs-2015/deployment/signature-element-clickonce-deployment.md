...
## <a name="example"></a>Exemple  
 L’exemple de code suivant illustre un élément `Signature` dans un manifeste de déploiement utilisé dans un déploiement [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)].  
