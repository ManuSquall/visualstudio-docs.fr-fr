---
title: 'Comment : utiliser ClickOnce pour déployer des applications qui peuvent s’exécuter sur plusieurs versions du .NET Framework | Microsoft Docs'
ms.date: 11/15/2016
...
- Mettez à jour et signez à nouveau les manifestes d’application et de déploiement. Pour plus d'informations, consultez [How to: Re-sign Application and Deployment Manifests](../deployment/how-to-re-sign-application-and-deployment-manifests.md).  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Schéma du fichier de configuration](https://msdn.microsoft.com/library/69003d39-dc8a-460c-a6be-e6d93e690b38)
