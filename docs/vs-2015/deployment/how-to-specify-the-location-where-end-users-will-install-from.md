...
Vous trouverez la dernière version de cette rubrique dans [Comment : spécifier l’emplacement où les utilisateurs finaux s’installer à partir de](https://docs.microsoft.com/visualstudio/deployment/how-to-specify-the-location-where-end-users-will-install-from).  
