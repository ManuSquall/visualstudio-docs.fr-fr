...
Vous trouverez la dernière version de cette rubrique dans [Comment : créer un Package de programme d’amorçage localisé](https://docs.microsoft.com/visualstudio/deployment/how-to-create-a-localized-bootstrapper-package).  
