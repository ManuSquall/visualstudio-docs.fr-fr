...
## <a name="example"></a> Exemple  
 Le code qui suit provient des [exemples VSSDK](../misc/vssdk-samples.md).  
...
## <a name="see-also"></a>Voir aussi  
 [Inscription des VSPackages](../extensibility/internals/registering-vspackages.md)   
