...
## <a name="related-sections"></a>Rubriques connexes  
 [Personnalisation pour les tests à l’aide du SDK de Visual Studio](https://msdn.microsoft.com/9cf7a840-dd66-4b00-90f7-e00e40370a69)  
 Décrit comment étendre [!INCLUDE[vsprvstte](../includes/vsprvstte-md.md)] pour prendre en charge de nouveaux types de tests.  
  
 [Tests d’intégration Visual Studio](https://msdn.microsoft.com/8d741735-7d93-46c2-ab93-01da7a0e016d)  
