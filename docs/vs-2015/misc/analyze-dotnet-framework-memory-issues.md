...
2. Dans la page **Résumé du fichier Minidump** , choisissez **Déboguer la mémoire managée**.  
    ...
    ![Page de résumé du fichier dump](../misc/media/mngdmem-dumpfilesummary.png "MNGDMEM_DumpFileSummary")  
...
|Nom|Description|  
|-|-|  
|**Activer Uniquement mon code**|Uniquement mon code masque les objets système les plus courants. Ainsi, seuls les types que vous créez figurent dans la liste.<br /><br /> Vous pouvez également définir l’option Uniquement mon code dans la boîte de dialogue **options** de Visual Studio. Dans le menu **Déboguer** , choisissez **Options et paramètres**. Sous l’onglet général du **débogage** / **General** , sélectionnez ou désactivez **uniquement mon code**.|  
...
|**Suppr. Handle épinglé**|Objet épinglé asynchrone tiré de la table de handles d'objets.|  
...
2. Dans la page rapport d’analyse de la mémoire, ouvrez la liste **Sélectionner une ligne de base** , puis choisissez **Parcourir** pour spécifier le premier fichier de vidage.  
   ...
   ![Colonnes Diff dans la liste des types](../misc/media/mngdmem-diffcolumns.png "MNGDMEM_DiffColumns")  
...
## <a name="see-also"></a>Voir aussi  
 [Blog VS ALM TFS : utilisation de Visual Studio 2013 pour diagnostiquer les problèmes de mémoire .NET en production](https://devblogs.microsoft.com/devops/using-visual-studio-2013-to-diagnose-net-memory-issues-in-production/)   
 [Channel 9 &#124; analyse de mémoire gérée &#124; de Visual Studio TV](https://channel9.msdn.com/Series/Visual-Studio-2012-Premium-and-Ultimate-Overview/Managed-Memory-Analysis)   
 [Channel 9 &#124; Visual Studio Toolbox &#124; l’analyse de la mémoire managée dans Visual Studio 2013](https://channel9.msdn.com/Shows/Visual-Studio-Toolbox/Managed-Memory-Analysis-in-Visual-Studio-2013)