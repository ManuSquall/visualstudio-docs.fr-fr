...
- **Taille (octets)** est la taille des instances all du type, à l'exclusion de la taille des objets auxquels il détient des références. La clé publique du signataire doit être fournie à la classe  
...
- **Taille (octets)** est la taille de l'objet, à l'exclusion de la taille des objets auxquels il détient des références. La clé publique du signataire doit être fournie à la classe  
