...
## <a name="using-domain-specific-language-tools-to-generate-a-directive-processor"></a>Utilisation de Outils Domain-Specific Language pour générer un processeur de directive
...
#### <a name="to-use-domain-specific-language-tools-to-generate-a-directive-processor-that-is-based-on-a-domain-model"></a>Pour utiliser Outils Domain-Specific Language pour générer un processeur de directive basé sur un modèle de domaine
...
#### <a name="to-connect-a-custom-text-template-host-to-the-generated-directive-processor"></a>Pour connecter un hôte de modèle de texte personnalisé au processeur de directive généré
