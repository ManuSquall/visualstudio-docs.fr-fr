...
> Une stratégie de verrouillage peut être contournée à l’aide de la réflexion. Il fournit une limite claire pour les développeurs tiers, mais ne fournit pas une sécurité renforcée.
 ...
 Des informations supplémentaires sont disponibles sur le [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] site Web du [Kit de développement logiciel de visualisation et de modélisation](https://www.microsoft.com/download/details.aspx?id=48148) .
