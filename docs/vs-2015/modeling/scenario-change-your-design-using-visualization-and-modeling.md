...
- Utilisez < \<create > > des messages pour indiquer la construction d’objets par d’autres objets. Cela doit être le premier message envoyé à l’objet.
