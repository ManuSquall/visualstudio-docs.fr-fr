...
Vous trouverez la dernière version de cette rubrique dans [partage de Classes entre plusieurs DSL à l’aide d’une bibliothèque DSL](https://docs.microsoft.com/visualstudio/modeling/sharing-classes-between-dsls-by-using-a-dsl-library).  
