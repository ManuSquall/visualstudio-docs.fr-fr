...
|   **Paramètres**    |    (aucun)    |      Une liste qui se présente sous la forme <em>nom</em>**:**<em>Type</em>**,** <em>nom</em>**:**  <em>Type</em>**,...** Cliquez sur **[...]**  pour modifier la liste.<br /><br /> Les types peuvent être des types primitifs ou des types définis dans le modèle. Si vous entrez un nom pour un nouveau type dans cette propriété, un type est ajouté à la section **Types non spécifiés** de l’Explorateur de modèles UML.      |
|   **Type de retour**   |    (aucun)    |                                                                               **(aucun)** , ou un type primitif ou un type qui est défini dans le modèle. Si vous entrez un nom pour un nouveau type dans cette propriété, un type est ajouté à la section **Types non spécifiés** de l’Explorateur de modèles UML.                                                                                |
...
|  **Conditions préalables**  |    (aucun)    |                                                                                                                            Condition facultative spécifiant les hypothèses concernant l'état du système avant l'exécution de l'opération.                                                                                                                            |
| **Conditions de corps** |    (aucun)    |                                                                                                                                                       Contrainte facultative sur les valeurs retournées par l'opération.                                                                                                                                                       |
