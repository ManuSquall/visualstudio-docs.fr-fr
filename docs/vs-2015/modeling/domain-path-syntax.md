...
ms.locfileid: "47501818"
---
# <a name="domain-path-syntax"></a>Syntaxe du chemin de domaine
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [syntaxe de chemin d’accès de domaine](https://docs.microsoft.com/visualstudio/modeling/domain-path-syntax).  
