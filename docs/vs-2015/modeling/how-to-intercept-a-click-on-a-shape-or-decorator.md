---
title: 'Comment : intercepter un clic sur une forme ou un Decorator | Microsoft Docs'
ms.date: 11/15/2016
...
4. Substituez la méthode InitializeShapeFields dans vos classes de forme en ajoutant la définition de classe partielle suivante.
...
## <a name="see-also"></a>Voir aussi
 [Réponse aux modifications et propagation](../modeling/responding-to-and-propagating-changes.md) [des propriétés des éléments décoratifs](../modeling/properties-of-decorators.md)
