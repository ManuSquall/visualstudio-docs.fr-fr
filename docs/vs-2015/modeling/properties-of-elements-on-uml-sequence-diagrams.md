...
|**Description**|(vide)|Tout|Vous pouvez consigner des remarques générales concernant l'élément.|
...
|**Intervenant**|False|Ligne de vie|Indique si la ligne de vie représente un utilisateur, un périphérique ou un composant logiciel qui est externe au composant décrit par ce diagramme.|
|**Espèces**|**Complete** : message qui a à la fois l’expéditeur et le destinataire.<br /><br /> **Found** : message dont l’expéditeur n’est pas spécifié.<br /><br /> **Lost** -un message qui a un destinataire non spécifié.|Message|Indique les extrémités d'un message qui sont attachées à une ligne de vie.<br /><br /> Vous ne pouvez pas modifier cette propriété. Elle est définie quand vous créez le message.|
|**Tris**|**AsynchCall** : message asynchrone.<br /><br /> **SynchCall** : message synchrone.<br /><br /> **Reply** -retourne une partie d’un message synchrone.<br /><br /> **CreateMessage** -message de création d’instance.|Message|Type de message. Vous ne pouvez pas modifier cette propriété. Elle est déterminée par l'outil que vous utilisez pour créer le message.|
