...
## <a name="related-topics"></a>Rubriques connexes
 ...
 Pour générer du texte en dehors d’une extension [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] : Définissez un hôte personnalisé. Pour plus d’informations, consultez [de traitement des modèles de texte à l’aide d’un hôte personnalisé](../modeling/processing-text-templates-by-using-a-custom-host.md).
