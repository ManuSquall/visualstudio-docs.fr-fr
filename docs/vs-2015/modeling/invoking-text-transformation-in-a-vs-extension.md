...
## <a name="related-topics"></a>Rubriques connexes
 ...
 Pour générer du texte en dehors d’une extension de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] : définissez un hôte personnalisé. Pour plus d’informations, consultez [traitement des modèles de texte à l’aide d’un hôte personnalisé](../modeling/processing-text-templates-by-using-a-custom-host.md).
