...
ms.locfileid: "47494719"
---
# <a name="security-of-text-templates"></a>Sécurité des modèles de texte
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [sécurité des modèles de texte](https://docs.microsoft.com/visualstudio/modeling/security-of-text-templates).  
