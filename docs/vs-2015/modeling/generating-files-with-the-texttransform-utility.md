...
|**-dp** \<processorName >! \<className >! \<assemblyName&#124;code base >|Le nom, le nom de type complet et l’assembly d’un processeur de directive qui peuvent être utilisés pour traiter des directives personnalisées dans le modèle de texte.|
