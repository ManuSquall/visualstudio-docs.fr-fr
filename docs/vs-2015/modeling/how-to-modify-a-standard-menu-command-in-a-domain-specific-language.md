...
Vous trouverez la dernière version de cette rubrique dans [Comment : modifier une commande de Menu Standard dans un langage spécifique à un domaine](https://docs.microsoft.com/visualstudio/modeling/how-to-modify-a-standard-menu-command-in-a-domain-specific-language).  
