---
title: 'Comment : ouvrir un modèle depuis un fichier de Code de programme | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
Vous trouverez la dernière version de cette rubrique dans [Comment : ouvrir un modèle depuis un fichier de Code de programme](https://docs.microsoft.com/visualstudio/modeling/how-to-open-a-model-from-file-in-program-code).  
...
-   Votre assembly DSL, vous trouverez sous le dossier bin de votre projet DSL. Son nom est généralement au format : *votresociété*. *VotreProjet*`.Dsl.dll`.  
