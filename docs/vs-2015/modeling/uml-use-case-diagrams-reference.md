...
### <a name="structuring-use-cases"></a>Structures des cas d'usage
 ![Cas d'usage avec include, extend et generalization](../modeling/media/uml-ucovstructure.png "UML_UCOvStructure")
