...
## <a name="in-this-section"></a>Dans cette section
 [Génération de texte au moment de l’exécution avec des modèles de texte T4](../modeling/run-time-text-generation-with-t4-text-templates.md) Dans toute application qui génère des fichiers texte, les modèles de texte précompilés constituent une méthode simple et fiable pour définir le texte. Toutefois, cette méthode ne peut pas être utilisée pour les modèles de texte qui changent au moment de l’exécution.
 ...
 [Procédure pas à pas : génération de code à l’aide de modèles de texte](../modeling/walkthrough-generating-code-by-using-text-templates.md) Démonstration d’une façon d’utiliser la génération de code.

 [Débogage d’un modèle de texte T4](../modeling/debugging-a-t4-text-template.md) Comment déboguer des modèles de texte et certaines erreurs courantes relatives aux modèles de texte.

 [Génération de fichiers avec l’utilitaire TextTransform](../modeling/generating-files-with-the-texttransform-utility.md) Outil en ligne de commande que vous pouvez utiliser pour exécuter des transformations de modèle de texte.

 [Personnalisation de la transformation de texte T4](../modeling/customizing-t4-text-transformation.md) Comment écrire des processeurs de directive et des hôtes de modèles personnalisés pour vos propres sources de données.

## <a name="see-also"></a>Voir aussi
 [Générer des fichiers à partir d’un modèle UML](../modeling/generate-files-from-a-uml-model.md) [générant du code à partir d’un langage spécifique à un domaine](../modeling/generating-code-from-a-domain-specific-language.md)
