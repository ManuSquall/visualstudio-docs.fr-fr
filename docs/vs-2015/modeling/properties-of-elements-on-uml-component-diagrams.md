...
Vous trouverez la dernière version de cette rubrique dans [propriétés d’éléments des diagrammes de composants UML](https://docs.microsoft.com/visualstudio/modeling/properties-of-elements-on-uml-component-diagrams).  
