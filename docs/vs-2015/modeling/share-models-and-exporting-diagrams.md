---
title: Partager des modèles et exporter des diagrammes | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="working-on-a-model-as-a-team"></a>Travail en équipe sur un modèle
 Les utilisateurs de Visual Studio peuvent créer et modifier des modèles, des diagrammes de couche et des graphiques orientés.

 Différents utilisateurs peuvent travailler simultanément sur un modèle UML, mais ils doivent travailler sur différents packages.

 Nous vous recommandons d'utiliser [!INCLUDE[esprscc](../includes/esprscc-md.md)].
...
## <a name="reading-and-reviewing-models"></a>Lecture et examen de modèles
 Les membres de l’équipe qui utilisent certaines versions de Visual Studio (qui ne peuvent pas créer de modèles) peuvent lire des modèles, modéliser des diagrammes et des graphiques orientés, mais ils ne peuvent pas les modifier.  Pour connaître les versions de Visual Studio qui prennent en charge cette fonctionnalité, consultez [Version support for architecture and modeling tools](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport).

 Un diagramme UML ou un diagramme de couche peut être ouvert uniquement dans le modèle dans lequel il a été créé. Pour fournir l'accès à un diagramme, vous devez donc fournir l'accès à tous les fichiers de projets de modélisation ou à des copies de ces fichiers.
...
## <a name="see-also"></a>Voir aussi
 [Créer des modèles pour votre application](../modeling/create-models-for-your-app.md) [utiliser des modèles dans votre processus de développement](../modeling/use-models-in-your-development-process.md)
