...
- **Générateurs de connexions**. Liste des générateurs de connexions dans le modèle. Pour plus d’informations sur les générateurs de connexions, consultez [Personnalisation de la création de lien-redirection](../misc/customizing-link-creation-redirection.md).
