...
## <a name="applying-validation-constraints"></a>Application de contraintes de validation
 ...
 Pour plus d’informations sur l’application de la validation, consultez [Validate Your UML Model](../modeling/validate-your-uml-model.md).
...
## <a name="how-validation-methods-are-applied"></a>Application des méthodes de validation
 ...
 La hiérarchie des types est résumée dans les [types d’éléments de modèle UML](../modeling/uml-model-element-types.md).
...
## <a name="see-also"></a>Voir aussi
 [Définir et installer une extension de modélisation](../modeling/define-and-install-a-modeling-extension.md) [programmation à l’aide de l’API UML](../modeling/programming-with-the-uml-api.md)
