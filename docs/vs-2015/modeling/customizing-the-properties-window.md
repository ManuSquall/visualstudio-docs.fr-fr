...
### <a name="adding-property-forwarding"></a>Ajout d’un transfert de propriété
...
## <a name="providing-a-drop-down-list-of-values"></a>Fournir une liste déroulante de valeurs
