...
ms.locfileid: "47507161"
---
# <a name="generate-files-from-a-uml-model"></a>Générer des fichiers à partir d'un modèle UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [générer des fichiers à partir d’un modèle UML](https://docs.microsoft.com/visualstudio/modeling/generate-files-from-a-uml-model).  
