---
title: Créer des éléments et des relations dans des modèles UML | Microsoft Docs
ms.date: 11/15/2016
...
```
 ...
 Certains types ont des méthodes de création plus complexes, en particulier dans les diagrammes de séquence. Consultez [modifier des diagrammes de séquence UML à l’aide de l’API UML](../modeling/edit-uml-sequence-diagrams-by-using-the-uml-api.md).
...
## <a name="see-also"></a>Voir aussi
 [Étendre des modèles et des diagrammes UML](../modeling/extend-uml-models-and-diagrams.md) [afficher un modèle UML sur des diagrammes](../modeling/display-a-uml-model-on-diagrams.md)
