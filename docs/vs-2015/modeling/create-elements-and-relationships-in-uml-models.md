...
Vous trouverez la dernière version de cette rubrique dans [créer des éléments et des relations dans les modèles UML](https://docs.microsoft.com/visualstudio/modeling/create-elements-and-relationships-in-uml-models).  
