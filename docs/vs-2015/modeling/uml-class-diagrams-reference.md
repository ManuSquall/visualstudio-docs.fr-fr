...
- [Propriétés des associations dans les diagrammes de classes UML](../modeling/properties-of-associations-on-uml-class-diagrams.md)
  ...
  ![Trois classes présentant des relations et des propriétés](../modeling/media/uml-classovreading.png "UML_ClassOvReading")
...
|    5a     |     **Aggregation**      |                                                                                                    Association représentant une relation de propriété partagée. La propriété **Agrégation** du rôle propriétaire a la valeur **Partagée**.                                                                                                     |
|    5b     |     **Composition**      |                                                                                                      Association représentant une relation de partie entière. La propriété **Agrégation** du rôle propriétaire a la valeur **Composite**.                                                                                                      |
...
|     8     |     **Multiplicité**     |                                         Indique combien des objets à cette extrémité peuvent être liés à chaque objet à l'autre extrémité. Dans l'exemple, chaque commande doit être liée à exactement un menu.<br /><br /> **\\** \* signifie qu’il n’y a aucune limite supérieure au nombre de liens qui peuvent être créés.                                         |
...
|12|**Package**|Groupe de classifieurs, associations, actions, lignes de vie, composants et packages. Un diagramme de classes logique montre que les packages et les classifieurs de membres sont contenus dans le package.<br /><br /> Les noms sont étendus au sein des packages afin que **Class1** dans **package1** soit distinct de **Class1** en dehors de ce package. Le nom du package apparaît dans le cadre des propriétés **Nom qualifié** de son contenu.<br /><br /> Vous pouvez définir la propriété **Package lié** d'un diagramme UML pour faire référence à un package. Tous les éléments que vous créez dans ce diagramme feront alors partie du package. Ils apparaîtront sous le package dans l'**Explorateur de modèles UML**.|
...
|Forme|**Élément**|Description|
|-----------|-----------------|-----------------|
|15|**Réalisation**|La classe implémente les opérations et les attributs définis par l'interface.<br /><br /> Utilisez l'outil **Héritage** pour créer une réalisation entre une classe et une interface.|
