...
```
 ...
 Les modèles de texte sont essentiels à [!INCLUDE[dsl](../includes/dsl-md.md)] . Ils sont utilisés pour générer le code source des éléments du modèle de domaine, ainsi que pour le VSPackage et les contrôles utilisés pour intégrer les outils à [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] .
