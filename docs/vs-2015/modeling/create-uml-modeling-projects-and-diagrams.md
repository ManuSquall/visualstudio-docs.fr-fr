...
2. Dans la boîte de dialogue **Ajouter un nouveau diagramme**, cliquez sur le type de diagramme de modélisation de votre choix.
...
4. Dans la zone **Ajouter au projet de modélisation** :
   ...
   2. Dans la boîte de dialogue **Créer un nouveau projet de modélisation**, entrez le nom et l'emplacement du nouveau projet, puis cliquez sur **OK**.
...
1. Dans l'**Explorateur de solutions**, cliquez sur le nœud du projet de modélisation.
...
4. Nommez le projet et spécifiez un emplacement, dans les zones **Nom** et **Emplacement**, respectivement.

5. Dans la zone **Solution**, sélectionnez **Ajouter à la solution** pour ajouter le nouveau projet à une solution que vous avez déjà ouverte ou **Créer une nouvelle solution** pour fermer les solutions ouvertes et ajouter le projet à une nouvelle solution.
