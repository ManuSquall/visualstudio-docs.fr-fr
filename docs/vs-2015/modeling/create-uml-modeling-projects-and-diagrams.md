...
3. Dans la boîte de dialogue **Ajouter un nouvel élément-nom de** *\<project >* , sous **modèles**, cliquez sur le type de diagramme de modélisation, par exemple **diagramme de composant UML**.
