...
ms.locfileid: "47496010"
---
# <a name="layer-diagrams-reference"></a>Diagrammes de couche : référence
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [des diagrammes de dépendance : référence](https://docs.microsoft.com/visualstudio/modeling/layer-diagrams-reference).  
