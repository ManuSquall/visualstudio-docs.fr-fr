...
Cette section répertorie les propriétés que vous voyez dans le Fenêtre Propriétés lorsque vous sélectionnez un élément dans le diagramme de définition DSL ou dans l’Explorateur DSL.
