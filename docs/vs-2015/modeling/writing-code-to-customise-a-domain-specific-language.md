...
Vous trouverez la dernière version de cette rubrique dans [écriture du Code pour personnaliser un langage spécifique à un domaine](https://docs.microsoft.com/visualstudio/modeling/writing-code-to-customise-a-domain-specific-language).  
