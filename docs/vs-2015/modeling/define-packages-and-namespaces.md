...
## <a name="in-this-topic"></a>Dans cette rubrique
 ...
 [Création et affichage des packages](#Packages)
...
## <a name="namespaces"></a><a name="Namespaces"></a> Espaces
...
## <a name="creating-and-viewing-packages"></a><a name="Packages"></a> Création et affichage de packages
...
## <a name="creating-model-elements-inside-packages"></a><a name="Elements"></a> Création d’éléments de modèle dans des packages
...
## <a name="moving-elements-into-and-out-of-packages"></a><a name="Moving"></a> Déplacement d’éléments à l’intérieur et à l’extérieur des packages
...
## <a name="pasting-elements-into-a-package"></a><a name="Pasting"></a> Collage d’éléments dans un package
...
## <a name="import-relationships-between-packages"></a><a name="Import"></a> Importer des relations entre des packages
...
## <a name="references-from-one-namespace-to-another"></a><a name="References"></a> Références d’un espace de noms à un autre
 ...
 Par exemple, supposez que le package `SalesCommon` définit le type `CustomerAddress`. Dans un autre package `RestaurantSales`, vous souhaitez définir un type `MealOrder`, qui a un attribut de type Customer Address. Deux options s'offrent à vous :
...
## <a name="properties-of-packages"></a><a name="Properties"></a> Propriétés des packages
