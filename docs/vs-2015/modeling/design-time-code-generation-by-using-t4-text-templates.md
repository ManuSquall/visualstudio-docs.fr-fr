...
1. Créez un [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] projet ou ouvrez-en un existant.
...
### <a name="getting-data-from-vsprvs"></a>Obtention de données à partir de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]
