...
ms.locfileid: "47508273"
---
# <a name="t4-parameter-directive"></a>Directive du paramètre T4
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Directive du paramètre T4](https://docs.microsoft.com/visualstudio/modeling/t4-parameter-directive).  
...
## <a name="passing-parameter-values-to-a-template"></a>Passer des valeurs de paramètre à un modèle  
 Si vous écrivez un [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Extension comme une commande de menu ou un gestionnaire d’événements, vous pouvez traiter un modèle en utilisant le service de création de modèles de texte :  
