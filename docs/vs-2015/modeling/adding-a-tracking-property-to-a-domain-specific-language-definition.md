---
title: Ajout d’une propriété de suivi à une définition de langage spécifique à un domaine | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="creating-the-dsl-project"></a>Création du projet DSL
 Créez le projet pour votre langage spécifique à un domaine.
...
## <a name="transforming-templates"></a>Transformation des modèles
...
## <a name="creating-files-for-custom-code"></a>Création de fichiers pour du code personnalisé
...
## <a name="adding-helper-classes-to-support-tracking-properties"></a>Ajout de classes d’assistance pour prendre en charge les propriétés de suivi
...
## <a name="adding-custom-code-for-the-custom-type-descriptor"></a>Ajout de code personnalisé pour le descripteur de type personnalisé
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>Pour mettre à jour le package DSL afin d’utiliser votre descripteur de type personnalisé
...
## <a name="adding-custom-code-for-the-model"></a>Ajout de code personnalisé pour le modèle
...
## <a name="adding-custom-code-for-the-tracking-property"></a>Ajout de code personnalisé pour la propriété Tracking
...
## <a name="adding-custom-code-to-support-serialization"></a>Ajout de code personnalisé pour prendre en charge la sérialisation
...
## <a name="testing-the-language"></a>Test du langage
...
#### <a name="to-exercise-the-language"></a>Pour exercer le langage

1. Dans le menu **Générer**, cliquez sur **Régénérer la solution**.

2. Dans le menu **Déboguer**, cliquez sur **Démarrer le débogage**.

     La build expérimentale de [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] ouvre la solution de **débogage** , qui contient un fichier de test vide.
...
## <a name="see-also"></a>Voir aussi
 ...
 [Comment définir un langage spécifique à un domaine](../modeling/how-to-define-a-domain-specific-language.md) [procédure : créer une solution de langage spécifique](../modeling/how-to-create-a-domain-specific-language-solution.md) à un domaine [procédure pas à pas : personnalisation de la définition de langage spécifique à un domaine](../misc/walkthrough-customizing-the-domain-specific-language-definition.md)
