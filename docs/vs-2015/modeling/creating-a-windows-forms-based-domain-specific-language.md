...
Vous trouverez la dernière version de cette rubrique dans [création d’un langage spécifique à un domaine de Windows Forms-Based](https://docs.microsoft.com/visualstudio/modeling/creating-a-windows-forms-based-domain-specific-language).  
