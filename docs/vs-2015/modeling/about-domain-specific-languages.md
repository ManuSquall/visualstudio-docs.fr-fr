...
## <a name="what-you-can-do-with-dsls"></a>Ce que vous pouvez faire avec DSL
 ...
 [!INCLUDE[dsl](../includes/dsl-md.md)] vous permet de créer un langage spécifique à un domaine qui contient votre propre concepteur graphique et votre propre notation de diagramme, puis d’utiliser le langage pour générer le code source approprié pour chaque projet.
