...
ms.locfileid: "47500927"
---
# <a name="start-view"></a>vue de départ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [vue de départ](https://docs.microsoft.com/visualstudio/xml-tools/start-view).  
