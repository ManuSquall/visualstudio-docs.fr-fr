...
-   Faites glisser-déposer les nœuds globaux, nœuds de fichier et nœuds d’espace de noms de l’Explorateur de schémas XML sur l’une des trois vues. Pour plus d’informations, consultez la section « En faisant glisser et suppression de nœuds » dans [Explorateur de schémas XML](../xml-tools/xml-schema-explorer.md).  
