...
ms.locfileid: "47493401"
---
# <a name="working-with-xml-data"></a>Utilisation de données XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonctionne avec des données XML](https://docs.microsoft.com/visualstudio/xml-tools/working-with-xml-data).  
