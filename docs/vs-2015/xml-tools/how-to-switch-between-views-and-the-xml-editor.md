...
2. Pour basculer vers le Concepteur de schémas XML à partir de l’éditeur XML, avec le bouton droit cliquez n’importe où dans l’éditeur XML et sélectionnez **Concepteur de vues**.  
...
4. Faites glisser le nœud `USAddress` de l'Explorateur de schémas XML sur la vue du graphique. Cliquez sur le `USAddress` nœud dans la vue du graphique, puis sélectionnez **afficher en vue de modèle de contenu** dans le menu contextuel.  
