...
## <a name="see-also"></a>Voir aussi
 [Éditeur XML](../xml-tools/xml-editor.md) [à l’aide d’IntelliSense](../ide/using-intellisense.md) [procédure pas à pas : utilisation d’IntelliSense XSLT](../xml-tools/walkthrough-using-xslt-intellisense.md)
