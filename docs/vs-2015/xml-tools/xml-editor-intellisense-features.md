...
ms.locfileid: "47494911"
---
# <a name="xml-editor-intellisense-features"></a>Fonctionnalités IntelliSense de l’Éditeur XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonctionnalités IntelliSense de l’éditeur XML](https://docs.microsoft.com/visualstudio/xml-tools/xml-editor-intellisense-features).  
