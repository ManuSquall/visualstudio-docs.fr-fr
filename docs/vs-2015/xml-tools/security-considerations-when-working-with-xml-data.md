...
Vous trouverez la dernière version de cette rubrique dans [considérations sur la sécurité lorsque vous travaillez avec des données XML](https://docs.microsoft.com/visualstudio/xml-tools/security-considerations-when-working-with-xml-data).  
