...
ms.locfileid: "47501632"
---
# <a name="sample-xsd-file-simple-schema"></a>Exemple de fichier XSD : schéma simple
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [exemple de fichier XSD : schéma Simple](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-simple-schema).  
