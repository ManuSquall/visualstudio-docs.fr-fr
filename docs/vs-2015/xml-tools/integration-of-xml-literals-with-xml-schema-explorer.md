...
Visual Basic prend en charge les littéraux XML, ce qui signifie que vous pouvez incorporer des fragments XML directement dans votre code Visual Basic. Pour plus d’informations, consultez [vue d’ensemble des littéraux XML](http://go.microsoft.com/fwlink/?LinkId=140325).
 ...
 ![Visual Basic littéraux XML ; Explorateur de schémas XML](../xml-tools/media/vbxmlliteralswithxmlschemaexplorer2.gif "VBXMLLiteralsWithXMLSchemaExplorer2")

 Cette fonctionnalité a été introduite dans Visual Studio 2008 SP1. Pour visionner un entretien dans lequel cette fonctionnalité est expliquée en détail, consultez l' [entretien de Channel 9 : XML Schema Explorer dans Visual Studio 2008 SP1](https://channel9.msdn.com/Blogs/funkyonex/XML-Schema-Explorer-in-Visual-Studio-2008-SP1).
