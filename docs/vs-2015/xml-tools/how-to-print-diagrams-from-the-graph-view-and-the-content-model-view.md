---
title: 'Comment : imprimer des diagrammes à partir de la vue du graphique et de la vue de modèle de contenu | Microsoft Docs'
ms.date: 11/15/2016
...
2. Exportez le diagramme vers un fichier XPS à l’aide du **diagramme d’exportation en tant qu’image...** élément de menu contextuel dans l’aire de conception de la vue du graphique ou de la vue de modèle de contenu.
...
## <a name="see-also"></a>Voir aussi
 Vue du [modèle de contenu](../xml-tools/content-model-view.md) de la [vue de graphique](../xml-tools/graph-view.md) [Concepteur de schémas XML](../xml-tools/xml-schema-designer-workspace.md)
