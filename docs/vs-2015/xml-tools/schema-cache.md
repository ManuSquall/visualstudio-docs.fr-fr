...
ms.locfileid: "47504280"
---
# <a name="schema-cache"></a>Cache de schéma
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Cache de schéma](https://docs.microsoft.com/visualstudio/xml-tools/schema-cache).  
