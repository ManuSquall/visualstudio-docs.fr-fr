...
## <a name="see-also"></a>Voir aussi
 [Explorateur de schémas XML](../xml-tools/xml-schema-explorer.md) [recherche dans le jeu de schémas](../xml-tools/searching-the-schema-set.md)
