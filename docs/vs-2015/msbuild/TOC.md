...
#### [Guide pratique pour sélectionner des fichiers dans une build](how-to-select-the-files-to-build.md)
...
#### [Guide pratique pour effectuer des builds incrémentielles](how-to-build-incrementally.md)
...
#### [Guide pratique pour générer un projet qui dispose de ressources](how-to-build-a-project-that-has-resources.md)
...
## [Procédure pas à pas : Utiliser MSBuild](walkthrough-using-msbuild.md)
## [Procédure pas à pas : Créer un fichier projet MSBuild à partir de zéro](walkthrough-creating-an-msbuild-project-file-from-scratch.md)
