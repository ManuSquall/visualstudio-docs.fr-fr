...
ms.locfileid: "47508720"
---
# <a name="obtaining-build-logs-with-msbuild"></a>Obtention de journaux de génération avec MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [obtention de journaux de génération avec MSBuild](https://docs.microsoft.com/visualstudio/msbuild/obtaining-build-logs-with-msbuild).  
