...
ms.locfileid: "47504339"
---
# <a name="property-functions"></a>Fonctions de propriétés
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [fonctions de propriété](https://docs.microsoft.com/visualstudio/msbuild/property-functions).  
