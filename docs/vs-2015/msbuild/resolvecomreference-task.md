...
ms.locfileid: "47508150"
---
# <a name="resolvecomreference-task"></a>ResolveComReference, tâche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [ResolveCOMReference, tâche](https://docs.microsoft.com/visualstudio/msbuild/resolvecomreference-task).  
