...
ms.locfileid: "47506198"
---
# <a name="calltarget-task"></a>CallTarget, tâche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [CallTarget, tâche](https://docs.microsoft.com/visualstudio/msbuild/calltarget-task).  
