...
ms.locfileid: "47493600"
---
# <a name="warning-task"></a>Warning, tâche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Warning, tâche](https://docs.microsoft.com/visualstudio/msbuild/warning-task).  
