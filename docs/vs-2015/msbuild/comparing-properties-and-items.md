...
ms.locfileid: "47496357"
---
# <a name="comparing-properties-and-items"></a>Comparaison des propriétés et des éléments
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [comparant les propriétés et les éléments](https://docs.microsoft.com/visualstudio/msbuild/comparing-properties-and-items).  
