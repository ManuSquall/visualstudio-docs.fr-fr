...
ms.locfileid: "47506212"
---
# <a name="msbuild-conditions"></a>Conditions MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Conditions MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-conditions).  
