...
ms.locfileid: "47516471"
---
# <a name="unregisterassembly-task"></a>UnregisterAssembly, tâche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [UnregisterAssembly, tâche](https://docs.microsoft.com/visualstudio/msbuild/unregisterassembly-task).  
