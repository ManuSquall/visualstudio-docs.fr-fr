...
Vous trouverez la dernière version de cette rubrique dans [Comment : afficher une liste d’éléments séparés par des virgules](https://docs.microsoft.com/visualstudio/msbuild/how-to-display-an-item-list-separated-with-commas).  
