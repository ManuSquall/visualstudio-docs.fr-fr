...
ms.locfileid: "47504981"
---
# <a name="tooltaskextension-base-class"></a>Classe de base ToolTaskExtension
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [une classe de Base ToolTaskExtension](https://docs.microsoft.com/visualstudio/msbuild/tooltaskextension-base-class).  
