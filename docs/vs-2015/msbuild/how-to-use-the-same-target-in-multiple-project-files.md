...
Vous trouverez la dernière version de cette rubrique dans [Comment : utiliser la même cible dans plusieurs fichiers projet](https://docs.microsoft.com/visualstudio/msbuild/how-to-use-the-same-target-in-multiple-project-files).  
