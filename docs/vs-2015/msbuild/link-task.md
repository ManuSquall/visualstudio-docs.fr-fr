...
- **AdditionalDependencies**  
   ...
   Pour plus d’informations, consultez l’article [Fichiers d’entrée LINK](https://msdn.microsoft.com/library/bb26fcc5-509a-4620-bc3e-b6c6e603a412).  
...
- **AddModuleNamesToAssembly**  
   ...
   Pour plus d’informations, consultez l’article [/ASSEMBLYMODULE (Ajouter un module MSIL à l’assembly)](https://msdn.microsoft.com/library/67357da8-e4b6-49fd-932c-329a5777f143).  
...
- **DelayLoadDLLs**  
   ...
   Pour plus d’informations, consultez l’article [/DELAYLOAD (Différer le chargement de l’importation)](https://msdn.microsoft.com/library/39ea0f1e-5c01-450f-9c75-2d9761ff9b28).  
...
- **DelaySign**  
   ...
   Pour plus d’informations, consultez l’article [/DELAYSIGN (Signer partiellement un assembly)](https://msdn.microsoft.com/library/15244d30-3ecb-492f-a408-ffe81f38de20).  
...
- **ForceSymbolReferences**  
   ...
   Pour plus d’informations, consultez l’article [/INCLUDE (Forcer les références des symboles)](https://msdn.microsoft.com/library/4a039677-360a-480f-bd0b-448e239b449c).  
...
- **GenerateManifest**  
   ...
   Pour plus d’informations, consultez l’article [/MANIFEST (Créer un manifeste d’assembly côte à côte)](https://msdn.microsoft.com/library/98c52e1e-712c-4f49-b149-4d0a3501b600).  
...
- **HeapCommitSize**  
   ...
   Pour plus d’informations, consultez l’argument `commit` dans l’article [/HEAP (Définir la taille des tas)](https://msdn.microsoft.com/library/a3f71927-7f1d-492c-9fdb-dfccb1a043da). Reportez-vous également au paramètre **HeapReserveSize**.  
...
- **HeapReserveSize**  
   ...
   Pour plus d’informations, consultez l’argument `reserve` dans l’article [/HEAP (Définir la taille des tas)](https://msdn.microsoft.com/library/a3f71927-7f1d-492c-9fdb-dfccb1a043da). Reportez-vous également au paramètre **HeapCommitSize** dans ce tableau.  
...
- **IgnoreAllDefaultLibraries**  
   ...
   Pour plus d’informations, consultez l’article [/NODEFAULTLIB (Ignorer les bibliothèques)](https://msdn.microsoft.com/library/7270b673-6711-468e-97a7-c2925ac2be6e).  
...
- **IgnoreEmbeddedIDL**  
   ...
   Pour plus d’informations, consultez l’article [/IGNOREIDL (Ne pas traiter les attributs dans MIDL)](https://msdn.microsoft.com/library/29514098-6a1c-4317-af2f-1dc268972780).  
...
- **LargeAddressAware**  
   ...
   Pour plus d’informations, consultez l’article [/LARGEADDRESSAWARE (Gérer les longues adresses)](https://msdn.microsoft.com/library/a29756c8-e893-47a9-9750-1f0d25359385).  
...
- **LinkIncremental**  
   ...
   Pour plus d’informations, consultez l’article [/INCREMENTAL (Lier par incrément)](https://msdn.microsoft.com/library/135656ff-94fa-4ad4-a613-22e1a2a5d16b).  
...
- **LinkTimeCodeGeneration**  
  ...
  - **PGUpdate**  
    ...
    Pour plus d’informations, consultez l’article [LTCG (Génération de code durant l’édition de liens)](https://msdn.microsoft.com/library/788c6f52-fdb8-40c2-90af-4026ea2cf2e2).  
...
- **Profile**  
   ...
   Pour plus d’informations, consultez l’article [/PROFILE (Profileur des outils d’analyse des performances)](https://msdn.microsoft.com/library/e676baa1-5063-47a3-a357-ba0d1f0d1699).  
...
- **ProfileGuidedDatabase**  
   ...
   Pour plus d’informations, consultez l’article [/PGD (Spécifier la base de données pour les optimisations guidées par profil)](https://msdn.microsoft.com/library/9f312498-493b-461f-886f-92652257e443).  
...
- **ProgramDatabaseFile**  
   ...
   Pour plus d’informations, consultez l’article [/PDB (Utiliser la base de données du programme)](https://msdn.microsoft.com/library/d23db0ce-10cb-427a-bc60-d6b2a852723d).  
...
- **SectionAlignment**  
   ...
   Pour plus d’informations, consultez l’article [/ALIGN (Alignement des sections)](https://msdn.microsoft.com/library/f2f8ac24-e90e-4bea-8205-f2960a3b1740).  
...
- **StackCommitSize**  
   ...
   Pour plus d’informations, consultez l’argument `commit` dans l’article [/STACK (Allocations de la pile)](https://msdn.microsoft.com/library/73283660-e4bd-47cc-b5ca-04c5d739034c).  
...
- **StackReserveSize**  
   ...
   Pour plus d’informations, consultez l’argument `reserve` dans l’article [/STACK (Allocations de la pile)](https://msdn.microsoft.com/library/73283660-e4bd-47cc-b5ca-04c5d739034c).  
...
- **SuppressStartupBanner**  
   ...
   Pour plus d’informations, consultez l’article [/NOLOGO (Suppression de la bannière de démarrage) (Éditeur de liens)](https://msdn.microsoft.com/library/3b20dddd-eca6-4545-a331-9f70bf720197).  
...
- **TreatLinkerWarningAsErrors**  
   ...
   Pour plus d’informations, consultez l’article [/WX (Traiter les avertissements de l’Éditeur de liens comme des erreurs)](https://msdn.microsoft.com/library/e4ba97c7-93f7-43ae-a4bb-d866790926c9).  
...
- **TypeLibraryFile**  
   ...
   Pour plus d’informations, consultez l’article [/TLBOUT (Nommer le fichier .TLB)](https://msdn.microsoft.com/library/0df6d078-2e48-46c9-a1a5-02674d85dce8).  
