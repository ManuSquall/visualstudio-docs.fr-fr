...
ms.locfileid: "47493969"
---
# <a name="importgroup-element"></a>Élément ImportGroup
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [ImportGroup élément](https://docs.microsoft.com/visualstudio/msbuild/importgroup-element).  
