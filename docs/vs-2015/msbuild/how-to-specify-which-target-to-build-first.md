...
ms.locfileid: "47505707"
---
# <a name="how-to-specify-which-target-to-build-first"></a>Comment : spécifier la cible à générer en premier
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Comment : spécifier la cible à générer en premier](https://docs.microsoft.com/visualstudio/msbuild/how-to-specify-which-target-to-build-first).  
