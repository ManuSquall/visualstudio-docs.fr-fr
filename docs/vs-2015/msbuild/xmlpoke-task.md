...
ms.locfileid: "47501657"
---
# <a name="xmlpoke-task"></a>Tâche XmlPoke
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [XmlPoke, tâche](https://docs.microsoft.com/visualstudio/msbuild/xmlpoke-task).  
