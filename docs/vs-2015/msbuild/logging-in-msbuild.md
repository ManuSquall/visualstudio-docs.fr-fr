...
ms.locfileid: "47506837"
---
# <a name="logging-in-msbuild"></a>Journalisation dans MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [journalisation dans MSBuild](https://docs.microsoft.com/visualstudio/msbuild/logging-in-msbuild).  
