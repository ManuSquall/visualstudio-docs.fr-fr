...
ms.locfileid: "47508828"
---
# <a name="msbuild-targets-files"></a>Fichiers .Targets MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [MSBuild. Fichiers cibles](https://docs.microsoft.com/visualstudio/msbuild/msbuild-dot-targets-files).  
