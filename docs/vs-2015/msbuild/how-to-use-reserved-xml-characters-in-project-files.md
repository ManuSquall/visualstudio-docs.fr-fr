...
Vous trouverez la dernière version de cette rubrique dans [Comment : utiliser des caractères XML réservés dans les fichiers projet](https://docs.microsoft.com/visualstudio/msbuild/how-to-use-reserved-xml-characters-in-project-files).  
