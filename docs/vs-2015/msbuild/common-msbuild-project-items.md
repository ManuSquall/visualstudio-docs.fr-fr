...
ms.locfileid: "47502242"
---
# <a name="common-msbuild-project-items"></a>Éléments communs des projets MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [éléments communs des projets MSBuild](https://docs.microsoft.com/visualstudio/msbuild/common-msbuild-project-items).  
