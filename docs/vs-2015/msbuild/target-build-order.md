...
ms.locfileid: "47504832"
---
# <a name="target-build-order"></a>Ordre de génération des cibles
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [ordre de génération des cibles](https://docs.microsoft.com/visualstudio/msbuild/target-build-order).  
