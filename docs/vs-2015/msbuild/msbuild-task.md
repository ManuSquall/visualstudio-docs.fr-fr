...
ms.locfileid: "47503030"
---
# <a name="msbuild-task"></a>MSBuild, tâche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [tâche MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-task).  
