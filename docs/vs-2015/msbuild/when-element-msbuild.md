...
ms.locfileid: "47495994"
---
# <a name="when-element-msbuild"></a>When, élément (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [élément When (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/when-element-msbuild).  
