...
ms.locfileid: "47502630"
---
# <a name="item-element-msbuild"></a>Item, élément (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [Item, élément (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/item-element-msbuild).  
