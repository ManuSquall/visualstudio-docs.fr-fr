...
ms.locfileid: "47508075"
---
# <a name="writecodefragment-task"></a>Tâche WriteCodeFragment
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [WriteCodeFragment, tâche](https://docs.microsoft.com/visualstudio/msbuild/writecodefragment-task).  
