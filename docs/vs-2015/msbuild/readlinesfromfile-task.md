...
ms.locfileid: "47503028"
---
# <a name="readlinesfromfile-task"></a>ReadLinesFromFile, tâche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [ReadLinesFromFile, tâche](https://docs.microsoft.com/visualstudio/msbuild/readlinesfromfile-task).  
