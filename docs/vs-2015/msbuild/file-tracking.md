...
ms.locfileid: "47495293"
---
# <a name="file-tracking"></a>Suivi de fichier
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [le suivi des fichiers](https://docs.microsoft.com/visualstudio/msbuild/file-tracking).  
