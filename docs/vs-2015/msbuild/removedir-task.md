...
ms.locfileid: "47508712"
---
# <a name="removedir-task"></a>RemoveDir, tâche
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [RemoveDir, tâche](https://docs.microsoft.com/visualstudio/msbuild/removedir-task).  
