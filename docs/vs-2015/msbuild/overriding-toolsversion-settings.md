...
ms.locfileid: "47505099"
---
# <a name="overriding-toolsversion-settings"></a>Substitution des paramètres ToolsVersion
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [substitution des paramètres ToolsVersion](https://docs.microsoft.com/visualstudio/msbuild/overriding-toolsversion-settings).  
