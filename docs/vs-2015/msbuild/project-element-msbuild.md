...
|        `Xmlns`         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 Attribut Required (dans MSBuild 15. x et versions antérieures).<br /><br /> L’attribut `xmlns` doit avoir la valeur de `http://schemas.microsoft.com/developer/msbuild/2003`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
