...
Vous trouverez la dernière version de cette rubrique dans [CA1710 : les identificateurs doivent avoir un suffixe correct](https://docs.microsoft.com/visualstudio/code-quality/ca1710-identifiers-should-have-correct-suffix).
