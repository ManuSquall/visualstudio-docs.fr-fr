...
Vous trouverez la dernière version de cette rubrique dans [CA1058 : les Types ne doivent pas étendre certains types de base](https://docs.microsoft.com/visualstudio/code-quality/ca1058-types-should-not-extend-certain-base-types).
