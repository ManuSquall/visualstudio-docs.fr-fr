...
## <a name="rule-description"></a>Description de la règle
 Pour [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] version 1, il était recommandé de dériver de nouvelles exceptions à partir de <xref:System.ApplicationException>. La recommandation a changé et les nouvelles exceptions doivent dériver de <xref:System.Exception?displayProperty=fullName> ou de l’une de ses sous-classes dans l’espace de noms <xref:System>.
