...
Vous trouverez la dernière version de cette rubrique dans [CA1000 : ne déclarez pas de membres statiques sur les types génériques](https://docs.microsoft.com/visualstudio/code-quality/ca1000-do-not-declare-static-members-on-generic-types).
