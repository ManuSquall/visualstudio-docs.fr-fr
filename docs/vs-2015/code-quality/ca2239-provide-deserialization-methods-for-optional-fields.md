...
## <a name="cause"></a>Cause
 Un type a un champ qui est marqué avec l’attribut <xref:System.Runtime.Serialization.OptionalFieldAttribute?displayProperty=fullName> et le type ne fournit pas de méthodes de gestion des événements de désérialisation.
