...
ms.locfileid: "68740210"
---
# <a name="c6277"></a>C6277
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

AVERTISSEMENT C6277: Nom d’application null avec un chemin d’accès sans guillemets \<dans l’appel à la fonction >: entraîne une faille de sécurité si le chemin d’accès contient des espaces  
