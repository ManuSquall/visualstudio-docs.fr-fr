...
Vous trouverez la dernière version de cette rubrique dans [CA1049 : les Types qui possèdent des ressources natives doivent être supprimables](https://docs.microsoft.com/visualstudio/code-quality/ca1049-types-that-own-native-resources-should-be-disposable).
