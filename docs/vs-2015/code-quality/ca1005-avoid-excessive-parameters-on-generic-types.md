...
Vous trouverez la dernière version de cette rubrique dans [CA1005 : éviter les paramètres excessifs sur les types génériques](https://docs.microsoft.com/visualstudio/code-quality/ca1005-avoid-excessive-parameters-on-generic-types).
