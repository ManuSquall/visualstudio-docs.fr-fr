...
ms.locfileid: "47588131"
---
# <a name="ca1021-avoid-out-parameters"></a>CA1021 : Éviter les paramètres out
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [CA1021 : éviter les paramètres out](https://docs.microsoft.com/visualstudio/code-quality/ca1021-avoid-out-parameters).
