...
Vous trouverez la dernière version de cette rubrique dans [CA2243 : littéraux de chaîne d’attribut doivent être analysés correctement](https://docs.microsoft.com/visualstudio/code-quality/ca2243-attribute-string-literals-should-parse-correctly).
