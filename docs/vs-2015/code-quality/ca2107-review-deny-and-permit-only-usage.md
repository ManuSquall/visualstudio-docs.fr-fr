...
Vous trouverez la dernière version de cette rubrique dans [CA2107 : révision refuser et autoriser uniquement l’utilisation](https://docs.microsoft.com/visualstudio/code-quality/ca2107-review-deny-and-permit-only-usage).
