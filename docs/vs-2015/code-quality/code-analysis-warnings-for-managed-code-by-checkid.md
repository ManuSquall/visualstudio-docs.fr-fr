...
Vous trouverez la dernière version de cette rubrique dans [avertissements d’analyse du Code pour le Code managé par CheckId](https://docs.microsoft.com/visualstudio/code-quality/code-analysis-warnings-for-managed-code-by-checkid).  
