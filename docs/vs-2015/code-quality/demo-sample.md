...
ms.locfileid: "47493408"
---
# <a name="demo-sample"></a>Exemple de démonstration
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [exemple de démonstration](https://docs.microsoft.com/visualstudio/code-quality/demo-sample).  
