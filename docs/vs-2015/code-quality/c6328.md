...
```  
 ...
 `c` serait de signe étendu à signé `int` avec la valeur -37, qui est en dehors de la plage valide pour [isspace](https://msdn.microsoft.com/library/3ac254c4-92aa-4238-882a-3a3fb576cdf5).  
