...
Vous trouverez la dernière version de cette rubrique dans [CA2228 : ne sont pas fournies de formats de ressources non commercialisés](https://docs.microsoft.com/visualstudio/code-quality/ca2228-do-not-ship-unreleased-resource-formats).
