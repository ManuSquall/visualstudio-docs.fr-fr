...
Vous trouverez la dernière version de cette rubrique dans [CA2115 : appelez le GC. KeepAlive lors de l’utilisation des ressources natives](https://docs.microsoft.com/visualstudio/code-quality/ca2115-call-gc-keepalive-when-using-native-resources).
