...
Vous trouverez la dernière version de cette rubrique dans [CA2126 : les demandes de liaison de Type nécessitent des demandes d’héritage](https://docs.microsoft.com/visualstudio/code-quality/ca2126-type-link-demands-require-inheritance-demands).
