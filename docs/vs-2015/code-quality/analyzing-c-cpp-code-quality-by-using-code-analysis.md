...
|[Guide pratique pour Définir les propriétés d’analyse de Code pour les projets C/C++](../code-quality/how-to-set-code-analysis-properties-for-c-cpp-projects.md)|Décrit les paramètres de configuration pour l’analyse du code.|  
|[Guide pratique pour Spécifier des informations de code supplémentaires en utilisant __analysis_assume](../code-quality/how-to-specify-additional-code-information-by-using-analysis-assume.md)|Découvrez comment utiliser `__analysis_assume` afin d’améliorer l’analyse du code.|  
