...
Vous trouverez la dernière version de cette rubrique dans [CA2104 : ne déclarez pas les types référence mutables uniquement en lecture](https://docs.microsoft.com/visualstudio/code-quality/ca2104-do-not-declare-read-only-mutable-reference-types).
