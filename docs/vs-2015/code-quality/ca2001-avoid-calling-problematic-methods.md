...
Vous trouverez la dernière version de cette rubrique dans [CA2001 : Évitez d’appeler des méthodes](https://docs.microsoft.com/visualstudio/code-quality/ca2001-avoid-calling-problematic-methods).
