...
|Méthode|Description|
|------------|-----------------|
|<xref:System.GC.Collect%2A?displayProperty=fullName>|Appel de GC. La collecte peut affecter de manière significative les performances de l’application et est rarement nécessaire. Pour plus d’informations, consultez l’entrée de blog [performance morceaux de Rico Mariani](http://go.microsoft.com/fwlink/?LinkId=169256) sur MSDN.|
...
|<xref:System.Reflection.Assembly.LoadFrom%2A?displayProperty=fullName><br /><br /> <xref:System.Reflection.Assembly.LoadFile%2A?displayProperty=fullName><br /><br /> <xref:System.Reflection.Assembly.LoadWithPartialName%2A?displayProperty=fullName>|Ces méthodes peuvent charger des assemblys à partir d’emplacements inattendus. Par exemple, consultez le blog .NET CLR notes de Suzanne Cook et les publications de l’article [LoadFile](http://go.microsoft.com/fwlink/?LinkId=164450) et du site Web MSDN pour obtenir des informations sur les méthodes de [chargement des assemblys](http://go.microsoft.com/fwlink/?LinkId=164451) .|
