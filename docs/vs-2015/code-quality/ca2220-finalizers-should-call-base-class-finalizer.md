...
Vous trouverez la dernière version de cette rubrique dans [CA2220 : les finaliseurs doivent appeler le finaliseur de la classe de base](https://docs.microsoft.com/visualstudio/code-quality/ca2220-finalizers-should-call-base-class-finalizer).
