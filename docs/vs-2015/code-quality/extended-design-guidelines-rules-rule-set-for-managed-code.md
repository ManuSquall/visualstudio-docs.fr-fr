...
Vous trouverez la dernière version de cette rubrique dans [règle de règles de conception étendue définie pour le code managé](https://docs.microsoft.com/visualstudio/code-quality/extended-design-guidelines-rules-rule-set-for-managed-code).  
...
|[CA1000](../code-quality/ca1000-do-not-declare-static-members-on-generic-types.md)|Ne déclarez pas de membres statiques sur les types génériques|  
|[CA1002](../code-quality/ca1002-do-not-expose-generic-lists.md)|N’exposez pas de listes génériques|  
|[CA1003](../code-quality/ca1003-use-generic-event-handler-instances.md)|Utiliser des instances du Gestionnaire d’événements génériques|  
...
|[CA1007](../code-quality/ca1007-use-generics-where-appropriate.md)|Utiliser des classes génériques le cas échéant|  
|[CA1008](../code-quality/ca1008-enums-should-have-zero-value.md)|Les enums doivent avoir la valeur zéro|  
|[CA1010](../code-quality/ca1010-collections-should-implement-generic-interface.md)|Collections doivent implémenter l’interface générique|  
|[CA1011](../code-quality/ca1011-consider-passing-base-types-as-parameters.md)|Envisagez de passer les types de base en tant que paramètres|  
|[CA1012](../code-quality/ca1012-abstract-types-should-not-have-constructors.md)|Types abstraits ne doivent pas avoir de constructeurs|  
...
|[CA1024](../code-quality/ca1024-use-properties-where-appropriate.md)|Utiliser des propriétés lorsque nécessaire|  
...
|[CA1026](../code-quality/ca1026-default-parameters-should-not-be-used.md)|Paramètres par défaut ne doivent pas être utilisés.|  
...
|[CA1030](../code-quality/ca1030-use-events-where-appropriate.md)|Utiliser des événements appropriés|  
...
|[CA1047](../code-quality/ca1047-do-not-declare-protected-members-in-sealed-types.md)|Ne déclarez pas de membres protégés dans les types sealed|  
|[CA1048](../code-quality/ca1048-do-not-declare-virtual-members-in-sealed-types.md)|Ne déclarez pas de membres virtuels dans les types sealed|  
|[CA1050](../code-quality/ca1050-declare-types-in-namespaces.md)|Déclarez les types dans les espaces de noms|  
|[CA1051](../code-quality/ca1051-do-not-declare-visible-instance-fields.md)|Ne déclarez pas de champs d’instances visibles|  
...
|[CA1058](../code-quality/ca1058-types-should-not-extend-certain-base-types.md)|Types ne doivent pas étendre certains types de base|  
|[CA1059](../code-quality/ca1059-members-should-not-expose-certain-concrete-types.md)|Membres ne doivent pas exposer certains types concrets|  
...
|[CA1708](../code-quality/ca1708-identifiers-should-differ-by-more-than-case.md)|Les identificateurs doivent différer par leur casse|  
...
|[CA1810](../code-quality/ca1810-initialize-reference-type-static-fields-inline.md)|Initialiser des champs statiques de type référence en ligne|  
|[CA1811](../code-quality/ca1811-avoid-uncalled-private-code.md)|Évitez le recours à code privé non appelé|  
...
|[CA1814](../code-quality/ca1814-prefer-jagged-arrays-over-multidimensional.md)|Préférer les tableaux en escalier multidimensionnel|  
|[CA1815](../code-quality/ca1815-override-equals-and-operator-equals-on-value-types.md)|Remplacez equals et l’opérateur est égal à dans les types valeur|  
...
|[CA1707](../code-quality/ca1707-identifiers-should-not-contain-underscores.md)|Identificateurs ne doivent pas contenir de traits de soulignement|  
|[CA1709](../code-quality/ca1709-identifiers-should-be-cased-correctly.md)|Identificateurs doivent être correcte|  
|[CA1710](../code-quality/ca1710-identifiers-should-have-correct-suffix.md)|Les identificateurs doivent avoir un suffixe correct|  
...
|[CA1712](../code-quality/ca1712-do-not-prefix-enum-values-with-type-name.md)|N’ajoutez pas de valeurs d’énumération avec le nom de type préfixe|  
|[CA1713](../code-quality/ca1713-events-should-not-have-before-or-after-prefix.md)|Événements ne doivent pas être préfixe before ou after|  
|[CA1714](../code-quality/ca1714-flags-enums-should-have-plural-names.md)|Énumérations d’indicateurs doivent avoir des noms au pluriel|  
|[CA1715](../code-quality/ca1715-identifiers-should-have-correct-prefix.md)|Les identificateurs doivent avoir un préfixe correct|  
...
|[CA1719](../code-quality/ca1719-parameter-names-should-not-match-member-names.md)|Noms de paramètres ne doivent pas correspondre aux noms de membres|  
|[CA1720](../code-quality/ca1720-identifiers-should-not-contain-type-names.md)|Identificateurs ne doivent pas contenir les noms de types|  
|[CA1721](../code-quality/ca1721-property-names-should-not-match-get-methods.md)|Noms de propriétés ne doivent pas correspondre à des méthodes get|  
...
|[CA1725](../code-quality/ca1725-parameter-names-should-match-base-declaration.md)|Les noms de paramètre doivent correspondre à la déclaration de base|  
|[CA1726](../code-quality/ca1726-use-preferred-terms.md)|Utilisez les termes préférés|  
