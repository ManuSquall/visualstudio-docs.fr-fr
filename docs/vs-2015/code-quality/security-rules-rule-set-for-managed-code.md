...
ms.locfileid: "72605425"
---
# <a name="security-rules-rule-set-for-managed-code"></a>Ensemble de règles des règles de sécurité pour le code managé
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous devez inclure l’ensemble de règles des règles de sécurité Microsoft pour maximiser le nombre de problèmes de sécurité potentiels signalés.
