...
Vous trouverez la dernière version de cette rubrique dans [CA1414 : marquer les arguments P-Invoke booléens comme MarshalAs](https://docs.microsoft.com/visualstudio/code-quality/ca1414-mark-boolean-p-invoke-arguments-with-marshalas).
