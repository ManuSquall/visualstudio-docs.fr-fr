...
Vous trouverez la dernière version de cette rubrique dans [CA1408 : ne pas utiliser AutoDual ClassInterfaceType](https://docs.microsoft.com/visualstudio/code-quality/ca1408-do-not-use-autodual-classinterfacetype).
