...
Vous trouverez la dernière version de cette rubrique dans [CA2204 : les littéraux doivent être correctement orthographiés](https://docs.microsoft.com/visualstudio/code-quality/ca2204-literals-should-be-spelled-correctly).
