...
Vous trouverez la dernière version de cette rubrique dans [CA1032 : implémenter des constructeurs d’exception standard](https://docs.microsoft.com/visualstudio/code-quality/ca1032-implement-standard-exception-constructors).
