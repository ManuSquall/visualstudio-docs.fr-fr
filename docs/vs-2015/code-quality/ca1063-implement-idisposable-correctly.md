...
- Supprimez IDisposable de la liste des interfaces implémentées par {0} et substituez l’implémentation dispose de la classe de base à la place.
...
- Renommez {0} en’dispose’et assurez-vous qu’il est déclaré comme public et sealed.
