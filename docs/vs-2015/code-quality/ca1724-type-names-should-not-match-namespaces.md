...
Vous trouverez la dernière version de cette rubrique dans [CA1724 : Type de noms de doit pas correspondance espaces de noms](https://docs.microsoft.com/visualstudio/code-quality/ca1724-type-names-should-not-match-namespaces).
