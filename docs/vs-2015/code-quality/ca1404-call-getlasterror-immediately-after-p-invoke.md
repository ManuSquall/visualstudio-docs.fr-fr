...
Vous trouverez la dernière version de cette rubrique dans [CA1404 : appeler des GetLastError immédiatement après P-Invoke](https://docs.microsoft.com/visualstudio/code-quality/ca1404-call-getlasterror-immediately-after-p-invoke).
