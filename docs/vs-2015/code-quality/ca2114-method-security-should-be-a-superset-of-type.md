...
Vous trouverez la dernière version de cette rubrique dans [CA2114 : sécurité de la méthode doit être un sur-ensemble du type](https://docs.microsoft.com/visualstudio/code-quality/ca2114-method-security-should-be-a-superset-of-type).
