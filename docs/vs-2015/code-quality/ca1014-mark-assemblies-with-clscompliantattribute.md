...
## <a name="see-also"></a>Voir aussi
 [indépendance du langage <xref:System.CLSCompliantAttribute?displayProperty=fullName> et composants indépendants du langage](https://msdn.microsoft.com/library/4f0b77d0-4844-464f-af73-6e06bedeafc6)
