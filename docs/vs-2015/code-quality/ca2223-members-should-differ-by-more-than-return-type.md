...
## <a name="example"></a>Exemple
 L’exemple suivant, en langage MSIL (Microsoft Intermediate Language), affiche un type qui viole cette règle. Notez que cette règle ne peut pas être violée à l’aide de C# ou de Visual Basic .NET.
