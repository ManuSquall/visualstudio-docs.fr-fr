...
Vous trouverez la dernière version de cette rubrique dans [CA1302 : ne pas coder en dur les chaînes de spécifiques de paramètres régionaux](https://docs.microsoft.com/visualstudio/code-quality/ca1302-do-not-hardcode-locale-specific-strings).
