...
Pour obtenir la dernière documentation sur Visual Studio, consultez [CA1709 : Identificateurs doivent être correcte](https://docs.microsoft.com/visualstudio/code-quality/ca1709-identifiers-should-be-cased-correctly).  
