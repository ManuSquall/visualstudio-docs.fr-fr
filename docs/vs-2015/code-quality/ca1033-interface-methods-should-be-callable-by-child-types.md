...
Vous trouverez la dernière version de cette rubrique dans [CA1033 : les méthodes d’Interface doivent pouvoir être appelées par les types enfants](https://docs.microsoft.com/visualstudio/code-quality/ca1033-interface-methods-should-be-callable-by-child-types).
