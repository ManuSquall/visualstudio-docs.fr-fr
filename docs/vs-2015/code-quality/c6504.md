...
avertissement C6504 : annotation non valide : propriété peut uniquement être employée dans des valeurs de type pointeur, pointeur vers membre ou tableau  
 ...
 Cet avertissement indique l’utilisation d’une propriété sur un type de données incompatible. Pour plus d’informations sur les types de données pris en charge par les propriétés, consultez [propriétés de l’Annotation](https://msdn.microsoft.com/f77b4370-6bda-4294-bd2a-e7d0df182a3d).  
