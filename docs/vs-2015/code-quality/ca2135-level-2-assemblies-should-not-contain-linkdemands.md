...
Vous trouverez la dernière version de cette rubrique dans [CA2135 : les assemblys de niveau 2 ne doivent pas contenir de LinkDemands](https://docs.microsoft.com/visualstudio/code-quality/ca2135-level-2-assemblies-should-not-contain-linkdemands).
