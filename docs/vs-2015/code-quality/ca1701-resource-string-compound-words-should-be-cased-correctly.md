...
Vous trouverez la dernière version de cette rubrique dans [CA1701 : mots composés de chaînes de ressources doivent être correcte](https://docs.microsoft.com/visualstudio/code-quality/ca1701-resource-string-compound-words-should-be-cased-correctly).
