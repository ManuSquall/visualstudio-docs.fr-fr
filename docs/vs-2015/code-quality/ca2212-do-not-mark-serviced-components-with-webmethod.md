...
Vous trouverez la dernière version de cette rubrique dans [CA2212 : ne marquez pas les composants pris en charge avec WebMethod](https://docs.microsoft.com/visualstudio/code-quality/ca2212-do-not-mark-serviced-components-with-webmethod).
