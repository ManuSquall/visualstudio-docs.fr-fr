...
ms.locfileid: "47589538"
---
# <a name="ca1800-do-not-cast-unnecessarily"></a>CA1800 : N'effectuez pas de cast inutilement
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Vous trouverez la dernière version de cette rubrique dans [CA1800 : n’effectuez pas de cast inutilement](https://docs.microsoft.com/visualstudio/code-quality/ca1800-do-not-cast-unnecessarily).
