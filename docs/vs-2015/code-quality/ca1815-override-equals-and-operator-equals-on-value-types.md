...
Vous trouverez la dernière version de cette rubrique dans [CA1815 : Remplacez equals et l’opérateur est égal à dans les types valeur](https://docs.microsoft.com/visualstudio/code-quality/ca1815-override-equals-and-operator-equals-on-value-types).
