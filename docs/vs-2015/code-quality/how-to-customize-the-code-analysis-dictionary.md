...
L’analyse du code utilise un dictionnaire intégré pour vérifier les identificateurs dans votre code à la recherche d’erreurs dans l’orthographe, la grammaire et d’autres conventions d’affectation des noms des directives de [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]. Vous pouvez créer un fichier XML de dictionnaire personnalisé pour ajouter, supprimer ou modifier des termes, des abréviations et des acronymes du dictionnaire intégré.
