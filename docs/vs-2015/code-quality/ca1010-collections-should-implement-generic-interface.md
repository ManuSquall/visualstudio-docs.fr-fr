...
Vous trouverez la dernière version de cette rubrique dans [CA1010 : les Collections doivent implémenter l’interface générique](https://docs.microsoft.com/visualstudio/code-quality/ca1010-collections-should-implement-generic-interface).
