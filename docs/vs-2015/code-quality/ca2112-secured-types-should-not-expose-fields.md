...
Vous trouverez la dernière version de cette rubrique dans [CA2112 : les types sécurisés ne doivent pas exposer de champs](https://docs.microsoft.com/visualstudio/code-quality/ca2112-secured-types-should-not-expose-fields).
