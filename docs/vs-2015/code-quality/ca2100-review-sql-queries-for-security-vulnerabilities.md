...
Vous trouverez la dernière version de cette rubrique dans [CA2100 : les requêtes SQL de la révision des vulnérabilités de sécurité](https://docs.microsoft.com/visualstudio/code-quality/ca2100-review-sql-queries-for-security-vulnerabilities).
