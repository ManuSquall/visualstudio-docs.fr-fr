...
```  
 ...
 Pour plus d’informations, consultez la [macro SUCCEEDED](https://go.microsoft.com/fwlink/?LinkId=92738) et l’échec de la [macro](https://go.microsoft.com/fwlink/?LinkId=180875)
