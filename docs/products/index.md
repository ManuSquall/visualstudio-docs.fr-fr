...
layout: HubPage
hide_bc: true
title: Produits Visual Studio | Microsoft Docs
...
<div id="main" class="v2">
    <div class="container">
                ...
                <ul id="products">
                    <li>
                        ...
                        <ul id="products1" class="cardsC cols cols3">
                            ...
                            <li>
                                <a href="/visualstudio/mac" title="Visual Studio pour Mac">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Intégration, livraison et étude en continu d’applications Android, iOS, Mac OS et Windows. Livrez des applications 5 étoiles de meilleure qualité plus rapidement et en toute confiance.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <a href="/visualstudio/subscriptions/" title="Abonnements Visual Studio">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Installez, mettez à niveau et gérez vos déploiements locaux.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <p>Visual Studio Team Services a été remplacé par Azure DevOps Services et Team Foundation Server (TFS) a été renommé Azure DevOps Server. Consultez <a href="/azure/devops/user-guide/what-happened-vsts?view=vsts">Qu’est-il arrivé à Visual Studio Team Services ?</a> et <a href="/tfs/server/tfs-is-now-azure-devops-server">Team Foundation Server est désormais Azure DevOps Server</a>.</p>
    </div>
</div>
