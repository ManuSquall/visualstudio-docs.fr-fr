...
Pour plus d’informations sur la personnalisation de l’éditeur, consultez la page [Personnaliser l’éditeur](../ide/customizing-the-editor.md). Pour connaître les options de l’éditeur propres à JavaScript, consultez la page [Options JavaScript de l’éditeur](../ide/reference/options-text-editor-javascript-formatting.md).
