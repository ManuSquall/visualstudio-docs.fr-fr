...
1.  [Applications mobiles dans Visual Studio avec Xamarin](https://visualstudio.microsoft.com/xamarin/) (visualstudio.com) fournit un récapitulatif des principales caractéristiques de Xamarin.
