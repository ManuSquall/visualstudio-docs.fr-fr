...
3.  **Émulateur Windows Phone de Microsoft.** Pour en savoir plus, consultez [Émulateur Windows Phone pour Windows Phone 8](../debugger/run-windows-phone-apps-in-the-emulator.md).  
