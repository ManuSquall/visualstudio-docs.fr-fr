...
-   Compte Xamarin. Accédez à [https://www.xamarin.com/](https://www.xamarin.com/), cliquez sur **Sign In** (Connexion) en haut à droite de la page, puis cliquez sur **Create a new account** (Créer un compte) dans la page qui s’affiche. Choisissez une adresse e-mail et un mot de passe pour votre compte Xamarin.
