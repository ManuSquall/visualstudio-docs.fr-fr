...
-   Dans l’application Terminal de votre Mac, entrez :  
 ...
 ![Utiliser vcremote pour générer un code PIN sécurisé](~/docs/cross-platform/media/cppmdd_vcremote_generateclientcert.png "CPPMDD_vcremote_generateClientCert")  
...
7.  Choisissez **Coupler** pour activer le jumelage.  
     ...
     ![Configurer la connexion vcremote pour les builds iOS](~/docs/cross-platform/media/cppmdd_options_ios.PNG "CPPMDD_Options_iOS")  
