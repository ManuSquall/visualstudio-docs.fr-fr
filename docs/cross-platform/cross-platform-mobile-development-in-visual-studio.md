...
##  <a name="NET"></a> Générer une application pour Android, iOS et Windows (.NET Framework)
 ![Appareils](~/docs/cross-platform/media/homedevices.png "HomeDevices")
...
####  <a name="ShareHTML"></a> Partager du code entre des appareils Android, iOS et Windows
 ...
 ![Partager du code entre les interfaces utilisateur Android, iOS et Windows](~/docs/cross-platform/media/sharecode.png "ShareCode")
...
###  <a name="WindowsHTML"></a> Cibler les appareils Windows 10
 ![Appareils Windows](~/docs/cross-platform/media/windowsdevices.png "WindowsDevices")
...
##  <a name="HTML"></a> Générer une application pour Android, iOS et Windows (HTML/JavaScript)
 ...
 ![Multi&#45;Device Hybrid Apps](~/docs/cross-platform/media/multidevicehybridapps.png "MultiDeviceHybridApps")
...
##  <a name="CPP"></a> Générer une application pour Android et Windows (C++)
 ![Utiliser C&#43;&#43; pour générer des applications pour Android, iOS, et Windows](~/docs/cross-platform/media/cross_plat_cpp_intro_image.png "Cross_Plat_CPP_Intro_Image")
 ...
 ![Modèle de projet d’activité native](~/docs/cross-platform/media/cross-plat_cpp_native.png "Cross-Plat_CPP_Native")
 ...
 ![Bibliothèques partagées statiques et dynamiques](~/docs/cross-platform/media/cross_plat_cpp_libraries.png "Cross_Plat_CPP_Libraries")
...
##  <a name="Unity"></a> Créer un jeu multiplateforme pour Android, iOS et Windows à l’aide de Visual Studio Tools pour Unity
 ...
 ![Environnement de développement VSTU](~/docs/cross-platform/media/vstu_overview.png "VSTU_Overview")
