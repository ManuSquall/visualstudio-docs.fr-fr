...
-   Version 64 bits de Windows 8 Professionnel, Windows 8.1 Professionnel, Windows 10 Professionnel ou version ultérieure  
 ...
 ![Vérifier la configuration requise](~/docs/cross-platform/media/android_emu_system_requirements.png "Android_Emu_System_Requirements")  
...
>  Une fois que vous avez rejoint le groupe, déconnectez-vous ou redémarrez l’ordinateur pour que la modification prenne effet.  
 ...
 ![Entrée dans le groupe de sécurité Administrateurs Hyper&#45;V](~/docs/cross-platform/media/android_emu_hyperv_admin.png "Android_Emu_HyperV_Admin")  
