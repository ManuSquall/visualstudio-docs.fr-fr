---
title: "Configuration syst&#232;me requise pour l&#39;&#233;mulateur Visual Studio pour Android | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
-   Version 64 bits de Windows 8 Professionnel, Windows 8.1 Professionnel, Windows 10 Professionnel ou version ultérieure  
 ...
 ![Vérifier la configuration système requise](../cross-platform/media/android_emu_system_requirements.png "Android\_Emu\_System\_Requirements")  
...
>  Une fois que vous avez rejoint le groupe, déconnectez\-vous ou redémarrez l’ordinateur pour que la modification prenne effet.  
 ...
 ![Entrée dans le groupe de sécurité Administrateurs Hyper&#45;V](../cross-platform/media/android_emu_hyperv_admin.png "Android\_Emu\_HyperV\_Admin")  
...
##  <a name="BootableVHD"></a> L’exécution de l’émulateur à partir d’un disque dur virtuel démarrable n’est pas prise en charge  
 ...
 Cette configuration n’est pas prise en charge. Pour plus d’informations sur les problèmes connexes, consultez [Dépannage de l'émulateur Visual Studio pour Android](../cross-platform/troubleshooting-the-visual-studio-emulator-for-android.md).  
...
## Configuration requise relative au transfert graphique matériel \(prise en charge d’OpenGL ES\)  
