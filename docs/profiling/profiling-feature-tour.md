...
![Fenêtre Outils de diagnostic](~/docs/profiling/media/prof-tour-diagnostic-tools.png "Outils de diagnostic")
...
![Vue Résumé des outils de diagnostic](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Résumé des outils de diagnostic")
...
![Activer l’utilisation de l’UC dans les Outils de diagnostic](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Outils de diagnostic - Activer l’utilisation de l’UC")
...
![Vue Utilisation de l’UC dans les Outils de diagnostic](~/docs/profiling/media/prof-tour-cpu-usage.png "Utilisation de l’UC dans les Outils de diagnostic")
...
![Vue « papillon » fonctions appelantes/fonctions appelées dans les Outils de diagnostic](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Vue fonctions appelantes/fonctions appelées dans les Outils de diagnostic")
...
![Vue Événements dans les Outils de diagnostic](~/docs/profiling/media/prof-tour-events.png "Outils de diagnostic - Afficher les événements")
...
![Conseils sur les performances dans la visite guidée du profilage](~/docs/profiling/media/prof-tour-perf-tips.png "Conseils sur les performances dans la visite guidée du profilage")
...
![Afficher les événements d’analyse de l’IU dans les Outils de diagnostic](~/docs/profiling/media/prof-tour-ui-analysis.png "Outils de diagnostic - Afficher les événements d’analyse de l’IU")
...
![Profileur de performances](~/docs/profiling/media/prof-tour-performance-profiler.png "Profileur de performances")
...
![Outil de profilage - Chronologie de l’application](~/docs/profiling/media/prof-tour-application-timeline.gif "Chronologie de l’application dans la visite guidée du profilage")
...
![Outil de profilage - Utilisation du GPU](~/docs/profiling/media/prof-tour-gpu-usage.png "Boîte de dialogue Utilisation du GPU")
...
![Outil de profilage - Utilisation du réseau](~/docs/profiling/media/prof-tour-network-usage.png "Boîte de dialogue Utilisation du réseau")

Sélectionnez une opération dans la vue du résumé pour afficher des informations plus détaillées.

![Informations détaillées dans l’outil Utilisation du réseau](~/docs/profiling/media/prof-tour-network-usage-details.png "Boîte de dialogue Détails de l’utilisation du réseau")
...
![Outil Explorateur de performances](~/docs/profiling/media/prof-tour-performance-explorer.png "Explorateur de performances")
