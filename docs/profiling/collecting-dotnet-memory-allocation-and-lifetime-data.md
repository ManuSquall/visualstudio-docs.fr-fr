...
[Comment : choisir des méthodes de collecte](../profiling/how-to-choose-collection-methods.md)
des [Propriétés de session de performance](../profiling/performance-session-properties.md)
