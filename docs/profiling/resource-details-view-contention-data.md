...
description: Découvrez comment la vue Détails des ressources présente un graphique chronologique des événements bloquants qui ont été provoqués par des conflits sur une ressource sélectionnée.
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
- Dans le graphique chronologique, cliquez sur **Total**.
     ...
     Le mode Conflits s’affiche pour la ressource. Pour plus d’informations, consultez [vue des conflits de ressources](../profiling/resource-contentions-view-contention-data.md).
