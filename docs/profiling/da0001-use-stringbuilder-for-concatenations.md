...
description: Les appels à System.String.Concat représentent une part importante des données de profilage. Envisagez d’utiliser la classe System. Text. StringBuilder pour construire des chaînes à partir de plusieurs segments.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
