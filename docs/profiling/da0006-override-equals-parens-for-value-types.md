...
description: Les appels à la méthode Equals ou aux opérateurs d’égalité d’un type valeur public représentent une part importante des données de profilage.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
