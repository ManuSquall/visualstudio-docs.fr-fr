---
title: Attacher le profileur à une application native & collecter des données d’accès concurrentiel
description: Utilisez les outils en ligne de commande de Visual Studio Outils de profilage pour attacher le profileur à une application autonome native (C/C++) et pour obtenir les données de conflit de threads.
