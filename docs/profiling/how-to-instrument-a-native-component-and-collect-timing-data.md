---
title: 'Ligne de commande Profiler : Composant natif d’instrument, obtenir des données de synchronisation'
ms.date: 11/04/2016
ms.topic: conceptual
...
3. Démarrez le profileur. Tapez :
   ...
   | [/croix](../profiling/crosssession.md) | Active le profilage des processus dans d’autres sessions. Cette option est nécessaire si l’application s’exécute dans une autre session. L’idenitifier de session est répertorié dans la colonne **d’identification de session** sur l’onglet Processus de Windows Task Manager. **/CS** peut être spécifié comme abréviation de **/crosssession**. |
...
## <a name="end-the-profiling-session"></a>Arrêter la session de profilage
 Pour mettre fin à une séance de profilage, fermez l’application qui exécute le composant instrumenté, puis appelez l’option **VSPerfCmd/shutdown** [/shutdown](../profiling/shutdown.md) pour désactiver le profileur et fermer le fichier de données de profilage.
