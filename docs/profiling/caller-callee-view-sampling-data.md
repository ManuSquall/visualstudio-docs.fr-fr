...
|**Type**|Contexte de la fonction :<br /><br /> -   **0** - la fonction actuelle<br />-   **1** - une fonction qui appelle la fonction actuelle<br />-   **2** - une fonction qui est appelée par la fonction actuelle|
