...
|----------|---------------------|
|**Attacher le profileur à un service .NET en cours d’exécution**|-   [Comment : Joindre le profileur à un service .NET pour recueillir des données de concordance](../profiling/how-to-attach-the-profiler-to-a-dotnet-service-to-collect-concurrency-data-by-using-the-command-line.md)|
...
|**Attacher le profileur à un service C/C++ en cours d’exécution**|-   [Comment : Joindre le profileur à un service autochtone pour recueillir des données de concordance](../profiling/how-to-attach-the-profiler-to-a-native-service-to-collect-concurrency-data-by-using-the-command-line.md)|
...
|Tâche|Contenu associé|
|----------|---------------------|
|**Profiler des applications autonomes**|-   [Recueillir des données de concurrence](../profiling/collecting-concurrency-data-for-stand-alone-applications.md)|
|**Profiler des applications web ASP.NET**|-   [Recueillir des données de concurrence](../profiling/collecting-concurrency-data-for-an-aspnet-web-application.md)|
