...
![Onglet Résumé des outils de diagnostics](~/docs/profiling/media/DiagToolsSummaryTab-2.png "DiagToolsSummaryTab")
...
![Outils de diagnostic - Vue Appelant/appelé](~/docs/profiling/media/DiagToolsCallerCallee.png "DiagToolsCallerCallee")
