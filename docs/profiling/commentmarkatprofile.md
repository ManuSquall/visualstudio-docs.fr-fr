...
description: Utilisez la méthode CommentMarkAtProfile pour insérer une valeur d’horodatage, une marque numérique et une chaîne de commentaire dans le fichier. vsp.
