...
En plus des données que vous collectez avec une méthode de profilage, les Outils de profilage [!INCLUDE[vsPreShort](../code-quality/includes/vspreshort_md.md)] vous permettent d’enregistrer et de voir des données supplémentaires.  
