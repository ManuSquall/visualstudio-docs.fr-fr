...
description: Apprenez à utiliser la méthode d’instrumentation à partir de la ligne de commande pour collecter des données de performances détaillées pour un composant autonome.
