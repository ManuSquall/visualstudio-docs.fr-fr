...
Windows 7 ou version ultérieure est obligatoire pour utiliser l’outil de profilage présenté dans cet article, à savoir le [Profileur de performances](../profiling/profiling-feature-tour.md).
