...
description: Découvrez que lorsqu’une section contient plus d’un type d’activité pour un intervalle de temps donné, deux couleurs sont affichées, une verticalement sur l’autre.
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
