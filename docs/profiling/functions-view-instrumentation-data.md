...
description: Lisez les descriptions des colonnes de données de profilage dans la vue rapport de fonctions, qui répertorie les données de profilage par nom de fonction.
