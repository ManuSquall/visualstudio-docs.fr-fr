...
##  <a name="FoldObjects"></a> Afficher les objets par dominateur  
 ...
 Pour basculer la vue des objets par dominateur, choisisse le bouton **Plier les objets par dominateur** . ![Repli d’objets dans leurs dominateurs](~/docs/profiling/media/js_mem_fold_objects.png "JS_Mem_Fold_Objects")  
...
##  <a name="BuiltInValues"></a> Afficher les objets intégrés  
 ...
 Pour afficher ces objets, choisissez **Afficher les éléments intégrés** dans la liste des paramètres ![Liste déroulante des paramètres dans l’analyseur de mémoire](~/docs/profiling/media/js_mem_settings.png "JS_Mem_Settings") située dans l’angle supérieur droit du volet.  
