...
Comme alternative, vous pouvez utiliser [le débogage](vs-azure-tools-debugging-cloud-services-overview.md) à distance pour vous attacher directement à un service cloud en cours d’exécution dans Azure.
