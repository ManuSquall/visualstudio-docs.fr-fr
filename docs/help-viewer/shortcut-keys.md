...
|ToolBar|**Retour arrière**<br /><br /> - OU -<br /><br /> **Alt**+**Flèche gauche**|Afficher la page précédente.|
|ToolBar|**Alt**+**Flèche droite**|Afficher la page suivante.|
|ToolBar|**Alt**+**Début**|Afficher la page d’accueil de la **visionneuse d’aide**.|
