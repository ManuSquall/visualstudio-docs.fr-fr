...
|Barre d’outils|**Retour arrière**<br /><br /> OU<br /><br /> **ALT** + **Flèche gauche**|Afficher la page précédente.|
|Barre d’outils|**ALT** + **Flèche droite**|Afficher la page suivante.|
...
|Navigateurs|**ALT** + **Je**<br /><br /> OU<br /><br /> **CTRL** + **MAJ** + **Je**|Afficher l’onglet **Index**.|
