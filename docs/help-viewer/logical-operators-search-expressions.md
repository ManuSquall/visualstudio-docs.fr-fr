...
description: Découvrez comment utiliser des opérateurs logiques et des opérateurs de recherche avancés pour affiner les expressions de recherche dans Microsoft Help Viewer.
