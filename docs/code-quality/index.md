...
description: Découvrez comment utiliser Visual Studio 2017 pour analyser la qualité du code.
ms.date: 12/03/2018
...
ms.locfileid: "52896768"
---
# <a name="code-analysis-in-visual-studio"></a>Analyse du code dans Visual Studio

Visual Studio fournit plusieurs outils pour analyser et améliorer la qualité du code.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analyser la qualité du code managé</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analyser la qualité du code C et C++</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Mesurer la facilité de maintenance du code avec des métriques de code</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Avertissements liés à l’analyse du code managé</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Avertissements de l'analyse du code C++</h3>
                    </div>
                </div>
            </div>
        </div>
