...
Le nom d’un champ d’instance commence par « s_ » ou le nom d’un champ `static` (`Shared` dans [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]) commence par « m _ ».
