---
title: C6517 | Documents Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
avertissement C6517 : annotation non valide : propriété de 'SAL_readableTo' ne peut pas être spécifiée dans des mémoires tampons ne sont pas lisibles : ' _Param\_(1)'.  
