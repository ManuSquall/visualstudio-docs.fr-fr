...
|[CA2100](../code-quality/ca2100-review-sql-queries-for-security-vulnerabilities.md)|Rechercher des failles de sécurité dans des requêtes SQL|  
...
|[CA2114](../code-quality/ca2114-method-security-should-be-a-superset-of-type.md)|La sécurité de la méthode doit être un surensemble du type|  
...
|[CA2240](../Topic/CA2240:%20Implement%20ISerializable%20correctly.md)|Implémentez ISerializable comme il se doit|  
