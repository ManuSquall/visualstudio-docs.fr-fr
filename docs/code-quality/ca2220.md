...
La finalisation doit être propagée par le biais de la hiérarchie d'héritage. Pour ce faire, les types doivent appeler leur méthode <xref:System.Object.Finalize%2A> de la classe de base à partir de leur propre méthode <xref:System.Object.Finalize%2A>. Le C# compilateur ajoute automatiquement l’appel au finaliseur de la classe de base.
