...
Un membre qui n’accède pas aux données d’instance n’est pas marqué comme static (Shared in [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] ).
