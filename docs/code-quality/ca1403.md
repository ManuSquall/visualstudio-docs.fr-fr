...
Pour corriger une violation de cette règle, remplacez la valeur de l’attribut <xref:System.Runtime.InteropServices.StructLayoutAttribute> par [LayoutKind. Explicit](<xref:System.Runtime.InteropServices.LayoutKind.Explicit>) ou [LayoutKind. sequential](<xref:System.Runtime.InteropServices.LayoutKind.Sequential>), ou rendez le type invisible pour com.
