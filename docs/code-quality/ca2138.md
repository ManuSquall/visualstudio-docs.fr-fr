...
Une méthode transparente de sécurité appelle une méthode qui est marquée avec l’attribut <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute>.
