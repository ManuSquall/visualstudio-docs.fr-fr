---
title: 'CA0054 : l’assembly de règle personnalisée contient des ressources XML non valides.'
description: Cela se produit si un assembly de règle personnalisée contient des ressources XML non valides décrivant ses règles.
ms.date: 10/19/2016
ms.topic: reference
f1_keywords:
- CA0054
