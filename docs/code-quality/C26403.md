...
Pour plus d’informations, consultez les [ C++ instructions principales](http://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#r-resource-management).
