...
Le nom d’une énumération se termine par un mot pluriel et l’énumération n' <xref:System.FlagsAttribute?displayProperty=fullName> est pas marquée avec l’attribut.
...
Faites du nom de l’énumération un mot au singulier ou <xref:System.FlagsAttribute>ajoutez.
