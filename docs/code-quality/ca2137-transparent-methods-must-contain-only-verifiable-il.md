...
La méthode dans cet exemple utilise du code non vérifiable et doit être marquée avec l' <xref:System.Security.SecurityCriticalAttribute> attribut <xref:System.Security.SecuritySafeCriticalAttribute> ou.
