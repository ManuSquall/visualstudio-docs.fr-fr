...
- Une valeur d’énumération [Newtonsoft. JSON. TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) , autre que `None` , est référencée.
