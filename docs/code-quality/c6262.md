...
ms.locfileid: "72013460"
---
# <a name="c6262"></a>C6262

AVERTISSEMENT C6262 : La fonction utilise \<constant > octets de la pile : dépasse/Analyze : STACKSIZE @ no__t-1constant 2 >. Envisagez de déplacer certaines données vers le tas
...
Le code suivant génère cet avertissement, car `char buffer` alloue 16 382 octets, tandis que la variable de type entier local `i` alloue 4 autres octets, qui dépassent ensemble la limite de taille de pile par défaut de 16 Ko.
...
- [Guide pratique : utiliser les vérifications natives à l’exécution](../debugger/how-to-use-native-run-time-checks.md)