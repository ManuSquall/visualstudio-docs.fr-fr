...
> [!NOTE]
> Dans l’implémentation la plus récente de l’analyseur de cette règle, il englobe également les fonctionnalités de la [règle ca1053](../code-quality/ca1053.md).
