...
Un type visible de l’extérieur peut être assigné à l’interface <xref:System.Runtime.Serialization.ISerializable?displayProperty=fullName> et l’une des conditions suivantes est remplie :
