...
L’exemple suivant montre des méthodes d’appel de code non managé marquées avec les attributs de <xref:System.Runtime.InteropServices.MarshalAsAttribute> appropriés.
