...
Cette règle recherche <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> appels de méthode de désérialisation ou des références, lorsque le <xref:System.Web.Script.Serialization.JavaScriptSerializer> peut avoir été initialisé avec un <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.

## <a name="how-to-fix-violations"></a>Comment corriger les violations

- Assurez-vous que <xref:System.Web.Script.Serialization.JavaScriptTypeResolver?displayPropertyName=nameWithType> objets ne sont pas initialisés avec un <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.
