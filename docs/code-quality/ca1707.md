...
Ne supprimez pas les avertissements pour le code de production. Toutefois, il est possible de supprimer cet avertissement en toute sécurité pour le code de test. Vous pouvez supprimer les avertissements de cette règle en affectant la valeur **aucun**à sa [gravité](use-roslyn-analyzers.md#configure-severity-levels) .
