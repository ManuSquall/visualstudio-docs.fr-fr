...
description: Une méthode utilise la sécurité impérative et est susceptible de construire l'autorisation à l'aide d'informations d'état ou de valeurs de retour qui peuvent changer pendant que la demande est active.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2103
