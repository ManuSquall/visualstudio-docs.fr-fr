...
Pour modifier le Framework cible d’un projet, consultez [How à : Cibler une version de .NET](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
