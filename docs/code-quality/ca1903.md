...
Pour modifier le Framework cible d’un projet, consultez [Comment : cibler une version de .net](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
