---
title: "Démarrage rapide : Analyse du Code pour C/C++ | Documents Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
##  <a name="BKMK_Creating_work_items_for_code_analysis_warnings"></a>Créer des éléments de travail pour le code les avertissements d’analyse  
