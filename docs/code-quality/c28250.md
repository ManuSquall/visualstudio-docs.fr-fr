...
ms.locfileid: "72014393"
---
# <a name="c28250"></a>C28250
AVERTISSEMENT C28250 : Annotation incohérente pour une fonction : l'instance précédente contient une erreur.

 Remarque : Il existe plusieurs prototypes pour cette fonction. Cet avertissement compare le premier prototype avec le numéro d’instance @no__t > 0number.

 Si une déclaration est faite à l’aide d’un `typedef`, la ligne où le `typedef` s’affiche est plus utile que la ligne de la déclaration.
