...
- Cette règle avertit les endroits où les constructeurs sont appelés pour les étendues ou les vues et que la mémoire tampon de données source appartient à un objet temporaire créé dans la même instruction. Cela concerne :
