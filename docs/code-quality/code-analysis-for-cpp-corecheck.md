...
[C26448 USE_GSL_FINALLY](c26448.md) Envisagez d’utiliser `gsl::finally` si l’action finale est prévue. Consultez [C++ Core Guidelines : GSL.util : utilitaires](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities).
