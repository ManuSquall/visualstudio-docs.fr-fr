...
## <a name="_out_-pstr"></a>@no__t 0Out @ no__t-1 PSTR
...
## <a name="wrong-context-in-_when_"></a>Contexte incorrect dans \_When @ no__t-1
...
## <a name="true-in-_success_"></a>TRUE dans \_Success @ no__t-1
...
Pour une variable de référence, la version précédente de SAL utilisait le pointeur implicite comme cible d’annotation et nécessitait l’ajout d’un `__deref` aux annotations attachées à une variable de référence. Cette version utilise l’objet lui-même et ne nécessite pas le @no__t supplémentaire-0.
