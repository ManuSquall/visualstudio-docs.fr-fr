...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Violation&mdash;fonction de document et exécution du script non désactivée
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>Solution&mdash;désactiver la fonction de document et l’exécution de scripts
