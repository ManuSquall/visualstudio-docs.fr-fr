---
title: "Structs et classes d’annotation | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
Vous pouvez annoter des membres de structure et de la classe à l’aide des annotations qui agissent comme des invariants, elles sont supposées être vraie en un appel de fonction ou d’une entrée/sortie de la fonction qui implique la structure englobante comme paramètre ou une valeur de résultat.  
...
-   `_Struct_size_bytes_(size)`  
     ...
     S’applique à la déclaration de classe ou de struct.  Indique qu’un objet valide de ce type peut être plus grand que le type déclaré, avec le nombre d’octets spécifiés par `size`.  Exemple :  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Paramètres de fonction et valeurs de retour d’annotation](../code-quality/annotating-function-parameters-and-return-values.md)   
