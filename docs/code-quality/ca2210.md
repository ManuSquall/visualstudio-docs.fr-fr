...
description: Un assembly n’est pas signé avec un nom fort, le nom fort n’a pas pu être vérifié ou le nom fort n’est pas valide sans les paramètres de registre actuels de l’ordinateur.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
