...
AVERTISSEMENT C28193 : La variable contient une valeur qui doit être examinée.
 ...
 Utilisez un avertissement `#pragma` pour supprimer l’avertissement : si en réordonnant le code, vous rendez le code trop complexe ou moins utile.
