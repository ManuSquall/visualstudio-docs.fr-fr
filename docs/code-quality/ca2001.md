...
|<xref:System.Reflection.Assembly.LoadFrom%2A?displayProperty=fullName><br /><br /><xref:System.Reflection.Assembly.LoadFile%2A?displayProperty=fullName><br /><br /><xref:System.Reflection.Assembly.LoadWithPartialName%2A?displayProperty=fullName>|Ces méthodes peuvent charger des assemblys à partir d’emplacements inattendus. Par exemple, consultez les billets de blog .NET CLR notes de Suzanne Cook [LoadFile vs. LoadFrom @ no__t-0 et en [choisissant un contexte de liaison](http://go.microsoft.com/fwlink/?LinkId=164451) pour obtenir des informations sur les méthodes qui chargent les assemblys.|
