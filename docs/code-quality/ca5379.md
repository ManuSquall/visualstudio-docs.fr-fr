---
title: 'CA5379 : Ne pas utiliser l’algorithme de fonction de dérivation de clés faibles'
...
ms.locfileid: "90097357"
---
# <a name="ca5379-do-not-use-weak-key-derivation-function-algorithm"></a>CA5379 : Ne pas utiliser l’algorithme de fonction de dérivation de clés faibles

|Élément|Valeur|
|-|-|
|ID de la règle|CA5379|
