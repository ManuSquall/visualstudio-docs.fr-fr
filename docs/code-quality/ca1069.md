...
Chaque membre enum doit avoir une valeur de constante unique ou être explicitement assigné avec un membre antérieur dans l’énumération pour indiquer l’intention explicite de la valeur de partage. Exemple :
