...
ms.locfileid: "72017969"
---
# <a name="c6277"></a>C6277
AVERTISSEMENT C6277 : Nom d’application NULL avec un chemin d’accès sans guillemets dans l’appel à \<function >: entraîne une faille de sécurité si le chemin d’accès contient des espaces
