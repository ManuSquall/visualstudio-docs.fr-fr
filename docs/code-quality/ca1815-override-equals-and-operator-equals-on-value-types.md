...
Un type valeur ne remplace <xref:System.Object.Equals%2A?displayProperty=fullName> pas ou n’implémente pas l’opérateur d’égalité (= =). Cette règle ne vérifie pas les énumérations.
