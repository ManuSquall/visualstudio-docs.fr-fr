...
ms.locfileid: "72450292"
---
# <a name="c26130"></a>C26130
AVERTISSEMENT C26130 : @no__t d’annotation manquant-0Requires @ no__t-1lock @ no__t-2held @ no__t-3 (\<LOCK >) ou \_No @ no__t-6competing @ no__t-7thread @ no__t-8 à la fonction \<func >. Dans le cas contraire, il peut s’agir d’une condition de concurrence. La variable \<var > doit être protégée par le > Lock \<lock.
