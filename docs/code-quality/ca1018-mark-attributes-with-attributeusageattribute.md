...
Pour corriger une violation de cette règle, spécifiez des cibles pour l’attribut <xref:System.AttributeUsageAttribute>à l’aide de. Lisez l'exemple suivant.
