...
- Méthode COM ou P/Invoke qui retourne un HRESULT ou un code d’erreur qui n’est jamais utilisé.

- Méthode LINQ qui retourne un résultat qui n’est jamais utilisé.
