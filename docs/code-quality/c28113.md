...
warning C28113: Accessing a local variable via an Interlocked function  
 ...
 Le pilote utilise une routine de prise en charge exécutive Interlocked, comme [InterlockedDecrement](http://msdn.microsoft.com/library/windows/hardware/ff547871.aspx), pour accéder à une variable locale.  
