...
> [!NOTE]
> Dans l’implémentation de l’analyseur FxCop de cette règle, il englobe également les fonctionnalités de la [règle ca1053](../code-quality/ca1053-static-holder-types-should-not-have-constructors.md).
