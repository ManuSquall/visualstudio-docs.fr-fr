...
### [Utiliser des ensembles de règles pour le code managé](how-to-configure-code-analysis-for-a-managed-code-project.md)
...
#### [Spécifier des ensembles de règles pour plusieurs projets](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Utiliser des ensembles de règles pour le code C++](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
### [Synchroniser des ensembles de règles applicables à des projets avec la stratégie d’archivage du projet d’équipe](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Créer des ensembles de règles personnalisés](creating-custom-code-analysis-rule-sets.md)
