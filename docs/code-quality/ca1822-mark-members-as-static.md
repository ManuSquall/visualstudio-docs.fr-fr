...
Marquez le membre comme static (ou Shared in [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]) ou utilisez’This'/'me’dans le corps de la méthode, le cas échéant.
