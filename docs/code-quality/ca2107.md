...
Le code qui s’appuie sur ces actions doit être soigneusement évalué pour les vulnérabilités de sécurité en raison de leur utilité limitée et de son comportement subtil. Considérons ce qui suit :
