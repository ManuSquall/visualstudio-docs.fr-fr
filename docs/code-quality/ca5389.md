---
title: 'CA5389 : ne pas ajouter le chemin d’accès de l’élément d’archive au chemin d’accès du système de fichiers cible'
...
ms.locfileid: "74809352"
---
# <a name="ca5389-do-not-add-archive-items-path-to-the-target-file-system-path"></a>CA5389 : ne pas ajouter le chemin d’accès de l’élément d’archive au chemin d’accès du système de fichiers cible
...
- `destinationFileName` de paramètres de la méthode <xref:System.IO.Compression.ZipFileExtensions.ExtractToFile%2A?displayProperty=nameWithType>
...
- chemin du paramètre de `fileName` <xref:System.IO.FileInfo?displayProperty=nameWithType>
