...
Vous pouvez supprimer un avertissement déclenché pour une propriété d’un attribut dérivé de la classe <xref:System.Attribute>. Les attributs peuvent contenir des propriétés qui retournent des tableaux, mais ne peuvent pas contenir de propriétés qui retournent des collections.
...
- @NO__T 0CA1024 : Utilisez les propriétés quand @ no__t-0 est approprié