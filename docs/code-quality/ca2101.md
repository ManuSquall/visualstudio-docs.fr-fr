...
> [!CAUTION]
> La [sécurité d’accès du code](/dotnet/framework/misc/code-access-security) (cas) ne doit pas être considérée comme une limite de sécurité.
