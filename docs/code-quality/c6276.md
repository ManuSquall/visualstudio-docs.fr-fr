...
ms.locfileid: "72447771"
---
# <a name="c6276"></a>C6276
avertissement C6276 : cast entre les types de chaînes sémantiquement différents : char * to wchar_t @ no__t-0. L’utilisation d’une chaîne non valide peut entraîner un comportement indéfini
