...
## <a name="command-menu-access"></a>Accès au menu commande
 Le chemin d’accès au menu de l’environnement de développement intégré [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] suivant est utilisé dans les cas de test.
