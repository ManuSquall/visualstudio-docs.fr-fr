...
## <a name="objects-in-the-automation-model"></a>Objets dans le modèle Automation  
 ...
 ![Graphique d’objet Automation Visual Studio](~/docs/extensibility/internals/media/vsvisualstudioautomationobjectchart.gif "vsVisualStudioAutomationObjectChart")  
