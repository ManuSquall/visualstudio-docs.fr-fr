...
## <a name="components"></a>Composants  
 ...
 ![Diagramme d’Architecture de contrôle de Code de la source](../../extensibility/internals/media/vs_sccsdk_plug_in_arch.gif "vs_sccsdk_plug_in_arch")  
