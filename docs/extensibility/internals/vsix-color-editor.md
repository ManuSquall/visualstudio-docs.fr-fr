...
L’outil Éditeur de couleurs des extensions Visual Studio permet de créer et de modifier des couleurs personnalisées pour Visual Studio. L’outil peut également générer des clés de ressources de thème afin que les couleurs puissent être utilisées dans le code. Cet outil est utile pour créer des couleurs pour une extension Visual Studio qui les prend en charge. Cet outil peut ouvrir les fichiers. pkgdef et. Xml. Les thèmes Visual Studio (fichiers. vstheme) peuvent être utilisés avec l’éditeur de couleurs de l’extension Visual Studio en remplaçant l’extension de fichier par. Xml. En outre, les fichiers. vstheme peuvent être importés dans un fichier. XML actuel.
 ...
 ![Éditeur de couleurs VSIX héros](../../extensibility/internals/media/vsix-color-editor-hero.png "Éditeur de couleurs VSIX héros")
...
5. Testez les modifications dans Visual Studio.
   ...
   **Étape 1 : Déterminez les noms de catégorie et de jeton pour les nouveaux jetons de couleur.**
...
- ListItemDisabledBorder
  ...
  **Étape 3 : Utilisez l’éditeur de couleurs pour créer de nouveaux jetons de couleur.**
  ...
  ![Éditeur de couleurs VSIX-nouvelle couleur](../../extensibility/internals/media/vsix-color-editor-new-color.png "Éditeur de couleurs VSIX-nouvelle couleur")
  ...
  ![Éditeur de couleurs VSIX-nouvelle couleur remplie](../../extensibility/internals/media/vsix-color-editor-new-color-filled.png "Éditeur de couleurs VSIX-nouvelle couleur remplie")
  ...
  ![Éditeur de couleurs VSIX-modifier la couleur](../../extensibility/internals/media/vsix-color-editor-edit-color.png "Éditeur de couleurs VSIX-modifier la couleur")

  ![Arrière-plan de l’éditeur de couleurs VSIX](../../extensibility/internals/media/vsix-color-editor-background.png "Arrière-plan de l’éditeur de couleurs VSIX")
  ...
  **Étape 4 : Utilisez les couleurs dans une extension Visual Studio.**
  ...
  ![Éditeur de couleurs VSIX, pkgdef](../../extensibility/internals/media/vsix-color-editor-pkgdef.png "Éditeur de couleurs VSIX, pkgdef")
  ...
  ![Éditeur de couleurs VSIX, visionneuse de code] de la ressource (../../extensibility/internals/media/vsix-color-editor-resource-code-viewer.png "Éditeur de couleurs VSIX, visionneuse de code") de la ressource

  Incluez ce code dans une classe statique du projet. Référence à **Microsoft. VisualStudio.\< Shell. VSVersion > fichier. 0. dll** doit être ajouté au projet pour utiliser le type **ThemeResourceKey** .
 ...
 **Étape 5 : Testez les modifications dans Visual Studio.**
 ...
 ![Application de l’éditeur de couleurs VSIX](../../extensibility/internals/media/vsix-color-editor-apply.png "Application de l’éditeur de couleurs VSIX")
