...
##### mécanismes de déploiement  
 ...
 ![Graphique d'extendeur automatique de la version d'un projet VS](~/extensibility/internals/media/vs_projectflavorautoextender.gif "VS\_ProjectFlavorAutoExtender")  
