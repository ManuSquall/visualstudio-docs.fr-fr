...
##### <a name="aggregation-mechanism"></a>Mécanisme d’agrégation  
 ...
 ![Visual Studio à plusieurs niveaux graphique de type de](../../extensibility/internals/media/vs_multilevelprojectflavor.gif "VS_MultilevelProjectFlavor")  
