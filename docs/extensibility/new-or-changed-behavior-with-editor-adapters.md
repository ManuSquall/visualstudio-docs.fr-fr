...
#### <a name="use-win32-and-wpf-versions-of-ivscodewindow"></a>Utiliser des versions de IVsCodeWindow Win32 et WPF
...
#### <a name="use-win32-and-wpf-versions-of-ivstextview"></a>Utiliser des versions de IVsTextView Win32 et WPF
 ...
 Pour définir un affichage de texte en mode de WPF, vous devez appeler <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView.Initialize%2A> et transmettez [TextViewInitFlags3.VIF_NO_HWND_SUPPORT](<xref:Microsoft.VisualStudio.TextManager.Interop.TextViewInitFlags3.VIF_NO_HWND_SUPPORT>) comme indicateurs d’un de l’initialisation de la `InitView` paramètre. Vous pouvez obtenir le <xref:System.Windows.FrameworkElement> en appelant <xref:Microsoft.VisualStudio.Shell.Interop.IVsUIElementPane.CreateUIElementPane%2A>.
...
#### <a name="pass-arrays-as-parameters-in-native-code"></a>Passer des tableaux en tant que paramètres dans le code natif
...
## <a name="unimplemented-methods"></a>Méthodes non implémentées
 Certaines méthodes n’ont pas été implémentées pour l’adaptateur de mémoire tampon de texte, un adaptateur de vue de texte et un adaptateur de couche de texte.
