...
> [!WARNING]
>  Modèles de projet sont pris en charge pour C++ à compter de Visual Studio 2012. Elles ne sont pas prises en charge pour C++ dans Visual Studio 2010 et versions antérieures.  
...
## <a name="remarks"></a>Remarques  
 ...
 La valeur de la `ProjectType` élément spécifie où le modèle se trouve dans le **nouveau projet** ou **ajouter un nouvel élément** boîte de dialogue. Par exemple, un modèle avec une `ProjectType` valeur `CSharp` apparaît sous le **Visual C#** nœud dans le **nouveau projet** boîte de dialogue.  
