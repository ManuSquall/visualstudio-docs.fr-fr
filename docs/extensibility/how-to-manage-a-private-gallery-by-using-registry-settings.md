...
ms.topic: "article"
helpviewer_keywords: 
  - "Galeries privées VSIX, gestion"
  - "la gestion des galeries privées VSIX"
...
---
# Comment&#160;: g&#233;rer une galerie priv&#233;e &#224; l’aide des param&#232;tres du Registre
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Si vous êtes un administrateur ou le développeur d’une extension de Shell isolé, vous pouvez contrôler l’accès à des contrôles, des modèles et des outils de la galerie Visual Studio, la galerie d’exemples ou des galeries privées. Pour rendre une galerie disponible ou indisponible, créez un fichier .pkgdef qui décrit les clés de Registre modifiés et leurs valeurs.  
...
```  
 ...
 Le `Repositories` clé fait référence à la galerie pour être activé ou désactivé. La galerie d’exemples et de la galerie Visual Studio utilisent le GUID de référentiel suivant :  
...
-   Galerie d’exemples : AEB9CB40\-D8E6\-4615\-B52C\-27E307F8506C  
 ...
 Le `Priority` valeur détermine l’ordre dans lequel les galeries sont répertoriés dans la boîte de dialogue Options. La galerie Visual Studio a priorité 10 et la galerie d’exemples a priorité 20. Les galeries privées commencent à priorité 100. Si plusieurs galeries ont la même valeur de priorité, l’ordre dans lequel ils apparaissent est déterminée par les valeurs de leur version localisée `DisplayName` attributs.  
  
 Le `Protocol` valeur est requise pour les galeries basée sur SharePoint ou Atom.  
  
 Soit `DisplayName`, ou les deux `DisplayNameResourceID` et `DisplayNamePackageGuid`, doit être spécifié. Si all est spécifié, le `DisplayNameResourceID` et `DisplayNamePackageGuid` est utilisée.  
  
## La désactivation de la galerie Visual Studio à l’aide d’un fichier .pkgdef  
