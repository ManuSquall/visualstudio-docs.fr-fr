...
#[Ouvrir un dossier](open-folder.md)
##[Espaces de travail](workspaces.md)
##[Contextes de fichier](workspace-file-contexts.md)
##[Indexation](workspace-indexing.md)
##[Services de langage](workspace-language-services.md)
##[Générer](workspace-build.md)
...
## [Guide pratique pour diagnostiquer les délais de l’interface utilisateur causés par les extensions](how-to-diagnose-ui-delays-caused-by-extensions.md)
