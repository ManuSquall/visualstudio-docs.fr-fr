...
1.  Les définitions pour les interfaces IVx * sont dans le *VSEditor.h* de fichiers dans le *\..\VisualStudioIntegration\Common\Inc\\* dossier de l’installation de Visual Studio SDK.  
