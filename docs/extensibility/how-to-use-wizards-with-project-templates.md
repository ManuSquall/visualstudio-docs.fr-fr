...
1. Créez un C# projet de modèle de projet (dans Visual Studio, sélectionnez **fichier** > **nouveau** > **projet** et recherchez « modèle de projet »). Nommez-le **MyProjectTemplate**.
