...
![Outils de génération VSSDK](~/docs/extensibility/media/vssdk-build-tools.png)
...
* Sélectionnez **conditions préalables** onglet et appuyez sur **nouveau** bouton.
  ...
  ![Concepteur de manifeste VSIX](~/docs/extensibility/media/vsix-manifest-designer.png)

* Le **ajouter nouvelle vérification** fenêtre s’ouvre.

  ![ajouter la condition préalable vsix](~/docs/extensibility/media/add-vsix-prerequisite.png)
...
* Si nécessaire, mettez à jour la version.
  ...
  ![ajouter la condition préalable roslyn](~/docs/extensibility/media/add-roslyn-prerequisite.png)
...
![Démarrer le programme externe](~/docs/extensibility/media/start-external-program.png)
...
![Programme d’installation de l’extension VSIX dans Visual Studio 2017](~/docs/extensibility/media/vsixinstaller-vs-2017.png)
...
![processus en cours d’exécution de Visual Studio](~/docs/extensibility/media/vs-running-processes.png)
...
![élément requis manquant vsixinstaller](~/docs/extensibility/media/vsixinstaller-missing-prerequisite.png)
