---
title: m_Parent champ | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
---
# <a name="mparent-field"></a>m_Parent champ
Le champ de stockage pour le <xref:System.Threading.Tasks.Task?displayProperty=fullName> `Parent` propriété.  
