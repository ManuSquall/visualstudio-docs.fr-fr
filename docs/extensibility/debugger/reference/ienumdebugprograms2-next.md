---
description: Retourne l’ensemble d’éléments suivant de l’énumération Programs.
title: 'IEnumDebugPrograms2 :: suivant | Microsoft Docs'
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[in, out] Tableau d’éléments [IDebugProgram2](../../../extensibility/debugger/reference/idebugprogram2.md) à remplir.
