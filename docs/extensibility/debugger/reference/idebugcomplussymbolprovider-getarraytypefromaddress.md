...
`pAddress`\
dans Adresse de débogage représentée par une interface [IDebugAddress](../../../extensibility/debugger/reference/idebugaddress.md) .

`pSig`\
dans Tableau à examiner.

`dwSigLength`\
dans Longueur en octets du `pSig` tableau.
