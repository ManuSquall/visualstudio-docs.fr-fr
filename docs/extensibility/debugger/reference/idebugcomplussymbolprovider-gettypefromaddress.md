...
`ppField`\
[out] Retourne le type de tableau tel qu’il est représenté par une interface [IDebugClassField.](../../../extensibility/debugger/reference/idebugclassfield.md)
