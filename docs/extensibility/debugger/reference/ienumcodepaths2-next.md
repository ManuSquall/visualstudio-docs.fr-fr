---
title: IEnumCodePaths2::Next | Documents Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
#### <a name="parameters"></a>Paramètres  
 ...
 `rgelt`  
 [dans, out] Tableau de [CODE_PATH](../../../extensibility/debugger/reference/code-path.md) éléments doit être renseigné.  
