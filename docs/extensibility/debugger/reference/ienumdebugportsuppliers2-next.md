---
title: 'IEnumDebugPortSuppliers2 :: suivant | Microsoft Docs'
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[in, out] Tableau d’éléments [IDebugPortSupplier2](../../../extensibility/debugger/reference/idebugportsupplier2.md) à remplir.
