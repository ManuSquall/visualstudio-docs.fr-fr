---
title: IDebugDocumentContext2::EnumCodeContexts (fr) Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Un seul contexte de document peut générer plusieurs contextes de code lorsque le document utilise des modèles ou inclut des fichiers.
