...
## <a name="remarks"></a>Notes  
 ...
 Le chemin d’accès des symboles peut également contenir un ou plusieurs emplacements du cache. Les caches sont répertoriés par ordre de priorité, avec le cache de priorité le plus élevé en premier et séparés par des * symboles. Par exemple :  
