---
title: IDebugComPlusSymbolProvider::GetLocalVariablelayout (fr) Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`cMethods`\
[dans] Nombre de jetons de `rgMethodTokens` méthode dans le tableau.

`rgMethodTokens`\
[dans] Array de jetons de méthode.
