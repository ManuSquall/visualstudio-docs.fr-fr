---
title: IDebugGenericParamField::GetFlags | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
## <a name="remarks"></a>Notes  
 Ces indicateurs contiennent des informations sur les contraintes spéciales différentes.  
