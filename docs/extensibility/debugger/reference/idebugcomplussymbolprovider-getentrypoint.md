---
title: IDebugComPlusSymbolProvider::GetEntryPoint - France Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`ppAddress`\
[out] Retourne le point d’entrée représenté par une interface [IDebugAddress.](../../../extensibility/debugger/reference/idebugaddress.md)
