---
description: Récupère les classes avec l’attribut spécifié qui sont implémentées dans le langage de programmation spécifié.
...
`guidLanguage`\
dans Identificateur unique de la langue.
