---
title: IDebugComPlusSymbolProvider::GetAttributedClassesForLanguage (fr) Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`guidLanguage`\
[dans] Identifiant unique pour la langue.

`pstrAttribute`\
[dans] La chaîne d’attribut.

`ppEnum`\
[out] Retourne un recensement des classes d’attributs.
