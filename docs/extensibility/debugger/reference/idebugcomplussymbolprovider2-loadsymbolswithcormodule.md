---
description: Charge les symboles de débogage en fonction de l’objet ICorDebugModule.
...
`pUnkMetadataImport`\
dans Objet qui contient les métadonnées de symbole de débogage.
