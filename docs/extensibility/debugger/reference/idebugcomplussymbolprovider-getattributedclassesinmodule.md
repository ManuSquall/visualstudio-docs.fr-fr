---
title: IDebugComPlusSymbolProvider::GetAttributedClassesinModule (fr) Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`ppEnum`\
[out] Retourne un recensement des classes attribuées.
