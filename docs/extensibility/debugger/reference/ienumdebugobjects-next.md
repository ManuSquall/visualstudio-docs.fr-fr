---
title: IEnumDebugObjects::Next | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>Paramètres  
 ...
 `rgelt`  
 [dans, out] Tableau de [IDebugObject](../../../extensibility/debugger/reference/idebugobject.md) éléments doit être renseigné.  
