...
## <a name="remarks"></a>Notes  
 Cette méthode ne fait pas partie de l’interface d’énumération COM habituel qui spécifie que le suivant, clonage, Skip et réinitialisation uniquement besoin d’être implémentée.  
