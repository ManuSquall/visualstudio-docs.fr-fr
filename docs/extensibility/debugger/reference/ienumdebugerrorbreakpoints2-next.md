---
title: IEnumDebugErrorBreakpoints2::Next | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>Paramètres  
 ...
 `rgelt`  
 [dans, out] Tableau de [IDebugErrorBreakpoint2](../../../extensibility/debugger/reference/idebugerrorbreakpoint2.md) éléments doit être renseigné.  
