...
### <a name="BKMK_PrioritizingAndLayering"></a>Hiérarchisation et structuration en couches
...
| Navigation dans la barre latérale | Appareil de commutation simple qui peut accueillir plus de catégories que les onglets<br /><br />Liste plate de catégories (aucune hiérarchie)<br /><br />extensibilité ;<br /><br />Exemple : **personnaliser... &gt; commande Ajouter** | Il ne s’agit pas d’une bonne utilisation de l’espace horizontal s’il y a moins de trois groupes<br /><br />La tâche peut être mieux adaptée à une liste déroulante |
...
Les projets sont généralement classés en tant que référence (capable de rendre persistants uniquement les références aux éléments de projet dans le stockage), basés sur un répertoire (en mesure de rendre persistants uniquement les éléments de projet stockés dans la hiérarchie d’un projet) ou mixte (capable de conserver les références ou éléments physiques). L’IDE prend en charge les trois types de projets simultanément dans le **Explorateur de solutions**.
...
| :---: | --- | --- |
| ![Icône de souris « aucune insertion »](../../extensibility/ux-guidelines/media/0706-01_mousenodrop.png "0706-01_MouseNoDrop") | Aucune suppression | Impossible de supprimer l’élément à l’emplacement spécifié. |
| ![Icône « copier » de la souris](../../extensibility/ux-guidelines/media/0706-02_mousecopy.png "0706-02_MouseCopy") | Copier | L’élément sera copié à l’emplacement cible. |
| ![Icône « déplacer » de la souris](../../extensibility/ux-guidelines/media/0706-03_mousemove.png "0706-03_MouseMove") | Déplacer | L’élément sera déplacé vers l’emplacement cible. |
| ![Icône « Ajouter une référence » de la souris](../../extensibility/ux-guidelines/media/0706-04_mouseaddref.png "0706-04_MouseAddRef") | Ajouter la référence | Une référence à l’élément sélectionné sera ajoutée à l’emplacement cible. |
...
| Aucun modificateur | Source | Supprime la référence à l’élément d’origine | Supprime la référence à l’élément d’origine |
| Aucun modificateur | Résultats | `DROPEFFECT_ MOVE` est retourné en tant qu’action de `::Drop` et l’élément reste à l’emplacement d’origine dans le stockage | `DROPEFFECT_ MOVE` est retourné en tant qu’action à partir d' `::Drop` et l’élément est supprimé de l’emplacement d’origine dans le stockage |
| Maj + glisser | Action | Déplacer | Déplacer |
| Maj + glisser | Cible | Ajoute une référence à l’élément d’origine | Copie l’élément dans l’emplacement cible |
| Maj + glisser | Source | Supprime la référence à l’élément d’origine | Supprime l’élément de l’emplacement d’origine |
| Maj + glisser | Résultats | `DROPEFFECT_ MOVE` est retourné en tant qu’action de `::Drop` et l’élément reste à l’emplacement d’origine dans le stockage | `DROPEFFECT_ MOVE` est retourné en tant qu’action à partir d' `::Drop` et l’élément est supprimé de l’emplacement d’origine dans le stockage |
| Ctrl + glisser | Action | Copier | Copier |
