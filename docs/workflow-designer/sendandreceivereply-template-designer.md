...
description: Découvrez comment vous pouvez utiliser le modèle SendAndReceiveReply pour créer une paire d’activités d’envoi et de ReceiveReply préconfigurées.
