...
Le tableau suivant présente les propriétés de <xref:System.Activities.Statements.PickBranch> les plus utiles et décrit comment les utiliser dans le Concepteur de flux de travail.
