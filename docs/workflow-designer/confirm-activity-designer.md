...
description: En savoir plus sur le concepteur d’activités Confirm et sur la façon dont vous pouvez utiliser ce concepteur pour créer et configurer une activité Confirm.
