...
3. Cliquez sur l'éditeur d'expressions à gauche dans le concepteur d'activités pour l'activité <xref:System.Activities.Statements.Assign>.
     ...
     Les chaînes en filigrane grises **\<To >** et **\<Enter une expression VB >** sont les chaînes de texte par défaut pour les éditeurs d’expressions dans l’activité <xref:System.Activities.Statements.Assign>.
