---
title: Concepteur de flux de travail - boîte de dialogue de l’éditeur de conditions de règle (héritée)
ms.date: 11/04/2016
ms.topic: reference
...
ms.locfileid: "31975945"
---
# <a name="rule-condition-editor-dialog-box-legacy"></a>Éditeur de conditions de règle, boîte de dialogue (héritée)

Cette rubrique décrit comment utiliser le **éditeur de conditions de règle** boîte de dialogue dans le Concepteur de flux de travail Windows hérité. Utilisez le Concepteur de flux de travail hérité lorsque vous avez besoin cibler le .NET Framework version 3.5 ou du WinFX.
