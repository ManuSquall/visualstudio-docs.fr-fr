...
Les concepteurs d’activités de Migration sont utilisés pour appeler des 3.0/3.5 activités de flux de travail à partir d’un flux de travail ciblant le .NET Framework 4. Les rubriques contenues dans cette section fournissent des conseils sur la façon d’utiliser les concepteurs d’activités de Workflow Designer.
