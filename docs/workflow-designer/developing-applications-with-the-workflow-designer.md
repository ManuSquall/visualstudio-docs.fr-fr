...
Le Concepteur de flux de travail est un concepteur visuel et le débogueur pour la construction graphique et le débogage de [Windows Workflow Foundation](/dotnet/framework/windows-workflow-foundation/index) applications (WF) dans Visual Studio. Il vous permet de composer une application de workflow composite, une bibliothèque d’activités ou un service Windows Communication Foundation (WCF) via l’utilisation de modèles et les concepteurs d’activités.
...
1. Dans le programme d’installation de Visual Studio, sélectionnez le **composants individuels** onglet.
...
1. Sélectionnez **Modifier**.
   ...
   Visual Studio installe le **Windows Workflow Foundation** composant.
