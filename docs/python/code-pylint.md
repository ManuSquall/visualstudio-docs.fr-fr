---
title: "Utilisation de PyLint dans Python Tools pour Visual Studio | Microsoft Docs"
ms.custom: 
ms.date: 3/7/2017
...
[PyLint](https://www.pylint.org/), un outil communément utilisé qui recherche les erreurs dans le code Python et favorise l’exactitude des modèles de codage Python, est intégré aux projets Visual Studio pour Python.
