...
![Saisie semi-automatique de membres](~/python/media/code-editing-completions-simple.png)
...
![Saisie semi-automatique de membres avec filtrage](~/python/media/code-editing-completion-filtering.png)
...
![Saisie semi-automatique de membres sur plusieurs types](~/python/media/code-editing-completion-types.png)
...
![Saisie semi-automatique de membres privés](~/python/media/code-editing-completion-dunder.png)
...
![Importation de saisie semi-automatique](~/python/media/code-editing-completion-import.png)
...
![Saisie semi-automatique d’exceptions](~/python/media/code-editing-completion-exception.png)
...
![Saisie semi-automatique de décorateurs](~/python/media/code-editing-completion-decorator.png)
...
![Assistance pour la signature](~/python/media/code-editing-signature-help.png)
...
![Info express](~/python/media/code-editing-quick-info.png)
...
![Coloration du code](~/python/media/code-editing-code-coloring.png)
...
![Options Polices et couleurs](~/python/media/code-editing-customize-colors.png)
...
![Extraits de code](~/python/media/code-editing-code-snippets.png)
...
![Gestionnaire des extraits de code](~/python/media/code-editing-code-snippets-manager.png)
...
![Barre de navigation](~/python/media/code-editing-navigation-bar.png)
...
![Atteindre la définition](~/python/media/code-editing-go-to-definition.png)
...
![Naviguer vers](~/python/media/code-editing-navigate-to.png)
...
![Résultats de Rechercher toutes les références](~/python/media/code-editing-find-all-references.png)
