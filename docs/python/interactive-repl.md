...
![Fenêtre interactive Python](~/python/media/interactive-window.png)
...
![Lien vers la fenêtre interactive dans la fenêtre des environnements Python](~/python/media/interactive-window-opening.png)
...
![Éléments de menu de la fenêtre interactive dans View > Other Windows (Affichage > Autres fenêtres)](~/python/media/interactive-window-menu.png)
...
![Exécution du projet dans le menu Python Interactive](~/python/media/interactive-execute-project.png)
...
![Portées de la fenêtre interactive](~/python/media/interactive-scopes.png)
...
![Fenêtre interactive dans la portée importlib](~/python/media/interactive-importlib-scope.png)
...
![Commande de menu Envoyer vers Interactive](~/python/media/interactive-send-to.png)
