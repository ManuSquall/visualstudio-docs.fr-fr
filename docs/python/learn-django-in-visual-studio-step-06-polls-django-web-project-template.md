...
Tout d’abord, les modèles d’URL dans `urls.py` du projet Django inclut `url(r'^admin/', include(admin.site.urls)),` par défaut ; le modèle « admin/doc » est également inclus sous forme de commentaire.
