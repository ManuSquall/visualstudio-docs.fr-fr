...
- [Étape 0 : Installation](vs-tutorial-01-00.md)
- [Étape 1 : Création d’un projet Python (cette rubrique)](#step-1-create-a-new-python-project)
- [Étape 2 : Écriture et exécution du code pour voir à l’œuvre Visual Studio IntelliSense](vs-tutorial-01-02.md)
- [Étape 3 : Créer davantage de code dans la fenêtre REPL interactive](vs-tutorial-01-03.md)
- [Étape 4 : Exécuter le programme terminé dans le débogueur Visual Studio](vs-tutorial-01-04.md)
...
> [Écriture et exécution de code](vs-tutorial-01-02.md)
