---
title: "Utilisation de Python dans Visual Studio, Étape 3 | Microsoft Docs"
ms.custom: 
ms.date: 10/16/2017
ms.reviewer: 
ms.suite: 
...
**Étape précédente : [Écriture et exécution du code](vs-tutorial-01-02.md)**
...
> [Exécution de code dans le débogueur](vs-tutorial-01-04.md)
