...
1. Cette action crée un `test1.py file with code that imports the standard `unittest` module, derives a test class from `unittest.TestCase`, and invokes `unittest.main() si vous exécutez le script directement :
