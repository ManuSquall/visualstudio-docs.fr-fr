...
1. Installez la version de Python Tools pour Visual Studio adaptée à votre version de Visual Studio :
    ...
    - Visual Studio 2013 : [PTVS 2.2.2 pour Visual Studio 2013](https://github.com/Microsoft/PTVS/releases/v2.2.2). La boîte de dialogue **Fichier** > **Nouveau projet** de Visual Studio 2013 vous offre un raccourci pour ce processus.
