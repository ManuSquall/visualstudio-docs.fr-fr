---
title: "Démarrage rapide : Création d’un projet Python dans Visual Studio à partir de code existant | Microsoft Docs"
description: "Commencez rapidement à utiliser Python en créant un projet Visual Studio à partir de code existant, à l’aide d’un modèle pratique."
ms.custom: 
ms.date: 01/08/2018
ms.reviewer: 
ms.suite: 
