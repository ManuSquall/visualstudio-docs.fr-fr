---
title: ID de composant et de charge de travail de Visual Studio Professional
titleSuffix: ''
description: Utilisez Visual Studio Professional ID de composant et de charge de travail pour installer Visual Studio à partir de la ligne de commande ou spécifier une dépendance dans un manifeste VSIX.
keywords: ''
author: ornellaalt
ms.author: ornella
manager: jillfra
