...
Vous devez avoir une connexion Internet pour effectuer cette étape. To create an offline installation with all languages and all features, use a command that is similar to one of the following examples.
