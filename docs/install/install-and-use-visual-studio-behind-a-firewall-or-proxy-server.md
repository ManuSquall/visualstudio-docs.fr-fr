...
| Package NPM <br>détection | Skimdb.npmjs.com <br><br>Registry.npmjs.org <br><br>Api.npms.io | https/443<br><br>& http/80<br> https/443<br>https/443 | Requis pour la recherche de packages NPM et utilisé pour l’installation de packages de scripts côté client dans les projets Web |
...
| Service d’empaquetage | [compte].visualstudio.com <br/> [compte].\*.visualstudio.com <br/> \*.blob.core.windows.net <br/> registry.npmjs.org </br> nodejs.org <br/> dist.nuget.org <br/> nuget.org | https/443 | Les \*. npmjs.org, \*. nuget.org et \*. nodejs.org sont uniquement nécessaires pour certains scénarios de tâches de génération (par exemple, le programme d’installation de l’outil NuGet, le programme d’installation de l’outil node) ou si vous envisagez d’utiliser le public en amont avec vos flux. Les trois autres domaines sont requis pour les fonctionnalités de base du service de création de packages. |
