...
3.  Dans la fenêtre **Propriétés**, choisissez la propriété **Custom Properties**, puis choisissez le bouton de sélection \(![Bouton de sélection du concepteur ASP.NET mobile](~/sharepoint/media/mwellipsis.gif "Bouton de sélection du concepteur ASP.NET mobile")\).  
