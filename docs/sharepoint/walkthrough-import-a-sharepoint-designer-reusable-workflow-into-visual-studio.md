...
11. Étant donné que le modèle **Importer le flux de travail réutilisable SharePoint 2010** n'importe pas les valeurs de propriété d'association pour le flux de travail importé, vous devez les entrer.  Pour cela :  
    ...
    2.  Cliquez sur le bouton de sélection \(![Bouton de sélection du concepteur ASP.NET mobile](~/docs/sharepoint/media/mwellipsis.gif "Bouton de sélection du concepteur ASP.NET mobile")\) à côté de l'une des propriétés de liste, telle que la propriété **Liste cible**.  
