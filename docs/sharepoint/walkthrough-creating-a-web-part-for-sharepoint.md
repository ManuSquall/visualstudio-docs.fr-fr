...
1. Démarrez [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] à l’aide de l’option **exécuter en tant qu’administrateur** .
...
1. Dans **Explorateur de solutions**, ouvrez *WebPart1. vb* (dans Visual Basic) ou *WebPart1.cs* (dans C#).
