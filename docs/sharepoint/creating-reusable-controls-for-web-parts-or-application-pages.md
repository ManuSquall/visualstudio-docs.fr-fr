...
## <a name="creating-a-user-control"></a>Création d’un contrôle utilisateur  
...
## <a name="designing-the-user-control"></a>Conception du contrôle utilisateur  
...
## <a name="consuming-the-user-control"></a>Utilisation du contrôle utilisateur  
...
## <a name="debugging-a-user-control"></a>Débogage d’un contrôle utilisateur  
