...
description: Utilisez le service de projet SharePoint pour effectuer des tâches liées au système de projet. Affichez la liste des fonctionnalités du service de projet.
