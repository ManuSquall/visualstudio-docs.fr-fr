---
title: "Importation d&#39;&#233;l&#233;ments d&#39;un site SharePoint existant"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  ...
  - "développement SharePoint dans Visual Studio, importer des fichiers .wsp"
...
## Que se passe\-t\-il lorsque vous importez une solution ?  
...
### Gestion des cas spéciaux  
 ...
 Quand vous importez des récepteurs d’événements, le fichier Elements.xml est copié vers l’emplacement correct, mais vous devez inclure manuellement l’assembly dans le package de solution pour qu’il soit déployé avec la solution.[!INCLUDE[crabout](../sharepoint/includes/crabout-md.md)] la procédure à suivre, consultez [Comment : ajouter et supprimer des assemblys supplémentaires](../sharepoint/how-to-add-and-remove-additional-assemblies.md).  
...
## Limite quant au nombre de caractères du nom d’article  
