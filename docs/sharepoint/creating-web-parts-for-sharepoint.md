...
## <a name="visual-web-part-limitations"></a>Limitations de Visual web part
...
## <a name="create-older-style-sharepoint-based-web-parts"></a>Créer des composants de site web SharePoint
