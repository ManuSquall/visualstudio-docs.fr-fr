...
## <a name="development-computer-requirements"></a>Exigences du développement d’ordinateur
 Pour créer des extensions pour les outils SharePoint, votre ordinateur de développement doit respecter les mêmes exigences pour la création de solutions SharePoint dans Visual Studio. Pour plus d’informations, consultez [configuration requise pour développer des solutions SharePoint](../sharepoint/requirements-for-developing-sharepoint-solutions.md).  
