...
### Modèle objet automation Visual Studio  
 ...
 Pour plus d'informations sur le modèle objet automation, consultez [Extension de l'environnement Visual Studio](../Topic/Extending%20the%20Visual%20Studio%20Environment.md) et [Guide de référence de l'extensibilité et de l'automation](../Topic/Automation%20and%20Extensibility%20Reference.md).  
