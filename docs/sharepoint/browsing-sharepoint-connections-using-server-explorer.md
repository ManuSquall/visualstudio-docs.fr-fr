...
ms.locfileid: "34691415"
---
# <a name="browsing-sharepoint-connections-that-use-server-explorer"></a>Parcours des connexions SharePoint qui utilisent l’Explorateur de serveurs
...
## <a name="node-shortcut-menu-commands"></a>Commandes de menu contextuel de nœud
 Chaque nœud dispose d’un menu contextuel auxquels vous accédez en cliquant sur le nœud ou sélectionnez-le, puis en choisissant le **MAJ**+**F10** clés. Commandes de nœud peuvent inclure les éléments suivants :  
