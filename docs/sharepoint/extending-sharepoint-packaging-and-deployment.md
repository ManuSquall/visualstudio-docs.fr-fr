...
## <a name="run-command-line-operations-before-or-after-a-project-is-deployed"></a>Exécuter des opérations de ligne de commande avant ou après le déployée d’un projet
