...
- [Guide pratique pour Créer des règles de validation pour les solutions SharePoint package et fonctionnalité personnalisée](../sharepoint/how-to-create-custom-feature-and-package-validation-rules-for-sharepoint-solutions.md)
