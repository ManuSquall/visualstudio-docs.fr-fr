...
5.  Dans le volet inférieur du concepteur, sélectionnez les balises `<Grid>` et `</Grid>` et remplacez-les par le code XAML suivant :  
    ...
    ```  
     ...
     ![Contrôle utilisateur QuickStartTask](~/docs/designers/media/wpfquickstart1.PNG "WPFQuickStart1")  
...
5.  Sélectionnez les balises `<Grid>` et `</Grid>` , et remplacez-les par le code XAML suivant :  
    ...
    ```  
     ...
     ![MainWindow dans le concepteur](~/docs/designers/media/wpfquickstart2.PNG "WPFQuickStart2")  
...
3.  Entrée `Do something else`, puis choisissez le bouton **Enregistrer** .  
     ...
     ![Les éléments TODO sont ajoutés à la liste.](~/docs/designers/media/wpfquickstart3.PNG "WPFQuickStart3")  
