...
- **NuGet :** Vous pouvez gérer les packages NuGet aussi bien dans Visual Studio que dans Blend pour Visual Studio. NuGet est un gestionnaire de package pour .NET, qui simplifie l’installation et la suppression de packages d’une solution.
