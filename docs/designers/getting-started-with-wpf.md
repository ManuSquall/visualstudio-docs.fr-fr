...
|||  
|-|-|  
|Je veux rentrer dans le vif du sujet...|[Procédure pas à pas : ma première application de bureau WPF](../designers/walkthrough-my-first-wpf-desktop-application2.md)|  
...
|En savoir plus sur WPF...|[Présentation de WPF](../designers/introduction-to-wpf.md)<br /><br /> [Vue d’ensemble du langage XAML (WPF)](/dotnet/framework/wpf/advanced/xaml-overview-wpf)<br /><br /> [Contrôles](/dotnet/framework/wpf/controls/)<br /><br /> [Vue d’ensemble de la liaison de données](/dotnet/framework/wpf/data/data-binding-overview)<br /><br /> [Liaison de données WPF avec LINQ to XML](../designers/wpf-data-binding-with-linq-to-xml.md)|  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Page d’accueil de la documentation .NET](/dotnet/index)   
