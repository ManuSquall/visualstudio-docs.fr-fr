...
![Panneau Outils dans Blend pour Visual Studio](../designers/media/blend-tools-panel.png)
...
![Fenêtre Composants dans Blend pour Visual Studio](../designers/media/blend-assets-window.png)
...
![Fenêtre Objets et chronologie en mode animation](../designers/media/storyboard-timeline.png)
