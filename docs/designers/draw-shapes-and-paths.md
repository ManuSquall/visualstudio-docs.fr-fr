...
### <a name="draw-a-straight-line"></a>Tracer une ligne droite
 Utilisez l’outil **Plume** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png) ou l’outil **Ligne** ![](../designers/media/eb618397-5283-48be-8396-3449be7b6fbf.png).

 **Utilisation de l'outil Plume** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)
 ...
 **Utilisation de l'outil Ligne** ![](../designers/media/eb618397-5283-48be-8396-3449be7b6fbf.png)
...
### <a name="draw-a-curve"></a>Tracer une courbe
 Utilisez l'outil **Plume** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png).
...
### <a name="change-the-shape-of-a-curve"></a>Modifier la forme d'une courbe
 Utilisez l'outil **Sous-sélection** ![](../designers/media/6dd6571f-c116-451d-8dd2-1f88b8406362.png).
...
### <a name="draw-a-free-form-path"></a>Dessiner un tracé de forme libre
 Utilisez l'outil **Crayon** ![](../designers/media/509dc167-734f-46c9-b012-987ee63450cd.png).
...
### <a name="remove-a-point-in-a-path"></a>Supprimer un point sur un tracé
 Utilisez l'outil **Sélection** ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png)et l'outil **Plume** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png).

 Utilisez l'outil **Sélection** ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png) pour sélectionner le tracé. Utilisez ensuite l'outil **Plume** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png) pour cliquer sur le point à supprimer.

### <a name="add-a-point-to-a-path"></a>Ajouter un point à un tracé
 Utilisez l'outil **Sélection** ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png)et l'outil **Plume** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png).

 Utilisez l'outil **Sélection** ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png) pour sélectionner le tracé. Utilisez l'outil **Plume** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png) pour cliquer à l'endroit où vous voulez ajouter le point sur le tracé.
...
|||||
|-|-|-|-|
|![](../designers/media/b1_1.png)|Les deux formes avant d'être combinées|![](../designers/media/b1_4.png)|Définir une intersection|
|![](../designers/media/b1_2.png)|Unir|![](../designers/media/b1_5.png)|Exclure le chevauchement|
|![](../designers/media/b1_3.png)|Diviser|![](../designers/media/b1_6.png)|Soustraire|
