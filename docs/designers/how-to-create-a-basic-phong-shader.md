...
description: Découvrez comment utiliser le concepteur de nuanceur et le langage de nuanceur de graphe orienté pour créer un nuanceur d’éclairage qui implémente le modèle d’éclairage Phong classique.
