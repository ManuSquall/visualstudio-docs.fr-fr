---
title: Examiner les nœuds à l’aide de la vue de modèle de contenu dans le Concepteur de schémas XML
ms.date: 11/04/2016
ms.topic: conceptual
...
8. Cliquez sur le **afficher la Documentation** bouton dans la barre d’outils XSD pour activer/désactiver la documentation. Vous pouvez également cliquer avec le bouton droit sur l'aire de conception pour basculer vers la documentation.

9. Cliquez sur le `purchaseOrder` nœud et sélectionnez **générer un exemple de code XML** pour voir le document d’instance XML.
