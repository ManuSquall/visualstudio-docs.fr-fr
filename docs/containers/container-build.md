...
---
# <a name="build-and-debug-containerized-apps-using-visual-studio-or-the-command-line"></a>Build and debug containerized apps using Visual Studio or the command line
...
## <a name="multistage-build"></a>Multistage build
...
## <a name="faster-builds-for-the-debug-configuration"></a>Faster builds for the Debug configuration
...
## <a name="building-from-the-command-line"></a>Building from the command line
...
To build an image for single docker container project you can use MSBuild with the `/t:ContainerBuild` command option. Exemple :
...
## <a name="project-warmup"></a>Project warmup
...
## <a name="volume-mapping"></a>Volume mapping
...
## <a name="ssl-enabled-aspnet-core-apps"></a>SSL-enabled ASP.NET Core apps
...
## <a name="container-entry-point"></a>Container entry point
