...
Si vous avez modifié votre conteneur manuellement et souhaitez redémarrer avec une image de conteneur propre, utilisez la commande **générer** > **nettoyer** dans Visual Studio, puis générez la valeur normal.
