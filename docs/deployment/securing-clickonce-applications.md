...
ms.locfileid: "39080338"
---
# <a name="secure-clickonce-applications"></a>Sécuriser les applications ClickOnce
...
## <a name="code-access-security-policies"></a>Stratégies de sécurité d’accès au code  
...
## <a name="aspnet-form-based-authentication"></a>Authentification par formulaire ASP.NET  
