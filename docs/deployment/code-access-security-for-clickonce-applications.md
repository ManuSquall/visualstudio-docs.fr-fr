...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "déploiement d’applications (ClickOnce), sécurité"
  - "applications ClickOnce, caspol"
  - "sécurité (ClickOnce), applications WPF hébergées dans un navigateur"
  - "sécurité (ClickOnce), applications ClickOnce"
  - "applications ClickOnce, stratégies de sécurité d’accès du code"
  - "sécurité, ClickOnce"
