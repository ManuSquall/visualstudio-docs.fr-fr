...
helpviewer_keywords: 
  - "fichiers .pfx"
  - "déploiement ClickOnce, Authenticode"
  - "Authenticode, ClickOnce"
  - "déploiement ClickOnce, certificats"
...
-   Générez votre propre certificat avec MakeCert.exe, fourni dans le [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)].  
  
### Avantages de l’utilisation d’autorités de certification pour les utilisateurs  
 ...
 Pour plus d’informations sur la génération de certificats automatiques, consultez [Makecert.exe \(Certificate Creation Tool\)](../Topic/Makecert.exe%20\(Certificate%20Creation%20Tool\).md).  
...
### Mise à jour des certificats expirés  
