...
## <a name="versioning-issues"></a>Problèmes de contrôle de version  
 ...
 Cette erreur peut se produire uniquement si vous modifiez votre [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] manifestes manuellement ; vous ne devez pas rencontrer cette erreur si vous générez votre déploiement à l’aide de [!INCLUDE[vsprvslong](../code-quality/includes/vsprvslong_md.md)].  
