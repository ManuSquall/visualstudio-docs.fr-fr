...
description: L’élément Product est l’élément XML de niveau supérieur à l’intérieur d’un fichier produit. L’élément Product est requis dans un fichier produit.
