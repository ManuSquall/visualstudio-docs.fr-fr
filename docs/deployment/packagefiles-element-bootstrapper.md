...
description: En savoir plus sur l’élément PackageFiles, qui contient les éléments PackageFile qui définissent les packages d’installation exécutés à la suite de l’élément Command.
