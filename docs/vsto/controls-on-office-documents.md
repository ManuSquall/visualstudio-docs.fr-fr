...
# <a name="controls-on-office-documents"></a>Contrôles sur des documents Office
 ...
 Lorsque vous développez des projets de complément VSTO pour Excel ou Word, vous pouvez ajouter par programmation ces contrôles à n’importe quel document ou classeur ouvert au moment de l’exécution.  
