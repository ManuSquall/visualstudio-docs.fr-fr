---
title: "Vue d&#39;ensemble des &#233;l&#233;ments h&#244;tes et des contr&#244;les h&#244;tes | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  ...
  - "éléments hôtes (développement Office dans Visual Studio)"
  ...
  - "contrôles hôtes (développement Office dans Visual Studio), liste"
  - "Excel (développement Office dans Visual Studio), éléments hôtes"
  - "contrôles hôtes (développement Office dans Visual Studio), affecter des noms"
  - "contrôles hôtes (développement Office dans Visual Studio)"
  - "contrôles hôtes (développement Office dans Visual Studio), à propos des contrôles hôtes"
  ...
  - "éléments hôtes (développement Office dans Visual Studio), à propos des éléments hôtes"
  - "éléments hôtes (développement Office dans Visual Studio), liste"
  - "documents (développement Office dans Visual Studio), éléments hôtes"
  - "liaison de données (développement Office dans Visual Studio), contrôles hôtes"
  ...
  - "contrôles hôtes (développement Office dans Visual Studio), supprimer"
...
### Présentation des éléments hôtes dans les projets au niveau du document  
...
### Présentation des éléments hôtes dans les projets de complément VSTO  
...
-   [XMLNodes, contrôle](../vsto/xmlnodes-control.md)  
 ...
 Vous pouvez également utiliser des contrôles Windows Forms dans vos solutions Office en les ajoutant directement à la surface du document Word et Excel. Pour plus d'informations, consultez [Vue d'ensemble des contrôles Windows Forms dans les documents Office](../vsto/windows-forms-controls-on-office-documents-overview.md).  
  
> [!NOTE]  
>  L’ajout de contrôles hôtes ou de contrôles Windows Forms à un sous\-document Word n’est pas pris en charge.  
  
### Ajout de contrôles hôtes à vos documents  
...
> [!NOTE]  
>  Vous ne devez pas attribuer la valeur **false** à la propriété <xref:Microsoft.Office.Interop.Excel._Application.EnableEvents%2A> de l'objet <xref:Microsoft.Office.Interop.Excel.Application> dans Excel. Si cette propriété a la valeur **false**, Excel ne peut pas déclencher d’événements, y compris les événements de contrôles hôtes.  
