---
title: "Combinaison de VBA et de personnalisations au niveau du document | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  ...
  - "VBA (développement Office dans Visual Studio)"
  - "documents Office (développement Office dans Visual Studio), et Visual Basic pour Applications"
  - "VBA (développement Office dans Visual Studio), à propos de VBA et des personnalisations au niveau du document"
  - "code managé (développement Office dans Visual Studio), et Visual Basic pour Applications"
  - "personnalisations au niveau du document (développement Office dans Visual Studio), et Visual Basic pour Applications"
...
> [!NOTE]  
>  Pour plus d’informations sur l’utilisation de la variable globale `missing` à la place de paramètres facultatifs dans Visual C\#, consultez [Écriture de code dans les solutions Office](../vsto/writing-code-in-office-solutions.md).  
  
## Appel de code dans les personnalisations au niveau du document depuis VBA  
...
## Permettre au code VBA d'exécuter un appel dans l'assembly de personnalisation  
...
-   Vous pouvez exposer à VBA des membres de n'importe quelle classe publique dans un projet Visual C\# ou des membres d'une classe d'élément non hôte dans un projet [!INCLUDE[vbprvb](../sharepoint/includes/vbprvb-md.md)]. Cette option vous offre davantage de liberté pour choisir les classes à exposer à VBA, mais elle nécessite également plus d'étapes manuelles.  
 ...
 Pour obtenir des instructions détaillées, consultez [Comment : exposer du code à VBA dans un projet Visual Basic](../vsto/how-to-expose-code-to-vba-in-a-visual-basic-project.md) et [Comment : exposer du code à VBA dans un projet Visual C&#35;](../vsto/how-to-expose-code-to-vba-in-a-visual-csharp-project.md).  
...
## Utilisation de membres dans le code VBA pour exécuter un appel dans l'assembly de personnalisation  
