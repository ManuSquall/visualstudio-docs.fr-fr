...
# Personnalisation d&#39;un ruban pour Outlook
 ...
 ![lien vers la vidéo](~/docs/data-tools/media/playvideo.gif "lien vers la vidéo") Pour visionner la démonstration vidéo associée, consultez [Comment : utiliser Concepteur de ruban pour personnaliser le ruban dans Outlook](http://go.microsoft.com/fwlink/?LinkID=130312).  
