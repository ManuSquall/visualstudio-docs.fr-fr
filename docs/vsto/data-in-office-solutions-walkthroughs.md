---
title: "Proc&#233;dures pas &#224; pas relatives aux donn&#233;es dans les solutions Office | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "données (développement Office dans Visual Studio), procédures pas à pas"
  - "procédures pas à pas (développement Office dans Visual Studio), données"
...
---
# Proc&#233;dures pas &#224; pas relatives aux donn&#233;es dans les solutions Office
...
## Liaison de contrôles à des données  
...
## Mise en cache des données dans les solutions au niveau du document  
 ...
 [Procédure pas à pas : récupération des données mises en cache d'un classeur sur un serveur](../vsto/walkthrough-retrieving-cached-data-from-a-workbook-on-a-server.md)  
...
## Voir aussi  
 ...
 [Procédures pas à pas relatives à la personnalisation de l'interface utilisateur Office](../vsto/office-ui-customization-walkthroughs.md)   
