...
### <a name="word-customization-programming-model"></a>Modèle de programmation de personnalisation Word
 ...
 Pour plus d’informations sur `ThisDocument` la classe et les autres fonctionnalités que vous pouvez utiliser dans un projet au niveau du document, consultez [programmes de personnalisation au niveau du document](../vsto/programming-document-level-customizations.md).
