---
title: "Solutions Word | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "solutions (développement Office dans Visual Studio), Word"
  - "projets Office (développement Office dans Visual Studio), Word"
  - "compléments de niveau application (développement Office dans Visual Studio), Word"
  - "Word (développement Office dans Visual Studio)"
  - "projets (développement Office dans Visual Studio), Word"
  - "Word (développement Office dans Visual Studio), à propos des solutions Word"
  - "solutions Office (développement Office dans Visual Studio), Word"
  - "Word (développement Office dans Visual Studio), compléments de niveau application"
  - "documents (développement Office dans Visual Studio), Word"
  - "développement Office dans Visual Studio, solutions Word"
  - "compléments (développement Office dans Visual Studio), Word"
  - "Word (développement Office dans Visual Studio), personnalisations au niveau du document"
  - "interfaces utilisateur (développement Office dans Visual Studio), Word"
  - "documents Office (développement Office dans Visual Studio), Word"
  - "personnalisations au niveau du document (développement Office dans Visual Studio), Word"
...
##  <a name="doclevel"></a> Développement de personnalisations au niveau du document pour Word  
...
### Modèle de programmation de personnalisation Word  
 ...
 Pour plus d’informations sur la classe `ThisDocument` et les autres fonctionnalités que vous pouvez utiliser dans un projet au niveau du document, consultez [Programmation de personnalisations au niveau du document](../vsto/programming-document-level-customizations.md).  
...
### Modèle de programmation de complément Word  
 ...
 Pour plus d’informations sur la classe `ThisAddIn` et les autres fonctionnalités que vous pouvez utiliser dans un complément VSTO, consultez [Programmation de compléments VSTO](../vsto/programming-vsto-add-ins.md).  
  
##  <a name="UI"></a> Personnalisation de l'interface utilisateur de Word  
...
|[Automatisation de Word à l'aide d'objets étendus](../vsto/automating-word-by-using-extended-objects.md)|Fournit des informations sur les objets étendus \(fournis par [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)]\) que vous pouvez utiliser dans les solutions Word.|  
