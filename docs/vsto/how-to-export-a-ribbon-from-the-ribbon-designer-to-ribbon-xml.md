---
title: 'Comment : exporter un ruban à partir du Concepteur de ruban vers ruban XML'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "35255075"
---
# <a name="how-to-export-a-ribbon-from-the-ribbon-designer-to-ribbon-xml"></a>Comment : exporter un ruban à partir du Concepteur de ruban vers ruban XML
