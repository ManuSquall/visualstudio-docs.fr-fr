---
title: Utilisation des classeurs | Documents Microsoft
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
|Tâche|Procédure|  
|----------|---------------|  
|Créer un classeur.|[Guide pratique pour créer des classeurs par programmation](../vsto/how-to-programmatically-create-new-workbooks.md)|  
...
|Obtenir un ensemble de fichiers de classeur utilisés récemment.|[Guide pratique pour répertorier les fichiers de classeur récemment utilisés par programmation](../vsto/how-to-programmatically-list-recently-used-workbook-files.md)|  
