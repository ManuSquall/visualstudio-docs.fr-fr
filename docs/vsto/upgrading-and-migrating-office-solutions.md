...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "applications Office (développement Office dans Visual Studio), mettre à niveau"
  - "projets Office (développement Office dans Visual Studio), mettre à niveau"
  - "mettre à niveau des applications (développement Office dans Visual Studio)"
  - "mettre à niveau des solutions Office dans Visual Studio"
  - "migrer des solutions Office dans Visual Studio"
...
-   Assemblys dans [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)]. Pour plus d’informations sur ces assemblys, consultez [Vue d'ensemble de Visual Studio Tools pour Office Runtime](../vsto/visual-studio-tools-for-office-runtime-overview.md).  
...
> [!NOTE]  
>  Si vous mettez à niveau un projet de complément VSTO pour cibler [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)] ou une version ultérieure, assurez\-vous que le gestionnaire d’événements `ThisAddIn_Startup` du complément VSTO ne contient pas de code qui accède à un document dans l’application. Pour plus d'informations, consultez [Accès à un document lorsque l'application Office démarre](../vsto/programming-vsto-add-ins.md#AccessingDocuments).  
...
### Projets de complément VSTO  
 ...
 Si vous voulez utiliser ClickOnce pour déployer votre complément VSTO, vous pouvez supprimer entièrement le projet d’installation ou InstallShield Limited Edition. Pour plus d’informations sur le déploiement de compléments VSTO à l’aide de ClickOnce, consultez [Déploiement d'une solution Office](../vsto/deploying-an-office-solution.md).  
