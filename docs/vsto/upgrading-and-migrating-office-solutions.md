---
title: Mise à niveau et migrer des solutions Office
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "34767271"
---
# <a name="upgrade-and-migrate-office-solutions"></a>Mise à niveau et migrer des solutions Office
...
### <a name="vsto-add-in-projects"></a>Projets de complément VSTO  
 ...
 Si vous voulez utiliser ClickOnce pour déployer votre complément VSTO, vous pouvez supprimer entièrement le projet d’installation ou InstallShield Limited Edition. Pour plus d’informations sur le déploiement des Compléments VSTO à l’aide de ClickOnce, consultez [déployer une solution Office](../vsto/deploying-an-office-solution.md).  
