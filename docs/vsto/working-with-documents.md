...
|Tâche|Procédure|  
|----------|---------------|  
|Créer un document basé sur le modèle Normal ou sur un autre modèle.|[Guide pratique pour Créer par programme des documents](../vsto/how-to-programmatically-create-new-documents.md)|  
...
|Afficher l'aperçu avant impression pour un document.|[Guide pratique pour Afficher des documents par programmation dans l’aperçu avant impression](../vsto/how-to-programmatically-display-documents-in-print-preview.md)|  
|Afficher une boîte de dialogue intégrée et collecter l'entrée de l'utilisateur.|[Guide pratique pour Utiliser par programmation les boîtes de dialogue intégrées dans Word](../vsto/how-to-programmatically-use-built-in-dialog-boxes-in-word.md)|  
|Utiliser les fonctionnalités d'une boîte de dialogue intégrée sans l'afficher.|[Guide pratique pour Par programmation les boîtes de dialogue utiliser Word en mode masqué](../vsto/how-to-programmatically-use-word-dialog-boxes-in-hidden-mode.md)|  
|Ajouter une image ou des effets WordArt à un document.|[Guide pratique pour Ajouter par programmation des images et des effets WordArt aux documents](../vsto/how-to-programmatically-add-pictures-and-word-art-to-documents.md)|  
...
|Ajouter un en-tête ou un pied de page à un document.|[Guide pratique pour Ajouter par programmation des en-têtes et pieds de page aux documents](../vsto/how-to-programmatically-add-headers-and-footers-to-documents.md)|  
|Supprimer tous les commentaires d'un document.|[Guide pratique pour Supprimer par programmation tous les commentaires des documents](../vsto/how-to-programmatically-remove-all-comments-from-documents.md)|  
