...
description: Apprenez à ajouter des contrôles à une feuille de calcul Microsoft Excel et à lier les contrôles aux données au moment de l’exécution.
