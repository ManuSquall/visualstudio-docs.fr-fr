...
-   [Word, InfoPath et PowerPoint](#WordAndInfoPath)  
 ...
 ![lien vers la vidéo](~/data-tools/media/playvideo.gif "lien vers la vidéo") Pour visionner une vidéo associée, consultez [Comment : gérer les volets de tâches dans les compléments VSTO Word](http://go.microsoft.com/fwlink/?LinkID=136781).  
