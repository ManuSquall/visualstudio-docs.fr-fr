...
1.  Ouvrez un projet au niveau du document pour Microsoft Office Word qui inclut un volet actions avec plusieurs contrôles utilisateur ou contrôles de volet actions imbriqués. Pour plus d’informations, consultez [Comment : ajouter un volet actions à des documents Word ou de classeurs Excel](../vsto/how-to-add-an-actions-pane-to-word-documents-or-excel-workbooks.md).  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Comment : ajouter un volet actions aux classeurs des Documents Word ou Excel](../vsto/how-to-add-an-actions-pane-to-word-documents-or-excel-workbooks.md)   
