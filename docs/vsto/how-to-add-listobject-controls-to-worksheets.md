---
title: 'Procédure : Ajouter des contrôles ListObject aux feuilles de calcul'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
##  <a name="designtime"></a> Ajouter des contrôles ListObject au moment du design  
 Il existe plusieurs façons d’ajouter <xref:Microsoft.Office.Tools.Excel.ListObject> contrôles à une feuille de calcul dans un projet au niveau du document au moment du design : À partir d’Excel, à partir de Visual Studio **boîte à outils**et à partir de la **des Sources de données** fenêtre.  
