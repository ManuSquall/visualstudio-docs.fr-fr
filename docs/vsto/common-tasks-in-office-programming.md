...
##  <a name="projects"></a> Le programme d’installation et tâches générales  
...
### <a name="controls-on-documents-and-worksheets"></a>Contrôles sur des documents et feuilles de calcul  
...
### <a name="task-panes-in-document-level-customizations"></a>Volets de tâches dans les personnalisations au niveau du document  
  
-   [Guide pratique pour Ajouter un volet actions à des documents Word ou de classeurs Excel](../vsto/how-to-add-an-actions-pane-to-word-documents-or-excel-workbooks.md).  
  
### <a name="task-panes-in-vsto-add-ins"></a>Volets de tâches dans des Compléments VSTO  
...
-   [Guide pratique pour Ajouter des commandes aux menus contextuels](../vsto/how-to-add-commands-to-shortcut-menus.md).  
  
##  <a name="excel"></a> Tâches d’automatisation Excel  
  
-   [Guide pratique pour Afficher par programme une chaîne dans une cellule de feuille de calcul](../vsto/how-to-programmatically-display-a-string-in-a-worksheet-cell.md).  
...
-   [Guide pratique pour Trier les données dans des feuilles de calcul par programmation](../vsto/how-to-programmatically-sort-data-in-worksheets.md).  
...
-   [Guide pratique pour Mettre en forme dans les documents par programmation](../vsto/how-to-programmatically-format-text-in-documents.md).  
...
##  <a name="data"></a> Tâches de données  
...
-   [Guide pratique pour Mettre en cache les données dans un document protégé par un mot de passe](../vsto/how-to-cache-data-in-a-password-protected-document.md).  
...
-   [Guide pratique pour Mise à jour des solutions Office déployées](https://msdn.microsoft.com/be96db53-b6ea-46ab-b8d9-b76b098b3b13).  
