...
##### [Activer l’accès à VBA pour créer ou ouvrir Visual Studio Tools pour un projet Microsoft Office System](enable-access-to-vba-to-create-or-open-a-visual-studio-tools-for-office-system-project.md)
