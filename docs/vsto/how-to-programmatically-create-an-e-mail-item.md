---
title: 'Comment : créer un élément de courrier électronique par programmation'
ms.date: 02/02/2017
ms.topic: how-to
dev_langs:
- VB
...
ms.locfileid: "85546040"
---
# <a name="how-to-programmatically-create-an-email-item"></a>Comment : créer un élément de courrier électronique par programmation
