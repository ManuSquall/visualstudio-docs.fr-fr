...
-   [Ajout de contrôles Windows Forms aux documents](#WindowsForms)  
 ...
 ![lien vers la vidéo](../vsto/media/playvideo.png "lien vers la vidéo") Pour visionner la démonstration vidéo associée, consultez [Comment ajouter des contrôles à la surface d’un document au moment de l’exécution ?](http://go.microsoft.com/fwlink/?LinkId=132782).  
