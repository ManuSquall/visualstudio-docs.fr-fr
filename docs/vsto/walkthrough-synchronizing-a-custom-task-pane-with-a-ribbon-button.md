...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "volets Office personnalisés (développement Office dans Visual Studio), afficher et masquer"
  - "afficher des volets de tâches personnalisés"
  - "Ruban (développement Office dans Visual Studio), volets Office personnalisés"
  - "boutons bascule (développement Office dans Visual Studio)"
  - "volets Office personnalisés (développement Office dans Visual Studio), synchroniser avec un bouton du ruban"
  - "interfaces utilisateur (développement Office dans Visual Studio), volets Office personnalisés"
  - "synchronisation (développement Office dans Visual Studio), volets Office personnalisés"
  - "volets Office (développement Office dans Visual Studio), afficher et masquer"
  - "volets Office personnalisés (développement Office dans Visual Studio), créer"
  - "masquer des volets de tâches personnalisés"
  - "volets Office (développement Office dans Visual Studio), créer"
  - "volets Office (développement Office dans Visual Studio), synchroniser avec un bouton du ruban"
...
## Création du volet Office personnalisé  
...
## Masquage et affichage du volet Office personnalisé à l’aide du bouton bascule  
