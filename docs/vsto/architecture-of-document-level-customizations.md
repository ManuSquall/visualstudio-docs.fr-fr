---
title: "Architecture des personnalisations au niveau du document | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  - "VSTOLoader.dll"
  - "formats (développement Office dans Visual Studio)"
  - "formats de fichier (développement Office dans Visual Studio)"
  - "vstoee.dll"
  - "extensions de code managé (développement Office dans Visual Studio), définition"
  - "personnalisations au niveau du document (développement Office dans Visual Studio)"
  - "AddInLoader.dll"
  - "architecture (développement Office dans Visual Studio), personnalisations au niveau du document"
...
-   [Fonctionnement des personnalisations avec les applications Microsoft Office](#HowCustomizationsWork)  
 ...
 Pour obtenir des informations générales sur la création de personnalisations au niveau du document, consultez [Vue d'ensemble du développement des solutions Office &#40;VSTO&#41;](../vsto/office-solutions-development-overview-vsto.md), [Mise en route de la programmation des personnalisations au niveau du document pour Word](../vsto/getting-started-programming-document-level-customizations-for-word.md) et [Mise en route de la programmation des personnalisations au niveau du document pour Excel](../vsto/getting-started-programming-document-level-customizations-for-excel.md).  
  
##  <a name="UnderstandingCustomizations"></a> Présentation des personnalisations  
...
#### Comparaison des perspectives du développeur et de l’utilisateur final  
...
### Formats de documents pris en charge pour les personnalisations au niveau du document  
...
### Prise en charge des documents Word ayant des extensions de noms de fichiers .xml  
