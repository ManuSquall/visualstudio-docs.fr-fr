---
title: "Utilisation de Microsoft Monitoring Agent | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Utilisation de Microsoft Monitoring Agent
...
-   Pour définir des autorisations avec l’Explorateur Windows \(ou l’Explorateur de fichiers\) :  
    ...
    7.  Vérifiez que le pool d’applications possède les autorisations **Lecture et exécution**.  
...
1.  Sur votre serveur web, ouvrez une fenêtre d’invite de commandes **Windows PowerShell** ou **Windows PowerShell ISE** en tant qu’administrateur.  
     ...
     ![Ouvrir Windows PowerShell en tant qu'administrateur](../debugger/media/ffr_powershellrunadmin.png "FFR\_PowerShellRunAdmin")  
...
#### Q : Quelles sont les valeurs collectées par l’agent ?  
...
### Créer un journal des événements enregistrés et continuer la surveillance  
...
2.  Exécutez la commande [Checkpoint\-WebApplicationMonitoring](http://go.microsoft.com/fwlink/?LinkID=313684) pour enregistrer un instantané du journal IntelliTrace :  
     ...
     **Checkpoint\-WebApplicationMonitoring** *"\<Nom\_site\_web\_IIS\>\\\<Nom\_application\_web\_IIS\>"*  
  
     \- ou \-  
  
     **Checkpoint\-WebApplicationMonitoring "IIS:\\sites** *\\\<Nom\_site\_web\_IIS\>\\\<Nom\_application\_web\_IIS\>"*  
...
### Créer un journal des événements enregistrés et arrêter la surveillance  
...
2.  Exécutez la commande [Stop\-WebApplicationMonitoring](http://go.microsoft.com/fwlink/?LinkID=313687) pour créer le journal IntelliTrace et arrêter la surveillance d’une application web spécifique :  
     ...
     **Stop\-WebApplicationMonitoring** *"\<Nom\_site\_web\_IIS\>\\\<Nom\_application\_web\_IIS\>"*  
  
     \- ou \-  
  
     **Stop\-WebApplicationMonitoring "IIS:\\sites** *\\\<Nom\_site\_web\_IIS\>\\\<Nom\_application\_web\_IIS\>"*  
