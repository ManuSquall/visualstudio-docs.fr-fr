...
|Temps CPU :|Temps processeur total passé sur ce processus et ses threads. Égal à temps utilisateur plus temps privilégié.|  
...
|durée calendaire|Le temps total écoulé que ce processus a été exécuté.|