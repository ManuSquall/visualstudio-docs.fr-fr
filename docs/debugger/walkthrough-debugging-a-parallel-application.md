---
title: Déboguer une Application parallèle | Documents Microsoft
description: Déboguer les fenêtres tâches parallèles et piles parallèles dans Visual Studio
ms.custom: ''
ms.date: 03/22/2018
