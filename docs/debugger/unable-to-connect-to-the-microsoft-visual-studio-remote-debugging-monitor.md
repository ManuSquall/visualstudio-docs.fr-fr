...
## <a name="rejected"></a>La demande de connexion a été rejetée par le débogueur distant
...
## <a name="invalid_access"></a>Accès non valide à l’emplacement de la mémoire
...
- Le débogueur distant peut s’exécuter sous un compte d’utilisateur différent. Suivez [ces étapes](#user_accounts).
...
## <a name="security_package"></a>Une erreur spécifique au package de sécurité s’est produite
