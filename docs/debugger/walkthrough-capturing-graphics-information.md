...
-   Dans la barre d’outils Graphics Diagnostics, choisissez le bouton **Capturer**.![Icône du bouton de capture de graphiques](~/docs/debugger/graphics/media/debuggingdirectxgraphics.png "DebuggingDirectXGraphics")  
