...
3. Définissez le champ Qualificateur sur **\<remote nom de l’ordinateur >** et appuyez sur **entrée**.

    Vérifiez que Visual Studio ajoute le port requis au nom de l’ordinateur, qui apparaît au format suivant : **\<remote nom de l’ordinateur >:p Trier**

    ::: moniker range=">=vs-2019"
    Dans Visual Studio 2019, vous devez voir **\<remote nom d’ordinateur >: 4024**
    ::: moniker-end
    ::: moniker range="vs-2017"
    Dans Visual Studio 2017, vous devez voir **\<remote nom d’ordinateur >: 4022**
    ::: moniker-end
