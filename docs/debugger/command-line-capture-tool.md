---
title: "Outil en ligne de commande de capture | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
 ...
 **IsWWA: No**  
 **AppSpec \(to launch\): **DXCap.exe \-c Microsoft.BingMaps\_2.1.2914.1734\_x64\_\_8wekyb3d8bbwe,AppexMaps****  La dernière ligne de sortie affiche la commande qui permet de capturer les informations graphiques de chaque application énumérée.  
...
```  
 ...
 Par défaut, la sortie XML est écrite dans un fichier qui porte le même nom que le journal de graphisme, mais dont l'extension est .xml.  Dans l'exemple ci\-dessus, le fichier XML se nomme **regression\_test\_12.xml**.  Pour renommer le fichier XML, indiquez le nouveau nom après `-toXML`.  
