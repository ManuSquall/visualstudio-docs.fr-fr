...
ms.locfileid: "72745472"
---
# <a name="block"></a>Bloc
Chaque bloc de code est identifié par un symbole de `SymTagBlock`. Les symboles de bloc sont utilisés pour identifier les étendues imbriquées dans les fonctions.
