---
title: IDiaSymbol::get_hasCastOperator | Documents Microsoft
ms.custom: ''
ms.date: 11/04/2016
...
#### <a name="parameters"></a>Paramètres  
 `pRetVal`  
 [out] Retourne un `TRUE` si le type de données défini par l’utilisateur a des opérateurs de cast définies ; sinon, retourne `FALSE`.  
