...
ms.locfileid: "72745235"
---
# <a name="enum-debug-interface-access-sdk"></a>Énumération (Kit de développement logiciel SDK de Debug Interface Access)
Les énumérations sont identifiées par `SymTagEnum` symboles. Chaque valeur d’énumération apparaît en tant qu’enfant de classe avec une balise `SymTagConstant`.
