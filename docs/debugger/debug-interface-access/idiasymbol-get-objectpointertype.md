...
## <a name="remarks"></a>Notes
 Cette propriété s’applique uniquement aux symboles avec un type d' [énumération SymTagEnum](../../debugger/debug-interface-access/symtagenum.md) de `SymTagFunctionType`.
