...
> [!NOTE]
>  Étant donné que l'énumération d' `CV_HREG_e` est trop grande pour reproduire dans son intégralité ici, une version abrégée est fournie en tant que référence.  Les entrées manquantes notated en italique.  l'énumération complète est disponible dans le fichier d'en\-tête de cvconst.h.  
...
## Éléments  
 CV\_REG\_\*  
 Registres utilisés par les processeurs 80x86 et ix86 Intel, et p\- code.  
  
 CV\_R68\_\*  
 S'inscrit utilisé par le processeur 68K.  
  
 CV\_M4\_\*  
 Stocke utilisé par les MIPS 4000 exécution du processeur.  
  
 CV\_ALPHA\_\*  
 S'inscrit utilisé par le processeur de série de Equipment numériquement Corporation Alpha AXP.  
  
 CV\_PPC\_\*  
 S'inscrit utilisé par processeur Motorola PowerPC\/IBM.  
  
 CV\_SH3\_\* et CV\_SH\_\*  
 Registres utilisés par SH processeur de Hitachi SH3 et de Hitachi série.  
  
 CV\_ARM\_\*  
 Registres utilisés par les processeurs de \(ARM\) de l'ordinateur de RISC Advanced.  
  
 CV\_IA64\_\*  
 S'inscrit utilisé par les processeurs de série d'Intel IA64.  
  
 CV\_TRI\_\*  
 S'inscrit utilisé par le processeur de Infineon Technologies TriCore.  
  
 CV\_AM33\_\*  
 Registres utilisés par Matsushita\/Panasonic AM33 et processeurs associés.  
  
 CV\_M32R\_\*  
 S'inscrit utilisé par le processeur de Mitsubishi M32R.  
  
## Notes  
 Chaque type de processeur utilise son propre jeu unique de registres.  
