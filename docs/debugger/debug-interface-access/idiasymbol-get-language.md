...
à Retourne une valeur de l’énumération d' [énumération CV_CFL_LANG](../../debugger/debug-interface-access/cv-cfl-lang.md) qui spécifie la langue de la source.
