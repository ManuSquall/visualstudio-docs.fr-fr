...
2. Dans le **automatique**, **espion**, ou **variables locales** fenêtre, cliquez sur une propriété et sélectionnez **arrêter lorsque la valeur change** dans le menu contextuel.
