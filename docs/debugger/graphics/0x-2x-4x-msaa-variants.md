...
description: Découvrez comment remplacer les paramètres d’anticrénelage (MSAA, multi-sample anti-aliasing) sur toutes les cibles de rendu et chaînes de permutation en utilisant des variantes MSAA 0x, 2x ou 4x.
