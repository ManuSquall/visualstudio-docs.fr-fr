...
description: Si le coût d’une variante de filtrage de texture ponctuelle, bilinéaire, trilinéaire ou anisotrope est significatif, vous pouvez envisager si son utilisation mérite le coût.
