...
## <a name="scenario"></a>Scénario  
 ...
 ![L’objet ne peut pas être visualisé. ] (media/gfx_diag_demo_missing_object_shader_problem.png "gfx_diag_demo_missing_object_shader_problem")  
