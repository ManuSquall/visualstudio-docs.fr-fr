...
Vous pouvez obtenir des données IntelliTrace à partir d’un IntelliTrace session dans Visual Studio Enterprise de débogage. Consultez [fonctionnalités IntelliTrace](../debugger/intellitrace-features.md).
