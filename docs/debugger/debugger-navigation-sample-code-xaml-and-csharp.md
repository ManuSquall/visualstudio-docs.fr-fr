---
title: "Exemple de code navigation (Xaml et c#) débogueur | Documents Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Le code dans cette rubrique est de l’exemple de fichier pour le [parcourir une session de débogage (Xaml et c#)](../debugger/navigate-a-debugging-session-in-visual-studio-xaml-and-csharp.md) rubrique.  
