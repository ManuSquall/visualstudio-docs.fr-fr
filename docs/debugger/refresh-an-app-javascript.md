...
7.  Cliquez sur le bouton Actualiser l'application Windows **, similaire à :** . ![Windows application bouton Actualiser](../debugger/media/js_refresh.png "JS_Refresh"). (Ou appuyez sur F4.)  
