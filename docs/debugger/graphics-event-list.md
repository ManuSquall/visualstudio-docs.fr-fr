...
La liste des événements Graphics dans Visual Studio Graphics Analyzer vous permet d'explorer les événements Direct3D enregistrés durant le rendu d'un frame de votre jeu ou application.  
 ...
 ![Liste des événements ayant « Index » dans leur nom.](../debugger/media/gfx_diag_demo_event_list_orientation.png "gfx_diag_demo_event_list_orientation")  
...
|![Icône d'événement de dessin](../debugger/media/vsg_eventlist_icon_draw.png "vsg_eventlist_icon_draw")|Événement de dessin<br /> Marque un événement de dessin qui s'est produit pendant le frame capturé.|  
|![Icône du marqueur d’événements définie par l’utilisateur](../debugger/media/vsg_eventlist_icon_user.png "vsg_eventlist_icon_user")|Groupe d'événements définis par l'utilisateur<br /> Événements liés au groupe, tels que définis par l'application.|  
|![Icône du marqueur d’événements définie par l’utilisateur](../debugger/media/vsg_eventlist_icon_user.png "vsg_eventlist_icon_user")|Marqueur d'événement défini par l'utilisateur<br /> Marque un emplacement spécifique, tel que défini par l'application.|  
...
|---------------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------|  
|Vérifier la disponibilité des événements définis par l'utilisateur|[PIXGetStatus](http://msdn.microsoft.com/fr-fr/f7ebd985-fb5d-46d7-abec-099df4b9be0e)|[PIXGetStatus](http://msdn.microsoft.com/fr-fr/1046ac43-a0a3-42bf-bae8-14aa72fa7567)|  
|Commencer un groupe d'événements|[PIXBeginEvent](http://msdn.microsoft.com/fr-fr/5f51fff7-f313-4558-965b-2a443653cd7b)|[PIXBeginEvent](http://msdn.microsoft.com/fr-fr/4ddb3311-b9b5-449a-bbfb-7634e0d56e87)|  
|Terminer un groupe d'événements|[PIXEndEvent](http://msdn.microsoft.com/fr-fr/fb526bf2-c17d-4a2a-8665-3b577a0f7fba)|[PIXEndEvent](http://msdn.microsoft.com/fr-fr/a3cd34a9-9dd9-40e1-ae86-0214b25ff185)|  
|Créer un marqueur d'événement|[PIXSetMarker](http://msdn.microsoft.com/fr-fr/0caf49ed-c99d-405e-89f4-0c887b8474ad)|[PIXSetMarker](http://msdn.microsoft.com/fr-fr/6610e5b9-a0c5-4236-b551-b6eb9fac64c1)|  
