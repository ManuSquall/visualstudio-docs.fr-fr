...
-   Dans Visual Studio, dans la barre d'outils **Graphiques**, choisissez le bouton **Capturer le frame**![Icône du bouton de capture de graphiques](../debugger/media/debuggingdirectxgraphics.png "DebuggingDirectXGraphics").  
