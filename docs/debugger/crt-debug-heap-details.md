...
Liste des blocs libérés (0xDD), les blocs libérés restés inutilisés dans le tas de débogage de lié lorsque la `_CRTDBG_DELAY_FREE_MEM_DF` indicateur est défini contiennent actuellement 0xDD.
