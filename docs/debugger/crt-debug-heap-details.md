...
Blocs libérés (0xDD) les blocs libérés conservés inutilisés dans la liste liée du tas de débogage lorsque l' `_CRTDBG_DELAY_FREE_MEM_DF` indicateur est défini sont actuellement remplis avec 0xDD.
