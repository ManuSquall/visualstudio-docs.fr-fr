...
dev_langs: 
  ...
  - "VB"
helpviewer_keywords: 
  - "Modifier & Continuer 64 bits"
  - "déboguer (Visual Basic), Modifier & Continuer"
  - "Modifier & Continuer (Visual Basic)"
  - "Modifier & Continuer, 64 bits"
  - "Visual Basic, Modifier & Continuer"
...
## Dans cette section  
 [Comment : appliquer des modifications en mode arrêt à l'aide de la fonctionnalité Modifier & Continuer](../debugger/how-to-apply-edits-in-break-mode-with-edit-and-continue.md)  
