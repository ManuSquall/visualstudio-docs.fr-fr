...
3. Supprimer les paramètres d’application suivants dans le portail Azure et enregistrez vos modifications. 
    ...
    > [!WARNING]
    > Les modifications apportées aux paramètres de l’Application lance un redémarrage de l’application. Vous pouvez trouver plus d’informations sur les paramètres de l’Application [ici](https://docs.microsoft.com/azure/app-service/web-sites-configure#app-settings). 
