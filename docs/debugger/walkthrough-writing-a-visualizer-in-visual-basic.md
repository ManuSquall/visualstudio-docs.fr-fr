...
2.  Dans la boîte de dialogue **Nouveau projet**, sous **Type de projet**, cliquez sur **Visual Basic**.  
...
2.  Dans la boîte de dialogue **Ajouter un nouveau projet**, dans le volet **Modèles**, cliquez sur **Application console**.  
