---
title: Afficher les instantanés avec IntelliTrace
description: Utiliser le retour en arrière IntelliTrace pour examiner l’historique de l’état d’application
ms.date: 09/20/2018
ms.topic: quickstart
helpviewer_keywords:
...
Pour plus d’informations, consultez [inspecter les États d’application précédents à l’aide d’IntelliTrace](../debugger/view-historical-application-state.md).
