...
description: Découvrez comment accéder aux extraits de code entourer de via un raccourci clavier, dans le menu Edition ou dans un menu contextuel.
...
1. Tapez **CTRL** + **K**, **CTRL** + **S**.

1. Sélectionnez l’extrait de code dans la liste des extraits de code à l’aide de la souris, ou en tapant le nom de l’extrait de code et en appuyant sur **Tab** ou **entrée**.
...
1. Sélectionnez l’extrait de code dans l’outil d’insertion d’extrait de code, puis appuyez sur **Tab** ou **entrée**.
...
1. Cliquez avec le bouton droit sur le texte sélectionné, puis sélectionnez la commande **entourer** de dans le menu contextuel.
