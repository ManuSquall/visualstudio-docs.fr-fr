...
description: Découvrez comment résoudre les erreurs de conception de classe en faisant glisser à nouveau le code source modifié ou déplacé vers le diagramme de classes pour l’afficher.
