---
title: Utilisation des diagrammes de classes (Concepteur de classes)
ms.date: 11/04/2016
...
---
# <a name="work-with-class-diagrams-class-designer"></a>Utiliser des diagrammes de classes (Concepteur de classes)
