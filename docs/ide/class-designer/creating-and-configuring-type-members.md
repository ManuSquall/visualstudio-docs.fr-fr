...
-   Le type est en lecture seule, quand, par exemple, il réside dans un assembly référencé. Lorsque vous sélectionnez la forme dans le Concepteur de classes, la fenêtre Détails de classe affiche ses détails en lecture seule.
