...
description: Découvrez comment ajouter des membres aux types dans un diagramme de classes et configurer ces membres dans la fenêtre Détails de classe.
...
- Sélectionnez **Afficher**  >  d'**autres**  >  **Détails de classe** Windows dans la barre de menus.
...
- **\<add member>**
     ...
     La dernière ligne de la fenêtre **Détails de classe** contient le texte **\<add member>** dans la cellule **nom** . Si vous cliquez sur cette cellule, vous pouvez créer un membre. Pour plus d’informations, consultez [Créer des membres](creating-and-configuring-type-members.md#create-members).
