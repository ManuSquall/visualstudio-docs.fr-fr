...
description: Découvrez comment ajouter une instruction if pour que, lorsque le joueur sélectionne une paire d’icônes correspondante, les icônes restent visibles.
