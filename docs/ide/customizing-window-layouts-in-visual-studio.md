...
### <a name="dock-windows"></a>Ancrer des fenêtres  
 ...
 ![Repère en forme de losange de la fenêtre de document](~/docs/ide/media/documentwindowguidediamonds.png "Documentwindowguidediamonds")  
 ...
 ![Repère en forme de losange de la fenêtre d’outils](~/docs/ide/media/vs10guidediamond.png "VS10GuideDiamond")  
 ...
 ![Ancrage de l’Explorateur de solutions dans une nouvelle position](~/docs/ide/media/vs2015_dock_diamond.png "VS2017_Dock_diamond")  
...
### <a name="close-and-auto-hide-tool-windows"></a>Fermer et masquer les fenêtres d’outil  
 ...
 ![Masquer automatiquement](~/docs/ide/media/vs2015_auto_hide.png "vs2017_auto_hide")  
