...
1. Choisissez le bouton **se connecter** dans l’angle supérieur droit de l’IDE (ou accédez à **fichier** > **paramètres du compte** pour ouvrir la boîte de dialogue Paramètres du **compte** , puis choisissez le bouton **se connecter** ).
