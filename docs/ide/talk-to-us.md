...
Utilisez notre bouton de commentaires **Cette page vous a-t-elle été utile ?** au bas de la page. Vous trouverez ce bouton dans toutes les pages de notre documentation. Vous pouvez aussi ajouter des commentaires pour n’importe quelle page de Visual Studio sur [docs.microsoft.com](https://docs.microsoft.com/visualstudio/) en utilisant votre compte GitHub ; choisissez le bouton **Envoyer des commentaires sur** > **Cette page**, également dans le bas de la page.
