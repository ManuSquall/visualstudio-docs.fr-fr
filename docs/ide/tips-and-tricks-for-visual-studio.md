...
---
# Conseils et astuces pour Visual Studio
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Vous pouvez naviguer dans [!INCLUDE[vs_dev12](../data-tools/includes/vs_dev12_md.md)] plus facilement en utilisant les raccourcis dans cette rubrique.  Pour obtenir plus d'informations générales, consultez [\<PAVEOVER\> Keyboard Shortcuts in Visual Studio](http://msdn.microsoft.com/fr-fr/2e15e27f-296b-4e9c-91e6-d91ea0110a67).  Pour plus d'informations sur l'optimisation de Visual Studio pour l'accessibilité, consultez [Conseils et astuces d'accessibilité](../ide/reference/accessibility-tips-and-tricks.md).  
...
|Résultats de la portée de lancement rapide|-   Options @opt<br />-   commandes @cmd<br />-   Derniers @mru utilisés<br />-   Documents ouverts @doc|  
...
##  <a name="BKMK_ALM"></a> Gestion du cycle de vie des applications  
 Consultez [Raccourcis clavier : Visual Studio Online, portail web TFS et Team Explorer](http://msdn.microsoft.com/fr-fr/35ea128b-7565-4ee3-8266-b9f0d32aecf4).  
  
## Voir aussi  
 [Visual Studio Blog \(Blog Visual Studio\)](http://blogs.msdn.com/b/visualstudio)   
 [Visual Studio Tips and Tricks Blog \(Blog sur les conseils et astuces Visual Studio\)](http://blogs.msdn.com/b/zainnab)   
 [Visual Studio Toolbox on Channel 9 \(Boîte à outils Visual Studio sur Channel 9\)](http://channel9.msdn.com/Shows/Visual-Studio-Toolbox)   
 [Visual Studio UserVoice](http://visualstudio.uservoice.com/forums/121579-visual-studio)   
 [Visual Studio Connect Bugs \(Bogues de connexion Visual Studio\)](http://connect.microsoft.com/VisualStudio)