...
f1_keywords: 
  ...
  - "vs.findinfiles"
helpviewer_keywords: 
  - "objets (Visual Studio), trouver"
  - "recherches de texte, remplacement de texte"
  - "objets (Visual Studio), recherche"
  - "Rechercher et remplacer (fenêtre), onglet Rechercher dans les fichiers"
  - "recherches de texte, fenêtre Rechercher et remplacer"
  - "documents, recherche"
  - "fichiers, recherche"
  - "Rechercher dans les fichiers (onglet), fenêtre Rechercher et remplacer"
...
L'option **Rechercher dans les fichiers** vous permet de faire des recherches dans un ensemble défini de fichiers.  Les correspondances trouvées et les actions prises sont répertoriées dans la fenêtre **Résultats de la recherche** sélectionnée dans **Options de résultat**.  
 ...
 Vous pouvez utiliser l'une des méthodes suivantes pour afficher l'option **Rechercher dans les fichiers** dans la fenêtre **Rechercher et remplacer**.  
  
### Pour afficher l'option Rechercher dans les fichiers  
...
## Regarder dans  
 L'option choisie dans la liste déroulante **Regarder dans** détermine si l'opération **Rechercher dans les fichiers** porte sur les fichiers actifs uniquement ou sur tous les fichiers figurant dans les dossiers choisis.  Sélectionnez une étendue de recherche dans la liste ou cliquez sur le bouton **Parcourir \(...\)** pour afficher la boîte de dialogue **Choisir des dossiers de recherche** et spécifier l'ensemble de répertoires de votre choix.  Vous pouvez également taper un chemin d'accès directement dans la zone **Regarder dans**.  
...
## Options de résultat  
 ...
 Affich. noms fichiers seulement  
