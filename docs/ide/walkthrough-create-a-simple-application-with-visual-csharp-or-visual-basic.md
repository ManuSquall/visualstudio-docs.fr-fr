...
#### <a name="create-the-wpf-project"></a>Créer le projet WPF

1.  Créer un nouveau projet. Dans la barre de menus, choisissez **Fichier** > **Nouveau** > **Projet**.
...
2.  Choisissez le modèle Application WPF Visual Basic ou Application WPF Visual C# en choisissant par exemple dans le volet gauche **Installé** > **Visual C#** > **Bureau classique Windows**, puis en choisissant **Application WPF (.NET Framework)** dans le volet central.  Nommez le projet `HelloWPFApp` en bas de la boîte de dialogue **Nouveau projet**.
...
#### <a name="clean-the-solution-files-and-build-a-release-version"></a>Nettoyer les fichiers solution et générer une version Release
...
Félicitations ! Vous avez terminé cette procédure. Le fichier *.exe* que vous avez généré se trouve sous le répertoire de votre solution et de votre projet (*...\HelloWPFApp\HelloWPFApp\bin\Release*). Pour explorer d’autres exemples, consultez [Exemples Visual Studio](../ide/visual-studio-samples.md).
