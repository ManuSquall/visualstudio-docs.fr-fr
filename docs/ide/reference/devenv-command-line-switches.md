...
|[/DebugExe (devenv.exe)](../../ide/reference/debugexe-devenv-exe.md)|Charge un exécutable [!INCLUDE[vcprvc](../../code-quality/includes/vcprvc_md.md)] sous le contrôle du débogueur. Ce commutateur n’est pas disponible pour les exécutables [!INCLUDE[vbprvb](../../code-quality/includes/vbprvb_md.md)] ou [!INCLUDE[csprcs](../../data-tools/includes/csprcs_md.md)]. Pour plus d’informations, consultez [Démarrer automatiquement un processus dans le débogueur](../../debugger/debug-multiple-processes.md#BKMK_Automatically_start_an_process_in_the_debugger).|  
...
|[/Updateconfiguration (devenv.exe)](../../ide/reference/updateconfiguration-devenv-exe.md)|Notifie [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] pour qu’il fusionne les packages [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] sur le système et vérifie si des modifications ont été apportées au cache MEF.|  
|[/Upgrade (devenv.exe)](../../ide/reference/upgrade-devenv-exe.md)|Met à niveau le fichier solution spécifié et tous ses fichiers projet, ou le fichier projet spécifié, vers les formats [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] actuels pour ces fichiers.|  
