...
|-------------------------|--------------------------|  
|![Capture dՎcran HTMLpageSelectionMarginOn](~/docs/ide/reference/media/vxselmaron.gif "vxSelmaron")|![Capture dՎcran HTMLpageSelectionMarginOff](~/docs/ide/reference/media/vxselmaroff.gif "vxSelmaroff")|  
