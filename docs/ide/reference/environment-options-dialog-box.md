...
ms.locfileid: "62790939"
---
# <a name="options-dialog-box-environment"></a>Boîte de dialogue Options : Environnement

Vous pouvez utiliser les pages du dossier **Environnement** de la boîte de dialogue **Options** pour définir comment certains éléments de l’environnement de développement intégré (IDE) s’affichent et se comportent. Vous pouvez accéder aux pages Environnement en choisissant **Outils** > **Options**, puis en sélectionnant **Environnement**.
...
|Pour spécifier s'il faut assurer l'itinérance des paramètres sur plusieurs ordinateurs.|[Comptes, Environnement, boîte de dialogue Options](../../ide/reference/accounts-environment-options-dialog-box.md)|
