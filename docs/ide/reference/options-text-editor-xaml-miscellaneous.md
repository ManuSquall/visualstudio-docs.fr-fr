...
description: Découvrez comment utiliser la page divers dans la section XML pour spécifier comment les éléments et les attributs sont mis en forme dans vos documents XAML.
