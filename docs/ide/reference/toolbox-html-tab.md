 ...
 **Pointeur**  
 ![Pointeur HTMLpage de concepteur ASP.NET mobile](~/docs/ide/reference/media/vxpointer.gif "vxPointer")  
 ...
 **Input (Button)**  
 ![Bouton de page web HTML](~/docs/ide/reference/media/vxbutton.gif "vxButton")  
 ...
 **Input (Reset)**  
 ![Capture d’écran de HTMLpageResetButton](~/docs/ide/reference/media/vxreset.gif "vxReset")  
 ...
 **Input (Submit)**  
 ![Capture d’écran de HTMLpageToolbarSubmitButton](~/docs/ide/reference/media/vxsubmit.gif "vxSubmit")  
 ...
 **Input (Text)**  
 ![Capture d’écran de HTMLpageToolbarTextField](~/docs/ide/reference/media/vxtextfield.gif "vxTextfield")  
 ...
 **Input (File)**  
 ![Champ File de page HTML](~/docs/ide/reference/media/vxfilefield.gif "vxFilefield")  
 ...
 **Input (Password)**  
 ![Champ Password de Visual Studio](~/docs/ide/reference/media/vxpassword.gif "vxPassword")  
 ...
 **Input (Check box)**  
 ![Option Checkbox de boîte à outils de page web HTML](~/docs/ide/reference/media/vxcheckbox.gif "vxCheckbox")  
 ...
 **Input (Radio)**  
 ![Capture d’écran de VisualStudioHTMLpageRadioButton](~/docs/ide/reference/media/vxradio.gif "vxRadio")  
 ...
 **Input (Hidden)**  
 ![Élément masqué de page HTML](~/docs/ide/reference/media/vxhidden.gif "vxhidden")  
 ...
 **Textarea**  
 ![Zone de texte de barre d’outils de page HTML](~/docs/ide/reference/media/vxtextarea.gif "vxTextarea")  
 ...
 **Table**  
 ![Capture d’écran de HTMLpageToolbarTable](~/docs/ide/reference/media/vxtable.gif "vxTable")  
...
**Image**  
 ![Élément d’image de page HTML](~/docs/ide/reference/media/vximage.gif "vxImage")  
 ...
 **Select**  
 ![Liste déroulante de boîte à outils de page HTML](~/docs/ide/reference/media/vxdropdown.gif "vxDropdown")  
 ...
 **Horizontal Rule**  
 ![Élément de règle horizontale de page HTML](~/docs/ide/reference/media/vxhorizontal.gif "vxHorizontal")  
 ...
 **Div**  
 ![Étiquette de page HTML](~/docs/ide/reference/media/vxlabel.gif "vxLabel")  
