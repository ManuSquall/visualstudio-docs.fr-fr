...
La section [Fonctionnalités de l’éditeur de code](../../ide/writing-code-in-the-code-and-text-editor.md) décrit les différentes façons d’utiliser l’éditeur de code.