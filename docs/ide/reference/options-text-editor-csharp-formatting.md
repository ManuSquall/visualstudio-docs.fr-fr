...
Utilisez la boîte de dialogue de page de propriétés **Mise en forme** pour définir des options de mise en forme du code dans l’éditeur de code. Pour accéder à la boîte de dialogue **Options** dans Visual Studio, cliquez sur **Outils** > **Options**. Développez ensuite **Éditeur de texte**, **C#** et **Style de code**, puis cliquez sur **Mise en forme**.  
