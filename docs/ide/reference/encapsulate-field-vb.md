---
title: "Refactoriser un champ en une propriété dans Visual Basic | Microsoft Docs"
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="encapsulate-a-field-in-visual-basic"></a>Encapsuler un champ dans Visual Basic
...
1. Mettez en surbrillance ou placez le curseur de texte dans le nom du type à encapsuler :
   ...
   ![Code mis en surbrillance](media/encapsulate-highlight-vb.png)
...
1. Effectuez ensuite l'une des opérations suivantes :
   ...
   **Encapsuler le champ (mais utiliser toujours le champ)** | Encapsule le champ avec une propriété, mais conserve intactes toutes les utilisations de ce champ
   ...
   ![Résultat de l’action Encapsuler une propriété](media/encapsulate-result-vb.png)
