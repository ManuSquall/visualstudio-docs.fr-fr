...
helpviewer_keywords: 
  - "couleurs, personnalisation de l’IDE"
  - "Concepteur de requêtes et de vues, personnalisation"
  - "polices, éditeurs"
  - "menus, personnalisation"
  - "Concepteur de tables, personnalisation"
  - "Concepteur de bases de données, personnalisation de l’environnement"
  - "couleurs par défaut"
  - "accessibilité, options"
  - "éditeurs, personnalisation"
  - "concepteurs, personnalisation de l’environnement"
  - "par défaut, couleurs"
  - "imprimantes, personnalisation"
...
---
# Polices et couleurs, Environnement, bo&#238;te de dialogue Options
...
|**Refactorisation de l'arrière\-plan**|Couleurs d'arrière\-plan de la boîte de dialogue **Aperçu des modifications**.|  
...
|**Balise active**|Sert à désigner le plan quand des balises actives sont appelées.|  
...
|**Attribut de documentation XML**|Valeur d'un attribut de documentation xml, tel que \<param name\="I"\> où "I" est en couleur.|  
|**Commentaire sur la documentation XML**|Commentaires insérés dans les commentaires de la documentation xml.|  
|**Balise de documentation XML**|Balises dans les commentaires de document XML, comme<br /><br /> \/\/\/ \<summary\>.|  
