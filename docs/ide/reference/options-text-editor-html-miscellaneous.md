...
- **Mettre en forme le code HTML lors du collage**

   Quand cette case est cochée, l’éditeur remet en forme les éléments collés dans la page, en utilisant les règles de mise en forme actuellement définies. Si cette case n’est pas cochée, l’éditeur colle les éléments en utilisant la mise en forme exacte de l’élément d’origine.
