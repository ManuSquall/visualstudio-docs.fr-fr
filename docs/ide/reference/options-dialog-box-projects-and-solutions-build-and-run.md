...
description: Spécifiez le nombre maximal de projets C++ ou C# qui peuvent être générés en même temps, certains comportements de génération par défaut et certains paramètres du journal de génération dans Visual Studio.
