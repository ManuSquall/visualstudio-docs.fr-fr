...
## <a name="navigate-in-the-code-window"></a>Naviguer dans la fenêtre de code  
 ...
 ![Boutons de navigation Suivant et Précédent](../ide/media/vs2015_nav_buttons.png "VS2015_Nav_buttons")  
...
![Fenêtre Naviguer vers - Recherche en lettres capitales](../ide/media/vside_capitalsearch.png "Fenêtre Naviguer vers - Recherche en lettres capitales")
...
-   [Paramètres de Visual Basic](/dotnet/visual-basic/developing-apps/using-ide/settings)  
