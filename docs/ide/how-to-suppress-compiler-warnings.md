...
1. Dans la barre de menus, sélectionnez **Projet** > **Recharger le projet**.

1. Dans la barre de menus, sélectionnez **Générer** > **Régénérer la solution**.
