...
- **Activer le chargement de solution allégé**
    ...
    Certaines fonctionnalités de l’IDE ne sont pas activées dans ce mode. Pour déterminer si ce choix peut être utile, consultez [Shorter solution load time](https://blogs.msdn.microsoft.com/visualstudio/2016/10/11/shorter-solution-load-time-in-visual-studio-15/) (Raccourcir la durée de chargement des solutions) et [Optimiser le temps de démarrage de Visual Studio](https://docs.microsoft.com/en-us/visualstudio/ide/optimize-visual-studio-startup-time#speed-up-solution-load).
