...
### <a name="add-using"></a>Ajouter using  
 ...
 ![Image de l’ajout d’une balise active](~/docs/ide/media/addusesmart.gif "AddUseSmart")  
 ...
 ![Image agrandie de la balise active Ajouter using](~/docs/ide/media/addusesmartexp.gif "AddUseSmartExp")  
...
## <a name="generate-event-handlers"></a>Générer des gestionnaires d'événements  
 ...
 ![Bouton de raccordement automatique](~/docs/ide/media/vxautohookup.gif "vxAutoHookUp")  
 ...
 ![Générer un gestionnaire d’événements](~/docs/ide/media/vxgenerateeventhandler.gif "vxGenerateEventHandler")  
