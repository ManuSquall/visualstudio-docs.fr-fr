...
###  <a name="a-namebkmkanalyzea-analyze"></a><a name="bkmk_analyze"></a> Analyser  
...
###  <a name="a-namebkmkarchitecturea-architecture"></a><a name="bkmk_architecture"></a> Architecture  
  
|Commandes|Raccourcis clavier|  
|--------------|------------------------|  
|Architecture.NewDiagram|Ctrl+\\, Ctrl+N|  
  
###  <a name="a-namebkmkbuilda-build"></a><a name="bkmk_build"></a> Générer  
...
###  <a name="a-namebkmkclassviewa-class-view-context-menus"></a><a name="bkmk_classview"></a> Menus contextuels de l’affichage de classes  
  
|Commandes|Raccourcis clavier|  
|--------------|------------------------|  
|ClassViewContextMenus.ClassViewMultiselectProjectreferencesItems.Properties|Alt+Entrée|  
  
###  <a name="a-namebkmkdebuga-debug"></a><a name="bkmk_debug"></a> Déboguer  
...
###  <a name="a-namebkmkdebuggera-debugger-context-menus"></a><a name="bkmk_debugger"></a> Menus contextuels du débogueur  
...
###  <a name="a-namebkmkdiagnosticsa-diagnostics-hub"></a><a name="bkmk_diagnostics"></a> Hub de diagnostic  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|DiagnosticsHub.StopCollection|Ctrl+Alt+F2|  
  
###  <a name="a-namebkmkedita-edit"></a><a name="bkmk_edit"></a> Edition  
...
###  <a name="a-namebkmkeditorcontexta-editor-context-menus"></a><a name="bkmk_editorContext"></a> Menus contextuels de l’éditeur  
...
###  <a name="a-namebkmkfilea-file"></a><a name="bkmk_file"></a> Fichier  
...
###  <a name="a-namebkmkhelpa-help"></a><a name="bkmk_help"></a> Aide  
...
###  <a name="a-namebkmkloadtesta-load-test"></a><a name="bkmk_loadtest"></a> Test de charge  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|LoadTest.JumpToCounterPane|Ctrl+R, Q|  
  
###  <a name="a-namebkmkothercontexta-other-context-menus"></a><a name="bkmk_otherContext"></a> Autres menus contextuels  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|OtherContextMenus.MicrosoftDataEntityDesignContext.AddNewDiagram|Insert|  
  
###  <a name="a-namebkmkprojecta-project"></a><a name="bkmk_project"></a> Projet  
...
###  <a name="a-namebkmkprojectcontexta-project-and-solution-context-menus"></a><a name="bkmk_projectContext"></a> Menus contextuels Projet et Solution  
...
###  <a name="a-namebkmkrefactora-refactor"></a><a name="bkmk_refactor"></a> Refactoriser  
...
###  <a name="a-namebkmksolutionexplorerglobala-solution-explorer"></a><a name="bkmk_solutionexplorerGLOBAL"></a> Explorateur de solutions  
...
###  <a name="a-namebkmkteama-team"></a><a name="bkmk_team"></a> Équipe  
...
###  <a name="a-namebkmktfcontexta-team-foundation-context-menus"></a><a name="bkmk_TFcontext"></a> Menus contextuels Team Foundation  
...
###  <a name="a-namebkmktesta-test"></a><a name="bkmk_test"></a> Tester  
...
###  <a name="a-namebkmktestexplorerglobala-test-explorer"></a><a name="bkmk_testexplorerGLOBAL"></a> Explorateur de tests  
...
###  <a name="a-namebkmktoolsa-tools"></a><a name="bkmk_tools"></a> Outils  
...
###  <a name="a-namebkmkviewa-view"></a><a name="bkmk_view"></a> Affichage  
...
###  <a name="a-namebkmkwindowa-window"></a><a name="bkmk_window"></a> Fenêtre  
...
##  <a name="a-namebkmkclassdiagrama-class-diagram"></a><a name="bkmk_classDiagram"></a> Diagramme de classes  
...
##  <a name="a-namebkmkcodeduitesta-coded-ui-test-editor"></a><a name="bkmk_codedUItest"></a> Éditeur de test codé de l’interface utilisateur  
...
##  <a name="a-namebkmkdataseta-dataset-editor"></a><a name="bkmk_dataset"></a> Éditeur DataSet  
...
##  <a name="a-namebkmkdiffa-difference-viewer"></a><a name="bkmk_diff"></a> Visionneuse de différences  
...
##  <a name="a-namebkmkdoma-dom-explorer"></a><a name="bkmk_DOM"></a> Explorateur DOM  
...
##  <a name="a-namebkmkgraphdoca-graph-document-editor"></a><a name="bkmk_graphDoc"></a> Éditeur de document de graphique  
...
##  <a name="a-namebkmkgraphicsdebuggera-graphics-diagnostics"></a><a name="bkmk_graphicsDebugger"></a> Graphics Diagnostics  
...
##  <a name="a-namebkmkhtmleditora-html-editor"></a><a name="bkmk_HTMLeditor"></a> Éditeur HTML  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|OtherContextMenus.HTMLContext.GoToController|Ctrl+M, Ctrl+G|  
  
##  <a name="a-namebkmkhtmleditordesigna-html-editor-design-view"></a><a name="bkmk_HTMLeditorDesign"></a> Éditeur HTML, mode Création  
...
##  <a name="a-namebkmkhtmleditorsourcea-html-editor-source-view"></a><a name="bkmk_HTMLeditorSource"></a> Éditeur HTML en mode Source  
...
##  <a name="a-namebkmklayerdiagrama-layer-diagram"></a><a name="bkmk_layerDiagram"></a> Diagramme de couche  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|Edit.Delete|Maj+Suppr|  
  
##  <a name="a-namebkmkmanagedresourcesa-managed-resources-editor"></a><a name="bkmk_managedResources"></a> Éditeur de ressources managées  
...
##  <a name="a-namebkmkmergeeditora-merge-editor-window"></a><a name="bkmk_MergeEditor"></a> Fenêtre de l’éditeur de fusion  
...
##  <a name="a-namebkmkschemacomparea-microsoft-sql-server-data-tools-schema-compare"></a><a name="bkmk_SchemaCompare"></a> Microsoft SQL Server Data Tools, Comparaison de schémas  
...
##  <a name="a-namebkmktabledesignera-microsoft-sql-server-data-tools-table-designer"></a><a name="bkmk_TableDesigner"></a> Microsoft SQL Server Data Tools, Concepteur de tables  
...
##  <a name="a-namebkmktsqleditora-microsoft-sql-server-data-tools-t-sql-editor"></a><a name="bkmk_TSQLeditor"></a> Microsoft SQL Server Data Tools, Éditeur T-SQL  
...
##  <a name="a-namebkmklinkfixa-microsoft-sql-server-data-tools-t-sql-pdw-editor"></a><a name="bkmk_linkfix"></a> Microsoft SQL Server Data Tools, Éditeur T-SQL PDW  
...
##  <a name="a-namebkmkpageinspectora-page-inspector"></a><a name="bkmk_PageInspector"></a> Inspecteur de page  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|PageInspector.Minimize|F12|  
  
##  <a name="a-namebkmkquerydesignera-query-designer"></a><a name="bkmk_QueryDesigner"></a> Concepteur de requêtes  
...
##  <a name="a-namebkmkqueryresultsa-query-results"></a><a name="bkmk_QueryResults"></a> Résultats de requête  
...
##  <a name="a-namebkmkreportdesignera-report-designer"></a><a name="bkmk_ReportDesigner"></a> Concepteur de rapports  
...
##  <a name="a-namebkmksequencediagrama-sequence-diagram"></a><a name="bkmk_SequenceDiagram"></a> Diagramme de séquence  
...
##  <a name="a-namebkmksettingsdesignera-settings-designer"></a><a name="bkmk_SettingsDesigner"></a> Concepteur de paramètres  
...
##  <a name="a-namebkmksolutionexplorera-solution-explorer"></a><a name="bkmk_SolutionExplorer"></a> Explorateur de solutions  
...
##  <a name="a-namebkmktfbuilda-team-foundation-build-detail-editor"></a><a name="bkmk_TFBuild"></a> Éditeur des détails Team Foundation Build  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|View.Refresh|F5|  
  
##  <a name="a-namebkmktestexplorera-test-explorer"></a><a name="bkmk_TestExplorer"></a> Explorateur de tests  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|TestExplorer.OpenTest|F12|  
  
##  <a name="a-namebkmktexteditora-text-editor"></a><a name="bkmk_TextEditor"></a> Éditeur de texte  
...
##  <a name="a-namebkmkumlactivitydiagrama-uml-activity-diagram"></a><a name="bkmk_UMLactivityDiagram"></a> Diagramme d’activités UML  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|Edit.Delete|Maj+Suppr|  
  
##  <a name="a-namebkmkumlclassdiagrama-uml-class-diagram"></a><a name="bkmk_UMLclassDiagram"></a> Diagramme de classes UML  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|Edit.DeleteFromModel|Maj+Suppr|  
  
##  <a name="a-namebkmkumlcomponentdiagrama-uml-component-diagram"></a><a name="bkmk_UMLcomponentDiagram"></a> Diagramme de composant UML  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|Edit.DeleteFromModel|Maj+Suppr|  
  
##  <a name="a-namebkmkumlusecasediagrama-uml-use-case-diagram"></a><a name="bkmk_UMLusecaseDiagram"></a> Diagramme de cas d’usage UML  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|Edit.DeleteFromModel|Maj+Suppr|  
  
##  <a name="a-namebkmkvcacceleratora-vc-accelerator-editor"></a><a name="bkmk_vcaccelerator"></a> Éditeur d’accélérateurs VC  
...
##  <a name="a-namebkmkvcdialogeditora-vc-dialog-editor"></a><a name="bkmk_vcdialogeditor"></a> Éditeur de boîtes de dialogue VC  
...
##  <a name="a-namebkmkvcimageeditora-vc-image-editor"></a><a name="bkmk_vcimageeditor"></a> Éditeur d’images VC  
...
##  <a name="a-namebkmkvcstringeditora-vc-string-editor"></a><a name="bkmk_vcstringeditor"></a> Éditeur de chaînes VC  
  
|Commande|Raccourci clavier|  
|-------------|-----------------------|  
|Edit.NewString|Insert|  
  
##  <a name="a-namebkmkviewdesignera-view-designer"></a><a name="bkmk_viewDesigner"></a> Concepteur de vues  
...
##  <a name="a-namebkmkwfdesignera-windows-forms-designer"></a><a name="bkmk_wfdesigner"></a> Concepteur Windows Forms  
...
##  <a name="a-namebkmkworkitemeditora-work-item-editor"></a><a name="bkmk_workItemEditor"></a> Éditeur d’élément de travail  
...
##  <a name="a-namebkmkwiqueryviewa-work-item-query-view"></a><a name="bkmk_WIqueryview"></a> Affichage des requêtes d’élément de travail  
...
##  <a name="a-namebkmkwiresultsviewa-work-item-results-view"></a><a name="bkmk_WIresultsview"></a> Affichage des résultats des éléments de travail  
...
##  <a name="a-namebkmkworkflowdesignera-workflow-designer"></a><a name="bkmk_workflowdesigner"></a> Concepteur de flux de travail  
...
##  <a name="a-namebkmkxamluidesignera-xaml-ui-designer"></a><a name="bkmk_xamluidesigner"></a> Concepteur XAML  
...
##  <a name="a-namebkmkxmltexteditora-xml-text-editor"></a><a name="bkmk_xmlTextEditor"></a> Éditeur XML (Texte)  
...
##  <a name="a-namebkmkxmlschemadesignera-xml-schema-designer"></a><a name="bkmk_xmlSchemaDesigner"></a> Concepteur de schémas XML  
...
## <a name="see-also"></a>Voir aussi  
 [Éditeur d’images pour les icônes](/visual-cpp/windows/image-editor-for-icons)   
