...
### <a name="configuring-a-build"></a>Configuration d'une build  
 ...
 ![Bouton de version Debug Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_type1.PNG "Vs_ide_gs_debug_build_type1")  
 ...
 ![Fenêtre Gestionnaire de fichiers de configuration Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr.PNG "Vs_ide_gs_debug_build_cf_mgr")  
 ...
 ![Fenêtre Gestionnaire de configurations Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr_2.PNG "Vs_ide_gs_debug_build_cf_mgr_2")  
...
### <a name="building-your-code"></a>Génération de code  
 ...
 ![Sélection du menu de génération du projet Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_menu_item.png "Vs_ide_gs_debug_build_menu_item")  
 ...
 ![Sortie de génération réussie Visual Studio](~/docs/ide/media/vs_ide_gs_debug_success_build.PNG "vs_ide_gs_debug_success_build")  
...
### <a name="reviewing-the-error-list"></a>Revue de la liste d’erreurs  
 ...
 ![Liste d’erreurs et sortie de Visual Studio](~/docs/ide/media/vs_ide_gs_debug_bad_build_error_list.PNG "Vs_ide_gs_debug_bad_build_error_list")  
 ...
 ![Éditeur Visual Studio avec des numéros de ligne](~/docs/ide/media/vs_ide_gs_debug_line_numbers.png "Vs_ide_gs_debug_line_numbers")  

 ![Option des numéros de ligne Visual Studio](~/docs/ide/media/vs_ide_gs_debug_options_line_numbers.png "Vs_ide_gs_debug_options_line_numbers")  
 ...
 ![Pointage d’erreur Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_hover1.png "Vs_ide_gs_debug_error_hover1")  

 Passez en revue la liste d'erreurs et corrigez toutes les erreurs dans votre code.  

 ![Fenêtre d’erreurs de débogage Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_list.PNG "Vs_ide_gs_debug_error_list")  
...
### <a name="reviewing-errors-in-detail"></a>Revue des erreurs en détail  
 ...
 ![Recherche Bing de liste d’erreurs Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_list_error_help.png "Vs_ide_gs_debug_error_list_error_help")  
...
### <a name="performing-static-code-analysis"></a>Analyse statique du code  
 ...
 ![Élément de menu Analyse du code dans Visual Studio](~/docs/ide/media/vs_ide_gs_debug_run_code_analysis.png "Vs_ide_gs_debug_run_code_analysis")  
 ...
 ![Liste d’erreurs Visual Studio avec des avertissements](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_error_list.PNG "vs_ide_gs_debug_code_analysis_warning_error_list")  
 ...
 ![Pointage de l’avertissement dans Analyse du code de Visual Studio](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_hover.png "vs_ide_gs_debug_code_analysis_warning_hover")  
...
### <a name="using-light-bulbs-to-fix-or-refactor-code"></a>Utilisation des ampoules pour corriger ou refactoriser du code  
 ...
 ![Options rapides d’ampoule dans Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb1.png "Vs_ide_gs_debug_light_bulb1")  

 La liste des corrections ou des refactorisations que vous pouvez appliquer à cette ligne de code s'affiche.  

 ![Aperçu d’ampoule dans Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb_preview_changes.PNG "Vs_ide_gs_debug_light_bulb_preview_changes")  
 ...
 ![Texte « aucune option » d’ampoule Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb_no_options.PNG "Vs_ide_gs_debug_light_bulb_no_options")  
...
### <a name="debugging-your-running-code"></a>Débogage de votre code en cours d'exécution  
 ...
 ![Fenêtres Automatique et Pile des appels de Visual Studio](~/docs/ide/media/vs_ide_gs_debug_autos_and_call_stack.PNG "Vs_ide_gs_debug_autos_and_call_stack")  
 ...
 ![Bouton Interrompre tout Visual Studio](~/docs/ide/media/vs_ide_gs_debug_break_all_button.png "vs_ide_gs_debug_break_all_button")  

 Appuyez sur F5 pour continuer l’exécution de l’application (ou cliquez sur le bouton **Continuer**).  

 ![Bouton de poursuite du débogage Visual Studio](~/docs/ide/media/vs_ide_gs_debug_continue_button.png "Vs_ide_gs_debug_continue_button")  
...
### <a name="setting-simple-breakpoints"></a>Définition de points d'arrêt simples  
 ...
 ![Point d’arrêt Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint1.png "Vs_ide_gs_debug_breakpoint1")  
...
### <a name="setting-conditional-breakpoints"></a>Définition de points d'arrêt conditionnels  
 ...
 ![Paramètres de point d’arrêt Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint_settings.png "Vs_ide_gs_debug_breakpoint_settings")  
 ...
 ![Point d’arrêt conditionnel Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint_conditional.PNG "Vs_ide_gs_debug_breakpoint_conditional")  
...
### <a name="inspecting-your-code-at-run-time"></a>Inspection du code au moment de l'exécution  
 ...
 ![Inspection de valeur d’exécution dans Visual Studio](~/docs/ide/media/vs_ide_gs_debug_inspect_value.PNG "vs_ide_gs_debug_inspect_value")  
 ...
 ![Fenêtre Outils de diagnostic de Visual Studio](~/docs/ide/media/vs_ide_gs_debug_diagnostic_tools.PNG "Vs_ide_gs_debug_diagnostic_tools")  
