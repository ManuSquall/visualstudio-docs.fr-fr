...
description: Découvrez comment configurer manuellement votre projet C++ pour que IntelliSense fonctionne correctement à l’aide de l’IDE de Visual Studio pour vous aider à identifier et résoudre les problèmes d’IntelliSense.
...
Pour voir les valeurs actuelles des macros de build comme **VC_IncludePath**, sélectionnez la ligne Répertoires Include, puis cliquez sur la liste déroulante à droite. Choisissez ensuite **\<Edit>** et cliquez sur le bouton **macros** .
...
Pour plus d’informations sur la variable d’environnement TRACEDESIGNTIME, voir [Roslyn](https://github.com/dotnet/roslyn/blob/master/docs/wiki/Diagnosing-Project-System-Build-Errors.md) et [Système de projet commun](https://github.com/dotnet/project-system/blob/master/docs/design-time-builds.md). Les informations contenues dans ces articles s’appliquent aux projets C++.
