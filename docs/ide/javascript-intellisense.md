...
À partir de [!include[vs_dev15](../misc/includes/vs_dev15_md.md)], JavaScript IntelliSense affiche beaucoup plus d’informations sur les listes de paramètres et de membres.
