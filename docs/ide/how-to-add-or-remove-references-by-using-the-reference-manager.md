...
- [Assemblys](#assemblies), avec les sous-groupes Framework et Extensions.

- [COM](#com) répertorie tous les composants COM pouvant être référencés.

- [Solution](#solution), avec le sous-groupe Projets.

- [Windows](#windows), avec les sous-groupes Principal et Extensions. Vous pouvez explorer les références dans le SDK Windows ou les SDK de l’extension à l’aide de l’**Explorateur d’objets**.

- [Parcourir](#browse), avec le sous-groupe Récent.
...
## <a name="a-idassemblies-assemblies-tab"></a><a id="assemblies" />Onglet Assemblys
...
## <a name="a-idcom-com-tab"></a><a id="com" />Onglet COM
...
## <a name="a-idsolution-solution-tab"></a><a id="solution" />Onglet Solution
...
## <a name="a-idwindows-windows-tab"></a><a id="windows" />Onglet Windows
...
## <a name="a-idbrowse-browse-button"></a><a id="browse" />Bouton Parcourir
