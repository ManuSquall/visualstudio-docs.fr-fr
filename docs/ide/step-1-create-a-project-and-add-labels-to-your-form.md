...
### Pour créer un projet et définir des propriétés pour un formulaire  
...
### Pour créer la zone Temps restant  
...
4.  Affectez la valeur **200, 30** à la propriété **Size**.  
...
7.  Choisissez le signe plus \(\+\) en regard de la propriété **Font**, puis remplacez la valeur de la propriété **Size** par 15,75.  
     ...
     ![Fenêtre Propriétés affichant la taille de police](../ide/media/express_setfontsize.png "Express\_setFontSize")  
...
9. Définissez la propriété **Text** sur **Temps restant**.  
...
1.  Ajoutez un contrôle **Label** à partir de la boîte à outils, puis attribuez à sa propriété **Text** la valeur **? Text**.  
  
2.  Affectez la valeur **False** à la propriété **AutoSize**.  
  
3.  Affectez la valeur **60, 50** à la propriété **Size**.  
...
16. Modifiez la propriété **\(Name\)** du contrôle **NumericUpDown** en lui affectant la valeur **sum** \(somme\).  
     ...
     ![Première ligne du questionnaire mathématique](../ide/media/express_firstrow.png "Express\_firstRow")  
...
7.  Affectez à la propriété **TabIndex** du contrôle NumericUpDown de somme la valeur **2**, à celle du contrôle de différence la valeur **3**, à celle du contrôle de produit la valeur **4** et à celle du contrôle quotient la valeur **5**.  
     ...
     ![Formulaire de questionnaire mathématique initial](../ide/media/express_formlaidout.png "Express\_FormLaidOut")  
...
-   Pour revenir à la rubrique de vue d'ensemble, consultez [Didacticiel 2 : créer un questionnaire mathématique chronométré](../ide/tutorial-2-create-a-timed-math-quiz.md).