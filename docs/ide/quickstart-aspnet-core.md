...
Dans cette introduction de 5-10 minutes à l’utilisation de Visual Studio, vous allez créer une simple application « Hello World » avec un modèle de projet ASP.NET et le langage de programmation C#.
...
Pour plus d’informations, passez aux tutoriels suivants :
