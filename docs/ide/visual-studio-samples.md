...
|[Exemples de développement Office](/office-dev/office-dev/office-development-samples)|Montre comment utiliser les outils de développement Office dans Visual Studio. Pour obtenir les exemples les plus récents, consultez les [exemples de code pour développeurs](http://go.microsoft.com/fwlink/?LinkID=248199).|  
