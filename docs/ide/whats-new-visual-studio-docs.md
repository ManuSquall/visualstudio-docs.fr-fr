---
title: 'Documentation Visual Studio : nouveautés de mars 2021'
titleSuffix: ''
description: Nouveautés de Visual Studio docs pour le 2021 mars.
ms.date: 04/02/2021
helpviewer_keywords:
...
Bienvenue dans les documents sur les nouveautés de Visual Studio pour le 2021 mars. Cet article répertorie les principales modifications apportées à la documentation au cours de cette période. Pour plus d’informations sur les nouveautés des mois précédents, consultez l’article nouveautés de l' [historique](whats-new-visual-studio-docs-history.md) .
...
- [Élément VisibilityItem](../extensibility/visibilityitem-element.md) -confirmer la fusion à partir de la branche de travail
...
- [Tutoriel : Bien démarrer avec C# et ASP.NET Core dans Visual Studio](../get-started/csharp/tutorial-aspnet-core.md)
  - Confirmer la fusion à partir de la branche de travail
  - Mettre à jour tutorial-aspnet-core.md
...
- [Dépanner et créer des journaux pour les problèmes MSBuild](./msbuild-logs.md) -confirmer la fusion à partir de la branche de travail
...
- [grossag](https://github.com/grossag) -Adam brut (1)
