...
## <a name="intellisense-features-in-c"></a>Fonctionnalités IntelliSense en C++  
 ...
 ![Outils, options, éditeur de texte, C/C++, avancé](~/docs/ide/media/sintellisensecpptoolsoptions.PNG "sIntelliSenseCppToolsOptions")  
 ...
 ![Menu IntelliSense Visual C++](~/docs/ide/media/vs2015_cpp_intellisense_menu.png "vs2015_cpp_intellisense_menu")  
...
### <a name="statement-completion-and-member-list"></a>Saisie semi-automatique des instructions et liste des membres  
 ...
 ![Fenêtre Compléter le mot Visual C++](~/docs/ide/media/vs2015_cpp_complete_word.png "vs2015_cpp_complete_word")  
 ...
 ![Liste de membres Visual C++](~/docs/ide/media/vs2015_cpp_list_members.png "vs2015_cpp_list_members")  
...
### <a name="parameter-help"></a>Aide sur les paramètres  
 ...
 ![Aide sur les paramètres Visual C++](~/docs/ide/media/vs_2015_cpp_param_help.png "vs_2015_cpp_param_help")  
...
### <a name="quick-info"></a>Info express  
 ...
 ![Info Express Visual C++](~/docs/ide/media/vs2015_cpp_quickinfo.png "vs2015_cpp_quickInfo")  
...
## <a name="error-squiggles"></a>Tildes d'erreur  
 ...
 ![Tildes d’erreur Visual C++](~/docs/ide/media/vs2015_cpp_error_quiggles.png "vs2015_cpp_error_quiggles")  
...
## <a name="cross-platform-intellisense"></a>IntelliSense interplateforme  
 ...
 ![Le projet Android est le projet actif](~/docs/ide/media/intellisensecppcrossplatform.png "IntelliSenseCppCrossPlatform")  
...
-   La ligne 12 a un tilde rouge sous l'identificateur BYE. Cet identificateur n'est pas défini dans le projet actif sélectionné.  
 ...
 ![iOS est sélectionné comme projet actif](~/docs/ide/media/intellisensecppcrossplatform2.png "IntelliSenseCppCrossPlatform2")  
...
## <a name="single-file-intellisense"></a>IntelliSense avec un fichier unique  
 ...
 ![IntelliSense avec un fichier unique](~/docs/ide/media/vs2015_cpp_single_file_intellisense.png "vs2015_cpp_single_file_intellisense")  
