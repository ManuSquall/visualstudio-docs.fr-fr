...
## <a name="accessing-or-changing-application-settings-at-run-time-in-visual-c"></a>Accès ou modification des paramètres d’application au moment de l’exécution en Visual C# #
