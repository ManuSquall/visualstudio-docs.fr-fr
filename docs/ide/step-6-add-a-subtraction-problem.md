...
2.  Ajoutez le code suivant après le commentaire « Fill in the subtraction problem » \(« Remplissage du problème de soustraction »\).  
     ...
     ![Info&#45;bulle de la fenêtre Intellisense](~/docs/ide/media/express_overloads.png "Express\_Overloads")  
Info\-bulle de la fenêtre Intellisense  
     ...
     ![Surcharge pour la méthode Next&#40;&#41; dans IntelliSense](~/docs/ide/media/express_nextoverload.png "Express\_NextOverload")  
