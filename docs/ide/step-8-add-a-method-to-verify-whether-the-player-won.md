...
3. Enregistrez et exécutez le programme. Jouez au jeu et associez toutes les icônes. Lorsque vous gagnez, le programme affiche un **MessageBox** de félicitations (comme indiqué dans la capture d’écran suivante), puis ferme la boîte.

     ![Jeu de combinaisons avec MessageBox](../ide/media/express_tut4step8.png)<br/>
***Jeu correspondant*** *avec* ***MessageBox***

## <a name="to-continue-or-review"></a>Pour continuer ou examiner

- Pour passer à l’étape suivante tutoriel, voir **[Étape 9: Essayez d’autres fonctionnalités](../ide/step-9-try-other-features.md)**.
