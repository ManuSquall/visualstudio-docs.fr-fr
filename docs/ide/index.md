...
ms.locfileid: "44384173"
---
# <a name="visual-studio-documentation"></a>Documentation de Visual Studio

Découvrez comment Visual Studio vous permet de développer des applications à l’aide de divers langages de programmation.
Des didacticiels, des vidéos et d’autres documents vous montrent comment créer des applications et du code à l’aide de Visual Studio.
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Découvrir comment installer et configurer Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Obtenir une vue d’ensemble de Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Studio 2017 sur Microsoft Virtual Academy</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="experience-visual-studio-with-5-minute-quickstarts"></a>Utiliser Visual Studio en suivant des guides de démarrage rapide de 5 minutes
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>S’orienter dans l’environnement de développement intégré (IDE)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Découvrir les projets et les solutions</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Personnaliser les couleurs des thèmes et du texte</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Créer une application web avec C#</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Créer une application console avec C++</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Créer une application web avec Python</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="go-deeper-with-tutorials"></a>Approfondir en suivant des didacticiels
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>Débogage</span></a></div>