...
- Personnalisez les Assistants de création de projets à partir de modèles.
   ...
   Pour plus d'informations, voir [Procédure : utiliser des Assistants avec des modèles de projet (extensibilité)](../extensibility/how-to-use-wizards-with-project-templates.md).
