...
> [Démarrage rapide : personnaliser l’IDE](../ide/quickstart-personalize-the-ide.md)
...
- [Fonctionnalités de Visual Studio 2017](../ide/advanced-feature-overview.md)