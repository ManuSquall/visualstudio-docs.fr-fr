# [Vue d’ensemble de l’IDE Visual Studio](visual-studio-ide.md)
...
## [Optimiser les performances de Visual Studio](optimize-visual-studio-startup-time.md)
...
# [Environnement connecté](connected-environment.md)
...
## [Comment déverrouiller Visual Studio](how-to-unlock-visual-studio.md)
