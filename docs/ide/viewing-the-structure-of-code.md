...
helpviewer_keywords: 
  ...
  - "définition de code (fenêtre)"
  - "structure du document (fenêtre)."
  - "Explorateur d'objets"
  - "Visual Studio, Hiérarchie d'appels (fenêtre)"
  - "Visual Studio, affichage de classes"
  - "Visual Studio, définition de code (fenêtre)"
  - "Visual Studio, Structure du document (fenêtre)"
  - "Visual Studio, Explorateur d'objets"
