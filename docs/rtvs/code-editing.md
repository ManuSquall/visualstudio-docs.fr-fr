...
![Couleurs de syntaxe pour le code R](~/rtvs/media/editing-syntax-colors.png)
...
![Polices et options de couleur pour le code R](~/rtvs/media/editing-syntax-colors-options.png)

Visual Studio souligne également les erreurs de syntaxe dans l’éditeur :

![Mise en surbrillance des erreurs de syntaxe dans le code R](~/rtvs/media/editing-syntax-error.png)
...
![Animation de la mise en forme inline](~/rtvs/media/editing-inline-formatting.gif)
...
![Animation du retrait automatique](~/rtvs/media/editing-auto-indentation.gif)
...
![Création d’une zone réductible avec des commentaires](~/rtvs/media/editing-collapsible-regions.gif)
...
![Animation de l’aperçu de la définition](~/rtvs/media/editing-peek-definition.gif)
...
L’application de la mise en forme la transformera en ce qui suit :
...
![Animation de l’insertion d’un commentaire Roxygen](~/rtvs/media/editing-roxygen-comments.gif)
