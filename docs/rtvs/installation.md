...
> [!Note]
> Après avoir installé Outils R, vous pouvez configurer une disposition optimisée pour les scientifiques des donnée dans Visual Studio, comme décrit dans la rubrique [Options](options.md).
