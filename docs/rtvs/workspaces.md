...
![Fenêtre Espaces de travail dans les Outils R pour Visual Studio (VS2017)](~/rtvs/media/workspaces-window.png)
...
![Ajout d’un nouvel espace de travail](~/rtvs/media/workspaces-add-new.png)
...
![Erreur quand aucun espace de travail n’est lié à RTVS](~/rtvs/media/workspaces-disconnected-interactive-window.png)
...
![Avertissement du certificat auto-signé lors de la connexion à un espace de travail distant](~/rtvs/media/workspaces-remote-self-signed-certificate-warning.png)
...
![Onglet d’exécution Propriétés du projet avec les paramètres de transfert de fichiers](~/rtvs/media/workspaces-remote-file-transfer-filter-settings.png)
