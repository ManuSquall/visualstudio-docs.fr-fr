...
![Fenêtre Explorateur de variables dans Visual Studio](~/rtvs/media/variable-explorer-window.png)
...
![Vue de tableau de l’Explorateur de variables](~/rtvs/media/variable-explorer-table-view.png)
...
![Vue de tableau du tri des données d’après deux colonnes.](~/rtvs/media/variable-explorer-table-view-sorting.png)
...
Pour une manipulation et une analyse approfondies, il est souvent utile d’exporter des variables de session au format CSV, ce que vous pouvez faire avec la petite icône Excel (![icône d’exportation Excel](~/rtvs/media/variable-explorer-excel-icon.png)) en regard de chaque nœud dans l’Explorateur de variables, ou en double-cliquant sur un élément et en sélectionnant **Ouvrir dans l’application CSV**. Quand vous sélectionnez l’icône, les données sont écrites dans un nouveau fichier CSV dans le dossier `%userprofile%\Documents\RTVS_CSV_Exports`, et ce fichier s’ouvre dans l’application associée à l’extension `.csv`.
...
![Explorateur de variables montrant une portée de package](~/rtvs/media/variable-explorer-package-scopes.png)
...
![Explorateur de variables montrant une trame de données pendant le débogage](~/rtvs/media/variable-explorer-as-locals-window.png)
...
![Boîte de dialogue Importer le jeu de données](~/rtvs/media/variable-explorer-import-dataset-dialog.png)
