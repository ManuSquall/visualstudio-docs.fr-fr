---
title: "Configuration de Service R à distance pour Linux | Microsoft Docs"
ms.custom: 
ms.date: 12/04/2017
ms.reviewer: 
ms.suite: 
...
## <a name="setting-up-remote-r-service"></a>Configuration de Service R à distance
