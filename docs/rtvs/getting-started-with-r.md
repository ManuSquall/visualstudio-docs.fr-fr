---
title: "Bien démarrer avec R dans Visual Studio | Microsoft Docs"
ms.custom: 
ms.date: 06/29/2017
ms.reviewer: 
ms.suite: 
...
1. Appuyez une nouvelle fois sur Ctrl+A et sur Ctrl+Entrée pour exécuter le code, et obtenir le résultat suivant :
