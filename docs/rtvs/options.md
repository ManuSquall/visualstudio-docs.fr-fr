...
Ces options contrôlent la façon dont les valeurs sont gérées dans l’[Explorateur de variables](variable-explorer.md) et dans les fenêtres du débogueur, comme Espion et Variables locales (voir [Débogage](debugging.md)).
